...
public class Common_ghin extends HttpServlet {
 ...
 public static void testXML(PrintWriter out) {
     
  try {
      
      //String urlString = "http://www.foretees.com/inquiryTest.htm";
      String urlString = "http://www.foretees.com/postTest.xml";
        
      DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
      DocumentBuilder builder = factory.newDocumentBuilder();
      Document document = getDocument(builder, urlString);
      Node root = document.getDocumentElement(); // allows direct access to the child node that is the root element of the document
      
      NodeList childNodes = document.getElementsByTagName("Login");
      
      out.println("<br>" + root.getNodeName() + " has " + childNodes.getLength() + " child elements.");
      
      
      //out.print("<br>Here is the document's root node: " + root.getNodeName());
      ...
      for (int i = 0; i < childNodes.getLength(); i++) {
        ...
        out.println("<br>child node " + i + " name is: " + currentNode.getNodeName());
      }
      ...
      out.println("<br><br>The first child of " + root.getNodeName() + " node is: " + currentNode.getNodeName());

      // get next sibling of first child
      out.print("<br>whose next sibling is: ");
      currentNode = currentNode.getNextSibling();
      if (currentNode == null) return;
      out.println(currentNode.getNodeName());

      // print value of next sibling of first child
      out.println("<br>value of " + currentNode.getNodeName() + " element is: "
          + currentNode.getNodeValue());

      // print name of parent of next sibling of first child
      out.print("<br>Parent node of " + currentNode.getNodeName() + " is: "
          + currentNode.getParentNode().getNodeName());  

    } 
    // handle exception creating DocumentBuilder
    catch (ParserConfigurationException parserError) {
      out.println("<br>Parser Configuration Error");
...
/*
    ...
    // handle exception parsing XML document
      ...
      out.println("Error Parsing Document");
