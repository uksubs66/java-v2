...
if (awmSupported){
var awmMenuPath;
if (document.layers) mpi=((document.images['awmMenuPathImg-foreteesMember'])?document.images['awmMenuPathImg-foreteesMember'].src:document.layers['xawmMenuPathImg-foreteesMember'].document.images['awmMenuPathImg-foreteesMember'].src); else mpi=document.images['awmMenuPathImg-foreteesMember'].src;
...
if (awmSupported){
awmImagesColl=['Mem_Tee_Times.gif',84,24,'Mem_Lessons.gif',75,24,'Mem_Events.gif',50,24,'Mem_Search.gif',66,24,'Mem_Email.gif',59,24,'Mem_Partners.gif',59,24,'Mem_Settings.gif',58,24];
