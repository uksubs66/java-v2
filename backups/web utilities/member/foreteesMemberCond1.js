...
//C:\JAVA\Tomcat\webapps\v5\web utilities\member\ForeteesMemberCond1.awm
var awmMenuName='foreteesMemberCond1';
var awmLibraryBuild=532;
var awmLibraryPath='/awmData-foreteesMemberCond1';
var awmImagesPath='/awmData-foreteesMemberCond1';
...
if (awmSupported){
var awmMenuPath;
if (document.layers) mpi=((document.images['awmMenuPathImg-foreteesMemberCond1'])?document.images['awmMenuPathImg-foreteesMemberCond1'].src:document.layers['xawmMenuPathImg-foreteesMemberCond1'].document.images['awmMenuPathImg-foreteesMemberCond1'].src); else mpi=document.images['awmMenuPathImg-foreteesMemberCond1'].src;
...
if (awmSupported){
awmImagesColl=['Mem_Tee_Times.gif',84,24,'Mem_Lessons.gif',75,24,'Mem_Events.gif',50,24,'Mem_Search.gif',66,24,'Mem_Partners.gif',59,24,'Mem_Settings.gif',58,24];
...
it=s0.addItemWithImages(2,3,3,"","","","",0,0,0,0,0,0,n,n,n,"",n,n,n,n,n);
...
it=s0.addItemWithImages(2,3,3,"","","","Maintain your buddy list.",4,4,4,0,0,0,n,n,n,"",n,n,"exeMenuAction('servlet/Member_buddy', 'get')",n,n);
it=s0.addItemWithImages(2,3,3,"","","","Maintain your personal configuration settings (email address, mode of transportation, etc.).",5,5,5,0,0,0,n,n,n,"",n,n,"exeMenuAction('servlet/Member_services', 'get')",n,n);
s0.pm.buildMenu();
}}
