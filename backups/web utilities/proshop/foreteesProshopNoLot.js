...
//C:\JAVA\Tomcat\webapps\v5\web utilities\proshop\ForeteesProshopNoLott.awm
var awmMenuName='foreteesProshopNoLot';
var awmLibraryBuild=532;
var awmLibraryPath='/awmData-foreteesProshopNoLot';
var awmImagesPath='/awmData-foreteesProshopNoLot';
...
if (awmSupported){
var awmMenuPath;
if (document.layers) mpi=((document.images['awmMenuPathImg-foreteesProshopNoLot'])?document.images['awmMenuPathImg-foreteesProshopNoLot'].src:document.layers['xawmMenuPathImg-foreteesProshopNoLot'].document.images['awmMenuPathImg-foreteesProshopNoLot'].src); else mpi=document.images['awmMenuPathImg-foreteesProshopNoLot'].src;
...
if (awmSupported){
awmImagesColl=['ProTee_Sheets.gif',85,24,'ProTee_Sheets-over.gif',85,24,'Event_Sign_Up.gif',92,24,'Event_Sign_Up-over.gif',91,24,'ProLessons.gif',71,24,'ProLessons-over.gif',71,24,'ProReports.gif',68,24,'ProReports-over.gif',67,24,'ProTools.gif',53,24,'ProTools-over.gif',54,24,'ProSystem_Config.gif',107,24,'ProSystem_Config-over.gif',106,24];
...
it=s0.addItemWithImages(2,3,4,"","","","Access the Event Registration Sheets.",2,3,3,0,0,0,n,n,n,"",n,n,"exeMenuAction('servlet/Proshop_events1', 'post')",n,n);
