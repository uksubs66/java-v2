...
public class Proshop_report_course_rounds extends HttpServlet {
      ...
      try {
         ...
         return;
            ...
            out.println("<table border=\"0\" bgcolor=\"#F5F5DC\" cellpadding=\"5\">");
               ...
               out.println("</tr><tr>");                     // Combined Rounds for Members
               out.println("<td align=\"right\">");
                  out.println("<font size=\"2\">");
                  out.println("Combinded Rounds:");
                  out.println("</font><br></td>");

               out.println("<td align=\"center\">");
                  out.println("<font size=\"2\">");
                  out.println(buildDisplayValue(mem18Rounds3 + (mem9Rounds3 / 2), 0, totRounds3));
                  out.println("</font><br></td>");
               ...
               out.println("</tr><tr>");                     // Combined Rounds for Guests
               out.println("<td align=\"right\">");
                  out.println("<font size=\"2\">");
                  out.println("Combinded Rounds:");
                  out.println("</font><br></td>");
               ...
               out.println("<td align=\"center\">");
                  out.println("<font size=\"2\">");
                  out.println(buildDisplayValue(gst18Rounds3 + (gst9Rounds3 / 2), 0, totRounds3));
                  out.println("</font><br></td>");
               ...
               if (otherRounds3 > 0) {
                  ...
                  out.println("</tr><tr>");                     // Combined Rounds for Others
                  out.println("<td align=\"right\">");
                     out.println("<font size=\"2\">");
                     out.println("Combinded Rounds:");
                     out.println("</font><br></td>");
                     ...
                     out.println("<td align=\"center\">");
                     out.println("<font size=\"2\">");
                     out.println(buildDisplayValue(other18Rounds3 + (other9Rounds3 / 2), 0, totRounds3));
                     out.println("</font><br></td>");
 ...
 private void doCustomDate(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
   ...
   // grand totals for combined rounds
   int gtotRounds1 = 0;
   int gmemRounds1 = 0;
   int gmem9Rounds1 = 0;
   int gmem18Rounds1 = 0;
   ...
   int ggst18Rounds1 = 0;
   int gotherRounds1 = 0;
   int gother9Rounds1 = 0;
   int gother18Rounds1 = 0;
   ...
   while (count2 > 0) {
     ...
     // increment our combined rounds counts
     gtotRounds1 += totRounds1;
     gmemRounds1 += memRounds1;
     gmem9Rounds1 += mem9Rounds1;
     gmem18Rounds1 += mem18Rounds1;
     ggstRounds1 += gstRounds1;
     ggst9Rounds1 += gst9Rounds1;
     ggst18Rounds1 += gst18Rounds1;
     gotherRounds1 += otherRounds1;
     gother9Rounds1 += other9Rounds1;
     gother18Rounds1 += other18Rounds1;
      ...
      out.println("<br><table border=\"0\" bgcolor=\"#F5F5DC\" cellpadding=\"5\">");
        ...
        out.println("<tr bgcolor=\"#336633\"><td>");
         ...
         out.println("</tr><tr>");                     // combined rounds
         out.println("<td align=\"right\">");
            out.println("<font size=\"2\">");
            out.println("Combined Rounds:");
            out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(mem18Rounds1 + (mem9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gst18Rounds1 + (gst9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
         ...
         if (otherRounds1 > 0) {
            ...
            out.println(buildDisplayValue(other18Rounds1, 0, totRounds1));
             ...
             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(other18Rounds1 + (other9Rounds1 / 2), 0, 0));
             out.println("</font><br></td>");
   ...
   if (multi != 0) {
      ...
      out.println("<br><table border=\"0\" bgcolor=\"#F5F5DC\" cellpadding=\"5\">");
        ...
        out.println("<tr bgcolor=\"#336633\"><td colspan=\"3\">");
        out.println("<font color=\"#FFFFFF\" face=\"verdana\" size=\"3\">");
        out.println("<p align=\"center\"><b>Combined Course Totals</b></p>");
        out.println("</font></td></tr>");
        ...
        out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br><b>");
            out.println(buildDisplayValue(gtotRounds1, 0, 0));
            out.println("</b></font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(gmemRounds1, 0, gtotRounds1));
            out.println("</b></font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem9Rounds1, 0, gtotRounds1));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem18Rounds1, 0, gtotRounds1));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem18Rounds1 + (gmem9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(ggstRounds1, 0, gtotRounds1));
            out.println("</b></font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br>");
            out.println(buildDisplayValue(ggst9Rounds1, 0, gtotRounds1));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst18Rounds1, 0, gtotRounds1));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst18Rounds1 + (ggst9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
         ...
         if (otherRounds1 > 0) {
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(gotherRounds1, 0, gtotRounds1));
               out.println("</b></font></td>");
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\"><br>");
            out.println(buildDisplayValue(gother9Rounds1, 0, gtotRounds1));
               out.println("</font></td>");
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gother18Rounds1, 0, gtotRounds1));
               out.println("</font></td>");
            ...
            out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gother18Rounds1 + (gother9Rounds1 / 2), 0, 0));
            out.println("</font><br></td>");
        ...
        if (req.getParameter("excel") == null) {
            ...
            out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_report_course_rounds\">");
                ...
                out.println("<input type=hidden name=cal_box_0 value=\"" + start_date + "\">");
                out.println("<input type=hidden name=cal_box_1 value=\"" + end_date + "\">");
                out.println("<input type=\"submit\" value=\"All Course Details\" style=\"text-decoration:underline; background:#8B8970\">");
            out.println("</form>");
   ...
   } // end if display combined course totals
 ...
 private void doRound(HttpServletRequest req, HttpServletResponse resp, PrintWriter out, HttpSession sess, Connection con) {
   ...
   int gotherRounds4 = 0;
   int gother9Rounds1 = 0;
   int gother9Rounds2 = 0;
   int gother9Rounds4 = 0;
   int gother18Rounds1 = 0;
   int gother18Rounds2 = 0;
   int gother18Rounds4 = 0;
   int gotherCRounds1 = 0;
   int gotherCRounds2 = 0;
   int gotherCRounds4 = 0;
   int ggnshowRounds4 = 0;
   int ggnshowRounds2 = 0;
   int ggnshowRounds1 = 0;
   //
   //  Array to hold the course names
   //
   String [] course = new String [20];                     // max of 20 courses per club
   ...
   while (count > 0) {
      ...
      try {
         ...
         //
         PreparedStatement pstmt1 = con.prepareStatement (
            "SELECT * FROM stats5 WHERE date >= ? AND course = ?");

         //
         //  Statement for Last Month's counts 
         //
         PreparedStatement pstmt3 = con.prepareStatement (
            "SELECT * FROM stats5 WHERE date >= ? AND date <= ? AND course = ?");
      ...
      out.println("<tr bgcolor=\"" +bgrndcolor+ "\">");
         ...
         //  Build the HTML for each stat gathered above
         //
         out.println("</tr><tr>");                       // Grand total for this course
         out.println("<td align=\"left\">");
            out.println("<font size=\"2\"><br>");
            out.println("<b>Total Rounds Played:</b>");
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            ...
            out.println("</b></font></td>");
gtotRounds4 += totRounds4;
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br><b>");
            out.println(buildDisplayValue(totRounds2, 0, 0));
            out.println("</b></font></td>");
gtotRounds2 += totRounds2;
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br><b>");
            out.println(buildDisplayValue(totRounds1, 0, 0));
            out.println("</b></font></td>");
gtotRounds1 += totRounds1;
         ...
         int tot18Rounds2;
         int tot18Rounds4;
         tot9Rounds1 = mem9Rounds1 + gst9Rounds1 + other9Rounds1; // added others
         tot9Rounds2 = mem9Rounds2 + gst9Rounds2 + other9Rounds2;
         tot9Rounds4 = mem9Rounds4 + gst9Rounds4 + other9Rounds4;
         tot18Rounds1 = mem18Rounds1 + gst18Rounds1 + other18Rounds1;
         tot18Rounds2 = mem18Rounds2 + gst18Rounds2 + other18Rounds2;
         tot18Rounds4 = mem18Rounds4 + gst18Rounds4 + other18Rounds4;
         
         
         gtot9Rounds1 += tot9Rounds1;
         gtot9Rounds2 += tot9Rounds2;
         gtot9Rounds4 += tot9Rounds4;
         gtot18Rounds1 += tot18Rounds1;
         gtot18Rounds2 += tot18Rounds2;
         gtot18Rounds4 += tot18Rounds4;
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(tot18Rounds4 + (tot9Rounds4 / 2), 0, 0));
            out.println("</font><br></td>");
gtotCRounds4 += tot18Rounds4 + (tot9Rounds4 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(tot18Rounds2 + (tot9Rounds2 / 2), 0, 0));
         out.println("</font><br></td>");
gtotCRounds2 += tot18Rounds2 + (tot9Rounds2 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(tot18Rounds1 + (tot9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
gtotCRounds1 += tot18Rounds1 + (tot9Rounds1 / 2);
...
gmem18Rounds1 += mem18Rounds1;
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(mem18Rounds4 + (mem9Rounds4 / 2), 0, 0));
            out.println("</font><br></td>");
gmemCRounds4 += mem18Rounds4 + (mem9Rounds4 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(mem18Rounds2 + (mem9Rounds2 / 2), 0, 0));
         out.println("</font><br></td>");
gmemCRounds2 += mem18Rounds2 + (mem9Rounds2 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(mem18Rounds1 + (mem9Rounds1 / 2), 0, 0));
         out.println("</font><br></td>");
gmemCRounds1 += mem18Rounds1 + (mem9Rounds1 / 2);
...
ggst18Rounds1 += gst18Rounds1;
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gst18Rounds4 + (gst9Rounds4 / 2), 0, 0));
            out.println("</font></td>");
ggstCRounds4 += gst18Rounds4 + (gst9Rounds4 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gst18Rounds2 + (gst9Rounds2 / 2), 0, 0));
         out.println("</font></td>");
ggstCRounds2 += gst18Rounds2 + (gst9Rounds2 / 2);
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gst18Rounds1 + (gst9Rounds1 / 2), 0, 0));
         out.println("</font></td>");
ggstCRounds1 += gst18Rounds1 + (gst9Rounds1 / 2);
...
gotherRounds1 += otherRounds1;
            ...
            out.println("<td align=\"center\">");
               ...
               out.println("</font></td>");
gother9Rounds4 += other9Rounds4;
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(other9Rounds2, 0, totRounds2));
               out.println("</font></td>");
gother9Rounds2 += other9Rounds2;
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(other9Rounds1, 0, totRounds1));
               out.println("</font></td>");
gother9Rounds1 += other9Rounds1;
            ...
            out.println("<td align=\"center\">");
               ...
               out.println("</font></td>");
gother18Rounds4 += other18Rounds4;
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(other18Rounds2, 0, totRounds2));
               out.println("</font></td>");
gother18Rounds2 += other18Rounds2;
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(other18Rounds1, 0, totRounds1));
               out.println("</font></td>");
gother18Rounds1 += other18Rounds1;
            out.println("</tr><tr>");                     // Combined Rounds
             ...
             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(other18Rounds4 + (other9Rounds4 / 2), 0, 0));
                out.println("</font></td>");
gotherCRounds4 += other18Rounds4 + (other9Rounds4 / 2);
             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(other18Rounds2 + (other9Rounds2 / 2), 0, 0));
             out.println("</font></td>");
gotherCRounds2 += other18Rounds2 + (other9Rounds2 / 2);
             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(other18Rounds1 + (other9Rounds1 / 2), 0, 0));
             out.println("</font></td>");
gotherCRounds1 += other18Rounds1 + (other9Rounds1 / 2);
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(nshowRounds4, 0, 0));
            out.println("<br></font></td>");
ggnshowRounds4 += nshowRounds4;
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(nshowRounds2, 0, 0));
            out.println("<br></font></td>");
ggnshowRounds2 += nshowRounds2;
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(nshowRounds1, 0, 0));
            out.println("<br></font></td>");
ggnshowRounds1 += nshowRounds1;
   ...
   if (multi != 0) {
    ...
    out.println("</font></td></tr>");
      ...
      out.println("<tr bgcolor=\"" + bgrndcolor + "\">");
         ...
         //  Build the HTML for each stat gathered above
         //
         out.println("</tr><tr>");                       // Grand totals for ALL courses
         out.println("<td align=\"left\">");
            out.println("<font size=\"2\"><br>");
            out.println("<b>Total Rounds Played:</b>");
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br><b>");
            out.println(buildDisplayValue(gtotRounds4, 0, 0));
            out.println("</b></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><br><b>");
            out.println(buildDisplayValue(gtotRounds2, 0, 0));
            out.println("</b></font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot9Rounds4, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot9Rounds2, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot9Rounds1, 0, 0));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot18Rounds4, 0, 0));
            out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot18Rounds2, 0, 0));
         out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtot18Rounds1, 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtotCRounds4, 0, 0));
            out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtotCRounds2, 0, 0));
         out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gtotCRounds1, 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(gmemRounds4, 0, 0));
            out.println("</b></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(gmemRounds2, 0, 0));
            out.println("</b></font></td>");

         out.println("<td align=\"center\">");
         out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(gmemRounds1, 0, 0));
            out.println("</b></font></td>");         
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem9Rounds4, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem9Rounds2, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem9Rounds1, 0, 0));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem18Rounds4, 0, 0));
            out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem18Rounds2, 0, 0));
         out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmem18Rounds1, 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmemCRounds4, 0, 0));
            out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmemCRounds2, 0, 0));
         out.println("</font><br></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(gmemCRounds1, 0, 0));
         out.println("</font><br></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(ggstRounds4, 0, 0));
            out.println("</b></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(ggstRounds2, 0, 0));
            out.println("</b></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(ggstRounds1, 0, 0));
            out.println("</b></font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst9Rounds4, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst9Rounds2, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst9Rounds1, 0, 0));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst18Rounds4, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst18Rounds2, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggst18Rounds1, 0, 0));
            out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggstCRounds4, 0, 0));
            out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggstCRounds2, 0, 0));
         out.println("</font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggstCRounds1, 0, 0));
         out.println("</font></td>");
         ...
         //  Only display 'Others' if there were some found (non-members, non-guests)
         //
         if (gotherRounds1 > 0 || gotherRounds2 > 0 || gotherRounds4 > 0) {
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\"><b>");
               out.println(buildDisplayValue(gotherRounds4, 0, 0));
               out.println("</b></font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\"><b>");
               out.println(buildDisplayValue(gotherRounds2, 0, 0));
               out.println("</b></font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\"><b>");
               out.println(buildDisplayValue(gotherRounds1, 0, 0));
               out.println("</b></font></td>");
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother9Rounds4, 0, 0));
               out.println("</font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother9Rounds2, 0, 0));
               out.println("</font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother9Rounds1, 0, 0));
               out.println("</font></td>");
            ...
            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother18Rounds4, 0, 0));
               out.println("</font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother18Rounds2, 0, 0));
               out.println("</font></td>");

            out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println(buildDisplayValue(gother18Rounds1, 0, 0));
               out.println("</font></td>");
            ...
            out.println("</tr><tr>");                     // Combined Rounds
             ...
             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(gotherCRounds4, 0, 0));
                out.println("</font></td>");

             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(gotherCRounds2, 0, 0));
             out.println("</font></td>");

             out.println("<td align=\"center\">");
                out.println("<font size=\"2\">");
                out.println(buildDisplayValue(gotherCRounds1, 0, 0));
             out.println("</font></td>");
         ...
         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggnshowRounds4, 0, 0));
            out.println("<br></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggnshowRounds2, 0, 0));
            out.println("<br></font></td>");

         out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            out.println(buildDisplayValue(ggnshowRounds1, 0, 0));
            out.println("<br></font></td>");
 ...
 private void doCustomDateDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    if (courseName.equals("-ALL-")) { courseClause = "courseName = ? AND "; }
 ...
 private String buildDisplayDateTime() {
    ...
    return "<i>This report generated on " + df_full.format(cal.getTime()) + "</i>";
