...
public class Proshop_report_course_rounds extends HttpServlet {
 ...
 private void doTodaySummary(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    while (count > 0) {
        ...
        displayCourseSummary(courseName, edate, edate, 0, excel, con, out);
    ...
    if (multi != 0) {
        ...
        displayCourseSummary("-ALL-", edate, edate, 0, excel, con, out);
 ...
 private void doTodayDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    if (g_debug) out.println("<!-- sdate=" + sdate + " | edate=" + edate + " | curr_time=" + curr_time + " -->");
   ...
   if (multi != 0) {           // if multiple courses supported for this club
    ...
    while (count > 0) {
        ...
        out.println("<tr bgcolor=\"" +bgrndcolor+ "\"><td>");
         ...
         displayCourseSummary(courseName, sdate, edate, 2, excel, con, out);
    ...
    if (multi != 0) {     
        ...
        displayCourseSummary("-ALL-", sdate, edate, 2, excel, con, out);
 ...
 private void doTransDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    while (count > 0) {
        ...
        displayTransportationQuery(courseName, sdate, edate, 13, excel, con, out);
    ...
    try {
            ...
            if (rs.getString(2) == null && rs.getString(3) == null && rs.getString(4) == null) {
                ...
                if (rs.getString(3) == null && rs.getString(4) == null) {
                    ...
                    if (rs.getString(3) != null && rs.getString(4) == null) {
                        ...
                        // hack
                        if (fld_tmode[rs_rows] == null) { 
                            fld_tmode[rs_rows] = ""; 
                            if (g_debug) out.println("<!-- NULL FOUND AT " + rs_rows + " -->"); 
                        }
        ...
        while (tmp_index < rs_rows) {
            ...
            //error_text = "Loop2 - Q " + tmp_index + "/" + rs_rows;
                ...
                out.println(buildDisplayValue(trans_type9Total[tmp_trans_types], trans_type18Total[tmp_trans_types], totRounds, pExcel));
            ...
            if (!tmp_mship_type.equals(fld_mship[tmp_index])) {
                ...
                out.println(buildDisplayValue(trans_mship9Total[tmp_mship_types], trans_mship18Total[tmp_mship_types], totRounds, pExcel));
                out.println("</b></font></td>");
                out.println("</tr>");
                out.println("<tr><td colspan=\"4\"></td></tr>");
            ...
            if (fld_sum9[tmp_index] + fld_sum18[tmp_index] > 0) {
                ...
                out.println("<td align=\"center\" nowrap>");
                out.println("<font size=\"2\"><b>");
                out.println(buildDisplayValue(fld_sum9[tmp_index], fld_sum18[tmp_index], totRounds, pExcel));
                out.println("</b></font></td>");
            ...
            error_text = "Loop2 C " + tmp_index + "/" + rs_rows;
                if (fld_sum18[tmp_index] > 0) {
                    ...
                    out.println(buildDisplayValue(fld_sum18[tmp_index], 0, totRounds, pExcel));
                    out.println("</font></td>");
                }
            ...
            error_text = "Loop2 D " + tmp_index + "/" + rs_rows;
                if (fld_sum9[tmp_index] > 0) {
                    ...
                    out.println("</font></td>");
                    out.println("<td align=\"center\" nowrap><font size=\"2\">");
                    out.println(buildDisplayValue(fld_sum9[tmp_index], 0, totRounds, pExcel));
                    out.println("</font></td>");
                }
 ...
 private void displayMemberTypeQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    try {
        ...
        while (tmp_index < tmp_mem_types) {
            ...
            out.println(buildDisplayValue(mem_type9Total[tmp_index], mem_type18Total[tmp_index], totalMemberRounds, pExcel));
            out.println("</font></td>");
            ...
            out.println(buildDisplayValue(mem_type18Total[tmp_index], 0, totalMemberRounds, pExcel));
            out.println("</font></td>");
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(mem_type9Total[tmp_index], 0, totalMemberRounds, pExcel));
            out.println("</font></td>");
 ...
 private void displayMemberShipTypeQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    while (tmp_index < rs_rows1) {
        ...
        if (!memship_type[tmp_index].equals(tmp_memship_type)) {
            ...
            out.println("<td align=\"center\">");
            out.println("<font size=\"2\"><b>");
            out.println(buildDisplayValue(memship_type9[tmp_index1] + memship_type18[tmp_index1], 0, totalMemberRounds, pExcel));
            out.println("</b></font></td>");
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(memship_type18[tmp_index1], 0, totalMemberRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">9 Hole Rounds:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(memship_type9[tmp_index1], 0, totalMemberRounds, pExcel));
            out.println("</font></td>");
        ...
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">");
        out.println(buildDisplayValue(mem_type9[tmp_index] + mem_type18[tmp_index], 0, totalMemberRounds, pExcel));
        out.println("</font></td>");
        ...
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(mem_type18[tmp_index], 0, totalMemberRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"right\">");
        out.println("<font size=\"2\">9 Hole Rounds:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(mem_type9[tmp_index], 0, totalMemberRounds, pExcel));
        out.println("</font></td>");
 ...
 private void displayGuestTypeQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    while (tmp_index < rs_rows1) {
        ...
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">");
        out.println(buildDisplayValue(gst_type9[tmp_index] + gst_type18[tmp_index], 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        ...
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(gst_type18[tmp_index], 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"right\">");
        out.println("<font size=\"2\">9 Hole Rounds:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(gst_type9[tmp_index], 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
 ...
 private void displayCourseSummary(String pCourseName, long pStartDate, long pEndDate, int pReportType, String pExcel, Connection con, PrintWriter out){
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalMemRounds, 0, 0, pExcel));
    out.println("</b></font></td>");
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalGstRounds, 0, 0, pExcel));
    out.println("</b></font></td>");
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalNsRounds, 0, 0, pExcel));
    out.println("</b></font></td>");
 ...
 private void displayCourseSummaryBig(String pCourseName, String pExcel, Connection con, PrintWriter out){
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalMemRounds1, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalMemRounds2, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalMemRounds3, 0, 0, pExcel));
    out.println("</b></font></td>");
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalGstRounds1, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalGstRounds2, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalGstRounds3, 0, 0, pExcel));
    out.println("</b></font></td>");
    ...
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalNsRounds1, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalNsRounds2, 0, 0, pExcel));
    out.println("</b></font></td>");
    out.println("<td align=\"center\">");
    out.println("<font size=\"2\"><b>");
    out.println(buildDisplayValue(totalNsRounds3, 0, 0, pExcel));
    out.println("</b></font></td>");
