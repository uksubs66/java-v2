...
*/        
 ...
 private void convert(HttpServletRequest req, PrintWriter out, Connection con, HttpSession session, HttpServletResponse resp) {
    ...
    try {
        ...
        PreparedStatement pstmt = con.prepareStatement ("SELECT * FROM lreqs3 WHERE id = ?");
        pstmt.clearParameters();
    ...
    if (count == 1) {
        ...
        if (group == 1) {
            ...
            if (group == 1) 
                ...
                { tmp_pos = ((fives == 0) ? 4 : 5) * (group - 1); }
            int tmp = 0;
            int tmp_loop = 1;
            for (tmp = tmp_pos; tmp <= tmp_pos + ((fives == 0) ? 4 : 5); tmp++) {
            ...
            switch (group) {
                ...
                case 1:
                    fields = "player1 = 'MOVED', player2 = 'MOVED', player3 = 'MOVED', player4 = 'MOVED'";
                    break;
            ...
            try {
                ...
                pstmt.setString(5, slotParms.user1);
                pstmt.setString(6, slotParms.user2);
                pstmt.setString(7, slotParms.user3);
                pstmt.setString(8, slotParms.user4);
                pstmt.setString(9, slotParms.p1cw);
                pstmt.setString(10, slotParms.p2cw);
                pstmt.setString(11, slotParms.p3cw);
                pstmt.setString(12, slotParms.p4cw);
                pstmt.setString(13, slotParms.mNum1);
                pstmt.setString(14, slotParms.mNum2);
                pstmt.setString(15, slotParms.mNum3);
                pstmt.setString(16, slotParms.mNum4);
                pstmt.setString(17, slotParms.userg1);
                pstmt.setString(18, slotParms.userg2);
                pstmt.setString(19, slotParms.userg3);
                pstmt.setString(20, slotParms.userg4);
                pstmt.setInt(21, slotParms.p91);
                pstmt.setInt(22, slotParms.p92);
                pstmt.setInt(23, slotParms.p93);
                pstmt.setInt(24, slotParms.p94);
                pstmt.setInt(25, slotParms.pos1);
                pstmt.setInt(26, slotParms.pos2);
                pstmt.setInt(27, slotParms.pos3);
                pstmt.setInt(28, slotParms.pos4);
                
                // if this was a 5 player pos
                pstmt.setString(29, slotParms.player5);
                pstmt.setString(30, slotParms.user5);
                pstmt.setString(31, slotParms.p5cw);
                pstmt.setString(32, slotParms.mNum5);
                pstmt.setString(33, slotParms.userg5);
                pstmt.setInt(34, slotParms.p95);
                pstmt.setInt(35, slotParms.pos5);

                pstmt.setInt(36, lottery_id);
