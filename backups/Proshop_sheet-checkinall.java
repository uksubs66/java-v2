   ...
   try {
      ...
      if (req.getParameter("print") == null) {
        ...
        if (fives == 0) {
            ...
            sqlQuery3 = "SELECT COUNT(date) AS total FROM teecurr2 WHERE " + courseClause + " date = ? AND blocker = '' AND player1 <> '' AND player2 <> '' AND player3 <> '' AND player4 <> '';"; // AND restriction = '' 
        } else {
            // query  to count the total # of tee times available
            sqlQuery1 =  "SELECT COUNT(date) AS total FROM teecurr2 WHERE " + courseClause + " date = ? AND blocker = \"\";"; //  AND restriction = \"\"
           ...
           sqlQuery2 = "SELECT SUM(subtotal) AS total FROM (" +
                ...
                ") AS gtotal;";
            // query to count the # of completly full tee times (all player positions are occupied)
            sqlQuery3 = "SELECT COUNT(date) AS total FROM teecurr2 WHERE " + courseClause + " date = ? AND blocker = '' AND player1 <> '' AND player2 <> '' AND player3 <> '' AND player4 <> '' AND (rest5 <> '' OR player5 <> '');"; // AND restriction = '' 
...
*/
        ...
        out.println("</td></tr></table>"); // end tee sheet legend
