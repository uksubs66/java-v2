 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("checkallin") != null) {
      ...
      try {
        ...
        //displayDatabaseErrMsg(exp.getMessage(), exp.toString() , out);
      }
...
*/
        ...
        out.println("<tr valign=\"top\"><td align=\"center\" rowspan=\"2\" width=\"150\">");
            ...
            out.println("w = window.open ('/" +rev+ "/servlet/Proshop_diary?index=" +num+ "&course=" +courseName1+ "&year=" +year+ "&month=" +month+ "&day=" +day+ "','clientIdPopup','width=640,height=455,scrollbars=1,dependent=0,directories=0,location=0,menubar=0,resizable=1,status=0,toolbar=0');");
            ...
            out.println("if (y == '' || y == null) return;");
            ...
            if (blocker.equals( "" ) && lskip == 0) {    // continue if tee time not blocked & not lottery - else skip
               ...
               if (in_use == 0 && noSubmit == 0) {                      // if not in use, then create submit button
                  ...
                  if (lstate > 0 && lstate < 5) {
                     ...
                     //
                     if (medinahMemTime == true || oaktime == true || mcctime == true || beartime == true) { // if Medinah, Oakmont or Milwaukee special time
                        ...
                        if ((club.equals( "ironwood" ) || club.equals( "lakes" ) || club.equals( "meadowsprings" )) && type == shotgun) {  // if Ironwood & Shotgun Event
                           ...
                           if (club.equals( "oswegolake" ) && !notes.equals( "" )) {   // if Oswego Lake and Notes included - orange

                              if (min < 10) {                                 // if min value is only 1 digit
                                 out.println("<input type=\"submit\" name=\"" + submit + "\" value=\"" + hr + ":0" + min + ampm + "\" alt=\"submit\" style=\"text-decoration:none; background:orange\">");
                              } else {                                        // min value is 2 digits
                                 out.println("<input type=\"submit\" name=\"" + submit + "\" value=\"" + hr + ":" + min + ampm + "\" alt=\"submit\" style=\"text-decoration:none; background:orange\">");
                              }
