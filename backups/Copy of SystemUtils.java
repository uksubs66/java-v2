 ...
 *               unfilter (changes special characters back for jump code) *** not used ***
...
//   public static String HOST = "mail.foretees.com";          // ****** for localhost testing !!!!!!!!!!!!!!
...
//   public static String PORT = "587";                       // TRAVIS port for emails
   ...
   //
   static long memDay1 = 20060529;        // Memorial Day (Monday)
   static long memDay2 = 20070528;
   static long july4th1 = 20060704;       // Actual 4th of July
   static long july4th2 = 20070704;
   static long july3rd1 = 20060703;
   static long july3rd2 = 20070703;
   static long laborDay1 = 20060904;      // Labor Day (Monday)
   static long laborDay2 = 20070903;

   //
   //  Time value save area for inactTimer verification
   //
...
//    return(DOCTYPE + "\n" +
 ...
 public synchronized static HttpSession verifyMem(HttpServletRequest req, PrintWriter out) {
...
//      logError(errorMsg);                           // log it
 ...
 //
 public synchronized static HttpSession verifyMem2(HttpServletRequest req, PrintWriter out) {
 ...
 public synchronized static HttpSession verifyHotel(HttpServletRequest req, PrintWriter out) {
...
//      out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">");
 ...
 public synchronized static HttpSession verifyPro(HttpServletRequest req, PrintWriter out) {
...
//      logError(errorMsg);                           // log it
 ...
 public synchronized static HttpSession verifyAdmin(HttpServletRequest req, PrintWriter out) {
...
//      out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">");
 ...
 public synchronized static void buildTee(int year, int month, int day, int day_name, String course, String club, Connection con)
         throws Exception {
...
*/
         ...
         //      April 21, 28
         //      May 4, 5, 10, 11, 19
         //      June 1, 7, 9, 15, 16, 29, 30
         //      July 7, 13, 26, 28 
         //      August 3, 4, 10, 16, 17 25, 31
         //      Sept  21, 22, 29
         //      Oct   5, 6
         //
         //******************************************************************************************
         ...
         if (club.equals( "westchester" ) && course.equalsIgnoreCase( "south" )) {     
            ...
            if (month == 5) {         // May
               ...
               if (day == 4 || day == 5 || day == 10 || day == 11 || day == 19) {
            ...
            if (month == 6) {         // June
               ...
               if (day == 1 || day == 7 || day == 9 || day == 15 || day == 16 || day == 29 || day == 30) {
            ...
            if (month == 8) {         // August
               ...
               if (day == 3 || day == 4 || day == 10 || day == 16 || day == 17 || day == 25 || day == 31) {
         ...
         //  Intervals:
         //
         //     Sat & Sun -  All year long the 1st 4 tee times are 8 minute intervals, then
         //                  the rest of the day its 10 minute intervals, though the 10 minute
         ...
         while (thistime <= lasttime) {
            ...
            if (club.equals( "piedmont" )) {       // if Piedmont Driving Club
               ...
               if ((name.equalsIgnoreCase( "saturday" ) || name.equalsIgnoreCase( "sunday" )) && count < 3) {
                    
                  min = min + 8;            // 1st 3 intervals on Sat & Sun are 8 minutes

               } else {

                  if ((name.equalsIgnoreCase( "saturday" ) || name.equalsIgnoreCase( "sunday" )) && count == 3) {

                     min = min + 6;            // go from hh:x4 to hh:x0
 ...
 public synchronized static void buildHTee(int year, int month, int day, int day_name, String course, Connection con)
         throws Exception {
 ...
 public synchronized static void moveTee(Connection con, long today_date, String club)
           throws Exception {
   ...
   try {
      ...
      while (rs.next()) {
         ...
         ecolor = rs.getString(10);
         rest = rs.getString(11);
         rcolor = rs.getString(12);
         player1 = rs.getString(13);
         player2 = rs.getString(14);
         player3 = rs.getString(15);
         player4 = rs.getString(16);
         user1 = rs.getString(17);
         user2 = rs.getString(18);
         user3 = rs.getString(19);
         user4 = rs.getString(20);
         p1cw = rs.getString(21);
         p2cw = rs.getString(22);
         p3cw = rs.getString(23);
         p4cw = rs.getString(24);
         show1 = rs.getShort(33);
         show2 = rs.getShort(34);
         show3 = rs.getShort(35);
         show4 = rs.getShort(36);
         fb = rs.getShort(37);
         player5 = rs.getString(38);
         user5 = rs.getString(39);
         p5cw = rs.getString(40);
         show5 = rs.getShort(42);
         notes = rs.getString(43);
         course = rs.getString(46);
         blocker = rs.getString(47);
         proNew = rs.getInt(48);
         proMod = rs.getInt(49);
         memNew = rs.getInt(50);
         memMod = rs.getInt(51);
         mNum1 = rs.getString(54);
         mNum2 = rs.getString(55);
         mNum3 = rs.getString(56);
         mNum4 = rs.getString(57);
         mNum5 = rs.getString(58);
 ...
 public synchronized static void teeTimer()
                          throws Exception {
 ...
 public synchronized static boolean scanTee(Connection con, String club)
                          throws Exception {
...
/*
         // ******** TEMP (see below also)  to force tee sheets to be built
         if (xx == 0) {
...
*/
   ...
   if (doneSome == true) {             // if we built any new tee times
      ...
      try {
         ...
         Calendar cal = new GregorianCalendar();        // get todays date again for movetee
         year = cal.get(Calendar.YEAR);
         month = cal.get(Calendar.MONTH);
         day = cal.get(Calendar.DAY_OF_MONTH);
         day_name = cal.get(Calendar.DAY_OF_WEEK);
 ...
 public static void insertTee2(parmTee parm, Connection con)
   ...
   try {
      ...
      SystemUtils.updateHist(parm.edate, parm.day, parm.time, parm.fb, parm.courseName, parm.player1, parm.player2, parm.player3,
 ...
 //************************************************************************
 //  unfilter - Searches the string provided for special characters and
 //           replaces them with HTML friendly characters.
 //
 //           < becomes &lt
 //           > becomes &gt
 ...
 public synchronized static void updateTeecurr(Connection con) {
 ...
 public synchronized static void doRests(Connection con) {
 ...
 public synchronized static void do1Rest(Connection con, String name) {
 ...
 public synchronized static void doFives(Connection con) {
 ...
 public synchronized static void do1Five(Connection con, String name) {
 ...
 public synchronized static void doEvents(Connection con) {
 ...
 public synchronized static void do1Event(Connection con, String name) {
 ...
 public synchronized static void doBlockers(Connection con) {
 ...
 public synchronized static void do1Blocker(Connection con, String name) {
      ...
      if (rs.next()) {
         ...
         if (courseName.equals( "-ALL-" )) {    // if ALL Courses
            ...
            if ( recurr.equalsIgnoreCase( "every day" ) ) {   // if everyday
               ...
               PreparedStatement pstmt1 = con.prepareStatement (
                 "UPDATE teecurr2 SET blocker = ? WHERE " +
                 "date >= ? AND date <= ? AND time >= ? AND " +
                 "time <= ? ");
 ...
 public synchronized static void doLotteries(Connection con) {
 ...
 public synchronized static void do1Lottery(Connection con, String name) {
 ...
 public synchronized static long getLottId(Connection con) {
   ...
   if (con != null) {
      ...
      try {
         ...
         if (rs.next()) {                 // only one per timer expiration (if more, wait for next timer exp)
            ...
            processLott(name, date, con);      // process this lottery
         } 
      ...
      //
      // *************************************************************************************************
      //  Custom processing for North Ridge, Rogue Valley, Manito, The Lakes, Cherry Hills
      // *************************************************************************************************
      //
...
//         if (ptime > 929 && ptime < 934) {      // release restrictions at 7:30 AM PT
 ...
 private static void processLott(String name, long date, Connection con) {
...
//         "ORDER BY players DESC");                    // process larger groups first
            ...
            if (ttime == time2 && tfb == parm.rfb) {   // if matching time/fb found
               ...
               while (grps > 0) {
                  ...
                  if (astat == 0 || bstat == 0) {   // if before or after still open to check
                     ...
                     if (parmc.id2A[i3] == 0 && parmc.timeA[i3] > 0) {  // if spot open (check associated entry in Id Array)
 ...
 private synchronized static boolean checkInUse(Connection con, long id) {
 ...
 public static int get1WeightP(Connection con, String user, long sdate, long edate) {
   ...
   try {
      ...
      PreparedStatement pstmt2 = con.prepareStatement (
                "SELECT mins " +
                "FROM lassigns5 WHERE date >= ? AND date <= ?");
      ...
      if (count == 0) {              // if no weight yet
         ...
         if (weight > 0) {              // make sure weight is non-zero (0 indicates user got all requested times)
 ...
 public static void xTimer() {
   ...
   if (server_id == server_master) {
      ...
      try {
         ...
         while (rs.next()) {               // process each club
            ...
            if (con2 != null) {
               ...
               xTees(club, con2);                    // check this club's tee sheets for X's

               xEvents(club, con2);                  // check this club's event signup sheets for X's

               con2.close();                   // close the connection to this club

            } else {

               String errorMsg = "Error in SystemUtils xTimer - unable to get con for club: " +club;
               logError(errorMsg);                                       // log it
            }
         ...
         //  save error message in /v_x/error.txt
         //
         String errorMsg = "Error in SystemUtils xTimer: ";
         errorMsg = errorMsg + e2.getMessage();                                 // build error msg
...
//      logError(errorMsg);                                       // log it
 ...
 public synchronized static void removeLessonBlockers(Connection con, long today_date, String club)
           throws Exception {
...
*/
 ...
 public synchronized static void logError2(String msg, parmLott parm, parmLottC parmc) {
