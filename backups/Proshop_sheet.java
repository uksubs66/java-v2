...
public class Proshop_sheet extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   //
   // if notes display, event/restriction/lottery display, POS (Jonas) Report Requested, or Notes Report
   //
   ...
   if (noShow == true) {
      ...
      try {
         ...
         if (checkedOut == true && (parmp.posType.equals( "Jonas" ) || parmp.posType.equals( "NorthStar" ) ||
             ...
             parmp.posType.equals( "TAI Club Management" ) || parmp.posType.equals( "IBS" ))) {
   ...
   //
   if (club.equals( "medinahcc" ) || club.equals( "bellerive2006" ) || club.equals( "diablocc" ) || club.equals( "stalbans" ) ||
       club.equals( "royaloakscc" )) {
   ...
   try {
      ...
      //
      //  Custom for Desert Highlands & Columbine - refresh the tee sheet every 9 minutes for proshop5 (bag room) between 7 AM and 7 PM.
      //
      if ((club.equals( "deserthighlands" ) || club.equals( "columbine" )) && user.equalsIgnoreCase( "proshop5" )) {
     ...
     out.println("<tr valign=\"top\"><td align=\"center\" rowspan=\"2\" width=\"150\">");
         ...
         if (paceofplay != 0 && index == 0) {

             //
             // Decide if we are going to show the pace report link in the control panel
             //
             int pace_count = 0;
             try {
     ...
     out.println("<script type=\"text/javascript\">");
      out.println("function openHistoryWindow(tid, index, course, time, fb) {");
      out.println("w = window.open ('/" +rev+ "/servlet/Proshop_teetime_history?tid=' +tid+ '&index=' +index+ '&course=' +course+ '&time=' +time+ '&fb=' +fb+ '&history=yes','historyPopup','width=800,height=455,scrollbars=1,dependent=0,directories=0,location=0,menubar=0,resizable=1,status=0,toolbar=0');");
      out.println("w.creator = self;");
      out.println("}");
     ...
     out.println("</font><font size=\"2\">");
      ...
      if (paceofplay != 0 && index == 0) out.println("&nbsp;&nbsp;&nbsp;<b>PP:</b> Pace of Play");
      ...
      //
      //  Custom for Desert Highlands & Columbine - proshop5 (bag room) - display view-only tee sheet with bag room #s
      //
      if ((club.equals( "deserthighlands" ) || club.equals( "columbine" )) && user.equalsIgnoreCase( "proshop5" )) {
      ...
      out.println("<tr bgcolor=\"#336633\">");
         ...
         if (paceofplay != 0 && index == 0) {            // only show for today and if club has PoP enabled
             out.println("<td align=\"center\">");
                out.println("<font color=\"#FFFFFF\" size=\"1\">");
      ...
      while (rs.next()) {
         ...
         if (blocker.equals( "" ) && lskip == 0) {    // continue if tee time not blocked & not lottery - else skip
            ...
            */
            ...
            out.println("<input type=\"image\" src=\"/" +rev+ "/images/history.gif\" width=\"12\" height=\"13\" border=\"0\" onclick=\"openHistoryWindow(" + teecurr_id + ", " + index + ",'" + courseNameT + "', " + time + "," + fb + ");return false;\" title=\"Click here to view tee time history.\">");
            out.println("</td></form>");         // end of the teetime history col

            //
            // Add Pace of Play link
            //
            if (paceofplay != 0 && index == 0 && (!player1.equals(""))) {
 ...
 // ********************************************************************************************
 //  Process the POS charges for this day - Abacus21, Jonas, CSG, NorthStar, IBS or TAI
 // ********************************************************************************************
   ...
   if (req.getParameter("POScontinue") == null) {
      ...
      try {
         ...
         while (rs.next()) {
            ...
            if (parmp.posType.equals( "TAI Club Management" ) || parmp.posType.equals( "IBS" )) {
         ...
         if (parmp.player.equals( "" )) {    // if member
            ...
            while (i < parmp.MAX_Mships) {
               ...
               if (parmp.mship[i].equalsIgnoreCase( mship )) {     // if matching mode mship type
                  ...
                  desc = "Greens Fees for Membership Classification";       // item description
