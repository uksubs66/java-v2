...
*/
    ...
    if (Utilities.isFTConnectClub(req) > 0 && Utilities.isFTConnectProUser(user, req)) {
        out.println("<tr><td><a href=\"Proshop_jump?switch&activity_id=8000\" class=linkA target=_top>ForeTees Connect - Home</a></td></tr>");
        out.println("<tr><td><a href=\"Proshop_jump?switch&activity_id=8001\" class=linkA target=_top>ForeTees Connect - Staff Directory</a></td></tr>");
        out.println("<tr><td><a href=\"Proshop_jump?switch&activity_id=8003\" class=linkA target=_top>ForeTees Connect - Newsletters</a></td></tr>");
    }
