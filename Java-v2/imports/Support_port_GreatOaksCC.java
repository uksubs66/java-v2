...
*/           
            ...
            if (mtype.equals("?")) {
                ...
                if (mtype.equalsIgnoreCase("A")) {
                    primary = 1;
                } else if (mtype.equalsIgnoreCase("B")) {
                    primary = 2;
                } else if (mtype.equalsIgnoreCase("C")) {
                    primary = 3;
                } else if (mtype.equalsIgnoreCase("D")) {
                    primary = 4;
                } else if (mtype.equalsIgnoreCase("E")) {
                    primary = 5;
                } else if (mtype.equalsIgnoreCase("F")) {
                    primary = 6;
                } else if (mtype.equalsIgnoreCase("G")) {
                    primary = 7;
                } else if (mtype.equalsIgnoreCase("H")) {
                    primary = 8;
                } else if (mtype.equalsIgnoreCase("I")) {
                    primary = 9;
                }
