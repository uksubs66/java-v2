...
//            mtype = toTitleCase( mtype );
            ...
            if (mship.equalsIgnoreCase("Spouse") || mship.equalsIgnoreCase("Child")) {
            ...
            if (!mship.equalsIgnoreCase("SKIP") && !mship.equalsIgnoreCase("?")) {
            if (dupName == false) {
               ...
               try {
                ...
                out.println("<br>Primary m_ship not found for " + lname + ", " + fname);
            }
