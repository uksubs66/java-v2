...
*/           
            ...
            if (mem_id.equals("1")) {
                ...
                mtype = "Adult Female";
                gender = "F";
            } else if (mem_id.equals("2")) {
                mem_id = mNum + "B";
                mtype = "Dependent";
            } else if (mem_id.equals("3")) {
                mem_id = mNum + "C";
                mtype = "Dependent";
            } else if (mem_id.equals("4")) {
                mem_id = mNum + "D";
                mtype = "Dependent";
            } else if (mem_id.equals("5")) {
                mem_id = mNum + "E";
                mtype = "Dependent";
            } else if (mem_id.equals("6")) {
                mem_id = mNum + "F";
                mtype = "Dependent";
            } else if (mem_id.equals("7")) {
                mem_id = mNum + "G";
                mtype = "Dependent";
            } else if (mem_id.equals("8")) {
                mem_id = mNum + "H";
                mtype = "Dependent";
            } else if (mem_id.equals("9")) {
                mem_id = mNum + "I";
                mtype = "Dependent";
            } else {
                mem_id = mNum;
