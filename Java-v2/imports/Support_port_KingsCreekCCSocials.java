...
*/          
            ...
            } else if (pri.startsWith("D")) {
              
                if (pri.equalsIgnoreCase("D1")) {
                    mem_id += "B";
                } else if (pri.equalsIgnoreCase("D2")) {
                    mem_id += "C";
                } else if (pri.equalsIgnoreCase("D3")) {
                    mem_id += "D";
                } else if (pri.equalsIgnoreCase("D4")) {
                    mem_id += "E";
                } else if (pri.equalsIgnoreCase("D5")) {
                    mem_id += "F";
                } else if (pri.equalsIgnoreCase("D6")) {
                    mem_id += "G";
                } else if (pri.equalsIgnoreCase("D7")) {
                    mem_id += "H";
                } else if (pri.equalsIgnoreCase("D8")) {
                    mem_id += "I";
                }
