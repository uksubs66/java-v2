...
*/           
            ...
            } else if (mship.equalsIgnoreCase("CHILD")) {
            ...
            if (mNum.endsWith("A") || mNum.endsWith("B") || mNum.endsWith("C") || mNum.endsWith("D") || mNum.endsWith("E") 
             || mNum.endsWith("F") || mNum.endsWith("G") || mNum.endsWith("H") || mNum.endsWith("I")) {
                ...
                if (mNum.endsWith("A")) {
                    primary = 1;
                } else if (mNum.endsWith("B")) {
                    primary = 2;
                } else if (mNum.endsWith("C")) {
                    primary = 3;
                } else if (mNum.endsWith("D")) {
                    primary = 4;
                } else if (mNum.endsWith("E")) {
                    primary = 5;
                } else if (mNum.endsWith("F")) {
                    primary = 6;
                } else if (mNum.endsWith("G")) {
                    primary = 7;
                } else if (mNum.endsWith("H")) {
                    primary = 8;
                } else if (mNum.endsWith("I")) {
                    primary = 9;
                }
            ...
            if (mship.equalsIgnoreCase("ACT") || mship.equalsIgnoreCase("JAA") || mship.equalsIgnoreCase("JAB") || mship.equalsIgnoreCase("JAC") || mship.equalsIgnoreCase("SEN A")) {
                mship = "Active";
            } else if (mship.equalsIgnoreCase("ASO") || mship.equalsIgnoreCase("JASC") || mship.equalsIgnoreCase("SSA")) {
                mship = "Associate";
            } else if (mship.equalsIgnoreCase("SPOUSE") || mship.equalsIgnoreCase("SSG")) {
                mship = "Spouse of Active";
            } else if (mship.equalsIgnoreCase("SEN B")) {
                mship = "Senior B";
            } else if (mship.equalsIgnoreCase("CHILD")) {
                mship = "Child";
            } else if (mship.equalsIgnoreCase("NRG")) {
                mship = "Non-Resident Golf";
            } else if (mship.equalsIgnoreCase("SEN")) {
                mship = "Senior No Access";
            }
