...
*/           
            ...
            String [] tempLname = lname.split(" ");
            
            mem_id = tempFname[0].toLowerCase().substring(0, 1) + "." + tempLname[0].toLowerCase();
            ...
            int tempMship = Integer.parseInt(mship);
            
            if (tempMship <= 36) {
                mship = "Mt Bachelor 4A";
            } else if (tempMship >= 37 && tempMship <= 39) {
                mship = "Mt Bachelor 3A";
            } else if (tempMship >= 40 && tempMship <= 42) {
                mship = "Mt Bachelor 2A";
            } else if (tempMship >= 43 && tempMship <= 44) {
                mship = "Mt Bachelor 1A";
            } else if (tempMship >= 45 && tempMship <= 47) {
                mship = "Mt Hood 4A";
            } else if (tempMship >= 48 && tempMship <= 49) {
                mship = "Mt Hood 3A";
            } else if (tempMship >= 50 && tempMship <= 53) {
                mship = "Mt Hood 2A";
            } else if (tempMship >= 54) {
                mship = "Mt Hood 1A";
            }
