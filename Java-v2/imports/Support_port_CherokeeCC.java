...
*/           
            ...
            if (mship.equalsIgnoreCase("Non")) {
                mship = "Non Resident";
            } else if (mship.equalsIgnoreCase("Res")) {
                mship = "Resident";
            } else if (mship.equalsIgnoreCase("Loa")) {
                mship = "Leave of Absence";
            } else if (mship.equalsIgnoreCase("Leg")) {
                mship = "Legacy";
            } else if (mship.equalsIgnoreCase("Ldy")) {
                mship = "Lady";
            } else if (mship.equalsIgnoreCase("Sen")) {
                mship = "Senior";
            } else if (mship.equalsIgnoreCase("Pro")) {
                mship = "Provisional";
            } else if (mship.equalsIgnoreCase("Aro")) {
                mship = "Associate Resident";
            } else if (mship.equalsIgnoreCase("Min")) {
                mship = "Minister";
            } else {
                mship = "Unknown - " + mship;
            }
            ...
            } else if (mtype.equalsIgnoreCase("Dependant")) {
