...
//            mtype = toTitleCase( mtype );
            ...
            } else if (mNum.endsWith("B") || mNum.endsWith("C") || mNum.endsWith("D") || mNum.endsWith("E") || mNum.endsWith("F") || mNum.endsWith("G") || mNum.endsWith("H") || mNum.endsWith("I")) {
                mNum = mNum.substring(0,mNum.length()-1);
            ...
            if (mship.equalsIgnoreCase("Dependent")) {
                    ...
                    if (rs.next()) {
                        ...
                        out.println("<br>m_ship not found for: " + lname + ", " + fname);
                    }
                    rs.close();
                    pstmt2.close();
