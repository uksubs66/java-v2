...
*/
            ...
            if (mship.equals("?")) {
                try {
                    PreparedStatement tempstmt = con.prepareStatement("SELECT m_ship FROM member2b where username=?");
                    tempstmt.clearParameters();
                    tempstmt.setString(1, mNum);

                    ResultSet temprs = tempstmt.executeQuery();

                    if (temprs.next()) {
                        mship = temprs.getString("m_ship");
                    } else {
                        mship = "Unknown - no primary found";
                    }
                } catch (Exception exc) {
                    mship = "Unknown - error";
                }
