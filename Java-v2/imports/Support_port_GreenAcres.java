...
*/
            ...
            if (mNum.endsWith("S") || mNum.endsWith("SO") || mNum.endsWith("C") || mNum.endsWith("C1") || mNum.endsWith("C2") || mNum.endsWith("C3") || mNum.endsWith("C4")
                    || mNum.endsWith("C5") || mNum.endsWith("C6") || mNum.endsWith("C7") || mNum.endsWith("C8") || mNum.endsWith("C9") || mNum.endsWith("S1") || mNum.endsWith("c1"))  {

                if (mNum.endsWith("S")) {
                    primary = 1;
                    mNum = mNum.substring(0, mNum.length() - 1);
                } else if (mNum.endsWith("SO") || mNum.endsWith("S1")) {
                    primary = 1;
                ...
                try {
                    pstmt3 = con.prepareStatement("SELECT m_ship FROM member2b WHERE username = ?");
                    ...
                    if (rs2.next()) {
                        ...
                        mship = "Unknown - "  + mship;
                        out.println("<br>No Primary found for " + lname + ", " + fname + " " + mi);
                    }

                    pstmt3.close();

                } catch (Exception ignore) {
                    out.println("<br>Error looking up " + lname + ", " + fname + " " + mi);
                    out.println("<br>" + ignore.getMessage());
