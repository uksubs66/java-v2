...
*/                       
            ...
            primary = Integer.parseInt(mem_id.substring(mem_id.length() - 1));
            
            if (mship.startsWith("Golf Regular")) {
                mship = "Golf Regular";
            }
            
            if (mem_id.endsWith("-000") || mem_id.endsWith("-001")) {
