   ...
   try {
      ...
      while ((line = bfrin.readLine()) != null) {            // get one line of text
         ...
         if (!lname.equals("?")) {
             ...
             depen = true;
             tok.nextToken();       // eat next '?'
             lname = tok.nextToken();
             fname = "temp";
             relVal = tok.nextToken();
             temp = tok.nextToken();
...
//         posid = tok.nextToken();
           ...
           if (!depen && !mnum_curr.equals(mNum)) {
               mnum_curr = mNum;
               lname_curr = lname;
           }
...
*/           
            ...
            if (depen) {
                ...
                primary = Integer.parseInt(relVal);
...
//            mtype = toTitleCase( mtype );
            ...
            if (!fname2.equals( "" )) {
               ...
               phone2 = "";
                ...
                StringTokenizer tokx = new StringTokenizer(fname2, " ");

                if (tokx.countTokens() == 1) {
                    fname2 = fname2;
                    lname2 = lname_curr;
                } else if (tokx.countTokens() == 2) {
                    fname2 = tokx.nextToken();
                    lname2 = tokx.nextToken();
                } else {
                    fname2 = tokx.nextToken();
                    mi = tokx.nextToken();
                    lname2 = tokx.nextToken();
