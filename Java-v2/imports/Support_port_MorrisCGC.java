...
*/           
            ...
            if (mship.equalsIgnoreCase("Honorary")) {
                mship = "Honorary";
            } else if (mship.equalsIgnoreCase("House Waiting Regular")) {
                mship = "House Waiting";
            } else if (mship.equalsIgnoreCase("Jr Non-Resident") || mship.equalsIgnoreCase("Junior Regular")) {
                mship = "Junior";
            } else if (mship.equalsIgnoreCase("Senior House") || mship.equalsIgnoreCase("Widow House")) {
                mship = "House";
            } else if (mship.equalsIgnoreCase("Senior Regular") || mship.equalsIgnoreCase("Widow Regular")) {
                mship = "Regular";
            } else if (mship.equalsIgnoreCase("Senior Social")) {
                mship = "Senior Social";
            } else if (mship.equalsIgnoreCase("Sr Non-Resident")) {
                mship = "Non Resident";
            } else {
                mship = "Unknown - " + mship;
            }
