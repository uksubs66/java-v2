...
public class Support_port extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   ArrayList<String> privCodes = new ArrayList<String>();
...
*/           
            ...
            if (mtype.equals("?")) {
                ...
                StringTokenizer tokx = new StringTokenizer(mtype, "#");

                String temptok = "";

                // load up privilege codes
                while (tokx.countTokens() > 0) {

                    temptok = tokx.nextToken().trim();

                    if (!temptok.equals("")) {
                        privCodes.add(temptok);
                    }
                }
                
                // loop through privilege codes and see if any match
                for (int j=0; j < privCodes.size(); j++) {

                    if (privCodes.get(j).equals("P00") || privCodes.get(j).equals("P01") || privCodes.get(j).equals("P02") || privCodes.get(j).equals("P03") ||
                        privCodes.get(j).equals("P0W") || privCodes.get(j).equals("P11") || privCodes.get(j).equals("P13")) {

                        mship = "MHGP";
                        msubtype = "AP";
                        break;

                    } else if (privCodes.get(j).equals("P06") || privCodes.get(j).equals("P07") || privCodes.get(j).equals("P08") || privCodes.get(j).equals("P0N")) {

                        mship = "MHGP";
                        msubtype = "NP";
                        break;

                    } else if (privCodes.get(j).equals("P09") || privCodes.get(j).equals("P12")) {

                        mship = "WSGPS";
                        msubtype = "WG";
                        break;

                    } else if (privCodes.get(j).equals("P10")) {

                        mship = "WSGPS";
                        msubtype = "WN";
                        break;

                    } else if (privCodes.get(j).equals("P18")) {

                        mship = "Member";
                        msubtype = "FJ";
                        break;

                    } else if (privCodes.get(j).equals("P19")) {

                        mship = "Member";
                        msubtype = "FN";
                        break;

                    } else if (privCodes.get(j).equals("P05")) {

                        mship = "Jr Golf";
                        msubtype = "IG";
                        break;

                    } else if (privCodes.get(j).equals("P04") || privCodes.get(j).equals("P17")) {

                        mship = "Jr Golf";
                        msubtype = "JR";
                        break;

                    } else if (privCodes.get(j).equals("P15")) {

                        mship = "MHGP";
                        msubtype = "BG";
                        break;

                    } else if (privCodes.get(j).equals("P22")) {

                        mship = "Member";
                        msubtype = "G80";
                        break;

                    } else if (privCodes.get(j).equals("G01")) {
            ...
            if (msubtype.equals("")) {
                // Member didn't fall under any of the privilege code classifications, check if they fall under one of the dues class categories with no privilege codes.
                if (mship.equals("AC0") || mship.equals("AC1") || mship.equals("AC2") || mship.equals("AC3") || mship.equals("AC4") ||
                    mship.equals("ACU") || mship.equals("ACW") ||
                    mship.equals("AT1") || mship.equals("AT2") || mship.equals("AT3") || mship.equals("AT4") ||
                    mship.equals("ATU") || mship.equals("ATW") ||
                    mship.equals("AV0") || mship.equals("AV1") || mship.equals("AV2") || mship.equals("AV3") || mship.equals("AV4") ||
                    mship.equals("CN1") || mship.equals("CN2") || mship.equals("CN3") || mship.equals("CN4") ||
                    mship.equals("DW1") || mship.equals("DW3") || mship.equals("DW5") ||
                    mship.equals("HON") ||
                    mship.equals("SN1") || mship.equals("SN2") ||
                    mship.equals("UNV")) {

                    mship = "Member";
                    msubtype = "MN";

                } else if (mship.equals("NRE") || mship.equals("ACN") || mship.equals("ATN")) {

                    mship = "Member";
                    msubtype = "NN";

                } else if (mship.equals("JUN") || mship.equals("JUV")) {

                    mship = "Jr No Golf";
                    msubtype = "JJ";

                } else if (mship.equals("INT") || mship.equals("ACI") || mship.equals("ATI")) {

                    mship = "Jr No Golf";
                    msubtype = "IM";

                } else if (mship.equals("NMG")) {
            ...
            //  If no mship classification could be determined, skip this member
            if (skip) {
                out.println("<br>Unknown or non-golf membership type: " + lname + ", " + fname);
                continue;
            }
...
//            mtype = toTitleCase( mtype );
            ...
            if (dupName == false) {
               ...
               try {
                  ...
                  pstmt2.setString(18, msubtype);
                  pstmt2.setString(19, email2);
                  pstmt2.setString(20, phone);
                  pstmt2.setString(21, phone2);
                  pstmt2.setString(22, webid);
                  pstmt2.setString(23, gender);
                  pstmt2.setInt(24, primary);
