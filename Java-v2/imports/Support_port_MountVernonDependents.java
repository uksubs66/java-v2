...
//         webid = tok.nextToken();
  //       posid = tok.nextToken();
         ...
         // make sure we have the essentials
           ...
           // get last name
           pstmt3 = con.prepareStatement("SELECT name_last, m_ship FROM member2b WHERE username = ?");
...
//            birth = getBirthValue(temp, 0);
            ...
            if (ageInt < 12) {
                mtype = "Dependent Under 12";
            } else if (ageInt < 18) {
                mtype = "Dependent 12-17";
            } else {
                mtype = "Dependent 18 and Up";
            }
