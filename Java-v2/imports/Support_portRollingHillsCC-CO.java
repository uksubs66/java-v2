...
*/
            ...
            if (lname3.equals( "?" )) {
               ...
               lname3 = "";
                ...
                tokdep = new StringTokenizer(lname3, " ");

                if (tokdep.countTokens() < 2) {
                    fname3 = tokdep.nextToken();
                    lname3 = lname;
                } else if (tokdep.countTokens() == 2) {
                    fname3 = tokdep.nextToken();
                    lname3 = tokdep.nextToken();
                } else if (tokdep.countTokens() > 2) {
                    fname3 = tokdep.nextToken() + " " + tokdep.nextToken();
                    lname3 = tokdep.nextToken();
                }
            }
            ...
            if (lname4.equals( "?" )) {
               ...
               lname4 = "";
                ...
                tokdep = new StringTokenizer(lname4, " ");

                if (tokdep.countTokens() < 2) {
                    fname4 = tokdep.nextToken();
                    lname4 = lname;
                } else if (tokdep.countTokens() == 2) {
                    fname4 = tokdep.nextToken();
                    lname4 = tokdep.nextToken();
                } else if (tokdep.countTokens() > 2) {
                    fname4 = tokdep.nextToken() + " " + tokdep.nextToken();
                    lname4 = tokdep.nextToken();
                }
            }
            ...
            if (lname5.equals( "?" )) {
               ...
               lname5 = "";
                ...
                tokdep = new StringTokenizer(lname5, " ");

                if (tokdep.countTokens() < 2) {
                    fname5 = tokdep.nextToken();
                    lname5 = lname;
                } else if (tokdep.countTokens() == 2) {
                    fname5 = tokdep.nextToken();
                    lname5 = tokdep.nextToken();
                } else if (tokdep.countTokens() > 2) {
                    fname5 = tokdep.nextToken() + " " + tokdep.nextToken();
                    lname5 = tokdep.nextToken();
                }
            }
            ...
            if (lname6.equals( "?" )) {
               ...
               lname6 = "";
                ...
                tokdep = new StringTokenizer(lname6, " ");

                if (tokdep.countTokens() < 2) {
                    fname6 = tokdep.nextToken();
                    lname6 = lname;
                } else if (tokdep.countTokens() == 2) {
                    fname6 = tokdep.nextToken();
                    lname6 = tokdep.nextToken();
                } else if (tokdep.countTokens() > 2) {
                    fname6 = tokdep.nextToken() + " " + tokdep.nextToken();
                    lname6 = tokdep.nextToken();
                }
            }
            ...
            if (lname7.equals( "?" )) {
               ...
               lname7 = "";
                ...
                tokdep = new StringTokenizer(lname7, " ");

                if (tokdep.countTokens() < 2) {
                    fname7 = tokdep.nextToken();
                    lname7 = lname;
                } else if (tokdep.countTokens() == 2) {
                    fname7 = tokdep.nextToken();
                    lname7 = tokdep.nextToken();
                } else if (tokdep.countTokens() > 2) {
                    fname7 = tokdep.nextToken() + " " + tokdep.nextToken();
                    lname7 = tokdep.nextToken();
                }
            }
