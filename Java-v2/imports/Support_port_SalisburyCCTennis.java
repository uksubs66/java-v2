...
*/           
            ...
            try { primary = Integer.parseInt(mNum.substring(mNum.length() - 1)); }
            catch (Exception ignore) { }
            
            if (mNum.endsWith("-0")) {
                gender = "M";
                mtype = "Adult Male";
            } else if (mNum.endsWith("-1")) {
                gender = "F";
                mtype = "Adult Female";
            } else {
                mtype = "Dependent";
            ...
            mNum = mNum.substring(1, mNum.length() - 2);
            
            while (mem_id.length() < 6) {
                mem_id = "0" + mem_id;
            } 
