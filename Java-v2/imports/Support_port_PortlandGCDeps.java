...
*/
            ...
            if (mNum.toLowerCase().endsWith("a")) {
                primary = 1;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("b")) {
                primary = 2;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("c")) {
                primary = 3;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("d")) {
                primary = 4;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("e")) {
                primary = 5;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("f")) {
                primary = 6;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("g")) {
                primary = 7;
                stripAlpha = true;
            } else if (mNum.toLowerCase().endsWith("h")) {
                primary = 8;
                stripAlpha = true;
            }
            ...
            try {
                ...
                out.println("<br>Error getting mship");
            }
