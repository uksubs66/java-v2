                ...
                if (!dupNameSpouse) {
                    ...
                    try {
                       ...
                       pstmt2.close();              // close the stmt
                             ...
                             out.println("<br>Insert failed for " + lname2 + ", " + fname2);
                       }

                }
                else {
                    out.println("<br>Duplicate found for " + lname2 + ", " + fname2);
                }
