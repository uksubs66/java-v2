...
*/
            ...
            /*
            MEMBERSHIP TYPE CODES			MEMBER TYPE CODES
A = ASSOCIATE			AM = ADULT MALE
AW = ASSOCIATE WEEKDAY			AF = ADULT FEMALE
AS = ASSOCIATE SINGLE			D = DEPENDENT
ASW = ASSOCIATE SINGLE WEEKDAY
F = FAMILY
S = SINGLE
SW = SINGLE WEEKDAY ONLY
TJR = TUES JUNIOR GOLF
              */

            mem_id = mNum;

            if (mtype.equalsIgnoreCase("AM")) {
                mtype = "Adult Male";
                gender = "M";
            } else if (mtype.equalsIgnoreCase("AF")) {
                mtype = "Adult Female";
                gender = "F";
            ...
            if (mship.equalsIgnoreCase("A")) {
                ...
                mship = "Associate Single";
            } else if (mship.equalsIgnoreCase("ASW")) {
                mship = "Associate Single Weekday";
            } else if (mship.equalsIgnoreCase("AW")) {
                mship = "Associate Weekday";
            } else if (mship.equalsIgnoreCase("F")) {
                mship = "Family";
            } else if (mship.equalsIgnoreCase("S")) {
                mship = "Single";
            } else if (mship.equalsIgnoreCase("SW")) {
                mship = "Single Weekday Only";
            } else if (mship.equalsIgnoreCase("TJR")) {
                mship = "Tues Junior Golf";
            }
