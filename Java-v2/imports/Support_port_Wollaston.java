...
*/
            ...
            if (lname.startsWith("MR ") || lname.startsWith("MR. ") || lname.startsWith("MRS") || lname.startsWith("DR ") || lname.startsWith("DR.")) {
                StringTokenizer nameTok = new StringTokenizer(lname, " ");

                nameTok.nextToken();
                    lname = nameTok.nextToken();
            ...
            if (nameTok.countTokens() > 3) {
                fname = nameTok.nextToken();
                fname = fname + " " + nameTok.nextToken();
                lname = nameTok.nextToken();
                lname = lname + " " + nameTok.nextToken();
            } else if (nameTok.countTokens() == 3) {
                fname = nameTok.nextToken();
                tempname = nameTok.nextToken();
                tempname2 = nameTok.nextToken();

                if (tempname2.equalsIgnoreCase("JR") || tempname2.equalsIgnoreCase("SR") || tempname2.equalsIgnoreCase("I")
                         || tempname2.equalsIgnoreCase("II") || tempname2.equalsIgnoreCase("III")) {
                    lname = tempname + " " + tempname2;
                }  else {
                    fname = fname + " " + tempname;
                    lname = tempname2;
                }
            } else if (nameTok.countTokens() == 2) {
                fname = nameTok.nextToken();
                lname = nameTok.nextToken();
            } else {
            ...
            if (mship.equals("") || mship.equals("?")) {
                PreparedStatement pstmt5 = con.prepareStatement("SELECT m_ship FROM member2b WHERE username = ?");
                ResultSet rs5 = null;
                pstmt5.clearParameters();
                pstmt5.setString(1, mNum);

                rs5 = pstmt5.executeQuery();

                if (rs5.next()) {
                    mship = rs5.getString("m_ship");
                } else {
                    mship = "Unknown";
                }
