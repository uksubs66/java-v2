...
*/           
            ...
            if (mNum.endsWith("S") || mNum.endsWith("s")) {
                mem_id = mNum.substring(0, mNum.length() - 1) + "2";
            ...
            if (mship.equalsIgnoreCase("Dependent - Spouse")) {
