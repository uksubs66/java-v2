...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
            ...
            if (!fname3.equals( "" )) {
               ...
               StringTokenizer tok5 = new StringTokenizer(fname3, " ");

               if (tok5.countTokens() > 1) {
                   fname3 = tok5.nextToken();

                   if (tok5.countTokens() == 2) {
                       mi = tok5.nextToken().substring(0,1);
                       lname3 = tok5.nextToken();
                   } else if (tok5.countTokens() == 1) {
                       lname3 = tok5.nextToken();
                   }
               }

               birth = getBirthValue(temp3, 4);
            ...
            if (!fname4.equals( "" )) {
               ...
               StringTokenizer tok5 = new StringTokenizer(fname4, " ");

               if (tok5.countTokens() > 1) {
                   fname4 = tok5.nextToken();

                   if (tok5.countTokens() == 2) {
                       mi = tok5.nextToken().substring(0,1);
                       lname4 = tok5.nextToken();
                   } else if (tok5.countTokens() == 1) {
                       lname4 = tok5.nextToken();
                   }
               }

               birth = getBirthValue(temp4, 4);
            ...
            if (!fname5.equals( "" )) {
               ...
               StringTokenizer tok5 = new StringTokenizer(fname5, " ");

               if (tok5.countTokens() > 1) {
                   fname5 = tok5.nextToken();

                   if (tok5.countTokens() == 2) {
                       mi = tok5.nextToken().substring(0,1);
                       lname5 = tok5.nextToken();
                   } else if (tok5.countTokens() == 1) {
                       lname5 = tok5.nextToken();
                   }
               }

               birth = getBirthValue(temp5, 4);
               password = lname2;
            ...
            if (!fname6.equals( "" )) {
               ...
               StringTokenizer tok5 = new StringTokenizer(fname6, " ");

               if (tok5.countTokens() > 1) {
                   fname6 = tok5.nextToken();

                   if (tok5.countTokens() == 2) {
                       mi = tok5.nextToken().substring(0,1);
                       lname6 = tok5.nextToken();
                   } else if (tok5.countTokens() == 1) {
                       lname6 = tok5.nextToken();
                   }
               }

               birth = getBirthValue(temp6, 4);
            ...
            if (!fname7.equals( "" )) {
               ...
               StringTokenizer tok5 = new StringTokenizer(fname7, " ");

               if (tok5.countTokens() > 1) {
                   fname7 = tok5.nextToken();

                   if (tok5.countTokens() == 2) {
                       mi = tok5.nextToken().substring(0,1);
                       lname7 = tok5.nextToken();
                   } else if (tok5.countTokens() == 1) {
                       lname7 = tok5.nextToken();
                   }
               }

               birth = getBirthValue(temp7, 4);
