...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
               ...
               String [] tempFname = fname2.split(" ");
               
               if (tempFname.length == 1) {
                   fname2 = tempFname[0];
               } else if (tempFname.length == 2) {
                   fname2 = tempFname[0];
                   lname2 = tempFname[1];
               } else if (tempFname.length >= 3) {
                   fname2 = tempFname[0];
                   lname2 = lname;
               }
