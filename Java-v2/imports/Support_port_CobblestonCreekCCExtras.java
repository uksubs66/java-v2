...
*/           
            ...
            try {
                PreparedStatement pstmt6 = con.prepareStatement("SELECT m_ship, pri_indicator FROM member2b where memNum = ? ORDER BY pri_indicator DESC LIMIT 1");
                pstmt6.clearParameters();
                pstmt6.setString(1, mNum);

                ResultSet rs6 = pstmt6.executeQuery();

                if (rs6.next()) {
                    mship = rs6.getString("m_ship");
                    primary = rs6.getInt("pri_indicator") + 1;
                } else {
                    mship = "Unknown";
                    primary = 0;
                }
