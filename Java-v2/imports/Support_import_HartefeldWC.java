         ...
         if ( tok.countTokens() > 0 ) {
            ...
            if (ghin.equals ( "?" )) {
               ...
               ghin = "";
                ...
                // since excel strips leading zeros - add one or two back on
                if (ghin.length() == 5) {
                    ghin = "00" + ghin;
                } else if (ghin.length() == 6) {
                    ghin = "0" + ghin;
                }
            }
         }
...
*/
 ...
 private void portWebid(HttpServletRequest req, PrintWriter out, Connection con, String club) {
    ...
    try {
        ...
        fr = new FileReader("//usr//local//tomcat//webapps//" +club+ "//mship.csv");
    ...
    if (failed == true) {
        ...
        try {
            ...
            fr = new FileReader("c:\\java\\tomcat\\webapps\\" + club + "\\mship.csv");
    ...
    try {
        ...
        while ((line = bfrin.readLine()) != null) {            // get one line of text
            ...
            if (cart.contains("Charter Member Inclusive")) {
                cart = "CHI";
            } else if (cart.contains("Cart Inclusive") && !cart.contains("Non Cart Inclusive") && !cart.contains("Non-Cart Inclusive")) {
                cart = "MCI";
            } else {
                cart = "CRT";
            }
            ...
            if (!user.equals( "" ) && !cart.equals("")) {
               ...
               count = 0;
                   ...
                   sql = "UPDATE member2b SET wc = ? WHERE username = ?";
                   pstmt2 = con.prepareStatement (sql);
                   pstmt2.clearParameters();
                   pstmt2.setString(1, cart);
                ...
                if (count == 0) {    // if not updated - record it (maybe it didn't update because it was already set - not with this api)
                   ...
                   msg = "Member Not Found: mem_id was " +mem_id+ ", name was " +lname+ ", " +fname;
                   logError(msg, club);                           // log it
                   err_nf++;
               ...
               msg = "Username Not Specified: mem_id was " +mem_id+ ", name was " +lname+ ", " +fname;
               logError(msg, club);                           // log it
               err_nf++;
