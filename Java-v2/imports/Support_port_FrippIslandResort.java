...
//         posid = tok.nextToken();
         ...
         if (!lname.equals("?") && !lname.equals("") &&
             !fname.equals("?") && !fname.equals("") && !mNum.equals("") && !mNum.equals("?"))  {   
...
*/           
            ...
            if (mship.equalsIgnoreCase("FIWGG") || mship.equalsIgnoreCase("FIW9")) {
                gender = "F";
                mtype = "Adult Female";
            } else {
                gender = "M";
...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
        ...
        */
             ...
             if (mNum.equals("") || mNum.equals("?")) {
                 out.println("<br>No member number provided for " + lname + ", " + fname);
             }
