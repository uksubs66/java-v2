...
//            mtype = toTitleCase( mtype );
            ...
            mem_id += "-2";
             while (!notfound) { 
                 ...
                 pstmt2 = con.prepareStatement("SELECT username FROM member2b WHERE username = ?");
                 ...
                 if (rs.next()) {
                     notfound = false;
                 if (mem_id.endsWith("-2")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "-3";
                 } else if (mem_id.endsWith("-3")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "-4";
                 } else if (mem_id.endsWith("-4")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "-5";
                 } else if (mem_id.endsWith("-5")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "6";
                 } else if (mem_id.endsWith("-6")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "-7";
                 } else if (mem_id.endsWith("-7")) {
                     mem_id = mem_id.substring(0,mem_id.length()-2);
                     mem_id += "-8";
                 }
                 } else {
            ...
            mtype = "Dependent";
            pstmt2 = con.prepareStatement("SELECT m_ship FROM member2b WHERE memNum = ?");
