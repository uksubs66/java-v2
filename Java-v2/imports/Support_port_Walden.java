...
*/           
            ...
            } else if (mNum.endsWith("C1") || mNum.endsWith("C2") || mNum.endsWith("C3") || mNum.endsWith("C4") || mNum.endsWith("C5") || mNum.endsWith("C6") ||
                       mNum.endsWith("C7") || mNum.endsWith("C8") || mNum.endsWith("C9")) {
                mtype = "Dependent";
                primary = Integer.parseInt(mNum.substring(mNum.length() - 1)) + 1;
