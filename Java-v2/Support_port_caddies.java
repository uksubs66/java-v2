...
public class Support_port_caddies extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   String phone = "";
   String cell_phone = "";
   String cell_provider = "";
   String cell_provider_code = "";
   String email = "";    
   String email2 = "";
   String temp = "";
   int count = 0;
...
//         mi = tok.nextToken();
         ...
         if (!lname.equals("?") && !lname.equals("") &&
            ...
            if ( tok.countTokens() > 0 ) {
               ...
               cell_provider = tok.nextToken();
            }
            if (cell_provider.equals( "?" )) {
            ...
            // If provided, attempt to set the cell phone provider value
            if (!cell_provider.equals("")) {
                if (cell_provider.equalsIgnoreCase("AT&T")) {
                    cell_provider_code = "number@txt.att.net";
                } else if (cell_provider.equalsIgnoreCase("Alltel")) {
                    cell_provider_code = "number@message.alltel.com";
                } else if (cell_provider.equalsIgnoreCase("Boost Mobile")) {
                    cell_provider_code = "number@sms.myboostmobile.com";
                } else if (cell_provider.equalsIgnoreCase("Cricket")) {
                    cell_provider_code = "number@sms.mycricket.com";
                } else if (cell_provider.equalsIgnoreCase("Metro PCS")) {
                    cell_provider_code = "number@mymetropcs.com";
                } else if (cell_provider.equalsIgnoreCase("Nextel")) {
                    cell_provider_code = "number@messaging.nextel.com";
                } else if (cell_provider.equalsIgnoreCase("Powertel")) {
                    cell_provider_code = "number@ptel.com";
                } else if (cell_provider.equalsIgnoreCase("Qwest")) {
                    cell_provider_code = "number@qwestmp.com";
                } else if (cell_provider.equalsIgnoreCase("Sprint")) {
                    cell_provider_code = "number@messaging.sprintpcs.com";
                } else if (cell_provider.equalsIgnoreCase("Suncom")) {
                    cell_provider_code = "number@tms.suncom.com";
                } else if (cell_provider.equalsIgnoreCase("T-Mobile")) {
                    cell_provider_code = "number@tmomail.net";
                } else if (cell_provider.equalsIgnoreCase("U.S. Cellular")) {
                    cell_provider_code = "number@email.uscc.net";
                } else if (cell_provider.equalsIgnoreCase("Verizon")) {
                    cell_provider_code = "number@vtext.com";
                } else if (cell_provider.equalsIgnoreCase("Viaero Wireless")) {
                    cell_provider_code = "number@mmsviaero.com";
                } else if (cell_provider.equalsIgnoreCase("Virgin Mobile")) {
                    cell_provider_code = "number@vmobl.com";
                }
            }
            ...
            try {
               ...
               pstmt2 = con.prepareStatement (
                  ...
                  "address, city, state, zip, telephone, email, email2, login_username, login_password, " +
               ...
               pstmt2.setString(5, email2);
               pstmt2.setString(6, mem_id);
               pstmt2.setString(7, password);
               pstmt2.setString(8, cell_phone);
               pstmt2.setInt(9, caddie_type);
               pstmt2.setString(10, cell_provider_code);
