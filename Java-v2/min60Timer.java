...
public class min60Timer {
   ...
   public min60Timer() {
     ...
     //if (Common_Server.SERVER_ID == SystemUtils.TIMER_SERVER) SystemUtils.logError("min60Timer: scheduled for 1 hour from now.");
   ...
   class tim60Task extends TimerTask {
      ...
      public void run() {
         ...
         try { // try catch is temporary for sanity, just in case
             SystemUtils.reminderNotifyTimer();
