...
//         if (courseName1.equals( "-ALL-" )) {
      ...
      out.println("</table><br>");                            // end of main page table
       ...
       out.println("<tr>");
       out.println("<td nowrap class=smtext><label title=\"Credit Card\"><input type=radio value=3 name=pn>Credit</label></td>");
       out.println("<td nowrap class=smtext><label title=\"Cash\"><input type=radio value=4 name=pn>Cash</label></td>");
       out.println("<td nowrap class=smtext><label title=\"Check\"><input type=radio value=5 name=pn>Check</label></td>");
       out.println("<td nowrap class=smtext><label title=\"Other\"><input type=radio value=6 name=pn>Other</label></td>");
       out.println("</tr>");

       out.println("<tr><td colspan=4 style=\"background-color:black\"></td></tr>");
       out.println("<tr><td colspan=4 style=\"background-color:black\"></td></tr>");
       out.println("<tr><td class=smtext colspan=4><input type=checkbox value=yes name=changeAll id=ca><label for=\"ca\">Change All</label></td></tr>");
         ...
         if (parmp.pos_paynow == 1 && num.equals("0") && pos != 1 && pos != 3) {
             ...
             if (club.equals("demobrad")) {
                 ...
                 if (pos == 0) {      // if currently NOT paid
                     ...
                     out.println("<a href=\"javascript:void(0)\" id=\"cw_"+teecurr_id+"_"+playern+"\" onclick=\"showPNPopupLite(this)\" value=\"" +pcw+ "\" "
                             + "playerSlot=\"" +playern+ "\" tid=\"" +teecurr_id+ "\" style=\"color: black; text-decoration: underline\">"
                             + "<img id=\"paybox_"+teecurr_id+"_"+playern+"\" src=\"/" +rev+ "/images/pospaynow.gif\" border=\"1\" name=\"paynow\" "
                             + "title=\"Click here to mark player as Paid.\"></a>");
                     
                 } else {      // if currently paid

                     out.print("&nbsp;<img onclick=\"doCheckIn("+teecurr_id+","+playern+",'"+courseNameT+"',this.id);\" id=\"paybox_"+teecurr_id+"_"+playern+"\" "
                             + "src=\"/" +rev+ "/images/pospaid.gif\" border=\"1\" name=\"paynow\" title=\"Click here to mark player as NOT Paid.\">");
                 }
