...
// Modified for ForeTees by Paul Sindelar
...
var sameAsLastName = 'Password is the same as your last name.'


function passwordStrength(password,username,lastname)
{
    score = 0 
    ...
    //password == lastname
    if (password.toLowerCase() == lastname.toLowerCase()) return sameAsLastName
...
function passwordStrengthPercent(password,username,lastname)
{
    score = 0 
    ...
    //password == lastname
    if (password.toLowerCase() == lastname.toLowerCase()) return 0
