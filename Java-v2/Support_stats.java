...
public class Support_stats extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("First Login Received (after last server bounce): <b>" +StatCounters.startDate+ "</b>");
   ...
   for (int i = 0; i < 24; i++) {          // do every hour of day
      ...
      out.println("<td><font size=\"2\">" + nf.format(StatCounters.loginCountsPro[i]) + "</font></td>");
         total1+= StatCounters.loginCountsPro[i];
      out.println("<td><font size=\"2\">" + nf.format(StatCounters.loginCountsMem[i]) + "</font></td>");
         total2+= StatCounters.loginCountsMem[i];
      out.println("<td><font size=\"2\">" + nf.format(StatCounters.sheetCountsPro[i]) + "</font></td>");
         total3+= StatCounters.sheetCountsPro[i];
      out.println("<td><font size=\"2\">" + nf.format(StatCounters.sheetCountsMem[i]) + "</font></td>");
         total4+= StatCounters.sheetCountsMem[i];
      out.println("</td></tr>");
   }
