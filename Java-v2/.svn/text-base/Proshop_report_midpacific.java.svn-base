...
public class Proshop_report_midpacific extends HttpServlet {
    ...
    private static void viewRounds(HttpServletRequest req, Connection con, PrintWriter out) {
        ...
        if (errMsg.equals("")) {
            ...
            midPacParms.teecurr_id = (long)-1;        // set to -1 so later methods know we're not coming from a tee time 
            ...
            if (midPacParms.memberClass.equals("A")) { 
                ...
                year_disp = String.valueOf(year).substring(2);
                year2_disp = String.valueOf(year2).substring(2);
                ...
                for (int i=0; i<12; i++) {
                    ...
                    if (i >= 8) {
                        midPacParms.time_mode_year = year;
                    } else {
                        midPacParms.time_mode_year = year2;
                    }
...
//                    MidPacificCustom.checkMidPacificUnrestrictedRounds(midPacParms, con, pastOnly);
                    MidPacificCustom.checkMidPacificClassH1(midPacParms, con, pastOnly);

                    // store results
//                    non_month[i] = midPacParms.non_month;
//                    non_total += midPacParms.non_month;
                    non_month[i] = (midPacParms.rounds18_year * 2) + midPacParms.rounds9_year;
                    non_total += (midPacParms.rounds18_year * 2) + midPacParms.rounds9_year;
                }
                ...
                out.println("<h3>Total Rounds This Year: " +
                        ...
                        "/" + MidPacificCustom.unrestricted_year_classH1 + " (18h = 2, 9h = 1)</h3>");
                ...
                out.println("<tr>");
                out.println("<td align=\"right\">Month</td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 9) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Sep '" + year_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 10) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Oct '" + year_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 11) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Nov '" + year_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 12) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Dec '" + year_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 1) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Jan '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 2) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Feb '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 3) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Mar '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 4) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Apr '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 5) ? "#CCCCAA" : "#F5F5DC") + "\"><b>May '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 6) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Jun '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 7) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Jul '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\" bgcolor=\"" + ((month == 8) ? "#CCCCAA" : "#F5F5DC") + "\"><b>Aug '" + year2_disp + "</b></td>");
                out.println("<td align=\"center\"><b>Total</b></td>");
                out.println("</tr>");
                // Print row of round totals
