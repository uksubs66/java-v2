...
public class Support_kick_timers extends HttpServlet {
 ...
 private void buildAllTees(HttpServletRequest req, PrintWriter out) {
   ...
   out.println("<HTML><HEAD><TITLE>Support Build Tee Sheets</TITLE></HEAD>");
   out.println("<BODY><CENTER><H3>Build/Move Tee Sheets</H3><BR>");
   out.println("Calling scanTee for all clubs. &nbsp;Progress:<br><br>");
   ...
   if (con != null) {
      ...
      try {
         ...
         while (rs.next()) {
            ...
            out.println("Starting Club " +club+ "<BR>");
            ...
            try {
                ...
                if (con2 != null) {
                   ...
                   out.println("<BR><BR>Problem getting a db connection. Check error log.");
                }
