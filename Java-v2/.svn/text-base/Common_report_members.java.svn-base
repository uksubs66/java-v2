...
public class Common_report_members extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<form action=\"Common_report_members\" method=\"post\">");
      ...
      out.println("<label><input checked type=\"checkbox\" name=\"lname\" value=\"1\">&nbsp;&nbsp;Last Name</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input checked type=\"checkbox\" name=\"fname\" value=\"1\">&nbsp;&nbsp;First Name</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input checked type=\"checkbox\" name=\"mi\" value=\"1\">&nbsp;&nbsp;Middle Initial</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input checked type=\"checkbox\" name=\"uname\" value=\"1\">&nbsp;&nbsp;User Name</label>");
      out.println("</font></td>");
      out.println("</tr>");

      out.println("<tr><td align=\"left\"><font size=\"2\">");
         out.println("<label><input checked type=\"checkbox\" name=\"mnum\" value=\"1\">&nbsp;&nbsp;Member Number</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"webid\" value=\"1\">&nbsp;&nbsp;Web Site Id</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"mship\" value=\"1\">&nbsp;&nbsp;Membership Type</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"mtype\" value=\"1\">&nbsp;&nbsp;Member Type</label>");
      out.println("</font></td>");
      out.println("</tr>");

      out.println("<tr><td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"email1\" value=\"1\">&nbsp;&nbsp;Email Address 1</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"email2\" value=\"1\">&nbsp;&nbsp;Email Address 2</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"phone1\" value=\"1\">&nbsp;&nbsp;Phone 1</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
         out.println("<label><input type=\"checkbox\" name=\"phone2\" value=\"1\">&nbsp;&nbsp;Phone 2</label>");
      out.println("</font></td>");
      out.println("</tr>");

      out.println("<tr><td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"bag\" value=\"1\">&nbsp;&nbsp;Bag Room Number&nbsp;&nbsp;</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"posid\" value=\"1\">&nbsp;&nbsp;POS Id</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"ghin\" value=\"1\">&nbsp;&nbsp;Handicap Id</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"wc\" value=\"1\">&nbsp;&nbsp;Transportation Preference</label>");
      out.println("</font></td>");
      out.println("</tr>");

      out.println("<tr><td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"birth\" value=\"1\">&nbsp;&nbsp;Birth Date&nbsp;&nbsp;</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"active\" value=\"1\">&nbsp;&nbsp;Active/Inactive</label>");
      out.println("</font></td>");
      out.println("<td align=\"left\"><font size=\"2\">");
      out.println("<label><input type=\"checkbox\" name=\"tflag\" value=\"1\">&nbsp;&nbsp;Tee Sheet Flag</label>");
      out.println("</font></td>");
      
      if (getActivity.isConfigured(con)) {
          out.println("<td align=\"left\"><font size=\"2\">");
          out.println("<label><input type=\"checkbox\" name=\"ntrp_rating\" value=\"1\">&nbsp;&nbsp;NTRP Rating</label>");
          out.println("</font></td>");
          out.println("</tr><tr>");
      }
      
      if (Utilities.isFTCPflexidAllowed(con)) {
          out.println("<td align=\"left\"><font size=\"2\">");
          out.println("<label><input type=\"checkbox\" name=\"flexid\" value=\"1\">&nbsp;&nbsp;Flex Id</label>");
          out.println("</font></td>");
      }
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   boolean tflag = false;
   boolean flexid = false;
   boolean ntrp_rating = false;
   ...
   if (req.getParameter("ntrp_rating") != null) {
      ntrp_rating = true;
      colCount++;
   }
   ...
   try{
       if (format.equals("excel")) {                           // if user requested Excel Spreadsheet Format
           ...
           resp.setHeader("Content-Disposition", "attachment;filename=\"roster.xls\"");
       }
   }
   catch (Exception exc) {
   }
   ...
   if (!format.equals("excel")) { 
      ...
      if (flexid == true) {          // if column to be displayed
         out.println("<input type=\"hidden\" name=\"flexid\" value=\"1\">");
      }
      if (ntrp_rating == true) {          // if column to be displayed
         out.println("<input type=\"hidden\" name=\"ntrp_rating\" value=\"1\">");
      }
   ...
   try {
      ...
      PreparedStatement stmt = con.prepareStatement (
               "SELECT * FROM member2b WHERE deleted = 0 ORDER BY name_last, name_first");
      ...
      while(rs.next()) {
         ...
         sflexid = rs.getString("flexid");
         dntrp_rating = rs.getDouble("ntrp_rating");
         
         if (suname.equalsIgnoreCase("save4foretees")) {
             continue;
         }
