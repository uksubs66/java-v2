      ...
      try {
         ...
         if (foretees_mode == 1 && sess_activity_id == 0) {           // Golf defined in system and not an Activity Pro?         
            ...
            stmt = con.prepareStatement (
               "SELECT date, mm, dd, yy, day, hr, min, time, event, player1, player2, player3, player4, player5, " +
               "event_type, fb, notes, courseName, rest5, custom_int " +
               "FROM teecurr2 " +
            ...
            if (!rs.next()) {              // any tee times?
               ...
               while (rs.next()) {
                  ...
                  if (club.equals("kiawahislandclub") && custom_int > 0) {
                      ...
                      out.println("<tr>");    // Default setup and background color
                      player_color = "white";
                  }
