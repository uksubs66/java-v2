    ...
    try {
        ...
        while ( rs.next()) {
          ...
          if (clubNum != null && clubAssocNum != null) {
            ...
            String date = "";   // Date
            String posted = "";   // Date
            String courseName = "";    // Course (in GHIN, not ForeTees course!)
...
//                      if ( type.equalsIgnoreCase("H") ) {  (WE ARE NOW PROCESSING ALL DOWNLOADED SCORES!)
                        ...
                        try {
                            node = document.getElementsByTagName("CourseName").item(i);
                            if (node != null) {
                                courseName = SystemUtils.scrubString(((CharacterData)node.getFirstChild()).getData());
                            } else {
                                courseName = "";
                            }
                        } catch (Exception e) {
                            courseName = "";    // Blank CourseName values come through as null, so just set courseName to blank and move on!
                        }
...
*/
                        ...
                        try {
                            ...
                            */
                            ...
                            pstmt = con.prepareStatement(
                                ...
                                "(hdcpNum, provider_uuid, date, score, type, tee_id, last_touched, courseName) " +
                    ...
                    try {
                        ...
                        // Delete any score posting within the specified date range that were not updated/inserted durring this cycle
                        pstmt = con.prepareStatement(
