 ...
 *         &lt;element name="xmlBatch" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "CreateMemberBatchPayment")
public class CreateMemberBatchPayment {

    @XmlElement(name = "a_sUserID")
    protected String asUserID;
    @XmlElement(name = "a_sUserPass")
    protected String asUserPass;
    protected String xmlBatch;
    ...
    /**
     * Gets the value of the xmlBatch property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the xmlBatch property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setXmlBatch(String value) {
        this.xmlBatch = value;
    }
