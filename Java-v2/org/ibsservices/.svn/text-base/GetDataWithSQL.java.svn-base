 ...
 *         &lt;element name="a_sSQL" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetDataWithSQL")
public class GetDataWithSQL {
    ...
    /**
     * Gets the value of the assql property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the assql property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setASSQL(String value) {
        this.assql = value;
    }
