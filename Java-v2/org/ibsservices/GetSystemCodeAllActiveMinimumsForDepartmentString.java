 ...
 *         &lt;element name="a_sDepartmentID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "GetSystemCodeAllActiveMinimumsForDepartmentString")
public class GetSystemCodeAllActiveMinimumsForDepartmentString {

    @XmlElement(name = "a_sUserID")
    protected String asUserID;
    @XmlElement(name = "a_sUserPass")
    protected String asUserPass;
    @XmlElement(name = "a_sDepartmentID")
    protected String asDepartmentID;
    ...
    /**
     * Gets the value of the asDepartmentID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getASDepartmentID() {
        return asDepartmentID;
    }

    /**
     * Sets the value of the asDepartmentID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setASDepartmentID(String value) {
        this.asDepartmentID = value;
    }
