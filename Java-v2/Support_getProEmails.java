 ...
 String SEPARATOR = ",";
    ...
    private void getList(String user, HttpServletRequest req, PrintWriter out) {
        ...
        try {
            ...
            rs1 = stmt1.executeQuery("SELECT clubname, fullname FROM clubs WHERE inactive='0' AND non_billable = 0 ORDER BY fullname");
    ...
    private void getEmailNames(PrintWriter out){
        ...
        try {
            ...
            con1 = Connect.getCon(rev);
            stmt1 = con1.createStatement();
            rs1 = stmt1.executeQuery("SELECT clubname, fullname FROM clubs WHERE inactive='0' AND non_billable='0'");
