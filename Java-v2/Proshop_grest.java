...
public class Proshop_grest extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<tr><td align=\"center\">");
      ...
      out.println("<center>");
      out.println("<form method=\"get\" action=\"Proshop_grest\" name=\"frmSortBy\">");
   ...
   try {
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"post\" action=\"Proshop_grest\" target=\"bot\">");
         out.println("<td align=\"center\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<tr><td align=\"center\">");
     ...
     out.println("<table border=\"1\" bgcolor=\"#F5F5DC\">");
       ...
       if (id > 0 ) out.println("<br><br><iframe id=\"suspiframe\" src=\"Proshop_grest?susp&grestid=" + id + "\" id=suspension style=\"width:800px;\" scrolling=no frameborder=no></iframe>");
 ...
 private void doCopy(HttpServletRequest req, PrintWriter out, Connection con, int lottery, int sess_activity_id) {
   ...
   try {
      ...
      if (found) {
         ...
         out.println("<form action=\"Proshop_grest\" method=\"post\" target=\"bot\">");
 ...
 private void printSuspensions(HttpServletRequest req, int sess_activity_id, Connection con, PrintWriter out) {
     ...
     try {
         ...
         while (rs.next()) {
             ...
             out.println("<form method=\"post\" action=\"Proshop_grest?susp\">");
         ...
         out.println("<form method=\"post\" action=\"Proshop_grest\">");
         ...
         out.println("&nbsp;&nbsp;&nbsp;<a href=\"Proshop_grest?susp&grestid=" + grest_id + "\" style=\"text-decoration: none;\"><button type=\"button\">Reset</button></a>");
 ...
 private void updateSuspension(HttpServletRequest req, Connection con, PrintWriter out) {
     ...
     if (!daysSelected || invalidMins || invalidTime || invalidDate) {        // If there was invalid data sent, reject and return them
         ...
         if (invalidDate) {
             out.println("  <li>End date must be later than start date</li>");
         }
         out.println("</ul>");
         ...
         try {
             ...
             String url = "Proshop_grest?susp&grestid=" + grest_id;
