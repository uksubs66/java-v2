...
public class CellRenderer {
  ...
  public static void render(Cell theCell, PrintWriter out)
  {
    ...
    if (theCell != null)
    {
      ...
      if ( theContent != null)
      {
        ...
        else if (theContent instanceof FileInput)
        {
          render((FileInput)theContent, out);
        }
        else
        {
  ...
  private static void render(String theContent, PrintWriter out)
  {
    ...
    private static void render(Attribute theContent, PrintWriter out) {
        ...
        if (theContent.getMode().equals(Attribute.EDIT)) {
            ...
            out.print(theContent.getLabel() + ":&nbsp;&nbsp;" + theContent.getValue());
  ...
  private static void render(TextBox theContent, PrintWriter out)
  {
    ...
    if (theContent.getMode().equals(Attribute.EDIT))
    {
      ...
      out.print("cols=\"" + theContent.getMaxLength() + "\" rows=\"" + theContent.getSize() + "\" id=\"" + theContent.getName() + "\" name=\"" + theContent.getName() + "\">" + theContent.getValue() + "</textarea>");
      if (theContent.getName().equals("messageField")) {
          out.println("<div id=\"counter\" class=\"text_counter\"></div>");
      }
      out.print("</td>");
  ...
  private static void render(FileInput theContent, PrintWriter out)
  {
      String label = theContent.getLabel();
      String onChange = theContent.getOnChange();
      ...
      out.print(" name=\"" + theContent.getName() + "\" id=\"" + theContent.getName() + "\">");
  ...
  private static void render(Checkbox theContent, PrintWriter out)
  {
      ...
      if (!theContent.isProshop()) {
          ...
          out.print("<label><input type=\"checkbox\" ");
