 ...
 *
 *      11/22/13   Added Send Email type fields to gathering email addresses (MemberHelper.getEmailAddresses). 
 *       9/12/13   Added FLEX_ID_LABEL and FLEXID.
...
public class Member {
  ...
  public static final String FLEX_ID_LABEL = "Flex Id";
...
//public static final String T_FLAG_LABEL_SHORT = "Member Flag";
  ...
  //
  //  Type of call when requesting an email address for one or more members (Send Email feature)
  //
  public static final String PRO_SEND_EMAIL = "pro_send_email";         // Pro/Staff is sending an email to member(s)
  public static final String MEM_SEND_EMAIL = "mem_send_email";         // Member is sending an email to other members
  public static final String GET_CALLER_EMAIL = "get_caller_email";     // Send_email needs to author's email address
