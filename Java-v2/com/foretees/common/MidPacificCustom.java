...
public class MidPacificCustom {
    ...
    public static int wkendRest_classJ_etime = 1259;  // End time for weekend restriction (class J only, Sat/Sun only)
...
public static boolean checkMidPacificTimes(String memberClass, String day_name, int tee_time, int fb) {
  ...
  */
 public static int checkMidPacificRounds(String user, String mship, long teecurr_id, int time_mode, boolean p9, boolean restricted, boolean checkPropGuests, boolean countGuests, boolean pastOnly, String memberClass, Connection con) {
         
     return checkMidPacificRounds(user, mship, teecurr_id, time_mode, 0, p9, restricted, checkPropGuests, countGuests, pastOnly, memberClass, con);
 }

 public static int checkMidPacificRounds(String user, String mship, long teecurr_id, int time_mode, int time_mode_year, boolean p9, boolean restricted, boolean checkPropGuests, boolean countGuests, boolean pastOnly, String memberClass, Connection con) {
...
//         }   
         ...
         // Club requested to change BACK to 1/1 - 12/31 for annual quotas.
         timeframe_val_1 = (year * 10000) + 101;
         timeframe_val_2 = (year * 10000) + 1231;
         ...
         timeframe_val_2 = (time_mode_year > 0 ? time_mode_year : year);    // Use specific year, if indicated, or default to current year
         ...
         try {
             ...
             if (!pastOnly) {
                 ...
                 if (teecurr_id >= 0) {
                     ...
                     if (memberClass.equals("A")) {
                         pstmt.setLong(8, teecurr_id);
                     } else {
                         pstmt.setLong(14, teecurr_id);
                     }
                 }
 ...
 public static boolean checkMidPacificClassH1(parmMidPacific midPacParms, Connection con, boolean pastOnly) {
     ...
     count = checkMidPacificRounds(midPacParms.user, midPacParms.mship, midPacParms.teecurr_id, midPacParms.time_mode, midPacParms.time_mode_year, p9, restricted, checkPropGuests, countGuests, pastOnly, "H1", con);
