...
public class getItem {
 ...
 public static void getEvents (long date, String courseName1, parmItem parm, int activity_id, Connection con) 
         throws Exception {
    ...
    String sql = "SELECT name, stime, etime, courseName, fb, stime2, etime2, fb2, color, season, type, act_hr, act_min " +
                 "FROM events2b WHERE date = ? AND inactive = 0 AND activity_id = ? ";
