...
public class parmEmail extends parmCore {

   public boolean error = false;
   public boolean suppressMemberEmails = false;
   public boolean handicapChair = false;
   ...
   public int season = 0;
   public int signup_on_teesheet = 0;
   ...
   public String dining_user_id = "";
   public int diningMsgId = 0;
   
   // Parameters used for sending dining reminder notifications
   public String dining_disp_date = "";
   public String dining_disp_time = "";
   public int dining_resNum = 0;
   public List<String> dining_names = new ArrayList<String>();
   public List<String> dining_users = new ArrayList<String>();
   ...
   /*
    ...
    public String getOldCw(int index){
        return getStringByName("oldpcw%", index);
    }
    ...
    public String[] getOldCwArray(int length){
        return getStringArrayByName("oldpcw%", length);
    }
    ...
    public void setOldCw(String value, int index){
        setParameterByName("oldpcw%", value, index);
    }
    ...
    public void setOldCw(String[] array){
        setParameterByName("oldpcw%", array);
    }
