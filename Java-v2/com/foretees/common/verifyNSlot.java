      ...
      while (rs.next()) {              // check all matching restrictions for this day, mship, mtype & F/B
         ...
         if ((rest_recurr.equals( "Every " + nSlotParms.day )) ||               // if this day
            ...
            if ((rest_fb.equals( "Both" )) || (rest_fb.equals( nSlotParms.sfb ))) {
               ...
               if (!verifySlot.checkRestSuspend(rs.getInt("id"), -99, 0, (int)nSlotParms.date, nSlotParms.time, nSlotParms.day, nSlotParms.course, con)) {
   ...
   try {
      ...
      while (rs.next()) {
         ...
         if ((rcourse.equals( "-ALL-" )) || (rcourse.equals( nSlotParms.course ))) {
            ...
            if (!verifySlot.checkRestSuspend(-99, grest_id, 0, (int)nSlotParms.date, nSlotParms.time, nSlotParms.day, nSlotParms.course, con)) {
