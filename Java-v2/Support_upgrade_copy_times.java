...
public class Support_upgrade_copy_times extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (!SystemUtils.verifySupport(userName)) {
   ...
   //
   String club = "pinehills";                        // ************ pine hills ***********
      ...
      while (rs.next()) {
         ...
         if (!player1.equals("")) {
            ...
            pstmt2 = con.prepareStatement (
               ...
               "p91 = ?, p92 = ?, p93 = ?, p94 = ?, p95 = ?, notes = ?, hideNotes = ? " +
               "WHERE date = 20150718 AND day = 'Saturday' AND time = ? AND fb = ? AND courseName = ?");
            ...
            pstmt2.setString(32, notes);
            pstmt2.setInt(33, hideNotes);

            pstmt2.setInt(34, time);
            pstmt2.setInt(35, fb);
