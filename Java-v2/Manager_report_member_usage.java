/******************************************************************************************
 *   Manager_report_member_usage:  This servlet will perform reporting for the manager portal
 *
...
public class Manager_report_member_usage extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
      ...
      //  if (!ua.access.view_foretees_report_member_usagements) session = null;
        if (session == null) {
        ...
        dashboard_single.append(
                ...
                "ftd_report_member_usagement_list ftd_report",
                null,
