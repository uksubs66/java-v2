                ...
                function(data) {
                    if(data !== null && data.query.results !== null) {
                        $.each(data.query.results, function(i, result) {
                            ...
                            $.proxy(options.success(weather), options.context);
                        });
                    } else {
                        if (data.query.results === null) {
                            $.proxy(options.error("Invalid location given."), options.context);
                        } else {
                            $.proxy(options.error("Weather could not be displayed. Try again."), options.context);
                        }
                    }
                }
                );
