...
public class Proshop_report_menu extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<br>");
      ...
      out.println("<a href=\"Proshop_report_course_rounds\">LM, MTD, YTD Summary Report</a>");
      out.println("<br><br>");

      out.println("<a href=\"Proshop_report_course_rounds?today\">Today Summary Report</a>");
      out.println("<br><br>");

      out.println("<a href=\"Proshop_report_course_rounds?custom\">Custom Date Range Report</a>");
      out.println("<br><br>");
   ...
   if (club.startsWith( "demo" )) {
      out.println("<br><br>");
      out.println("<a href=\"Proshop_report_course_utilization\">**New** Click Here to Test Course Utilization Report</a>");
   }
   out.println("</font>");
