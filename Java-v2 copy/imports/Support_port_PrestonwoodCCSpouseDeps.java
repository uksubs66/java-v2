...
/*
            ...
            if (!mNum.endsWith("-1")) {
                ...
                if (fname3.equals("?")) fname3 = "";
                if (fname4.equals("?")) fname4 = "";
                if (fname5.equals("?")) fname5 = "";
                if (fname6.equals("?")) fname6 = "";
                if (fname7.equals("?")) fname7 = "";
                if (fname8.equals("?")) fname8 = "";
                if (fname9.equals("?")) fname9 = "";
                if (fname10.equals("?")) fname10 = "";
            }
...
*/           
            ...
            String[] tempName = lname.split(" ");
            
            if (tempName.length == 2) {
                fname = tempName[0];
                lname = tempName[1];
            } else if (tempName.length == 3) {
                fname = tempName[0] + " " + tempName[1];
                lname = tempName[2];
            } else if (tempName.length > 3) {
                fname = tempName[0] + " " + tempName[1];
                lname = tempName[2] + " " + tempName[3];
            }
            ...
            if (mNum.endsWith("-1")) {
                ...
                try {
                    ...
                    if (rsx.next()) {
                        mship = rsx.getString(1);
                    } else {
                        mship = "No Primary Found";
                    }
                    
                } catch (Exception exc) {
                    mship = "Error Finding Primary";
                } finally {
                    try { rsx.close(); }
