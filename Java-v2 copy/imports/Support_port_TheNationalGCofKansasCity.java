...
*/           
            ...
            if (mNum.endsWith("A") || mNum.endsWith("B") || mNum.endsWith("C") || mNum.endsWith("D") || mNum.endsWith("E") 
                    || mNum.endsWith("F") || mNum.endsWith("T") || mNum.endsWith("U") || mNum.endsWith("V") || mNum.endsWith("W") || mNum.endsWith("X") || mNum.endsWith("Y") || mNum.endsWith("Z")) {
                ...
                if (mNum.endsWith("A")) {
                ...
                } else if (mNum.endsWith("B") || mNum.endsWith("C") || mNum.endsWith("D") || mNum.endsWith("E") || mNum.endsWith("F")) {
                    mtype = "Dependant";
                    ...
                    if (mNum.endsWith("T")) {
                        primary = 7;
                    } else if (mNum.endsWith("U")) {
                        primary = 8;
                    } else if (mNum.endsWith("V")) {
                        primary = 9;
                    } else if (mNum.endsWith("W")) {
                        primary = 10;
                    } else if (mNum.endsWith("X")) {
                        primary = 11;
                    } else if (mNum.endsWith("Y")) {
                        primary = 12;
                    } else if (mNum.endsWith("Z")) {
                        primary = 13;
                    }
