 ...
 */
            ...
            if (tok.countTokens() > 0) {
                ...
                if (fname3.equals("?")) {
                    ...
                    StringTokenizer nameTok = new StringTokenizer(fname3, " ");

                    if (nameTok.countTokens() > 1) {
                        fname3 = nameTok.nextToken().trim();
                        lname3 = nameTok.nextToken().trim();
                    }
                }
            }
            if (tok.countTokens() > 0) {
                ...
                if (fname4.equals("?")) {
                    ...
                    StringTokenizer nameTok = new StringTokenizer(fname4, " ");

                    if (nameTok.countTokens() > 1) {
                        fname4 = nameTok.nextToken().trim();
                        lname4 = nameTok.nextToken().trim();
                    }
                }
            }
            if (tok.countTokens() > 0) {
                ...
                if (fname5.equals("?")) {
                    ...
                    StringTokenizer nameTok = new StringTokenizer(fname5, " ");

                    if (nameTok.countTokens() > 1) {
                        fname5 = nameTok.nextToken().trim();
                        lname5 = nameTok.nextToken().trim();
                    }
                }
            }
            if (tok.countTokens() > 0) {
                ...
                if (fname6.equals("?")) {
                    ...
                    StringTokenizer nameTok = new StringTokenizer(fname6, " ");

                    if (nameTok.countTokens() > 1) {
                        fname6 = nameTok.nextToken().trim();
                        lname6 = nameTok.nextToken().trim();
                    }
                }
            }
            if (tok.countTokens() > 0) {
                ...
                if (fname7.equals("?")) {
                    ...
                    StringTokenizer nameTok = new StringTokenizer(fname7, " ");

                    if (nameTok.countTokens() > 1) {
                        fname7 = nameTok.nextToken().trim();
                        lname7 = nameTok.nextToken().trim();
                    }
                }
            }
            ...
            if (lname3.endsWith("\"")) {
                lname3 = lname3.substring(0, lname3.length()-1);
            }
            if (fname4.endsWith("\"")) {
                fname4 = fname4.substring(0, fname4.length()-1);
            }
            if (lname4.endsWith("\"")) {
                lname4 = lname4.substring(0, lname4.length()-1);
            }
            if (fname5.endsWith("\"")) {
                fname5 = fname5.substring(0, fname5.length()-1);
            }
            if (lname5.endsWith("\"")) {
                lname5 = lname5.substring(0, lname5.length()-1);
            }
            if (fname6.endsWith("\"")) {
                fname6 = fname6.substring(0, fname6.length()-1);
            }
            if (lname6.endsWith("\"")) {
                lname6 = lname6.substring(0, lname6.length()-1);
            }
            if (fname7.endsWith("\"")) {
                fname7 = fname7.substring(0, fname7.length()-1);
            }
            if (lname7.endsWith("\"")) {
                lname7 = lname7.substring(0, lname7.length()-1);
            }
