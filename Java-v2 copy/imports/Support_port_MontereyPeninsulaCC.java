...
//            mtype = toTitleCase( mtype );
            ...
            if (!fname2.equals( "" )) {
               ...
               StringTokenizer tok2 = new StringTokenizer(fname2, " ");

               if (tok2.countTokens() > 1) {
                   fname2 = tok2.nextToken().trim();
                   lname2 = tok2.nextToken().trim();
               }
   ...
   //            lname2 = lname;
           ...
           //    gender = "F";      // default for spouse
            ...
            if (!fname3.equals( "" )) {
               ...
               if (fname3.startsWith("\"")) {
                   fname3 = fname3.substring(1);
               }
               if (fname3.endsWith("\"")) {
                   fname3 = fname3.substring(0, fname3.length() - 1);
               }

               fname3.trim();

               StringTokenizer tok2 = new StringTokenizer(fname3, " ");

               if (tok2.countTokens() > 1) {
                   fname3 = tok2.nextToken().trim();
                   lname3 = tok2.nextToken().trim();
               }
            ...
            if (!fname4.equals( "" )) {
               ...
               if (fname4.startsWith("\"")) {
                   fname4 = fname4.substring(1);
               }
               if (fname4.endsWith("\"")) {
                   fname4 = fname4.substring(0, fname4.length() - 1);
               }

               fname4.trim();

               StringTokenizer tok2 = new StringTokenizer(fname4, " ");

               if (tok2.countTokens() > 1) {
                   fname4 = tok2.nextToken();
                   lname4 = tok2.nextToken();
               }
               ...
               fname4 = toTitleCase( fname4 ).trim();
               lname4 = toTitleCase( lname4 ).trim();
            ...
            if (!fname5.equals( "" )) {
               ...
               if (fname5.startsWith("\"")) {
                   fname5 = fname5.substring(1);
               }
               if (fname5.endsWith("\"")) {
                   fname5 = fname5.substring(0, fname5.length() - 1);
               }

               fname5.trim();

               StringTokenizer tok2 = new StringTokenizer(fname5, " ");

               if (tok2.countTokens() > 1) {
                   fname5 = tok2.nextToken().trim();
                   lname5 = tok2.nextToken().trim();
               }
            ...
            if (!fname6.equals( "" )) {
               ...
               if (fname6.startsWith("\"")) {
                   fname6 = fname6.substring(1);
               }
               if (fname6.endsWith("\"")) {
                   fname6 = fname6.substring(0, fname6.length() - 1);
               }

               fname6.trim();

               StringTokenizer tok2 = new StringTokenizer(fname6, " ");

               if (tok2.countTokens() > 1) {
                   fname6 = tok2.nextToken().trim();
                   lname6 = tok2.nextToken().trim();
               }
            ...
            if (!fname7.equals( "" )) {
               ...
               if (fname7.startsWith("\"")) {
                   fname7 = fname7.substring(1);
               }
               if (fname7.endsWith("\"")) {
                   fname7 = fname7.substring(0, fname7.length() - 1);
               }

               fname7.trim();

               StringTokenizer tok2 = new StringTokenizer(fname7, " ");

               if (tok2.countTokens() > 1) {
                   fname7 = tok2.nextToken().trim();
                   lname7 = tok2.nextToken().trim();
               }
            ...
            if (!fname8.equals( "" )) {
               ...
               if (fname8.startsWith("\"")) {
                   fname8 = fname8.substring(1);
               }
               if (fname8.endsWith("\"")) {
                   fname8 = fname8.substring(0, fname8.length() - 1);
               }

               fname8.trim();

               StringTokenizer tok2 = new StringTokenizer(fname8, " ");

               if (tok2.countTokens() > 1) {
                   fname8 = tok2.nextToken().trim();
                   lname8 = tok2.nextToken().trim();
               }
            ...
            if (!fname9.equals( "" )) {
               ...
               if (fname9.startsWith("\"")) {
                   fname9 = fname9.substring(1);
               }
               if (fname9.endsWith("\"")) {
                   fname9 = fname9.substring(0, fname9.length() - 1);
               }

               fname9.trim();

               StringTokenizer tok2 = new StringTokenizer(fname9, " ");

               if (tok2.countTokens() > 1) {
                   fname9 = tok2.nextToken().trim();
                   lname9 = tok2.nextToken().trim();
               }
            ...
            if (!fname10.equals( "" )) {
               ...
               if (fname10.startsWith("\"")) {
                   fname10 = fname10.substring(1);
               }
               if (fname10.endsWith("\"")) {
                   fname10 = fname10.substring(0, fname10.length() - 1);
               }

               fname10.trim();

               StringTokenizer tok2 = new StringTokenizer(fname10, " ");

               if (tok2.countTokens() > 1) {
                   fname10 = tok2.nextToken().trim();
                   lname10 = tok2.nextToken().trim();
               }
