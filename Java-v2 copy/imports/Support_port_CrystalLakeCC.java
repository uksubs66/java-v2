...
*/
            ...
            if (mNum.endsWith("-1")) {
                primary = 1;
                stripdash = true;
            } else if (mNum.endsWith("-2")) {
                primary = 2;
                stripdash = true;
            } else if (mNum.endsWith("-3")) {
                primary = 3;
                stripdash = true;
            } else if (mNum.endsWith("-4")) {
                primary = 4;
                stripdash = true;
            } else if (mNum.endsWith("-5")) {
                primary = 5;
                stripdash = true;
            } else if (mNum.endsWith("-6")) {
                primary = 6;
                stripdash = true;
            } else if (mNum.endsWith("-7")) {
                primary = 7;
                stripdash = true;
            } else if (mNum.endsWith("-8")) {
                primary = 8;
                stripdash = true;
            }
