...
*/
            ...
            if (mNum.endsWith("-01")) {
                ...
                primary = 1;
                mNum = mNum.substring(0, mNum.length() - 3);

            } else if (mNum.endsWith("-02") || mNum.endsWith("-03") || mNum.endsWith("-04") ||
                       mNum.endsWith("-05") || mNum.endsWith("-06") || mNum.endsWith("-07") ||
                       mNum.endsWith("-08") || mNum.endsWith("-09")) {
            ...
            if (tempInact.equalsIgnoreCase("Suspended")) {
                inact = 1;
            } else {
                inact = 0;
            }
            ...
            if (dupName == false) {
               ...
               try {
                  ...
                  pstmt2 = con.prepareStatement (
                     ...
                     "email_bounced, email2_bounced, gender, pri_indicator, inact) " +
                     "VALUES (?,?,?,?,?,?,?,?,0,?,?,?,'',?,?,?,'',?,?,?,'',?,?,?,'','',?,0,0,?,?,?)");
