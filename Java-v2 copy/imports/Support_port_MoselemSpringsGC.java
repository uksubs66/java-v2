...
*/           
            ...
            if (mNum.endsWith("S")) {
                ...
                primary = 2;
                stripAlpha = true;
            } else if (mNum.endsWith("C1") && !mNum.equals("C1")) {
                primary = 3;
                stripAlpha2 = true;
            } else if (mNum.endsWith("C2")) {
                primary = 4;
                stripAlpha2 = true;
            } else if (mNum.endsWith("C3")) {
                primary = 5;
                stripAlpha2 = true;
            } else if (mNum.endsWith("C4")) {
                primary = 6;
                stripAlpha2 = true;
            } else if (mNum.endsWith("C5")) {
                primary = 7;
                stripAlpha2 = true;
            }
