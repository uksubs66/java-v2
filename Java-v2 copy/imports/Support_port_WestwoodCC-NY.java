...
//         mi = tok.nextToken();
 ...
 //        mem_id = tok.nextToken();
         mship = tok.nextToken().trim();
//         temp = tok.nextToken();
         mtype = tok.nextToken().trim();
         gender = tok.nextToken().trim();
//         ghin = tok.nextToken();
//         temp = tok.nextToken();
//         webid = tok.nextToken();
//         posid = tok.nextToken();
...
//            gender = "";
            ...
            if ( tok.countTokens() > 0 ) {
               ...
               temp = tok.nextToken().trim();                    // birth date (string)
            }
...
*/           
            ...
            if (mNum.endsWith("-1") || mNum.endsWith("-2") || mNum.endsWith("-3") || mNum.endsWith("-4") || mNum.endsWith("-5") || mNum.endsWith("-6") || mNum.endsWith("-7") || mNum.endsWith("-8") || mNum.endsWith("-9")) {
                
                primary = Integer.parseInt(mNum.substring(mNum.length() - 1));
            ...
            } else if (mtype.equalsIgnoreCase("Dependent")) {
                if (gender.equalsIgnoreCase("F")) {
