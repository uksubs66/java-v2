...
*/           
            ...
            if (mem_id.endsWith("A")) {
                ...
                primary = 7;
            } else if (mem_id.endsWith("H")) {
                primary = 8;
            } else if (mem_id.endsWith("I")) {
                primary = 9;
            }
            
            if (mtype.equalsIgnoreCase("Primary") || mtype.equalsIgnoreCase("Spouse")) {
                if (gender.equalsIgnoreCase("F")) {
                    mtype = "Bergamont Adult Female";
                } else {
                    mtype = "Bergamont Adult Male";
                }
            } else {
                mtype = "Bergamont Junior";
            }
            
            if (mship.endsWith("Sport Member")) {
                mship = "Sport Member";
            }
