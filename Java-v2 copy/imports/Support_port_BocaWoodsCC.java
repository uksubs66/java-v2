...
*/           
            ...
            if (mship.equalsIgnoreCase("Assoc.")) {
                mship = "Associate";
            } else if (mship.equalsIgnoreCase("RENTERS")) {
                mship = "Renters";
            ...
            String [] nameTemp = fname.split(" ");
            
            if (nameTemp.length > 1 && nameTemp[1].length() > 1) {
                fname = nameTemp[0];
                lname = nameTemp[1];
            } else if (nameTemp.length > 2) {
                fname = nameTemp[0] + " " + nameTemp[1];
                lname = nameTemp[2];
            }
