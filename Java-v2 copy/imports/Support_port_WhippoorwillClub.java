...
*/           
            ...
            if (mem_id.equals("00")) {
                mem_id = mNum;
            } else if (mem_id.equals("01")) {
                mem_id = mNum + "A";
            } else if (mem_id.equals("02")) {
                mem_id = mNum + "B";
            } else if (mem_id.equals("03")) {
                mem_id = mNum + "C";
            } else if (mem_id.equals("04")) {
                mem_id = mNum + "D";
            } else if (mem_id.equals("05")) {
                mem_id = mNum + "E";
            } else if (mem_id.equals("06")) {
                mem_id = mNum + "F";
            } else if (mem_id.equals("07")) {
                mem_id = mNum + "G";
            } else if (mem_id.equals("08")) {
                mem_id = mNum + "H";
            } else if (mem_id.equals("09")) {
                mem_id = mNum + "I";
            }
