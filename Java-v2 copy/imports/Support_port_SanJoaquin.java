...
*/          
            ...
            out.println("<br>2L: " + lname + " - F: " + fname);
            mem_id = mNum;
            ...
            if (mship.equals("3")) {
                mship = "Honorary";
            } else if (mship.equals("60")) {
                mship = "Regular";
            } else if (mship.equals("62")) {
                mship = "Surviving Spouse";
            } else if (mship.equals("63")) {
                mship = "Non-Resident";
            } else if (mship.equals("64")) {
                mship = "Senior";
            } else if (mship.equals("65")) {
                mship = "Business";
            } else {
                mship = "Junior";
            }
