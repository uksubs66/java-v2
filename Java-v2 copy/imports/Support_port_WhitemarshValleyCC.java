...
*/
            ...
            if (tokx.countTokens() == 2) {
                ...
                fname = tokx.nextToken();
                lname = tokx.nextToken();
                tempname = tokx.nextToken();

                if (tempname.startsWith("Jr") || tempname.startsWith("Sr") || tempname.startsWith("II") || tempname.startsWith("Esq")) {
                    lname += " " + tempname;
                } else {
                    mi = lname;
                    lname = tempname;
            ...
            } else if (tokx.countTokens() == 4) {

                fname = tokx.nextToken();
                mi = tokx.nextToken();
                lname = tokx.nextToken() + " " + tokx.nextToken();
