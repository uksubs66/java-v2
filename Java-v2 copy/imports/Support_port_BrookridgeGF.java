...
*/           
            ...
            if (mtype.equalsIgnoreCase("A")) {
                mtype = "Primary";
            } else {
                
                if (mtype.equalsIgnoreCase("DEP")) {
                    ...
                    if (mNum.endsWith("B")) {
                        ...
                        primary = 9;
                    } else if (mNum.endsWith("J")) {
                        primary = 10;
                    } else if (mNum.endsWith("K")) {
                        primary = 11;
                    } else if (mNum.endsWith("L")) {
                        primary = 12;
                    } else if (mNum.endsWith("M")) {
                        primary = 13;
                    } else if (mNum.endsWith("N")) {
                        primary = 14;
                    } else if (mNum.endsWith("O")) {
                        primary = 15;
                    }
                    
                } else if (mtype.equalsIgnoreCase("SPS")) {
                    mtype = "Spouse";
                    primary = 1;
                }
