...
*/
            ...
            if (tempName.length == 2) {
                ...
                if (tempval.length() == 1 || (tempval.length() == 2 && tempval.contains(".")) || (!tempval2.equalsIgnoreCase("JR") && !tempval2.equalsIgnoreCase("SR") &&
                    !tempval2.equalsIgnoreCase("I") && !tempval2.equalsIgnoreCase("II") && !tempval2.equalsIgnoreCase("III") && !tempval2.equalsIgnoreCase("MD") &&
                    !tempval2.equalsIgnoreCase("M.D."))) {
                    mi = tempval;
                    lname = tempval2;
                } else {
                    lname = tempval + " " + tempval2;
                }
            } else if (tempName.length > 3) {
                fname = tempName[0];
                mi = tempName[1];
