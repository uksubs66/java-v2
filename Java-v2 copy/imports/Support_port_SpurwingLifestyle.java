...
*/           
            ...
            } else if (mNum.toUpperCase().endsWith("B")) {
                mtype = "Junior";
                gender = "";
                primary = 2;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("C")) {
                mtype = "Junior";
                gender = "";
                primary = 3;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("D")) {
                mtype = "Junior";
                gender = "";
                primary = 4;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("E")) {
                mtype = "Junior";
                gender = "";
                primary = 5;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("F")) {
                mtype = "Junior";
                gender = "";
                primary = 6;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("G")) {
                mtype = "Junior";
                gender = "";
                primary = 7;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("H")) {
                mtype = "Junior";
                gender = "";
                primary = 8;
                mNum = mNum.substring(0, mNum.length() - 1);
            } else if (mNum.toUpperCase().endsWith("I")) {
                mtype = "Junior";
                gender = "";
                primary = 9;
                mNum = mNum.substring(0, mNum.length() - 1);
