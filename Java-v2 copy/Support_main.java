    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (clubname.equals(club)) {
                if (inactive > 0) {                    
                    out.println("<option selected value=\"" + clubname + "\">" + clubname + " - " + fullname + " (INACT)</option>"); 
                } else {
                    out.println("<option selected value=\"" + clubname + "\">" + clubname + " - " + fullname + "</option>"); 
                }
            } else {
                if (inactive > 0) {                    
                    out.println("<option value=\"" + clubname + "\">" + clubname + " - " + fullname + " (INACT)</option>"); 
                } else {
                    out.println("<option value=\"" + clubname + "\">" + clubname + " - " + fullname + "</option>"); 
                }
            }
        }  
        pstmt.close();
