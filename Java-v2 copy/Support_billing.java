 ...
 *   last updated:
 *
 *          3/01/13  Default the billing options (mship and mtype) to checked to speed up the process.
...
public class Support_billing extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<table border=\"1\" bgcolor=\"#F5F5DC\" cellpadding=\"6\">");
      ...
      out.println("<form action=\"Support_billing\" method=\"post\">");
      ...
      for (i=0; i < maxMships; i++) {
         ...
         if (!mArrays.mship[i].equals( "" )) {
            ...
            if (mArrays.mship[i].startsWith("Social")) {
             
                out.println("&nbsp;&nbsp;<input type=\"checkbox\" name=\"mship" +i+ "\" value=\"1\">&nbsp;&nbsp;" +mArrays.mship[i]+ "&nbsp;&nbsp;&nbsp;&nbsp;" +roundsPer+ " <br>");

            } else {
            
                out.println("&nbsp;&nbsp;<input type=\"checkbox\" checked name=\"mship" +i+ "\" value=\"1\">&nbsp;&nbsp;" +mArrays.mship[i]+ "&nbsp;&nbsp;&nbsp;&nbsp;" +roundsPer+ " <br>");
            }
         }
      }
      out.println("</font></td><td align=\"left\">");
      ...
      for (i=0; i < maxMems; i++) {
         ...
         if (!mArrays.mem[i].equals( "" )) {
            ...
            if (mArrays.mem[i].startsWith("Junior") || mArrays.mem[i].startsWith("Dependent")) {
             
                out.println("&nbsp;&nbsp;<input type=\"checkbox\" name=\"mtype" +i+ "\" value=\"1\">&nbsp;&nbsp;" +mArrays.mem[i]+ "<br>");

            } else {
                
                out.println("&nbsp;&nbsp;<input type=\"checkbox\" checked name=\"mtype" +i+ "\" value=\"1\">&nbsp;&nbsp;" +mArrays.mem[i]+ "<br>");
            }
         }
      }
      out.println("</font></td></tr>");
      ...
      out.println("<tr><td align=\"left\">");
      out.println("<font size=\"2\">");
      out.println("<b>&nbsp;&nbsp;Select Billing Type:</b>&nbsp;&nbsp;");
      out.println("</font></td><td align=\"left\">");
      out.println("<font size=\"2\">");
      out.println("&nbsp;&nbsp;<input type=\"radio\" name=\"rate\" value=\"peradult\">&nbsp;&nbsp;$10 Per Adult&nbsp;&nbsp;<BR>");
      out.println("&nbsp;&nbsp;<input type=\"radio\" name=\"rate\" value=\"permship\">&nbsp;&nbsp;$20 Per Membership&nbsp;&nbsp;");
      out.println("</font></td></tr>");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      while (i < Max && !mship.equals( "" )) {       // do each requested mship type
         ...
         out.println("<font size=\"2\">" + mshipName);
         out.println("</font></td>");
         out.println("<td align=\"left\">");
         out.println("<font size=\"2\">");
      ...
      if (rate.equals("permship")) {    
        ...
        out.println("<BR><BR><b>Notice:</b> Make sure this club has the same Member Number for the family and all Member Numbers are specified in roster!!");
      }
      ...
      out.println("<BR><BR> <A HREF=\"Support_billing\">Return</A>");
      out.println("</CENTER></BODY></HTML>");
      return;
   }
