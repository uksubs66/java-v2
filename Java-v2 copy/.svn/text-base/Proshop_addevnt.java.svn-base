...
*/
   ...
   out.println("<BR><BR>If you would like to recur this event, please verify that the event was added as desired and then go to System Config - Event Setup - Recur an Existing Event.");
/*   
   if (itinL > 255) {
