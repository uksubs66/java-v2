    ...
    try {
      ...
      //if (index2 <= days) {
        if (new_skin) {
            ...
            out.print("<div>");
            out.print("<label for=\"hr\">What time would you like the first tee?</label>");
            ...
            out.println("<input type=button class=\"standard_button change_notification_button\" value=\"Make New Request\" onclick=\"makeNotify()\">");
            ...
            out.println("<div class=\"sub_instructions\">"
                    ...
                    + "<p><b>Notifications are accepted between the hours of " + fstart_time + " and " + fend_time + ".</b></p>"
                    + "</div>");
            out.print("</div>");
            
            out.print("</div></div></fieldset>");
            out.println("</form>");
            ...
            if (!event1.equals("")) {
                ...
                out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?event=" + event1 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                out.println("<button type=\"button\" style=\"background:" + ecolor1 + "\">" + event1 + "</button></a>");
                out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                if (!event2.equals("")) {

                    out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?event=" + event2 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                    out.println("<button type=\"button\" style=\"background:" + ecolor2 + "\">" + event2 + "</button></a>");
                    out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                    if (!event3.equals("")) {

                        out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?event=" + event3 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                        out.println("<button type=\"button\" style=\"background:" + ecolor3 + "\">" + event3 + "</button></a>");
                        out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                        if (!event4.equals("")) {

                            out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?event=" + event4 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
            ...
            if (!rest1.equals("")) {
                ...
                out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?rest=" + rest1 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                out.println("<button type=\"button\" style=\"background:" + rcolor1 + "\">" + rest1 + "</button></a>");
                out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                if (!rest2.equals("")) {

                    out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?rest=" + rest2 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                    out.println("<button type=\"button\" style=\"background:" + rcolor2 + "\">" + rest2 + "</button></a>");
                    out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                    if (!rest3.equals("")) {

                        out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?rest=" + rest3 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
                        out.println("<button type=\"button\" style=\"background:" + rcolor3 + "\">" + rest3 + "</button></a>");
                        out.println("&nbsp;&nbsp;&nbsp;&nbsp;");

                        if (!rest4.equals("")) {

                            out.println("<a href=\"javascript:void(0)\" onclick=\"window.open('MemberTLT_sheet?rest=" + rest4 + "', 'newwindow', 'height=430, width=550, toolbar=no, menubar=no, scrollbars=auto, resizable=yes, location=no, directories=no, status=no');return false;\">");
      ...
      out.println("}");
        ...
        if (new_skin) {
            ...
            out.println("<table class=\"standard_list_table upcoming_notifications\">");
            out.println("<caption><h3>" + ((index == 0) ? "Today's " : day_name + "'s ") + " Upcoming Notifications</h3></caption>");
            out.print("<thead><tr>");

            out.print("<th class=\"collapse_width\">Estimated Arrival</th>");
            if (courseName1.equals("-ALL-")) {
                out.print("<th>Course</th>");
            }
            out.print("<th>Members</th>");
            out.print("<th class=\"collapse_width\">Holes</th>");
            out.print("<th class=\"collapse_width\">Players</th>");
            ...
            while (rs.next()) {
                ...
                if (allow) {
                    ...
                    data_map.put("data",form_data_map);
                    out.print("<td><a href=\"#\" class=\"standard_button post_button\" value=\"" + req_time + "\" data-ftjson=\""+StringEscapeUtils.escapeHtml(gson_obj.toJson(data_map))+"\">"+req_time+"</a></td>");
                } else {
                    out.print("<td><div class=\"time_slot\">");
                    if (rs.getInt("converted") == 1) {
                ...
                out.print("<td>" + rs.getString("holes") + "</td>");
                out.print("<td>" + rs.getString("player_count") + "</td>");
            ...
            while (rs.next()) {
                ...
                //  disallow access if this user is not part of this tee time
                if (belongs == null || !belongs.equals(user)) {
                    allow = false;
                }
                ...
                if (courseName1.equals("-ALL-")) {
                    out.println("<td><font size=2>" + courseName + "</font></td>");
                }
        ...
        if (true) { // index == 0  // always show tee sheet
            ...
            if(new_skin){
                ...
                //
                out.println("<table class=\"standard_list_table\">");    // tee sheet table
                out.print("<caption>");
                //
                ...
                out.print("<hr>");
                out.print("<p class=\"legend\"><b>F/B:</b> <span>F = Front Nine,</span> <span>B = Back Nine,</span> "
                        + "<span>O = Open (for cross-overs),<span> S = Shotgun Event</span></p>");
                ...
                for (int ic = 0; ic < 16; ic++) {
                    ...
                    if (!parmc.tmodea[ic].equals("")) {
                        out.print("<span>" + parmc.tmodea[ic] + " = " + parmc.tmode[ic] + ",</span> ");
                    }
                }
                out.println("<span>(__9 = 9 holes)</span></p>"); 
                out.println("</caption>");
                ...
                out.print("<th class=\"collapse_width\">Time</th>");

                if (parm.constimesm > 1) {      // if Consecutive Tee Times allowed
                    out.print("<th class=\"collapse_width\">#</th>");
                }
                if (courseName1.equals("-ALL-")) {
                    out.print("<th>Course</th>");
                }
                out.print("<th class=\"collapse_width\">F/B</th>");
                
                for(int i2 = 1; i2 <= ((fivesALL != 0)?5:4); i2 ++){
                    out.print("<th>Player "+i2+((disp_hndcp == false)?"":" <span class=\"small_text\"><u>hndcp</u></span>")+"</th>");
                    out.print("<th class=\"collapse_width\">C/W</th>");
                }
                ...
                String sql = ""
                        ...
                        + (!club.equals("bearcreekgc") ? "    AND player1 <> '' " : "" )
                        + "    AND blocker = '' "
                ...
                while (rs.next()) {
                    ...
                    out.print("<tr>");         // start of tee slot (row)

                    if ((allow == true) && (in_use == 0) && !hide_submit) {         // if still ok

                        out.print("<td><a href=\"#\" data-ftjson=\""+StringEscapeUtils.escapeHtml(gson_obj.toJson(data_map))+"\" class=\"teetime_button standard_button\">"+ hr + ":" + SystemUtils.ensureDoubleDigit(min) + ampm +"</a></td>");
                    ...
                    if (courseName1.equals("-ALL-")) {
                        ...
                        out.print("<td style=\"" + course_color + "\">"+courseNameT+"</td>");
                    }
                ...
                while (rs.next()) {
                    ...
                    if (blocker.equals("")) {    // continue if tee time not blocked & not lottery - else skip
                        ...
                        if ((allow == true) && (in_use == 0) && (hideSubmit == 0)) {         // if still ok
                            ...
                            out.println("<input type=\"hidden\" name=\"ttdata\" value=\"" + Utilities.encryptTTdata(hr + ":" + String.format("%02d", min) + ampm + "|" + fb + "|" + user) + "\">");
                        ...
                        if (courseName1.equals("-ALL-")) {
                            ...
                            if (tmp_i >= colorMax) {
                                tmp_i = (colorMax - 1);      // default to White if exceeds # of colors
                            }
