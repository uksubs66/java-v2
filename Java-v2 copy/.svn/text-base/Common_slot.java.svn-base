...
public class Common_slot {
    ...
    public static void setDefaultTransportTypes(parmSlotPage parm) {
        ...
        if (isTeeSlot && parm.club.equals("lakes")) {
            ...
            parm.guest_type_cw_map.put("_default_", "C");      // set default Mode of Trans
                ...
                || parm.club.equals("theplantationgc") || parm.club.equals("lakewoodranch") || parm.club.equals("oronoquecc")))) {
            ...
            parm.guest_type_cw_map.put("Accompanied", "CI");
            parm.guest_type_cw_map.put("PGA Member", "CI");
            parm.guest_type_cw_map.put("Family", "CI");
            parm.guest_type_cw_map.put("Employee", "CI");
            parm.guest_type_cw_map.put("_default_", ""); // Use  default
    ...
    public static void setGuestTypes(Connection con, parmSlotPage parm, parmClub clubParm, parmSlot slotParms, parmSlotm slotmParms) {
        ...
        if (isEventSlot && (parm.club.equals("medinahcc") || parm.club.equals("olyclub"))) {
            ...
            parm.guest_types_map.put("gt_0", new LinkedHashMap<String, Object>());
            ((Map<String, Object>) parm.guest_types_map.get("gt_0")).put("guest_type", "Event Guest");
            ((Map<String, Object>) parm.guest_types_map.get("gt_0")).put("guest_type_db", 0);
            return;
        ...
        if (isEventSlot && parm.club.equals("wellesley")) {
            ...
            parm.guest_types_map.put("gt_0", new LinkedHashMap<String, Object>());
            ((Map<String, Object>) parm.guest_types_map.get("gt_0")).put("guest_type", "Tourney Guest");
            ((Map<String, Object>) parm.guest_types_map.get("gt_0")).put("guest_type_db", 0);
            return;
        ...
        for (int i = 0; i < clubParm.MAX_Guests; i++) {
            ...
            if (clubParm.guest[i] != null && !clubParm.guest[i].equals("") && clubParm.gOpt[i] == 0) {   // if guest name is open for members
                ...
                if (!skipGuestType) {
                    parm.guest_types_map.put("gt_" + i, new LinkedHashMap<String, Object>());
                    ((Map<String, Object>) parm.guest_types_map.get("gt_" + i)).put("guest_type", clubParm.guest[i]);
                    ((Map<String, Object>) parm.guest_types_map.get("gt_" + i)).put("guest_type_db", clubParm.gDb[i]);
                    ...
                    if (isTeeSlot && slotParms != null && (parm.club.equals("olyclub") || parm.club.equals("demov4"))) {     // custom to mark some guest types disabled
                        ...
                        if (olyclubGR == true) {    // if restricted - mark it disabled
                            ...
                            ((Map<String, Object>) parm.guest_types_map.get("gt_" + i)).put("guest_type_disabled", true);
