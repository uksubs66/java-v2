 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (sess_activity_id == 0) {    // if Golf  
      ...
      if (new_skin) {
          ...
          out.println("<H2>Past Reservations for " + name + "</H2><br>");
         ...
         if (new_skin) {
          ...
          out.println("<p><BR><b>" + name + "</b> played a total of <b>" + count + "</b> rounds during the specified period.</p>");         
   ...
   String clubName = Utilities.getClubName(con, true);        // get the full name of this club
    ...
    try {
        ...
        if (new_skin) {
              ...
              out.println("  <thead><tr>");
              out.println("  <th> </th>");
              out.println("  <th>Allowed</th>");
              out.println("  <th>Used</th>");
              out.println("  <th>Remaining</th>");
              out.println(" </tr></thead>");
              out.println(" <tbody>");                             
              out.println("<tr><td>Golf Year</td><td>" + maxg + "</td><td>" + counts + "</td><td>" + (maxg - counts) + "</td></tr>");
              out.println("</table>");
