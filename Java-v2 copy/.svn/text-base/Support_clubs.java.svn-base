 ...
 *   last updated:
 *
 *        1/16/13   BP - Moved Act/Inact processing to Support_displayClubs.
...
*/
   ...
   if (req.getParameter("delete") != null) {
      ...
      out.println("<form method=\"post\" action=\"Support_clubs\">");
      ...
      */
      ...
      out.println("<INPUT TYPE='BUTTON' Value='NO - CANCEL' onClick='self.close()'>");
      out.println("</FORM>");
      out.println("</CENTER></BODY></HTML>");
      return;
