               ...
               if (nSlotParms.members > 1 || !nSlotParms.g1.equals( "" )) {  // if multiple members OR slot 1 is a guest
                  ...
                  //
                    if (new_skin) {
                        ...
                        String[] player_a = nSlotParms.getStringArrayByName("player%");
                        String[] pcw_a = nSlotParms.getStringArrayByName("p%cw");
                        int[] p9_a = nSlotParms.getIntArrayByName("p9%");
                        String[] userg_a = nSlotParms.getStringArrayByName("userg%");
...
*/
   ...
   //***********************************************
   //
   if (sendemail != 0 || club.equals("bearcreekgc")) {
