...
/* ADD ALL PLAYER POSTIONS TO THE ARRAYS
            player_names.add(rs.getString("player1"));
            player_names.add(rs.getString("player2"));
            player_names.add(rs.getString("player3"));
            player_names.add(rs.getString("player4"));
...
/*  ADD ONLY MEMBERS TO THE ARRAYS
...
*/
    ...
    //out.println("<!-- Found " + player_names.size() + " players (" + usernames.size() + ") -->");
        ...
        try {
            ...
            if (!usernames.get(i).equals("")) {
                ...
                if ( rs.next() ) {
                    ...
                    filenames.add("");  // add empty string to make handling this array easier later on

                }

            } else {

                filenames.add(""); // and empty entry to keep arrays sync'd
    ...
    //out.println("<!-- Found " + filenames.size() + " filenames -->");
