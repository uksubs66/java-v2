 ...
 *
 *         7/24/13  Wait List color will now be displayed on the Edit Wait List page.
...
*/
    ...
    out.println("<form action=\"Proshop_waitlist\" method=\"GET\">");
...
*/
    ...
    out.println("<form action=\"Proshop_waitlist\" method=post>");
 ...
 private void buildList(int multi, PrintWriter out, Connection con) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tmp_color = rs.getString("color");
                                
                out.println("<tr align=center height=50><form>" +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_name + "</td>" +
                            ((multi == 0) ? "" : "<td style=\"background-color:" + tmp_color + "\">" + tmp_course + "</td>") +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_sdate + "</td>" +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_edate + "</td>" +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_stime + "</td>" +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_etime + "</td>" +
                            "<td style=\"background-color:" + tmp_color + "\">" + tmp_recurrence + "</td>" +
                            "<td style=\"background-color:" + tmp_color + "\"><input type=hidden name=edit><input type=hidden name=waitListId value=\"" + tmp_id + "\">" + 
        ...
        out.println("<br><form action=\"Proshop_announce\">");
        out.println("<input type=hidden name=menu>");
        out.println("<input type=submit value=\"Return\">");
        out.println("</form>");
        out.println("</center>");
