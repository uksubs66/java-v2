 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      PreparedStatement pstmt = con.prepareStatement (
         ...
         "FROM teepast2 " +
         "WHERE date = ? AND courseName = ? AND (event != '' OR restriction != '') " +
         "ORDER BY time, fb");
    ...
    if (!excel.equals("yes")) {
      ...
      out.println("<td align=left width=\"20%\">");         // column for Control Panel
      
         /*  // this was not intended to go live yet
         //
         ...
         //  Add Print Menu Form
         //
         out.println("<form name=\"cpHlp\" action=\"/" +rev+ "/servlet/Proshop_oldsheets\">");
         ...
         */
         ...
         if (printAccess && enableAdvAssist) {
         ...
         if (!player1.equals("")) {
            ...
            if (excel.equals("yes")) {
                ...
                if (player1.equalsIgnoreCase("x")) {
                   ...
                   if ((club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) && !custom_disp1.equals("")) {
                       p1 += " " + custom_disp1;
                   }
         ...
         if (!player2.equals("")) {
            ...
            if (excel.equals("yes")) {
                ...
                if (player2.equalsIgnoreCase("x")) {
                   ...
                   // If Club at Pradera and a cart number was found for this player, display it behind their name.
                   if ((club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) && !custom_disp2.equals("")) {
                       p2 += " " + custom_disp2;
                   }
         ...
         if (!player3.equals("")) {
            ...
            if (excel.equals("yes")) {
                ...
                if (player3.equalsIgnoreCase("x")) {
                   ...
                   // If Club at Pradera and a cart number was found for this player, display it behind their name.
                   if ((club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) && !custom_disp3.equals("")) {
                       p3 += " " + custom_disp3;
                   }
         ...
         if (!player4.equals("")) {
            ...
            if (excel.equals("yes")) {
                ...
                if (player4.equalsIgnoreCase("x")) {
                   ...
                   // If Club at Pradera and a cart number was found for this player, display it behind their name.
                   if ((club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) && !custom_disp4.equals("")) {
                       p4 += " " + custom_disp4;
                   }
               ...
               if (show5 == 1) {                 // if player has been checked in
                ...
                if (excel.equals("yes")) {
                   ...
                   if (player5.equalsIgnoreCase("x")) {
                      ...
                      // If Club at Pradera and a cart number was found for this player, display it behind their name.
                      if ((club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) && !custom_disp5.equals("")) {
                          p5 += " " + custom_disp5;
                      }
...
*/
 ...
 private void cancel(HttpServletRequest req, PrintWriter out, Connection con) {
   ...
   out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_oldsheets?calDate=" + calDate + "&course=" + course + "&post=yes\">");
   out.println("</HEAD>");
 ...
 /*        slotParms.pos1 = rs.getShort("pos1");
   ...
   out.println("<link rel=\"stylesheet\" href=\"/" +rev+ "/web utilities/foretees2.css\" type=\"text/css\">");
   out.println("<Title>Proshop Tee Slot Page</Title>");
   out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_oldsheets?calDate=" +calDate+ "&course=" + slotParms.course + "&jump=" + slotParms.jump + "&post=yes\">");
   out.println("</HEAD>");
