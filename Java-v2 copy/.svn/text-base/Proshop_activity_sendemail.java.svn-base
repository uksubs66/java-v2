...
*/    
    ...
    if (setall == false) {
       ...
       out.println("<a href=\"Proshop_activity_sendemail?group_id=" +group_id+ "&setall=yes&date=" + date + "\" target=\"bot\" title=\"Click Here to Check All Boxes Below\" alt=\"Check All\">");
