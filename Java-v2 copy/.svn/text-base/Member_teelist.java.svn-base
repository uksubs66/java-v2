...
public class Member_teelist extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if ((club.equals("ballantyne") || club.equals("sierraviewcc") || club.equals("fortcollins")) && sess_activity_id == 1) {
            sysLingo.setLessonBookLingo("Ball Machine");
        } else if (club.equals("kopplinandkuebler")) {
            sysLingo.setLessonBookLingo("Meetings");      // custom site for scheduling meetings - Kopplin & Kuebler (Greg DaRosa)
        } else {
   ...
   /*
        ...
        //
        // Note: Continue new_skin below, after setting some variables.
        //
        ...
        if (!new_skin) {
            ...
            if (club.equals("interlachenspa")) {
                ...
                if (lottery > 0 && parm.foretees_mode == 1 && (selected_act_id == 0 || selected_act_id == all_activities)) {
                ...
                if (organization_id != 0) {
                    ...
                    out.println("<td width=\"170\" align=\"center\"><font size=\"1\" color=\"Steelblue\">");
                    out.println("Your Dining Reservations");
                    out.println("</font></td>");
            ...
            if (parm.genrez_mode != 0 && (!getActivity.isStagingMode(con) || sess_activity_id != 0)) {  // if any activities defined in system - add a drop down selection list for activities

                out.println("<font size=\"2\"><br>");
                out.println("<form action=\"Member_teelist\" method=\"post\" name=\"cform\" target=\"bot\">");

                out.println("<b>Select the Activity to Display:</b>&nbsp;&nbsp;");
                getActivity.buildActivitySelect(1, selected_act_id, "onChange=\"document.cform.submit()\"", true, con, out);
            ...
            if (club.equals("estanciaclub")) {
                ...
                out.println("    <p><b>You currently have " + ((4 - advTimeCount > 0) ? (4 - advTimeCount) : 0) + " out of 4 Advance Guest Times remaining.</b></p><br>");
            }
            ...
            if (!caller.equals("FLEXWEBFT") && ((parm.genrez_mode != 0 && (!getActivity.isStagingMode(con) || sess_activity_id != 0)) || organization_id != 0)) {       // if any activities defined in system - add a drop down selection list for activities
                ...
                out.println("    <form action=\"Member_teelist\" method=\"get\" name=\"cform\">");
                out.println("    <p>");

                out.println("      <b>Select the Activity to Display:</b>&nbsp;&nbsp;");
                getActivity.buildActivitySelect(1, selected_act_id, "onChange=\"document.cform.submit()\"", true, con, out);
                out.println("    </p><br></form>");
            }


            out.println("    <a href=\"#\" class=\"standard_button print_button\"><b>Print this page</b></a>");
        ...
        if ((club.equals("deserthighlands") && sess_activity_id == 0) || club.equals("mirabel") || club.equals("stcloudcc") || 
             club.equals("esterocc") || club.equals("edina")) {
        ...
        for (i2 = 0; i2 < months; i2++) {                 // do each month
            ...
            */
            ...
            try {
                ...
                if (/*parm.genrez_mode == 0 || */selected_act_id == all_activities) {     // if no Activities or ALL selected
                    ...
                    if (club.equals("tcclub")) {
                        ...
                        pstmt1 = con.prepareStatement(
                                "SELECT day "
                                + "FROM events2b WHERE date > ? AND date < ? AND activity_id = ? AND inactive = 0");
            ...
            if (parm.genrez_mode != 0 && (flxRezAct_selected || allAct)) {      // if any activites defined for this club
                ...
                try {
                    ...
                    pstmt1 = con.prepareStatement(
                            ...
                            + "WHERE DATE_FORMAT(a.date_time, '%Y%m%d') >= ? AND DATE_FORMAT(a.date_time, '%Y%m%d') <= ? AND ap.username = ? " + (selected_act_id != all_activities ? "AND a.activity_id IN (" + selected_act_children + ") " : "")
            ...
            if (!new_skin) {
                ...
                out.println("<thead>");
                out.println("<tr>");
                out.println("<th><b>Sunday</b></th>");
                out.println("<th><b>Monday</b></th>");
                out.println("<th><b>Tuesday</b></th>");
                out.println("<th><b>Wednesday</b></th>");
                out.println("<th><b>Thursday</b></th>");
                out.println("<th><b>Friday</b></th>");
                out.println("<th><b>Saturday</b></th>");
                ...
                if (!new_skin) {
                    ...
                    if (max > 0) {            // if member can view tee sheet for this date
                        ...
                        if (sess_activity_id == 0) {          // if Golf
                            out.println("<a href=\"Member" + ((IS_TLT) ? "TLT" : "") + "_sheet?index=" + index + "\">");
                        } else if (sess_activity_id == dining_activity_id) {
                            out.println("<a href=\"Dining_slot?action=new&amp;orig=calendar&amp;date=" + date + "\">");
                        } else {
                            out.println("<a href=\"Member_gensheets?date=" + date + "\">");
                        }
                        out.println(day + "</a>");
                    ...
                    if (max > 0 && (sess_activity_id == 0 || sess_activity_id == dining_activity_id || !getActivity.isChildlessActivity(sess_activity_id, con))) {            // if member can view tee sheet for this date
                        ...
                        if (sess_activity_id == 0) {          // if Golf
                            ...
                            out.println("<a class=\"day\" href=\""+dining_base+"Dining_slot?action=new&amp;orig=calendar&amp;date=" + date + "\" title=\"Create a reservation for this day\">");
                        } else {
                            ...
                            if (!new_skin) {
                                ...
                                if (sess_activity_id == 0) {
                                    out.println(
                                            ...
                                            + buildItemDescription("Golf", rs.getString("pretty_time")) + "</a>");
                                } else {
                                    out.println(
                                            "<div class=\"tee_list_tlt_time\">" + buildItemDescription("Golf", rs.getString("pretty_time")) + "</div>");
                                }
                                out.print("</div>");
                            } // else (if !new_skin)
                        }
                            ...
                            while (rs.next()) {
                                ...
                                if (!ename.equals("") && etype == 1) {  // tee time during a shotgun event
                                    ...
                                    if (!new_skin) {
                                        ...
                                        out.print("<div class=\"item_container\">");
                                        out.println("<div class=\"shotgun\">" + buildItemDescription("Shotgun Start", stime2) + "</div>");
                                        out.print("</div>");
                                    }
                                    ...
                                    if (!restricted && !cutoff && !(date == todayDate && time <= ctime) && sess_activity_id == 0) {     // if mem can edit tee time
                                        ...
                                        if (!new_skin) {
                                            ...
                                            if (Common_Server.SERVER_ID == 4) {
                                                ...
                                                out.println("<a href=\"data_loader?ical&amp;id=" + rs.getInt("teecurr_id") + "&amp;id_type=tee\">(download iCal)</a><br>");
                                            }
                                        } // if (!new_skin)
                                        else {
                                            ...
                                            out.print("<a class=\"teetime_button tee_list_color_4\" href=\"#\" "
                                                    + "data-ftjson=\"" + StringEscapeUtils.escapeHtml(gson_obj.toJson(hashMap)) + "\">" + buildItemDescription("Tee Time", stime) + "</a>");
                                        ...
                                        if (!new_skin) {
                                            ...
                                            out.print("<div class=\"item_container\">");
                                            out.print("<div class=\"teetime\"" + buildItemDescription("Tee Time", stime) + "</div>");
                                            out.print("</div>");
...
//               if (rs.next()) {               // just get the first one as each lesson can have multiple entries
                        while (rs.next()) {              // get all lesson times that have a num greater than zero (not a subsequent time)
                            ...
                            if (!new_skin) {
                                ...
                                if (club.equals("interlachenspa")) {
                                    ...
                                    item_name = buildItemDescription(sysLingo.TEXT_Lesson, stime2+ampm);
                                }
                                out.print("<div class=\"item_container\">");
                                if (returned_activity_id == sess_activity_id) {
                                    out.println("<a href=\"javascript: exeLtimeForm('" + proid + "','" + calDate + "','" + date + "','" + time + "','" + dayname + "','" + ltype + "','" + lesson_id + "','" + sess_activity_id + "')\" class=\"tee_list_color_5\">"
                                            + item_name + "</a>");
                                } else {
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            if (!new_skin) {
                                ...
                                item_name = buildItemDescription(lgname, stime2+ampm);
                                if (returned_activity_id == sess_activity_id) {
                                ...
                                if (!new_skin) {
                                    if (signedup == true) {     // if member already registered
                                        ...
                                        if (returned_activity_id == sess_activity_id) {
                                            ...
                                            if (wait == 0) {
                                                ...
                                                if (Common_Server.SERVER_ID == 4) {
                                                    ...
                                                    out.println("<a href=\"data_loader?ical&amp;id=" + id + "&amp;id_type=evntsup\">(download iCal)</a><br>");
                                                }
                                            } else {
                                        ...
                                        if (Common_Server.SERVER_ID == 4) {
                                            ...
                                            out.println("<a href=\"data_loader?ical&amp;id=" + event_id + "&amp;id_type=event\">(download iCal)</a><br>");
                                        }
                                    }
                                    ...
                                    if (signedup == true) {     // if member is registered
                                        ...
                                        if (returned_activity_id == sess_activity_id || returned_activity_id == selected_act_id || selected_act_id == all_activities) {
                                            ...
                                            if (wait == 0) {
                                                out.println(buildItemDescription(ename + (selected_act_id == all_activities ? " - (" + activity_name + ")" : "") + " - Registered", stime));

                                            } else {
                                                out.println(buildItemDescription(ename + (selected_act_id == all_activities ? " - (" + activity_name + ")" : "") + " - Wait List", stime));
                                            }
                                                        ...
                                                        if (rsDenver2.next()) {
                                                            ...
                                                            if (returned_activity_id == sess_activity_id || returned_activity_id == selected_act_id || selected_act_id == all_activities) {
                                                                ...
                                                                if (wait == 0) {
                                                                    ...
                                                                    out.println(buildItemDescription(ename + (selected_act_id == all_activities ? " - (" + activity_name + ")" : "") + " - Child Registered", stime));

                                                                } else {

                                                                    out.println(buildItemDescription(ename + (selected_act_id == all_activities ? " - (" + activity_name + ")" : "") + " - Child on Wait List", stime));
                                                                }
                                        ...
                                        if (signedup == false) {     // if dependents not registered either - add link to event info
                                            ...
                                            if (returned_activity_id == sess_activity_id || returned_activity_id == selected_act_id || selected_act_id == all_activities) {
                                                ...
                                                out.println(buildItemDescription(ename + (selected_act_id == all_activities ? " - (" + activity_name + ")" : ""), stime));
                                                out.println("</a>");
                                            } else {
                ...
                if (waitlistA[day] != 0) {
                    ...
                    try {
                        ...
                        if (rs.next()) {
                            ...
                            if (!new_skin) {
                                if (sess_activity_id == 0) {
                                    out.print("<a href=\"javascript:void(0)\" onclick=\"top.location.href='Member_waitlist?waitListId=" + rs.getInt("wait_list_id") + "&date=" + rs.getInt("dateymd") + "&index=999&day=" + rs.getString("day_name") + "&course=" + rs.getString("course") + "&returnCourse=" + rs.getString("course") + "'\" class=mWLsignup>");
                            ...
                            while (rs.next()) {
                                ...
                                if (!new_skin) {
                                    if (root_id == sess_activity_id) {
                                        out.print("<a href=\"javascript:void(0)\" onclick=\"top.location.href='Member_activity_slot?slot_id=" + rs.getInt("sheet_id") + "&date=" + rs.getInt("dateymd") + "&index=999'\" style=\"color: brown\">");
                                        out.print(activity_name + " at " + rs.getString("pretty_time"));
                                        out.println("</a>");
                                    } else {
                                        out.print("<div style=\"color: brown\">" + item_name + "</div>");
                                    }
                                } // if (!new_skin)
                                else {
                                    out.print("<div class=\"item_container\">");
                ...
                if (organization_id != 0 && diningA[day] != 0 && (selected_act_id == all_activities || selected_act_id == dining_activity_id || !new_skin)) {
                    ...
                    try {
                        ...
                        if (con_d != null) {
                            ...
                            while (rs.next()) {
                                ...
                                if (!new_skin) {
                                    if (false) { // rs.getBoolean("members_can_make_reservations") == true && state.equals("")

                                        // only make it a link if they are able to sign up but have not yet signed up.
                                        out.print("<a href=\"http://dining.foretees.com/self_service/reservations/member_login?landing=event&amp;event_id=" + rs.getInt("id") + "&amp;username=" + mNum + "&amp;organization_id=" + organization_id + "\" target=\"_dining\" style=\"color: Steelblue\">");
                                        out.print(rs.getString("name") + " at " + Utilities.getSimpleTime(dtime));
                                        out.println("</a>");

                                    } else {

                                        // display the event name
                                        out.print("<div style=\"color: Steelblue\">" + item_name);
                                        if (!state.equals("")) {
                                            out.print("<span class=\"item_state\" style=\"color: Steelblue\">(" + state + ")</span>");
                                        }
                                        out.println("</div>");
                                    ...
                                    if (rs.getBoolean("members_can_make_reservations") == false) {
                                        ...
                                        out.print("<a href=\"#\" data-ftlink=\""+dining_base+"Dining_home?nowrap&amp;event_popup&amp;event_id=" + rs.getInt("id") + "\" class=\"dining_event_modal tee_list_color_10\">"); // tu_iframe_620x400
                                        out.print(item_name);
                                        out.println("</a>");
                                        ...
                                        out.print("<a href=\"#\" data-ftlink=\""+dining_base+"Dining_home?nowrap&amp;event_popup&amp;event_id=" + rs.getInt("id") + "\" class=\"dining_event_modal tee_list_color_9\">");
                ...
                //
                if (organization_id != 0 && diningR[day] != 0 && (selected_act_id == all_activities || selected_act_id == dining_activity_id || !new_skin)) {
                        ...
                        if (con_d != null) {
                            ...
                            while (rs.next()) {
                                ...
                                if (!new_skin) {
                                    ...
                                    out.print("<a href=\""+dining_base+"Dining_slot?action=edit&amp;orig=calendar&amp;reservation_id=" + rs.getInt("id") + "\" style=\"color: Steelblue\" target=\"_top\">");
                                    out.print("<span style=\"color: Steelblue\">Reservation at " + Utilities.getSimpleTime(dtime) + "</span>");
                                    out.print("</a>");

                                } else {

                                    item_name = buildItemDescription("Reservation", Utilities.getSimpleTime(dtime));
...
//             }
        ...
        if (!new_skin) {
            ...
            //
            out.println("<form name=\"teeTime\" action=\"Member_slot\" method=\"post\" target=\"_top\">");
            ...
            //  Lottery Forms
            //
            out.println("<form name=\"lott2\" action=\"Member_lott\" method=\"post\" target=\"_top\">");
            out.println("<input type=\"hidden\" name=\"date\" value=\"\">");
            out.println("<input type=\"hidden\" name=\"day\" value=\"\">");
            out.println("<input type=\"hidden\" name=\"course\" value=\"\">");
            ...
            out.println("<form name=\"lott5\" action=\"Member_slot\" method=\"post\" target=\"_top\">");
            out.println("<input type=\"hidden\" name=\"date\" value=>");
            out.println("<input type=\"hidden\" name=\"day\" value=>");
            out.println("<input type=\"hidden\" name=\"course\" value=\"\">");
            out.println("<input type=\"hidden\" name=\"lname\" value=\"\">");
            ...
            //
            out.println("<form name=\"eventForm2\" action=\"Member_sheet\" method=\"post\" target=\"_blank\">");
