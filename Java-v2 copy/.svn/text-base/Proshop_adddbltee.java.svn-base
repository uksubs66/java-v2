 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println(SystemUtils.HeadTitle2("Proshop - Add Double Tee Main"));
    ...
    out.println("<center>");
       ...
       out.println("<form action=\"Proshop_adddbltee\" method=\"post\" target=\"bot\" name=\"f\">");
       out.println("<tr>");
          out.println("<td width=\"500\">");
            ...
            if (multi != 0) {           // if multiple courses supported for this club
             ...
             out.println("<p align=\"center\">");
               ...
               out.println("&nbsp;&nbsp;(<b>Be Patient - This may take a couple of minutes.</b>)");
             out.println("</p>");
             out.println("</font>");
          out.println("</td>");
       out.println("</tr>");
...
//   name = SystemUtils.filter(name);
   ...
   out.println("<font size=\"2\">");
   if (copy == false) {
      out.println("<form method=\"get\" action=\"Proshop_adddbltee\">");
   } else {
      out.println("<form method=\"get\" action=\"Proshop_dbltee\">");
