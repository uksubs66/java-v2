...
public class Support_cluboptions extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<table border=\"1\" bgcolor=\"#F5F5DC\" width=\"550\">");
      ...
      out.println("<tr><td align=\"left\" width=\"300\">");
      out.println("<font size=\"2\"><br>");
      out.println("&nbsp;&nbsp;FT Conenct Site?:&nbsp;&nbsp;");           // FT Connect Site
      out.println("</td><td align=\"left\">");
      ...
      out.println("<font size=\"2\"><form method=post action=\"Support_cluboptions\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("symlinks") != null  || req.getParameter("syncwebapps") != null ||
       ...
       if ((Common_Server.SERVER_ID >= 11 && Common_Server.SERVER_ID <= 13) || Common_Server.SERVER_ID == 4) {
   ...
   temp = req.getParameter("ftConnect");
   ...
   try {
      ...
      pstmt.setInt(12, flxrez_staging);
      pstmt.setInt(13, mobile);
      pstmt.setString(14, website_url);
      pstmt.setInt(15, stripalpha);
      pstmt.setInt(16, stripdash);
      pstmt.setInt(17, ftConnect);
      pstmt.setInt(18, memberInact);
      pstmt.setString(19, gn21_sourceClubId);
