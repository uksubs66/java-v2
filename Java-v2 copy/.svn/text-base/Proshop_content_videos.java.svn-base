...
public class Proshop_content_videos extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<p align=center><br><strong>NOTE:</strong> We suggest that you view the videos in <strong>full screen mode</strong>. ÊClick the full screen icon <img src=\"/" +rev+ "/images/full_screen.png\" width=\"28\" height=\"32\"> located near the bottom right corner of the video player.");
