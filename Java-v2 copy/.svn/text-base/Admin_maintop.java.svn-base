 ...
 *   last updated:
 *
 *      7/18/12  Denver CC (denvercc) - Added a custome weather link.
   ...
   if (club.equals("tpcpotomac") || club.equals("tpcsouthwind") || club.equals("tpcsugarloaf") || club.equals("tpcwakefieldplantation") || 
     ...
     out.println("<td valign=\"middle\" width=\"12%\" align=\"left\" rowspan=\"2\">");
       if (club.equals("gcgeorgia")) {
           ...
           out.print("<a href=\"http://weather.weatherbug.com/CO/Denver-weather/local-forecast/7-day-forecast.html?zcode=z5545&units=0\" target=\"_blank\">");
       } else {
     ...
     out.println("<td width=\"52%\" align=\"center\">");
        ...
        if (getActivity.isConfigured(con) || user.equals("admin4tea")) {
            out.println("&nbsp;&nbsp;<a href=\"Admin_mships\" target=\"bot\">mships</a>");
        }
        //// TEMP - REMOVE LATER!!!! ////

        out.println("</p>");
      out.println("<!-- Begin code to display images horizontally. -->");
      out.println("<a href=\"Admin_announce\" target=\"bot\" onMouseOver=\"document.images['AdminHome'].src = '/" +rev+ "/images/AdminHome-over.png'\" onMouseOut=\"document.images['AdminHome'].src = '/" +rev+ "/images/AdminHome.png'\"><img name=\"AdminHome\" src=\"/" +rev+ "/images/AdminHome.png\" hspace=\"0\" border=\"0\" alt=\"Return to Announcement Page\"></a>");
      out.println("<a href=\"Admin_members\" target=\"bot\" onMouseOver=\"document.images['AdminMembers'].src = '/" +rev+ "/images/AdminMembers-over.png'\" onMouseOut=\"document.images['AdminMembers'].src = '/" +rev+ "/images/AdminMembers.png'\"><img name=\"AdminMembers\" src=\"/" +rev+ "/images/AdminMembers.png\" hspace=\"0\" border=\"0\" alt=\"Maintain Member Database\"></a>");

      if (hotel != 0) {
         out.println("<a href=\"Admin_hotelusers\" target=\"bot\" onMouseOver=\"document.images['Hotel_Users'].src = '/" +rev+ "/images/Hotel_Users-over.png'\" onMouseOut=\"document.images['Hotel_Users'].src = '/" +rev+ "/images/Hotel_Users.png'\"><img name=\"Hotel_Users\" src=\"/" +rev+ "/images/Hotel_Users.png\" hspace=\"0\" border=\"0\" alt=\"Create and Manage the Hotel User Accounts\"></a>");
      }
      out.println("<a href=\"Admin_proshopusers\" target=\"bot\" onMouseOver=\"document.images['Proshop_Users'].src = '/" +rev+ "/images/Admin_ProUsers-over.png'\" onMouseOut=\"document.images['Proshop_Users'].src = '/" +rev+ "/images/Admin_ProUsers.png'\"><img name=\"Proshop_Users\" src=\"/" +rev+ "/images/Admin_ProUsers.png\" hspace=\"0\" border=\"0\" alt=\"Create and Manage the Proshop User Accounts\"></a>");
      out.println("<a href=\"Common_report_members\" target=\"bot\" onMouseOver=\"document.images['AdminListExport'].src = '/" +rev+ "/images/AdminListExport-over.png'\" onMouseOut=\"document.images['AdminListExport'].src = '/" +rev+ "/images/AdminListExport.png'\"><img name=\"AdminListExport\" src=\"/" +rev+ "/images/AdminListExport.png\" hspace=\"0\" border=\"0\" alt=\"List or Export The Member Roster\"></a>");
      ...
      out.println("<a href=\"Logout\" target=\"_top\" onMouseOver=\"document.images['AdminLogout'].src = '/" +rev+ "/images/AdminLogout-over.png'\" onMouseOut=\"document.images['AdminLogout'].src = '/" +rev+ "/images/AdminLogout.png'\"><img name=\"AdminLogout\" src=\"/" +rev+ "/images/AdminLogout.png\" hspace=\"0\" border=\"0\" alt=\"Exit ForeTees\"></a>");
