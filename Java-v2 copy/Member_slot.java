...
public class Member_slot extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        configure_slot:
        {
            if (club.equals("tpcboston") || club.equals("alisoviejo") || club.equals("bluebellcc") || club.equals("hiwan") || club.equals("trophyclubcc")
                    ...
                    || club.equals("marbellacc") || club.equals("shadycanyongolfclub") || club.equals("plantationgcc") || club.equals("bayhill")) {
...
*/
      ...
      /*
        ...
        if (club.equals("shadycanyongolfclub") && emailCan == 0) {
            ...
            if (emailNew == 1 && !slotParms.notes.equals("")) {  // new request and contains notes, send email.
                ...
                try {
                    ...
                    pstmtTemp.clearParameters();
                    pstmtTemp.setInt(1, slotParms.teecurr_id);
        ...
        if ((club.equals("bishopsgategc") || club.equals("demobrad")) && (slotParms.members > 0 || slotParms.guests > 0) && slotParms.custom_int == 0
