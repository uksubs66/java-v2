 ...
 *   last updated:
 *
 *       12/21/12   Fixed font color on password reset page to be black instead of white on the beige background.
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<tr>");
     out.println("<td align=\"center\"><br>");
      ...
      out.println("<form action=\"Proshop_services\" method=\"post\" target=\"bot\" name=\"f\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (old_password.equals( curr_password ) &&
        ...
        if (club.startsWith( "demo" )) {        // do not change pw if demo site
            ...
            out.println("<font size=\"2\">");
            out.println("<form method=\"get\" action=\"Proshop_services\">");
