      ...
      if (organization_id > 0) {
          ...
          if (con_d != null) {
              ...
              try {
                  ...
                  pstmt = con.prepareStatement("SELECT name_pre, name_last, name_first, name_mi, name_suf, email, emailOpt, phone1, phone2, birth, IF(dining_id = NULL, 0, dining_id) as dining_id_val FROM member2b WHERE username = ?");
                  pstmt.clearParameters();
              ...
              if (dining_id > 0) {      // Member already has a record in the Dining db, update it with the info from ForeTees member2b
                  ...
                  try {
                      ...
                      pstmt = con_d.prepareStatement(
                              ...
                              "auto_email_for_event_reservations = ? " +
                              "WHERE id = ? " +
                              "RETURNING *");
                      pstmt.clearParameters();
                      /*
                      ...
                      */
                      ...
                      pstmt.setString(4, home_phone);
                      pstmt.setString(5, work_phone);
                      pstmt.setString(6, email_address);
                      pstmt.setDate(7, birth_date);
                      pstmt.setBoolean(8, emailOptBool);
                      pstmt.setBoolean(9, emailOptBool);

                      pstmt.setInt(10, dining_id);
              ...
              } else {      // No record exists for this member in the Dining db, insert a new record and populate the dining_id field in ForeTees member2b
