...
public class Proshop_report_activity_utilization extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   // event time options
   out.println("<p align=\"left\"><b>5. Include Event Times?:</b>&nbsp;&nbsp;");
...
*/
 ...
 private boolean gatherStats(parmUtilization parm, PrintWriter out, Connection con) {
    ...
    ArrayList<String> previous_related_ids = new ArrayList<String>();
    ...
    try {
        ...
        pstmt = con.prepareStatement (
            "SELECT t1.sheet_id, t1.event_id, t1.rest_id, t1.related_ids, t2.username, t2.player_name, " +
            ...
            "WHERE " +
                ...
                ((!parm.inc_events) ? "AND event_id = 0 " : "") +
            "ORDER BY " + order_by + ";");
            ...
            if (rs.getInt("sheet_id") == last_id) {
                ...
                */
                ...
                if (rs.getString("player_name") == null) {
                    ...
                    // For blank player slots in FlxRez, we need to always treat event slots as USED since they cannot plug in the players.
                    if (rs.getInt("event_id") != 0) {
                    ...
                    } else if (parm.count_restricted && rs.getInt("rest_id") != 0) {
...
*/
    ...
    if (parm.inc_events == true) {          // if column to be displayed
        ...
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">");
        out.println("<b>Event Times<br>Found</b>");
        out.println("</font></td>");
    }
