          ...
          if (in_use == 1) {
              ...
              try {
                  ...
                  if (rs.next()) { 
                      ...
                      out.println("Start Time: <span style=\"font-weight:bold\">" + rs.getString("time") + "</span><br>");
    ...
    if (run_mode == 1) {
        ...
        if (interval > 0 && consec_csv.size() > 0) {
            ...
            if (slotParms.sheet_ids.size() == 0) {
                ...
                out.println("<br>Sorry, but we were unable to find enough consecutive time slots at the selected time and location to fulfill your request.");
