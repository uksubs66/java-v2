...
*/
 ...
 private void doCheckOut(HttpServletRequest req, HttpSession session, Connection con, PrintWriter out, int lottery, int sess_activity_id) {
    ...
    if (found > 0 && req.getParameter("confirmCheckOut") == null) {
        ...
        out.println("&nbsp;<a href=\"Proshop_demo_clubs?checkInOut\" style=\"text-decoration:underline;color:black\"><button style=\"width:120px\">Back to Checkout</button></a>");
        out.println("</form></center>");
 ...
 private void getCheckIn(HttpServletRequest req, Connection con, PrintWriter out, int lottery, int sess_activity_id) {
    ...
    out.println("<tr align=center style=\"background:#336633; color:white; font-size:10pt; font-weight:bold\"><td><td>Demo " + ((sess_activity_id == 0) ? "Club" : "Equipment") + "</td><td>ICN</td><td>Member</td><td>Mem #</td><td>Date Out</td><td>Days</td><td>Notes</td></tr>");
    ...
    if (count == 0) {
        out.println("<tr><td style=\"text-align:center;\" colspan=\"7\">No demo " + ((sess_activity_id == 0) ? "clubs" : "equipment") + " currently checked out.");
    }
