...
*/
   ...
   if (req.getParameter("backToSheet") != null) {
       ...
       if (!mode.equals("")) {
           ...
           //
           //  check for empty lottery that has completed (processed but no requests/tee times - must be cleared
           //
           if (tmp_count == 0 && tmp_mode.equals("Lottery")) {
               
                out.println("<center>");
                out.println("<h2>No Lottery Requests Processed</h2>");
...
//      SystemUtils.doBlockers(con);
 ...
 private void moveWhole(parmSlot slotParms, long date, String prompt, int skip, HttpServletRequest req, 
   ...
   int guest_id4 = 0;
   int guest_id5 = 0;
   int teecurr_id_from = 0;         // 'from' teecurr id
   int teecurr_id_to = 0;           // 'to' teecurr id
   int lottery_email = 0;
   int shotgun_time = 0;
   ...
   if (!player1.equals( "" ) || !player2.equals( "" ) || !player3.equals( "" ) || !player4.equals( "" ) || !player5.equals( "" )) {
      ...
      try {
        ...
        String sqlString = "UPDATE teecurr2 SET last_mod_date = now(), player1 = ?, player2 = ?, player3 = ?, player4 = ?, " +
         ...
         if (lottery_email > 0) {
            ...
            pstmt6.setInt(71, lottery_email);
            ...
            pstmt6.setLong(71, date);
            pstmt6.setInt(72, slotParms.to_time);
            pstmt6.setInt(73, slotParms.to_fb);
            pstmt6.setString(74, slotParms.to_course);
         }
      ...
      if (!lottery.equals("")) {
         ...
         try {
             ...
             pstmt.clearParameters();
             pstmt.setInt(1, teecurr_id_to);
             pstmt.setInt(2, teecurr_id_from);
