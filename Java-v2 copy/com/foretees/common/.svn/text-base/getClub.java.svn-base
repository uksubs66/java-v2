         ...
         if (parm.club.equals( "fortcollins" ) && activity_id == 0) {     // if Fort Collins or Greeley (shared site)
            ...
            if (parm.course.equals( "Greeley CC" )) {     // if Greeley
               ...
               */
               ...
               parm.guest[5] = rs.getString("guest20");
               parm.guest[6] = rs.getString("guest21");
               parm.guest[7] = rs.getString("guest27");
               parm.guest[8] = rs.getString("guest28");
               parm.guest[9] = rs.getString("guest29");
               parm.guest[10] = rs.getString("guest30");
               parm.guest[11] = rs.getString("guest31");
               parm.guest[12] = rs.getString("guest32");
               parm.guest[13] = rs.getString("guest33");
               parm.guest[14] = rs.getString("guest34");
               parm.guest[15] = rs.getString("guest35");
               parm.guest[16] = rs.getString("guest36");
               parm.guest[17] = "";
               parm.guest[18] = "";
               parm.guest[19] = "";
               parm.guest[20] = "";
            ...
            try {
                ...
                pstmt = con.prepareStatement("SELECT guest, gOpt, revenue, use_guestdb FROM guest5 WHERE activity_id = ?");
            ...
            if (parm.club.equals( "olyclub" ) || parm.club.equals("theconcession") || parm.club.equals("lascampanas") || parm.club.equals("oldhawthorne") 
                    || parm.club.equals("fairbanksranch") || parm.club.equals("ironwood")) {     // use specific order for Olympic Club

               pstmt = con.prepareStatement("SELECT guest, gOpt, revenue, use_guestdb FROM guest5 WHERE activity_id = ? ORDER BY sort_by, guest"); 
