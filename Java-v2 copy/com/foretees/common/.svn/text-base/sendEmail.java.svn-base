 ...
 **/
 ...
 public static void sendIt(parmEmail parms, Connection con) {
   ...
   if (parms.type.equals( "lesson" )) {
       ...
       if ((club.equals("ballantyne") || club.equals("sierraviewcc") || club.equals("fortcollins")) && parms.activity_id == 1) {
   ...
   if (emailOk != 0 || parms.preview == true) { // this if block span the entire method!
      ...
      if (parms.type.equals( "lottery" )) {
         ...
         if (club.equals( "westchester" )) {
            ...
            subject = "ForeTees Tee Time Notification (" + dayShort + mm + "/" + dd + "/" + yy + " " + etime + ")";
         }
         ...
         can = "The following Event Registration has been CANCELED by " + author + ".\n\n";
         ...
         if (!activityDisplayName.equals("")) {
            ...
            subject = "FlxRez " + activityDisplayName + " " + sysLingo.TEXT_Lesson_Reservation + " Notification";
            ...
            if (club.equals("kopplinandkuebler")) {      // if Meeting Scheduling site for Kopplin & Kuebler (Greg DeRosa)
               ...
               subject = "Kopplin & Kuebler Meeting Notification";
               enew = parms.player1 + " has been scheduled for the following Meeting by " + author + ".\n\n";
               can = parms.player1 + "'s Meeting has been canceled by " + author + ".\n\n";
         ...
         subject = "FlxRez - " + activityDisplayName + " Reservation (" + dayShort + mm + "/" + dd + "/" + yy + " " + etime + ")";
      ...
      if (parms.type.equals("drequest")) {
         ...
         // Add the originator of the reservation to the email, if included
         if (!orig_by.equals("") && !ProcessConstants.isProshopUser(orig_by)) {
         ...
         if (emailNew != 0) {        // if new request
            ...
            if (parms.type.startsWith( "lesson" )) {         // if lesson type
               ...
               if (parms.type.equals( "lessongrp" )) {         // if group lesson 
                 ...
                 enewMsg = header + enew + " " + sysLingo.TEXT_Lesson + " Type: " + parms.course + "  " + act_name + "  Date: " +parms.day+ ", " +mm+ "/" +dd+ "/" +yy+
                           " at " + etime + " With " +proName+ ".";
               }
            ...
            if (parms.type.startsWith( "lesson" )) {         // if lesson type
               ...
               ecanMsg = header + can + " " + sysLingo.TEXT_Lesson + " Type: " + parms.course + "    Date: " +parms.day+ ", " +mm+ "/" +dd+ "/" +yy+
                           " at " + etime + " With " +proName+ ".";
...
*/
    ...
    if (emailParm.type.equals("EmailToolPro")) {
        ...
        } else if (club.equals("bhamcc")) {
            title = "Golf Department Communication";
    ...
    if (club.equals("mirabel") || club.equals("denvercc")) {
...
*/
    ...
    for (int i = 0; i < eaddrTo.size(); i++) {
        ...
        */
        ...
        try {
        ...
        } catch (javax.mail.internet.AddressException ignore) {
            ...
            if (!eaddrTo.get(i).get(1).equals( "" )) {
                ...
                Utilities.logError("sendEmail() - BAD EMAIL ADDRESS: club=" + emailParm.club + ", user=" + eaddrTo.get(i).get(1) + ", email=" + eaddrTo.get(i).get(0));
            }
    ...
    if (emailParm.type.equals("EmailToolPro")) {
        ...
        } else if (emailParm.type.equals("EmailTool")) {
        ...
        try {
            ...
            pstmt.setString(5, emailParm.subject.substring(0, emailParm.subject.lastIndexOf("(") - 1));          // subject  msgSubject
            ...
            Utilities.logError("sendEmail - auditLog error - " + exc.toString() + ", insertStatement=" + insertStatement.toString());
 ...
 public static void sendOakmontEmail(parmEmail parms, Connection con, String club) {
   ...
   if (club.equals( "hallbrookcc" )) {
      ...
      if (course.equals("Ace Club")) {
         ...
         to = "bkindoll@frenchcreekgolf.com";
   ...
   } else if (club.equals("baltimore") || club.equals("rehobothbeachcc") || club.equals("silverleaf")) {
