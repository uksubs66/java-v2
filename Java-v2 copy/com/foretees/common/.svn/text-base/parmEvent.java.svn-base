...
public class parmEvent {
    ...
    public ArrayList<String> eventCostCategory = new ArrayList<String>();
    public ArrayList<String> eventCostPrice = new ArrayList<String>();
    public ArrayList<String> eventSeatingTimes = new ArrayList<String>();
