...
public class MemberHelper {
  ...
  public static final int NUM_MEMBER_SUB_TYPES = 18;        // for Hazeltine Natl & Interlachen & others - Custom
  public static final int NUM_LIMITED_ACCESS_TYPES = 40;    // used for limited access proshop users
...
*/
  ...
  **/
  ...
  public static SelectionList queryMembersWithEmailAddresses(Connection con, String club, String theLetter, PrintWriter out, boolean isPro) throws SQLException
  {
    ...
    //
    String sql = "SELECT * FROM member2b WHERE name_last LIKE ? AND inact = 0 AND billable = 1 AND ";
