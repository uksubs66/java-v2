 ...
 *
 *   Revisions:     
 *                  01/28/2014  El Camino CC (elcaminocc) - Perform member lookup using last name instead of member number (case 2357).
...
public class Proshop_member_lookup extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<form method=post action=Proshop_post_scores name=frmPostScore id=frmPostScore>");
    //out.println("<form method=post action=Proshop_post_scores>");
    ...
    try {
        ...
        PreparedStatement pstmtc = con.prepareStatement ("SELECT name_first, name_last, username, m_type, m_ship, memNum FROM member2b WHERE " + (club.equals("elcaminocc") ? "name_last" : "memNum") + " LIKE ? ORDER BY name_last, name_first");
        ...
        if (i==0) {
            out.println("<center><br><p><i><b><font color=red>No member found with " + (club.equals("elcaminocc") ? "last name" : "member number") + ":</font> "+ smem_num +"</b></i></p>");
            ...
            out.println("<center><p><i><b><font size=2>&nbsp;Found "+ i +" members with matching " + (club.equals("elcaminocc") ? "last names" : "member numbers") + ".</font></b></i></p>");
