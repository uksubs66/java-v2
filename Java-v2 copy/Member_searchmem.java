...
public class Member_searchmem extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (new_skin) {
       ...
       if (hideNames == 0 || club.equals( "foresthighlands" ) || !club.equals( "demov4" )) {     // if its ok to allow members to search for others
      ...
      // if ((hideNames == 0 || club.equals( "foresthighlands" )) && !club.equals( "blackdiamondranch" )) {
       if (hideNames == 0 || club.equals( "foresthighlands" )) {
          ...
          out.println("<form action=\"Member_searchmem\" method=\"post\" target=\"bot\" name=\"f\">");
          out.println("<input type=\"hidden\" name=\"source\" value=\"main\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   //
   if (req.getParameter("letter") != null && !new_skin) {     // if user clicked on a name letter
      ...
      out.println("<form action=\"Member_searchmem\" method=\"post\" name=\"f\">");
      ...
      out.println("</td><td valign=\"top\" align=\"center\">");   // end of name list column
         ...
         out.println("<form method=\"get\" action=\"Member_searchmem\">");
      ...
      try {
         ...
         if (sess_activity_id == 0) {    // if Golf  
            ...
            if (new_skin) {
                ...
                // Instructions for this page
                out.println("<div class=\"main_instructions\"><H2>Tee Times</H2>");          
                out.println("To join an open tee time simply click on the button containing the time (2nd column).");          
                out.println("<br><br>F/B Legend:&nbsp;&nbsp;&nbsp;&nbsp;F = Front 9, &nbsp;&nbsp;B = Back 9, &nbsp;&nbsp;O = Other</div>");
...
*/
            ...
            if (lottery > 0) {
               ...
               if (new_skin) {
                    ...
                    if (club.equals( "oldoaks" )) {
                        out.println("<br><br><div class=\"main_instructions\"><H2>Current Tee Time Requests</H2>");
                        out.println("If the tee time request is eligible for change, you will be able to click on the button containing the time (2nd column).");          
                    } else if (!lotteryText.equals("")) {
                        out.println("<br><br><div class=\"main_instructions\"><H2>Current " +lotteryText+ "s</H2>");
                        out.println("If the " +lotteryText+ " is eligible for change, you will be able to click on the button containing the time (2nd column).");          
                    } else {
                        out.println("<br><br><div class=\"main_instructions\"><H2>Current Lottery Requests</H2>");
                        out.println("If the lottery request is eligible for change, you will be able to click on the button containing the time (2nd column).");          
                    }
                    out.println("<br><br>F/B Legend:&nbsp;&nbsp;&nbsp;&nbsp;F = Front 9, &nbsp;&nbsp;B = Back 9, &nbsp;&nbsp;O = Other</div>");
               ...
               if (count == 0) {
                  ...
                  if (!new_skin) out.println("<font size=\"2\">");
         ...
         if (new_skin) {
             ...
             out.println("<br><div style=\"text-align:center;\">");
             out.println("<input id=\"back\" name=\"back\" type=\"button\" value=\"Return\" onclick=\"window.location.href='Member_searchmem'\" />");
