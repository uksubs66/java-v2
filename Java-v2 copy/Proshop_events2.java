...
//
        ...
        while (rs.next()) {
            ...
            if (export_type == 1) {                
                ...
                if (!rs.getString("player5").equals("")) tourExPrintPlayer(rs.getString("player5"), rs.getString("username5"), rs.getString("homeclub5"), rs.getString("ghin5"), rs.getString("gender5"), rs.getString("hndcp5"), rs.getString("p5cw"), team_num, con, out);
                                                         ...
                                                         golfGeniusPrintPlayer(rs.getString("player1"), rs.getString("username1"), rs.getString("homeclub1"), rs.getString("ghin1"), rs.getString("gender1"), rs.getString("hndcp1"), team_num, 1, con, out);
                if (!rs.getString("player2").equals("")) golfGeniusPrintPlayer(rs.getString("player2"), rs.getString("username2"), rs.getString("homeclub2"), rs.getString("ghin2"), rs.getString("gender2"), rs.getString("hndcp2"), team_num, 2, con, out);
                if (!rs.getString("player3").equals("")) golfGeniusPrintPlayer(rs.getString("player3"), rs.getString("username3"), rs.getString("homeclub3"), rs.getString("ghin3"), rs.getString("gender3"), rs.getString("hndcp3"), team_num, 3, con, out);
                if (!rs.getString("player4").equals("")) golfGeniusPrintPlayer(rs.getString("player4"), rs.getString("username4"), rs.getString("homeclub4"), rs.getString("ghin4"), rs.getString("gender4"), rs.getString("hndcp4"), team_num, 4, con, out);
                if (!rs.getString("player5").equals("")) golfGeniusPrintPlayer(rs.getString("player5"), rs.getString("username5"), rs.getString("homeclub5"), rs.getString("ghin5"), rs.getString("gender5"), rs.getString("hndcp5"), team_num, 5, con, out);
 ...
 private void golfGeniusPrintPlayer(String player, String username, String clubName, String ghin, String gender, String hndcp, int team_num, int seq_num, Connection con, PrintWriter out) {
 ...
 private void viewEventLog(HttpServletRequest req, PrintWriter out, Connection con) {
        ...
        */
        ...
        while ( rs.next() ) {
            ...
            if (sort.equals("user")) {
                ...
                out.print("<td nowrap>" + Utilities.getDateFromYYYYMMDD(rs.getInt("r_date"), 2) + " at "  + Utilities.getSimpleTime(rs.getInt("r_time")) + "</td>"); // registered date/time
            ...
            out.print("<td nowrap>" + email_suppressed + "</td>");
            out.println("</tr>");
        ...
        if (!h) {
            ...
            out.println("</table>");
            out.println("<center><p><i><b>&nbsp;Found "+ signup_num +" historical entries for this event.</b></i></p></center>");
        }
