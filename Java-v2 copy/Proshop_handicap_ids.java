...
public class Proshop_handicap_ids extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<iframe name=\"memdataiframe\" id=\"memdataiframe\" src=\"Proshop_handicap_ids?memdata\" width=\"90%\" scrolling=no frameborder=no></iframe>");
 ...
 private void memDataTable(String user_id, PrintWriter out, Connection con) {
    ...
    out.println("Handicap Number:&nbsp;&nbsp;<input type=text name=handicap_number value=\"" +hndcpNum+ "\" size=16 maxlength=16>&nbsp;&nbsp;&nbsp;&nbsp;");
