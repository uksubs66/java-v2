 ...
 *   Last Updated:  
 *
 *        5/22/13   Make the member enter a time range - do not default to the entire wait list period as this locks up the tee sheet.
...
public class Member_waitlist_slot extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        slotPageParms.slot_url = "Member_waitlist_slot";
        ...
        configure_slot:
        {
            ...
            if (parmWL.member_access != 1) {
                ...
                if (new_skin) {
                    ...
                    slotPageParms.page_start_title = "[options.waitlist.noMemberAccessTitle]";
                    slotPageParms.page_start_notifications.add("[options.waitlist.noMemberAccessNotice]");
                    ...
                    out.println("<form action=\"Member_waitlist_slot\" method=\"post\" name=\"can\">");
            ...
            if (sok_stime == null || sok_etime == null) {
                ...
                if (start_ampm.equals("PM") && shr != 12) {
                    shr += 12;
                }
                ok_stime = (shr * 100) + smin;

                if (end_ampm.equals("PM") && ehr != 12) {
                    ehr += 12;
                }
            ...
            if ((req.getParameter("letter") != null) || (req.getParameter("return") != null) || req.getParameter("memNotice") != null) {
                ...
                if (signup_id != 0) {
                    ...
                    if (shr == 0) {
                        ...
                        slotParms.ok_stime = 0;
                        slotParms.ok_etime = 0;
                ...
                if (in_use != 0) {              // if time slot already in use
                    ...
                    if (new_skin) {
                        ...
                        if (msg.endsWith("after connection closed.")) {
                            slotPageParms.page_start_button_go_back = true;
                            slotPageParms.page_start_title = "[options.notify.sessionTimeOutTitle]";
                            slotPageParms.page_start_notifications.add("[options.notify.sessionTimeOutNotice]");
                        } else {
                            slotPageParms.page_start_button_go_back = true;
                            slotPageParms.page_start_title = "[options.waitlist.slotBusyTitle]";
                            slotPageParms.page_start_notifications.add("[options.waitlist.slotBusyNotice]");
                        }
                        break configure_slot;
                ...
                if (!memNotice.equals("") && req.getParameter("skip_member_notice") == null) {      // if message to display
                    ...
                    if (new_skin) {
                        ...
                        out.println("<td align=\"center\">");
                        out.println("<font size=\"2\">");
                        out.println("<form action=\"Member_waitlist_slot\" method=\"post\" target=\"_top\">");
                        out.println("<input type=\"hidden\" name=\"signupId\" value=\"" + signup_id + "\">");
                        out.println("<input type=\"hidden\" name=\"waitListId\" value=\"" + wait_list_id + "\">");
        ...
        slotPageParms.slot_type = "Wait List";
        slotPageParms.signup_type = "Sign-up";
        slotPageParms.bread_crumb = "Wait List Registration";
        slotPageParms.page_title = "Member Wait List Request Page";
        ...
        if (club.equals("congressional")) {
            //slotPageParms.course_disp = congressionalCustom.getFullCourseName(date, (int) dd, course);
        }
        ...
        slotPageParms.edit_mode = (!slotParms.player1.equals(""));
        slotPageParms.show_tbd = (x != 0);
        slotPageParms.notes_prompt = "[options.labelContactNotes]";
        slotPageParms.allow_cancel = allowCancel;
        slotPageParms.show_time_picker = true;
        ...
        slotPageParms.visible_players_per_group = parmWL.max_team_size;
        if (twoSomeOnly) {
            slotPageParms.visible_players_per_group = 2;
        }
        ...
        slotPageParms.id = wait_list_id;
        slotPageParms.lstate = lstate;
        slotPageParms.signup_id = signup_id;
        ...
        slotPageParms.start_hr = shr;
        slotPageParms.start_min = smin;
        slotPageParms.start_ampm = start_ampm;
        slotPageParms.end_hr = ehr;
        slotPageParms.end_min = emin;
        slotPageParms.end_ampm = end_ampm;
        ...
        slotPageParms.slot_submit_map.put("signupId", "signup_id");
        slotPageParms.slot_submit_map.put("waitListId", "id");
        ...
        slotPageParms.slot_submit_map.put("start_hr", "start_hr");
        slotPageParms.slot_submit_map.put("start_min", "start_min");
        slotPageParms.slot_submit_map.put("start_ampm", "start_ampm");
        slotPageParms.slot_submit_map.put("end_hr", "end_hr");
        slotPageParms.slot_submit_map.put("end_min", "end_min");
        slotPageParms.slot_submit_map.put("end_ampm", "end_ampm");
...
//     out.println("<img src=\"/" +rev+ "/images/foretees.gif\" border=0>");
            ...
            out.println("<form action=\"Member_waitlist_slot\" method=\"post\" name=\"playerform\" id=\"playerform\">");
    ...
    private void verify(HttpServletRequest req, PrintWriter out, Connection con, HttpSession session, HttpServletResponse resp) {
        ...
        if (req.getParameter("remove") != null) {
            ...
            if (!tmp_msg.equals("")) {
                ...
                out.println("<BR><BR>The times you provided for the wait list are outside the acceptable range.");
                    ...
                    if (slotParms.members == 0 && parm.unacompGuest == 1) {
                        ...
                        if (slotParms.members > 1 || !slotParms.g1.equals("")) {  // if multiple members OR slot 1 is a guest
                            ...
                            if (new_skin) {
                                ...
                                String[] player_a = slotParms.getStringArrayByName("player%");
                                String[] pcw_a = slotParms.getStringArrayByName("p%cw");
                                int[] p9_a = slotParms.getIntArrayByName("p9%");
                                String[] userg_a = slotParms.getStringArrayByName("userg%");
                                int[] guest_id_a = slotParms.getIntArrayByName("guest_id%");

                                // Fill that field map with values that will be used when calling back
                                hidden_field_map.put("signupId", slotParms.signup_id);
                                hidden_field_map.put("waitListId", wait_list_id);
                                hidden_field_map.put("skip8", "yes");
                                hidden_field_map.put("date", date);
                                hidden_field_map.put("ok_stime", ok_stime);
                                hidden_field_map.put("ok_etime", ok_etime);
