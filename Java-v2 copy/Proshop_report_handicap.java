 ...
 public void viewSavedScores(HttpServletRequest req, String user, HttpSession session, String club, Connection con, PrintWriter out) {
    ...
    try {
                ...
                for (i = 0; i < posting_dates.size(); i++) {
                    ...
                    if (post_date > play_date && used == 0) {
                        ...
                        if (isProshopUser) {
                            ...
                            out.println("<tr>" +
                                    "<td  bgcolor=\"#FFFF8F\" class=\"hcaps_peer\" colspan=\"" + ((multi == 0) ? "2" : "3") + "\"><i>No Matching Round</i></td>" +
                                    "<td class=\"hcaps_peer\">" + post_sdate + "</td>" +
                                    "<td class=\"hcaps_peer\">" + score + "</td>" +
                                    "<td class=\"hcaps_peer\">" + type + "</td>" + 
                                    "<td class=\"hcaps_peer\">" + tees + "</td></tr>");
            ...
            for (i = 0; i < posting_dates.size(); i++) {
                ...
                if (post_date == play_date && used == 0) { //  bgcolor=#F5F5DC   bgcolor=#86B686
                    ...
                    if (isProshopUser) {
                        ...
                        out.println("<tr bgcolor=\"#86B686\"><td class=\"hcaps_peer\">" + play_sdate + "</td>");
            ...
            if (!found) { // && i != 0) {
                ...
                if (holes == 18 || skip_9_NoPosts == false) {    // skip if 9-hole round and user opted to skip 9-hole No Posts
                  ...
                  if (isProshopUser) {
                     ...
                     out.println("<td class=\"hcaps_peer hcaps_empty\" colspan=\"4\" bgcolor=\"#FFFF8F\">No Matching Score</td></tr>");
        ...
        if (isProshopUser) {
            ...
            out.println("<tr bgcolor=\"#86B686\">" +
                    "<td align=\"center\" colspan=\"" + ((multi == 0) ? "2" : "3") + "\">9 hole: <b>" + rounds[0] + "</b><br>18 hole: <b>" + rounds[1] + "</b></td>" +
    ...
    if (req.getParameter("popup") != null || useDates == true) {
        ...
        if (req.getParameter("excel") == null) {     // if normal request
            ...
            out.println("</p><center><form method=\"post\" action=\"" + (isProshopUser ? "Proshop_report_handicap" : "Member_handicaps") + "\">");
            ...
            out.println("<form method=\"post\" action=\"" + (isProshopUser ? "Proshop_report_handicap" : "Member_handicaps") + "\" target=\"_blank\">");
...
*/
   ...
   out.println("<table border=\"0\" align=\"center\">");
      ...
      //   if (club.startsWith( "demo" )) {
            ...
            //
            out.println("<font size=\"2\"><br><br><br><br>Click here for a Summary Report of All Members:<br><br></font>");
            out.println("<input type=\"submit\" value=\"Summary Report\" name=\"allMems\" onclick=\"document.forms['f'].method='get'\" style=\"text-decoration:underline\">");
     //   }
...
private void doAllMems(HttpServletRequest req, HttpSession session, Connection con, PrintWriter out) {
   ...
   out.println("<b>Handicap Summary Report</b><br>");
...
private void doAllMems2(HttpServletRequest req, HttpSession session, Connection con, PrintWriter out) {
  ...
  //  int last_date = (int)Utilities.getDate(con, -(days));
    ...
    out.println("<p align=center><BR><font size=5>Handicap Summary Report</font>");
    ...
    out.println("<tr style=\"font-weight:bold;background-color:#336633;color:white;\">" +
                    ...
                    "<td align=center rowspan=2><font size=3><b>Scores Posted</b></font></td></tr>" +
        ...
        */
        ...
        while ( rs.next() ) {
           ...
           String[] p918 = rs.getString("p918").split(";");
            ...
            rounds[0] = Integer.parseInt( p918[0] );
            rounds[1] = Integer.parseInt( p918[1] );
            rounds[2] = rs.getInt("posted_scores");

           if (rounds[0] > 0 || rounds[1] > 0) {        // if any rounds played
              ...
              out.println("<tr bgcolor=" +last_color+ " align=\"center\">" +
                        ...
                        "<td align=\"center\"><font size=2>" +rounds[0]+ "</font></td>" +
                        "<td align=\"center\"><font size=2>" +rounds[1]+ "</font></td>" +
                        "<td align=\"center\"><font size=2>" +(rounds[1] + (rounds[0]/2))+ "</font></td>" +
                        "<td align=\"center\"><font size=2>" +rounds[2]+ "</font></td></tr>");
           }
...
private void promptMemDate(HttpServletRequest req, String club, HttpSession session, Connection con, PrintWriter out) {
 ...
 private boolean checkMember(String user, String club, HttpServletRequest req, PrintWriter out, Connection con) {
    ...
    if (!subtype.equals("Handicap Chair")) {      // if not the Handicap Chair
