 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("suppressEmails") != null) {   // user wish to suppress emails? (option on this page only)
      ...
      if (club.equals("charlottecc") || club.equals("shadowridgecc") || club.equals("desertforestgolfclub") || club.equals("thereserveclub") ||
          club.equals("dataw") || club.equals("bhamcc") || club.equals("aronimink") || club.equals("overlakegcc") || (club.equals("tcclub") && index.equals("0"))) {         // always set to Yes initially for Charlotte
   ...
   out.println("<tr><td align=\"center\"><br>");
      ...
      out.println("<td align=\"center\" valign=\"top\">");
         ...
         if (assign == 0) {      // if normal tee time
            ...
            } else if (club.equals("pradera") || club.equals("pinery") || club.equals("canyonoakscc")) {
            ...
            out.println("1:&nbsp;&nbsp;<input type=\"text\" name=\"player1\" value=\"" + player1 + "\" size=\"20\" maxlength=\"43\" onkeypress=\"return DYN_disableEnterKey(event)\"" + ((userToName) ? " onchange=\"memTOname(this, 1)\"" : "") + ">");
              ...
              if ((club.equals("bishopsgategc") || club.equals("demobrad")) && custom_int == -1) {
         ...
         if (!club.equals("oaklandhills") && !club.equals("pradera") && !club.equals("pinery") && !club.equals("canyonoakscc")) {
             out.println("<input type=\"hidden\" name=\"custom1\" value=\"" + custom1 + "\">");
             out.println("<input type=\"hidden\" name=\"custom2\" value=\"" + custom2 + "\">");
             out.println("<input type=\"hidden\" name=\"custom3\" value=\"" + custom3 + "\">");
             out.println("<input type=\"hidden\" name=\"custom4\" value=\"" + custom4 + "\">");
            ...
            if (slotParms.rnds > 1) {       // if multiple rounds per day supported
               ...
               if (slotParms.hit3 == true) {       // if rounds too close together
                  ...
                  out.println(slotParms.player + " is already scheduled to play on this date at <b>" +tmsg+ "</b>.<br><br>");
                    ...
                    if (club.equals("longcove") && slotParms.date >= 20120409 && slotParms.date <= 20120415) {
                       out.println("<BR>Sorry, <b>" + slotParms.player + "</b> is already scheduled to play on this date. A member can only be scheduled once per day from April 18th-24th.");
                    } else {
      ...
      if (skip < 9) {     // *****NOTE:  skip=10 is set in doPost above from 'Assign' here ********
         ...
         if (slotParms.guests != 0 && slotParms.members != 0) {      // if both guests and members were included
            ...
            if (!slotParms.g1.equals( "" ) || slotParms.members > 1) {  // if slot 1 is a guest OR more than 1 member
               ...
               if (slotParms.club.equals("oaklandhills") || slotParms.club.equals("pradera") || slotParms.club.equals("pinery") || slotParms.club.equals("canyonoakscc")) {       // Include custom_disp values if present for oaklandhills
...
//               }
   ...
   //
   if (club.equals("hazeltine") || club.equals("moselemsprings") || club.equals("bishopsgategc") || club.equals("demobrad")) {      // if Hazeltine National
...
*/
   ...
   if (club.equals("oakmont") || club.equals("pradera") || club.equals("pinery") || club.equals("snoqualmieridge") || club.equals("tartanfields")) {
