      ...
      out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" align=\"center\">"); // table to contain 4 tables below
         ...
         out.println("<td align=\"center\" valign=\"top\" width=\"390\">");
            ...
            if (export_type != 0 || ask_hdcp == 1) {
                out.println("<td>&nbsp;</td>" +
                            "<td nowrap>&nbsp;" + ((sess_activity_id == 0) ? "Hdcp #" : "USTA #") + "</td>");
            }
 ...
 private int getNewId(Connection con, String name, String course, long date, int time) {
   ...
   try {
     ...
     */
      ...
      //
      //  Create a new entry for this event -    NOTE:  id is now auto-increment and unique!! (as of 8/20/08)
      //
    /*
...
/*         
         oldGender1 = rs.getString("gender1");
         oldGender2 = rs.getString("gender2");
         oldGender3 = rs.getString("gender3");
         oldGender4 = rs.getString("gender4");
         oldGender5 = rs.getString("gender5");
         oldGhin1 = rs.getString("ghin1");
         oldGhin2 = rs.getString("ghin2");
         oldGhin3 = rs.getString("ghin3");
         oldGhin4 = rs.getString("ghin4");
         oldGhin5 = rs.getString("ghin5");
         oldHomeclub1 = rs.getString("homeclub1");
         oldHomeclub2 = rs.getString("homeclub2");
         oldHomeclub3 = rs.getString("homeclub3");
         oldHomeclub4 = rs.getString("homeclub4");
         oldHomeclub5 = rs.getString("homeclub5");
         oldPhone1 = rs.getString("phone1");
         oldPhone2 = rs.getString("phone2");
         oldPhone3 = rs.getString("phone3");
         oldPhone4 = rs.getString("phone4");
         oldPhone5 = rs.getString("phone5");
         oldAddress1 = rs.getString("address1");
         oldAddress2 = rs.getString("address2");
         oldAddress3 = rs.getString("address3");
         oldAddress4 = rs.getString("address4");
         oldAddress5 = rs.getString("address5");
         oldEmail1 = rs.getString("email1");
         oldEmail2 = rs.getString("email2");
         oldEmail3 = rs.getString("email3");
         oldEmail4 = rs.getString("email4");
         oldEmail5 = rs.getString("email5");
         oldShirt1 = rs.getString("shirtsize1");
         oldShirt2 = rs.getString("shirtsize2");
         oldShirt3 = rs.getString("shirtsize3");
         oldShirt4 = rs.getString("shirtsize4");
         oldShirt5 = rs.getString("shirtsize5");
         oldShoe1 = rs.getString("shoesize1");
         oldShoe2 = rs.getString("shoesize2");
         oldShoe3 = rs.getString("shoesize3");
         oldShoe4 = rs.getString("shoesize4");
         oldShoe5 = rs.getString("shoesize5");
*/
      }
      ...
      if (rs.next()) {
         ...
         //who_shirtsize = rs.getInt("who_shirtsize");
         //who_shoesize = rs.getInt("who_shoesize");
         //who_otherQ1 = rs.getInt("who_otherQ1");
         //who_otherQ2 = rs.getInt("who_otherQ2");
         //who_otherQ3 = rs.getInt("who_otherQ3");
   ...
   if (req.getParameter("remove") != null) {
      ...
      try {
         ...
         PreparedStatement pstmt4 = con.prepareStatement (
            "SELECT id " +
            "FROM evntsup2b " +
            "WHERE (username1 = ? OR username2 = ? OR username3 = ? OR username4 = ? OR " +
                   "username5 = ?) AND name = ? AND courseName = ? AND id = ?");
...
*/
      ...
      if (((player1.equals( "" )) || (player1.equalsIgnoreCase( "x" )) || (!g1.equals( "" ))) &&
         ...
         returnForm(player1, player2, player3, player4, player5, p1cw, p2cw, p3cw, p4cw, p5cw, 
                    ...
                    notes, hides, index, course, name, rev, id, event_id, out);
      ...
      if (player1.equalsIgnoreCase( "x" )) xcount++;
      if (player2.equalsIgnoreCase( "x" )) xcount++;
      if (player3.equalsIgnoreCase( "x" )) xcount++;
      if (player4.equalsIgnoreCase( "x" )) xcount++;
      if (player5.equalsIgnoreCase( "x" )) xcount++;
      ...
      try {
         ...
         if ((!fname1.equals( "" )) && (!lname1.equals( "" ))) {
           ...
           /*       Removed - they changed their minds.  See others below if adding back in later!!
               // enforce a default guest type for tcclub - this is repeated for each position (case #1458)
               if (club.equals("tcclub")) {

                   player1 = "Guest " + player1;                // append 'Guest' to player name
                   g1 = "Guest";                                // save name of guest type
                   gstA[0] = player1;                           // save full player name
      ...
      if (req.getParameter("sp") == null && 
          ...
          extraInfoForm(player1, player2, player3, player4, player5, p1cw, p2cw, p3cw, p4cw, p5cw, 
                        ...
                        guest_id1, guest_id2, guest_id3, guest_id4, guest_id5,
                        notes, hides, index, course, name, club, rev, id, event_id, out);
  ...
  // if (checkWait != 0 && !club.equals("medinahcc") && !club.equals("portlandgc")) { // no automated wait list move ups for Medinah (Case# 1475)
   if (checkWait != 0 && !club.equals("medinahcc")) { // no automated wait list move ups for Medinah (Case# 1475)
 ...
 private void returnForm(String player1, String player2, String player3, String player4, String player5,
                         ...
                         String rev, int id, int event_id, PrintWriter out) {
 ...
 private static void extraInfoForm(
                        ...
                        int guest_id1, int guest_id2, int guest_id3, int guest_id4, int guest_id5,
                        String notes, String hides, String index, String course, String name,
                        String club, String rev, int signup_id, int event_id, PrintWriter out) {
    ...
    if (guests > 0 && (ask_homeclub + ask_phone + ask_address + ask_email > 0)) {
        ...
        for (i = 0; i < players; i++) {
            ...
            if (!gstA[i].equals("")) {
                ...
                if (ask_phone > 0) out.println("<td><input type=text size=11 maxlength=20 name=phone" + (i + 1) + " value=\"" + phone[i] + "\" " + ((ask_phone == 2) ? tmp_style : "") + "></td>");
                ...
                if (ask_email > 0) out.println("<td><input type=text size=16 maxlength=50 name=email" + (i + 1) + " value=\"" + email[i] + "\" " + ((ask_email == 2) ? tmp_style : "") + "></td>");
            }
    ...
    if (ask_shirtsize + ask_shoesize + ask_otherA1 + ask_otherA2 + ask_otherA3 > 0) {
        ...
        for (i = 0; i < players; i++) {
            ...
            if (!player[i].equals("")) {
                ...
                if (ask_otherA1 > 0 && !otherQ1.equals("")) out.println("<td><input type=text size=20 maxlength=24 name=other" + (i + 1) + "A1 value=\"" + otherA1[i] + "\" " + ((ask_otherA1 == 2) ? tmp_style : "") + "></td>");
                if (ask_otherA2 > 0 && !otherQ2.equals("")) out.println("<td><input type=text size=20 maxlength=24 name=other" + (i + 1) + "A2 value=\"" + otherA2[i] + "\" " + ((ask_otherA2 == 2) ? tmp_style : "") + "></td>");
                if (ask_otherA3 > 0 && !otherQ3.equals("")) out.println("<td><input type=text size=20 maxlength=24 name=other" + (i + 1) + "A3 value=\"" + otherA3[i] + "\" " + ((ask_otherA3 == 2) ? tmp_style : "") + "></td>");
            }
    ...
    */
    ...
    out.println("</form></td>");
    out.println("</tr><tr>");
    out.println("<form action=\"/" +rev+ "/servlet/Member_evntSignUp\" method=\"post\" name=\"can\"><td align=center><br>");
