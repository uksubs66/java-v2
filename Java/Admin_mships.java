...
public class Admin_mships extends HttpServlet {
  ...
  **/
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
      ...
      out.println("<tr>");
      out.println("<form action=\"/" + rev + "/servlet/Admin_mships\" method=\"POST\" name=\"addMshipForm\">");
      ...
      out.println("<tr>");
      out.println("<form action=\"/" + rev + "/servlet/Admin_mships\" method=\"POST\" name=\"editMshipForm\">");
      ...
      out.println("<td align=\"center\" colspan=\"2\"><br>" +
              ...
              "<button type=\"button\" onClick=\"location.href='/" + rev + "/servlet/Admin_announce'\">Cancel</button>" +
              "</td>");
      out.println("</tr>");
      out.println("</form>");
      out.println("</table>");
  ...
  private boolean editMship(HttpServletRequest req, Connection con) {
      ...
      if (req.getParameter("delMship") != null) { 
          ...
          if (req.getParameter("mship") != null) mship = req.getParameter("mship");
          ...
          if (req.getParameter("mship") != null) mship = req.getParameter("mship");
          if (req.getParameter("mshipName") != null) mshipName = req.getParameter("mshipName");
