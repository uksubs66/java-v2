...
public class Common_report_members extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<form action=\"/" +rev+ "/servlet/Common_report_members\" method=\"post\">");
   ...
   if (user.startsWith( "proshop" )) {
      ...
      out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Admin_announce\">");
   }
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (!format.equals("excel")) { 
      ...
      out.println("<tr><td align=\"center\">");
      out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Common_report_members\">");
      out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
      out.println("</form>");
      out.println("</td><td align=\"center\">");
      out.println("</td>&nbsp;&nbsp;<td align=\"center\">");

      out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Common_report_members\" target=\"_blank\">");
   ...
   if (!format.equals("excel")) {
      out.println("<p align=\"center\"><a href=\"/" +rev+ "/servlet/Common_report_members\">Return</a></p>");
      out.println("</center></font>");
      out.println("</body></html>");
   }
   out.close();                   
 ...
 private void displayDatabaseErrMsg(String user, String pMessage, String pException, PrintWriter out) {
    ...
    if (user.startsWith( "admin" )) {
       out.println("<BR><BR><a href=\"/" +rev+ "/servlet/Admin_announce\">Home</a>");
    } else {
