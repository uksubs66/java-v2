...
*/    
    ...
    if (setall == false) {
       ...
       out.println("<a href=\"/" +rev+ "/servlet/Proshop_activity_sendemail?group_id=" +group_id+ "&setall=yes&date=" + date + "\" target=\"bot\" title=\"Click Here to Check All Boxes Below\" alt=\"Check All\">");
       out.println("Check All</a><br><br>");
       
    } else {

       // add a Clear All button
       out.println("<a href=\"/" +rev+ "/servlet/Proshop_activity_sendemail?group_id=" +group_id+ "&date=" + date + "\" target=\"bot\" title=\"Click Here to Clear All Boxes Below\" alt=\"Clear All\">");
    ...
    //
    out.println("<form action=\"/" +rev+ "/servlet/Send_email\" method=\"get\">");
