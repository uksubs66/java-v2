    ...
    try {
        ...
        if (foretees_mode != 0) {
           ...
           if (Utilities.isFTProshopUser(user)) {   // if proshop4tea
              ...
              out.println("<tr><td><a href=\"/"+rev+"/servlet/Proshop_jump?switch&activity_id=0\" class=linkA target=_top>ForeTees Golf</a></td></tr>");
        ...
        while (rs.next()) {
            ...
            out.println("<tr><td><a href=\"/"+rev+"/servlet/Proshop_jump?switch&activity_id=" + rs.getInt("activity_id") + "\" class=linkA target=_top>" + rs.getString("activity_name") + "</a></td></tr>");
            //out.println("<tr><td><a href=\"/"+rev+"/servlet/Proshop_gensheets?parent_id=" + rs.getInt("activity_id") + "\" class=linkA>" + rs.getString("activity_name") + "</a></td></tr>");
...
/*    
    ...
    // TESTING CODE
    out.println("<a href=\"/v5/servlet/Proshop_activity_config\">conf</a>");
