...
//
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (excel == false) {                // if not Excel Spreadsheet Format
       ...
       out.println("</td>");
       out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_report_rounds_by_month\" target=\"_blank\">");
       ...
       out.println("</td>");
       out.println("</form>");
       out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_report_rounds_by_month\">");
       out.println("<input type=\"hidden\" name=\"month\" value=\"" + month + "\">");
       out.println("<input type=\"hidden\" name=\"year\" value=\"" + year + "\">");
       out.println("<td>");
