...
public class Member_slot extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("cancel") != null) {
      ...
      cancel(mobile, req, out, club, con);       // process cancel request
      return;
   }
   ...
   if (club.equals("tpcboston") || club.equals("alisoviejo") || club.equals("bluebellcc")) {
       restrictByOrig = true;
   }
   ...
   if ((req.getParameter("letter") != null) || (req.getParameter("return") != null) || (req.getParameter("memNotice") != null) ||
      ...
      if (req.getParameter("orig_by") != null) orig_by = req.getParameter("orig_by");
      if (req.getParameter("custom1") != null) custom1 = req.getParameter("custom1");   // custom parms added for Interlachen, but can be used by others too
      if (req.getParameter("custom2") != null) custom2 = req.getParameter("custom2");
      if (req.getParameter("custom3") != null) custom3 = req.getParameter("custom3");
      if (req.getParameter("custom4") != null) custom4 = req.getParameter("custom4");
      if (req.getParameter("custom5") != null) custom5 = req.getParameter("custom5");
      if (req.getParameter("gp1") != null) custom1 = req.getParameter("gp1");           // custom parms used by oaklandhills (and interlachen)
      if (req.getParameter("gp2") != null) custom2 = req.getParameter("gp2");
      if (req.getParameter("gp3") != null) custom3 = req.getParameter("gp3");
      if (req.getParameter("gp4") != null) custom4 = req.getParameter("gp4");
      if (req.getParameter("gp5") != null) custom5 = req.getParameter("gp5");
      ...
      if (club.equals("timarroncc") || club.equals("pmarshgc")) {
          if (req.getParameter("custom_disp1") != null) custom_disp1 = req.getParameter("custom_disp1");
          if (req.getParameter("custom_disp2") != null) custom_disp2 = req.getParameter("custom_disp2");
          if (req.getParameter("custom_disp3") != null) custom_disp3 = req.getParameter("custom_disp3");
          if (req.getParameter("custom_disp4") != null) custom_disp4 = req.getParameter("custom_disp4");
          if (req.getParameter("custom_disp5") != null) custom_disp5 = req.getParameter("custom_disp5");
      ...
      if (date == 0 || time == 0 || course == null || user.equals( "" ) || user == null) {
         ...
         try {
            ...
            if (newreq == true) {      // if new request, find next avail if busy
               ...
               //
               if (club.equals("eaglecreek") && ((ind == 3 && thisTime < 602) || ind > 3)) {  // 7:00 ET 2 days in adv

                  acError = checkECearly(user, ind, 1);    // check if early
               ...
               if ((club.equals("pelicansnest") && ind == 7 && thisTime < 605) ||
                    (club.equals("eaglecreek") && ind == 3 && thisTime < 605) ||
               ...
               if (in_use == 9) {                     // if found, but different than requested
                  ...
                  promptOtherTime(mobile, out, slotParms);    // send prompt
      ...
      if (in_use != 0 || !slotParms.event.equals("") || !slotParms.blocker.equals("")) {   // if time slot already in use or not allowed
         ...
         if (mobile == 0) {         // if NOT mobile user
            ...
            out.println("<body bgcolor=\"#FFFFFF\" text=\"#000000\">");
            out.println("<font size=\"2\" face=\"Arial, Helvetica, Sans-serif\">");
            if (!slotParms.event.equals("") || !slotParms.blocker.equals("")) {   // if time not allowed
   ...
   //                  out.println("<form method=\"get\" action=\"/" +rev+ "/member_selmain.htm\">");
      ...
      if (!index.equals( "888" ) && !index.equals( "995" ) && !index.equals( "999" )) {  // if from Member_sheet
         ...
         if (!wasP1.equals( player1 ) || !wasP2.equals( player2 ) || !wasP3.equals( player3 ) || !wasP4.equals( player4 ) ||
            ...
            returnToMemSheet(date, time, fb, course, day_name, club, mobile, out, con);
            return;
         }
      }
      ...
      if (p5.equals( "Yes" )) {      // if 5-somes
         ...
         if (!player1.equals( "" ) && !player2.equals( "" ) &&
            ...
            if (!user1.equalsIgnoreCase( user ) && !user2.equalsIgnoreCase( user ) && !user3.equalsIgnoreCase( user ) &&
               ...
               returnToMemSheet(date, time, fb, course, day_name, club, mobile, out, con);           // act like its busy
               return;
            }
         }
      ...
      if (!memNotice.equals( "" )) {      // if message to display
         ...
         if (mobile == 0) {                     // if NOT a mobile user
            ...
            out.println("<table border=\"1\" cols=\"1\" bgcolor=\"#f5f5dc\" cellpadding=\"3\">");
               ...
               out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
                  out.println("<form action=\"/" +rev+ "/servlet/Member_slot\" method=\"post\">");
                  out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
                  out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
                  out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
                  out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + returnCourse + "\">");
...
*/
   ...
   */
   ...
   //
   //  If Tavistock CC, remove the trans mode 'CRY' and 'TRL if any day but Tues/Thurs and before 3pm
   //
   ...
   if (club.equals("wayzata")) {
       ...
       if (shortDate >= 621 && shortDate <= 831 && time < 1500 &&
   ...
   if (club.equals( "congressional" )) {
      ...
      if (course.startsWith( "Club Cours" ) && day_name.equals( "Tuesday" )) {
   ...
   if (club.equals( "claremontcc" )) {
      ...
      if (day_name.equals("Sunday") && time >= 1030 && time <= 1115) twoSomeOnly = true;
   }
   ...
   if (club.equals( "baldpeak" )) {
      ...
      if ( (day_name.equals("Friday") || day_name.equals("Sunday")) &&
           time >= 730 && time <= 754 ) twoSomeOnly = true;
   }
   ...
   if (first_call == true && !player1.equals( name ) && !player2.equals( name ) && !player3.equals( name ) && !player4.equals( name ) && !player5.equals( name )) {
      ...
      } else if ((p5.equals( "Yes" )) && (player5.equals(""))) {
   ...
   if (club.equals("loscoyotes") && newreq == false) {
         ...
         if (!name.equals(player1)) blockP1 = true;          // do not allow member to remove/change any player!
         if (!name.equals(player2)) blockP2 = true;
         if (!name.equals(player3)) blockP3 = true;          // everyone is now blocked !!
         if (!name.equals(player4)) blockP4 = true;
         if (!name.equals(player5)) blockP5 = true;
   ...
   //
   if ((club.equals( "brookhavenclub" ) || club.equals("trophyclubcc") || club.equals("gleneaglesclub") || club.equals("pinehurstcountryclub")) &&
   ...
   if (restrictByOrig && newreq == false) {
      ...
      if ((orig1.equals("") && !player1.equals("") && !player1.equals(name)) ||
              (!orig1.equals("") && !player1.equals(name) && !player1.equalsIgnoreCase("x") && !user.equals(orig1) && !user.equals(slotParms.userg1))) {     // if player is NOT this member or this member's guest

         blockP1 = true;               // do not allow him to change/erase this one
      }
      if ((orig2.equals("") && !player2.equals("") && !player2.equals(name)) ||
              (!orig2.equals("") && !player2.equals(name) && !player2.equalsIgnoreCase("x") && !user.equals(orig2) && !user.equals(slotParms.userg2))) {

         blockP2 = true;
      }
      if ((orig3.equals("") && !player3.equals("") && !player3.equals(name)) ||
              (!orig3.equals("") && !player3.equals(name) && !player3.equalsIgnoreCase("x") && !user.equals(orig3) && !user.equals(slotParms.userg3))) {

         blockP3 = true;
      }
      if ((orig4.equals("") && !player4.equals("") && !player4.equals(name)) ||
              (!orig4.equals("") && !player4.equals(name) && !player4.equalsIgnoreCase("x") && !user.equals(orig4) && !user.equals(slotParms.userg4))) {

         blockP4 = true;
      }
      if ((orig5.equals("") && !player5.equals("") && !player5.equals(name)) ||
              (!orig5.equals("") && !player5.equals(name) && !player5.equalsIgnoreCase("x") && !user.equals(orig5) && !user.equals(slotParms.userg5))) {

         blockP5 = true;
      }

      if ((player1.equals("") || orig1.equals(user)) && (player2.equals("") || orig2.equals(user)) &&
          (player2.equals("") || orig3.equals(user)) && (player4.equals("") || orig4.equals(user)) &&
          (player5.equals("") || orig5.equals(user))) {
   ...
   //
   //  Custom for Pelican Marsh - If within 48 hrs, then all members in the request can only remove themselves (and their guests).
   //
   /*   club not ready
   if (club.equals("pmarshgc") && newreq == false) {
      ...
      if ((okDate > date) || (okDate == date && okTime > time)) {    // if withiin 48 hours
   ...
   if (msg.equals( "" )) {        // if no error detected above
      ...
      if (club.equals( "loscoyotes" )) {      // if Los Coyotes
   ...
   if (mobile > 0) {
      ...
      parmM.newreq = newreq;
      parmM.twoSomeOnly = twoSomeOnly;
      parmM.threeSomeOnly = threeSomeOnly;
...
//      out.println("alert(x);");
   ...
   if (merionCaddie == true) {           // if Merion and Caddie to be the forced default
   ...
   if (club.equals("marbellacc")) {
      ...
      out.println("if ((wc == null) || (wc == '')) {");           // if wc not provided
      out.println("wc = 'C';");                                   // use Cart
      out.println("}");
   }
   ...
   } else if (club.equals( "castlepines" ) || club.equals( "jonathanslanding" ) || club.equals("gulfharbourgcc") || club.equals("lakewoodcc") ||
   ...
   } else if (club.equals( "ranchobernardo" )) {

      out.println("defCW = 'CCH';");       // set default Mode of Trans

   } else if ((club.equals( "fortcollins" ) && course.startsWith( "Greeley" )) || club.equals("pmarshgc") || club.equals( "pinery" ) ||
           club.equals( "trophyclubcc" ) || club.equals("midpacific")) {

      out.println("defCW = 'GC';");       // set default Mode of Trans

   } else if (club.equals( "redrocks" )) {

      out.println("defCW = 'NA';");       // set default Mode of Trans

   } else if (club.equals( "chartwellgcc" ) || club.equals( "bluebellcc" )) {

      out.println("defCW = 'CAR';");       // set default Mode of Trans

   } else if (club.equals( "admiralscove" ) || club.equals( "mtngatecc" ) || club.equals( "championhills" )) {

      out.println("defCW = 'CF';");       // set default Mode of Trans

   } else if (club.equals( "mediterra" ) || club.equals("westmoor")) {

      out.println("defCW = 'R';");       // set default Mode of Trans

   } else if (club.equals( "marbellacc" ) || club.equals("theclubatnevillewood")) {

      out.println("defCW = 'C';");

   } else if (club.equals( "mnvalleycc" )) {

      out.println("defCW = 'WK';");

   } else if (club.equals( "northridge" )) {

      out.println("defCW = 'CC';");

   } else if (club.equals( "tcclub" ) || (club.equals( "merion" ) && merionCaddie == true)) {

      out.println("defCW = 'CAD';");

   } else if (club.equals( "tpcsugarloaf" )) {

      out.println("defCW = 'GCT';");

   } else if (club.equals( "southview" )) {

      out.println("defCW = 'WA';");

   } else if (club.equals( "minnetonkacc" )) {

      out.println("defCW = 'WLK';");

   } else if (club.equals( "roundhill" )) {
...
//     out.println("<img src=\"/" +rev+ "/images/foretees.gif\" border=0>");
      ...
      out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" align=\"center\">"); // table to contain 4 tables below
         ...
         out.println("<td align=\"center\" valign=\"top\">");
            ...
            out.println("<tr><td align=\"center\">");
               ...
               //
               out.println("<br>");
               if (!player2.equals("") && blockP2 == true) {    // if member cannot change this player
                   out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
               ...
               //
               out.println("<br>");
               if (!player3.equals("") && blockP3 == true) {    // if member cannot change this player
               ...
               if (threeSomeOnly == false) {               // If tee time NOT restricted to 3-somes (custom requests)
                  ...
                  //
                  out.println("<br>");
                  if (!player4.equals("") && blockP4 == true) {    // if member cannot change this player
                  ...
                  if (p5.equals( "Yes" )) {
                     ...
                     //
                     out.println("<br>");
                     if (!player5.equals("") && blockP5 == true) {    // if member cannot change this player
   ...
   //
   if (club.equals( "greenwich" ) && twoSomeOnly == true) {
 ...
 private void verify(HttpServletRequest req, PrintWriter out, Connection con, HttpSession session, HttpServletResponse resp) {
   ...
   //
   try { mobile = (Integer)session.getAttribute("mobile"); }
   catch (Exception ignore) { }
   ...
   if (req.getParameter("p91") != null) slotParms.p91 = Integer.parseInt(req.getParameter("p91"));             // get 9-hole indicators if they were checked
   ...
   try {
      ...
      if ((slotParms.in_use == 0) || (!slotParms.in_use_by.equals( user ))) {    // if time slot NOT in use OR not by this user
   ...
   if (req.getParameter("remove") != null) {
      ...
      if (disallowCancel == false) {      // allow cancel if not Los Coyotes and not Merion (set above)
         ...
         try {
            ...
            if (rs.next()) {
               ...
               msgBody = "You cannot cancel a reservation that you are not part of.<BR><BR>You must be a member currently on the tee slot in order to cancel it.";
         ...
         if ((req.getParameter("ack_remove") != null) || (players < 2)) {  // if remove has been confirmed or 1 player
            ...
            if (club.equals( "longcove" )) {        // if Long Cove fill in the tee time so only proshop can change
               ...
               //
               // Do Not fill with X's if between Sunday 6:30 PM and Tues 7:00 AM (ET)
               //
         ...
         if (mobile == 0) {       // if not mobile user
            ...
            if (club.equals("merion")) out.println("(610) 642-5600");
            ...
            if (club.equals("merion")) out.println("<div class=\"smheadertext\">(610) 642-5600</div>");
      ...
      if (club.equals( "oahucc" ) && !slotParms.mship1.startsWith("Regular") &&
          ...
          if (
              (slotParms.day.equals( "Sunday" ) || ( slotParms.date == Hdate1 || slotParms.date == Hdate2 || slotParms.date == Hdate2b || slotParms.date == Hdate3 )
              ) && slotParms.time > 629 && slotParms.time < 858) {
...
*/
      ...
      if (slotParms.guests != 0) {      // if any guests were included
         ...
         if (club.equals( "cherryhills" )) {           // if Cherry Hills
            ...
            if (slotParms.mtype1.startsWith( "Junior" ) || slotParms.mtype2.startsWith( "Junior" ) || slotParms.mtype3.startsWith( "Junior" ) ||
               ...
               //
               if (slotParms.mtype1.equals( "Member" ) || slotParms.mtype2.equals( "Member" ) || slotParms.mtype3.equals( "Member" ) ||
                   slotParms.mtype4.equals( "Member" ) || slotParms.mtype5.equals( "Member" ) ||
                   slotParms.mtype1.equals( "Spouse" ) || slotParms.mtype2.equals( "Spouse" ) || slotParms.mtype3.equals( "Spouse" ) ||
                   slotParms.mtype4.equals( "Spouse" ) || slotParms.mtype5.equals( "Spouse" )) {
         ...
         //
         //  Baltusrol - Must be at least one guest or one X in every request
         //
      ...
      //
      if (club.equals( "congressional" ) && slotParms.course.equals( "Open Course" )) {
         ...
         if (ind > 9 || (ind == 9 && thisTime < congTime)) {     // if a special guest time
            ...
            if (slotParms.player2.startsWith( "Non Local Guest" ) || slotParms.player3.startsWith( "Non Local Guest" ) ||
               ...
               msgBody = "<BR><BR>Sorry, you must include at least one Non Local Guest in the group" +
      ...
      if (club.equals( "northhills" )) {
         ...
         if ((date == Hdate1 || date == Hdate2b || date == Hdate3) &&
              ind == 6 && thisTime < northTime) {                            // if Holiday & 6 days in adv before time

            mccskip = true;                   // ok to skip the 'days in advance' test (guest time), but check for guests

         } else {

            if ((date == Hdate1 || date == Hdate2b || date == Hdate3) && ind > 6) {   // if Holiday & more than 6 days in adv
         ...
         if (club.equals( "oakmont" ) && slotParms.oldPlayer1.equals( "" )) {   // oakmont and new tee time request
            ...
            if (thisMonth > 0 && thisMonth < 5) {         // if Jan, Feb, Mar or Apr (tee sheets closed in Jan, but check anyway)
               ...
               if (error == true) {
                   ...
                   msgBody = "<BR><BR>Sorry,  " +slotParms.player+ " has already scheduled the max allowed guest times this month.<BR>There is a limit to the number of advance guest rounds that can be scheduled in Feb, Mar, and Apr." +
                             "<BR><BR>Please contact the golf shop if you have any questions.<BR><BR>";
      ...
      if (tmp_pci != 2 && club.equals("pelicansnest")) {
          ...
          tmp_pci = (
              ...
              dd == cal_pci.get(cal_pci.DAY_OF_MONTH) &&
              yy == cal_pci.get(cal_pci.YEAR) &&
              cal_pci.get(Calendar.HOUR_OF_DAY) >= 17
             ) ? (short)2 : (short)0;
      }
...
*/
 ...
 private boolean checkECearly(String user, int ind, int count) {
   ...
   } else if (ind == 3 && thisTime < 60002) {  // if 2 days in adv and 7:00 AM ET or earlier
 ...
 private void cancel(int mobile, HttpServletRequest req, PrintWriter out, String club, Connection con) {
 ...
 private void returnToMemSheet(long date, int time, int fb, String course, String day, String club, int mobile, PrintWriter out, Connection con) {
 ...
 private void returnToSlot(int mobile, PrintWriter out, parmSlot slotParms) {
   ...
   if (slotParms.club.equals("timarroncc") || slotParms.club.equals("pmarshgc")) {
 ...
 private void promptOtherTime(int mobile, PrintWriter out, parmSlot parm) {
   ...
   if (mobile == 0) {               // if NOT Mobile
      ...
      out.println("<li><form action=\"/" +rev+ "/servlet/Member_slot\" method=\"post\" name=\"can\">");
      out.println("<input type=\"hidden\" name=\"index\" value=\"" + parm.index + "\">");
      out.println("<input type=\"hidden\" name=\"course\" value=\"" + parm.course + "\">");
      out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + parm.returnCourse + "\">");
      out.println("<input type=\"hidden\" name=\"day\" value=\"" + parm.day + "\">");
      ...
      out.println("<li><form action=\"/" +rev+ "/servlet/Member_slot\" method=\"post\">");
      out.println("<input type=\"hidden\" name=\"index\" value=\"" + parm.index + "\">");
      out.println("<input type=\"hidden\" name=\"course\" value=\"" + parm.course + "\">");
      out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + parm.returnCourse + "\">");
      out.println("<input type=\"hidden\" name=\"date\" value=\"" + parm.date + "\">");
