...
public class Proshop_dining extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<br><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_announce'\">Return</button><br>");
   
   out.println("<br>For help with the Dining Configuration below, click here:&nbsp;<button type=\"button\" style=\"width:80px\" onclick=\"location.href='http://www.foretees.com/newfeatures/Dining Request.pdf'\">Help</button><br>");
   ...
   out.println("<iframe id=\"diningiframe\" src=\"/" + rev + "/servlet/Proshop_dining?dining\" style=\"width:800px;\" scrolling=no frameborder=no></iframe>");
   ...
   out.println("<tr><td align=\"center\">");
   out.println("<iframe id=\"messagesiframe\" src=\"/" + rev + "/servlet/Proshop_dining?messages\" style=\"width:800px\" scrolling=no frameborder=no></iframe>");
   out.println("</td></tr><table><br>");
   ...
   out.println("<tr><td align=\"center\">");
   out.println("<iframe id=\"emailsiframe\" src=\"/" + rev + "/servlet/Proshop_dining?emails\" style=\"width:800px\" scrolling=no frameborder=no></iframe>");
   out.println("</td></tr><table><br>");
   ...
   out.println("<tr><td align=\"center\">");
   out.println("<iframe id=\"roomsiframe\" src=\"/" + rev + "/servlet/Proshop_dining?rooms\" style=\"width:800px\" scrolling=no frameborder=no></iframe>");
   out.println("</td></tr>");
   
   out.println("</table>");
   out.println("<br><button align=\"center\" style=\"width:80\" onclick=\"location.href='/" + rev + "/servlet/Proshop_announce'\">Return</button><br>");
   ...
   out.println("{");
   out.println("location.href=\"/" + rev + "/servlet/Proshop_dining?rooms&id=\" + eval(\"document.getElementById(diningRoom).options[document.getElementById(diningRoom).selectedIndex].value\")");
   out.println("}");
   out.println("}");
   out.println("// -->");
   out.println("</script>");          // End of script
 ...
 private void doDining(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
   ...
   out.println("<form action=\"/" +rev+ "/servlet/Proshop_dining?dining\" method=\"POST\" name=\"diningform\">");
   ...
   out.println("<td align=\"left\">Select which locations you'd like to display prompts/links for making a dining request.  " +
               "The first set of options may be enabled separately for Proshop and Member sides of the system.</td>");
   out.println("<td>");
   ...
   out.println("<td><input type=\"checkbox\" name=\"memMain\"" + checkMemMain + "></td>");
   out.println("</tr><tr align=\"center\" width=\"300\">");
   out.println("<td align=\"right\">Tee Time Confirmation</td>");
   ...
   out.println("</tr><tr align=\"center\" width=\"300\">");
   out.println("<td align=\"right\">Lesson Book Confirmation</td>");
 ...
 private void doMessages(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         ...
         out.println("<tr><td align=\"center\" colspan=\"2\">");
         out.println("Add, Update, or Remove any desired custom messages below.  These messages will display instead of the default messages during their timeframe.  " +
                 ...
                 "what message will currently display for a specific day." +
         ...
         out.println("</td></tr>");
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_dining?messages\" method=\"POST\" name=\"messagesform\">");
         ...
         out.println("&nbsp;<button style=\"width:70px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_dining?messages'\">Reset</button>");
         
         if (!sdate.equals("")) {
             params = "&date=" + sdate;
         }
         out.println("<br><br><button align=\"center\" style=\"width:80px\" onclick=\"window.open('/" + rev + "/servlet/Proshop_dining?preview')\">Preview</button>");
         out.println("</td></tr>");
 ...
 private void doEmails(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         ...
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_dining?emails\" method=\"POST\" name=\"emailsform\">");
         out.println("<tr align=\"center\" width=\"300\">");
         ...
         out.println("</form><form action=\"/" +rev+ "/servlet/Proshop_dining?emails\" method=\"POST\" name=\"emailsform2\">");
 ...
 private void doRooms(HttpServletRequest req, PrintWriter out, Connection con)
     ...
     try {
         ...
         out.println("Add the names and descriptions of all dining rooms at your club to the list below for them to be selectable on the dining request form.  If no dining rooms are defined, users will be able to enter their own dining room name." +
                 "<br><br>Changes are saved whenever the Add, Update, or Remove buttons are clicked as long as all data in the form is valid.<br>");
         out.println("</td></tr>");
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_dining?rooms\" method=\"POST\" name=\"roomsform\">");
         out.println("<tr><td align=\"center\">");
         ...
         out.println("&nbsp;<button style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_dining?rooms'\">Reset</button>");
         out.println("</td></tr>");
         out.println("</table>");       // End of right side table
 ...
 private void updateDining(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         ...
         if (req.getParameter("firstTime") != null) {
             ...
             pstmt.setInt(10, emailTeetime);
             pstmt.setInt(11, emailLesson);
             pstmt.setString(12, customURL);

             result = pstmt.executeUpdate();
         }
         
         String url = "/" + rev + "/servlet/Proshop_dining?dining";
         ...
         out.println("<BR><BR>If problem persists, contact customer support.");
         out.println("<BR><BR>");
         out.println("<a href=\"/" +rev+ "/servlet/Proshop_dining?dining\">Home</a>");
         out.println("</CENTER></BODY></HTML>");
         return;
     }
 ...
 private void updateMessage(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         ...
         if (req.getParameter("addMsg") != null || (req.getParameter("updateMsg") != null && req.getParameter("diningMsg") != null)) {
             ...
             if (nameError || dateError || dateRangeError || msgAbsent || !daysSelected) {
                 ...
                 out.println("<form method=\"post\" action=\"/" + rev + "/servlet/Proshop_dining?messages\">");
                 ...
                 if (rs.next()) {
                     ...
                     out.println("<button align=\"center\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_dining?preview&date=" + sdate + "'\">Preview</button>");
                     out.println("<button align=\"center\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_dining?messages'\">Continue</button>");
                     out.println("</td></tr></table>");
                     out.close();
                 }
                 ...
                 if (results <= 0) {
                     ...
                     out.println("<BR><BR>If problem persists, contact customer support.");
                     out.println("<BR><BR>");
                     out.println("<a href=\"/" +rev+ "/servlet/Proshop_dining?messages\">Home</a>");
                     out.println("</CENTER></BODY></HTML>");
                     out.close();
                     return;
                 }
 ...
 private void removeMessage(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
 ...
 private void addEmail(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         if (req.getParameter("emailToAdd") != null && !req.getParameter("emailToAdd").equals("")) {
             ...
             if (results <= 0) {
                 ...
                 out.println("<BR><BR>If problem persists, contact customer support.");
                 out.println("<BR><BR>");
                 out.println("<a href=\"/" +rev+ "/servlet/Proshop_dining?emails\">Home</a>");
                 out.println("</CENTER></BODY></HTML>");
                 return;
             }
 ...
 // ********************************************************************************
 private void removeEmail(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
 ...
 private void updateDiningRoom(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         if (req.getParameter("addRoom") != null && !req.getParameter("name").equals("")) {
             ...
             if (results <= 0) {
                 ...
                 out.println("<BR><BR>If problem persists, contact customer support.");
                 out.println("<BR><BR>");
                 out.println("<a href=\"/" +rev+ "/servlet/Proshop_dining?rooms\">Home</a>");
                 out.println("</CENTER></BODY></HTML>");
                 return;
             }
 ...
 private void removeDiningRoom(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     PreparedStatement pstmt = null;
     int results = 0;
 ...
 private void displayPreview(HttpServletRequest req, PrintWriter out, Connection con)
         throws ServletException, IOException {
     ...
     try {
         ...
         if (!linkText.equals("")) {
             ...
             out.println("<a href=\"/" + rev + "/servlet/Proshop_dining?preview&date=" + date + "\">" + linkText + "</a>");
             out.println("</td></tr></table><br>");
             out.println("</td></tr>");
         }
         ...
         out.println("<form method=\"POST\" name=\"frmPreview\" action=\"/" + rev + "/servlet/Proshop_dining?preview\">");
 ...
 public static void buildDiningForm(HttpServletRequest req, PrintWriter out, HttpSession session, Connection con)
     ...
     try {
         ...
         if (isProshop) {
             out.println("<form name=\"diningRequestForm\" method=\"POST\" action=\"/" + rev + "/servlet/Proshop_dining\">");
         } else {
             out.println("<form name=\"diningRequestForm\" method=\"POST\" action=\"/" + rev + "/servlet/Member_dining\">");
         ...
         out.println("<td align=\"right\">Time: </td>");
         out.println("<td align=\"left\" nowrap>");
         ...
         if (isProshop) {
             if (caller.equals("main")) {
                 out.println("<td align=\"left\"><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_announce'\">Cancel</button><br></td>");
             } else if (caller.equals("teetime")) {
                 if (!sub.equals("")) {
                     if (!search.equals("")) {
                         out.println("<td align=\"left\"><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_jump&search=yes'\">Cancel</button><br></td>");
                     } else {
                         out.println("<td align=\"left\"><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_" + sub + ".htm'\">Cancel</button><br></td>");
                     }
                 } else {
                     out.println("<td align=\"left\">");
                     out.println("<button align=\"center\" style=\"width:80px\" onclick=\"submitForm('proTeetimeForm')\">Cancel</button>");
                     out.println("</td>");
                     out.println("<form name=\"proTeetimeForm\" action=\"/" +rev+ "/servlet/Proshop_jump\" method=\"post\" target=\"_top\">");
                 ...
                 out.println("</td>");
                 out.println("<form name=\"proLessonForm\" action=\"/" +rev+ "/servlet/Proshop_jump\" method=\"post\" target=\"_top\">");
             ...
             if (caller.equals("email")) { // name=\"Cancel\" value=\"Cancel\"
                 ...
                 out.println("<td align=\"left\"><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Member_announce'\">Cancel</button><br></td>");
             } else if (caller.equals("teetime")) {
                 if (!sub.equals("")) {
                     out.println("<td align=\"left\"><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Member_" + sub + ".htm'\">Cancel</button><br></td>");
                 } else {
                     out.println("<td align=\"left\">");
                     out.println("<button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"submitForm('memTeetimeForm')\">Cancel</button>");
                     out.println("</td>");
                     out.println("<form name=\"memTeetimeForm\" action=\"/" +rev+ "/servlet/Member_jump\" method=\"post\" target=\"_top\">");
                     out.println("<input type=\"hidden\" name=\"index\" value=" + index + ">");
                     out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
                     out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
                     out.println("</form>");
                 ...
                 if (!group.equals("")) {
                     if (!proid.equals("")) {
                         out.println("<form name=\"memLessonForm\" action=\"/" +rev+ "/servlet/Member_lesson\" method=\"post\">");
                         out.println("<input type=\"hidden\" name=\"proid\" value=\"" + proid + "\">");
                         out.println("<input type=\"hidden\" name=\"group\" value=\"yes\">");
                     } else {
                         out.println("<form name=\"memLessonForm\" action=\"/" +rev+ "/servlet/Member_teelist\" method=\"get\">");
                     }
                 } else {
                     out.println("<form name=\"memLessonForm\" action=\"/" +rev+ "/servlet/Member_jump\" method=\"post\" target=\"_top\">");
                     out.println("<input type=\"hidden\" name=\"lesson\" value=\"yes\">");
                     out.println("<input type=\"hidden\" name=\"proid\" value=\"" + proid + "\">");
                     out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
                 }
         ...
         if (isProshop) {
             ...
             */
             out.println("<form method=\"post\" name=\"playerform\" action=\"/" +rev+ "/servlet/Proshop_dining?dReq&caller=" + caller + "\">");
 ...
 public static void processDiningForm(HttpServletRequest req, PrintWriter out, HttpSession session, Connection con)
     ...
     try {
         ...
         if (noName || noEmail || invalidMins) {            // If there was invalid data sent, reject and return them
             ...
             out.println("Please correct the above and submit the dining request again.");
             if (isProshop) {
                 out.println("<form method=\"post\" action=\"/" + rev + "/servlet/Proshop_dining\">");
             } else {
                 out.println("<form method=\"post\" action=\"/" + rev + "/servlet/Member_dining\">");
             }
             out.println("<input type=\"hidden\" name=\"returning\" value=\"true\">");
             out.println("<input type=\"hidden\" name=\"caller\" value=\"" + caller + "\">");
             if (req.getParameter("ext-dReq") != null) {
             ...
             if (isProshop) {
                 if (caller.equals("main")) {
                     out.println("<br><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_announce'\">Return</button><br>");
                     out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" + rev + "/servlet/Proshop_announce\">"); // auto-refresh
                 } else if (caller.equals("teetime")) {
                     if (!sub.equals("")) {
                         if (!search.equals("")) {
                             out.println("<br><button align=\"center\" type=\"button\" style=\"width:80px\" onclic=\"location.href='/" + rev + "/servlet/Proshop_jump&search=yes'\">Return</button><br>");
                             out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_jump?search=yes\">");
                         } else {
                             out.println("<br><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Proshop_" + sub + ".htm'\">Return</button><br>");
                         }
                     } else {
                         ...
                         out.println("<br><input type=\"submit\" value=\"Return\">");
                         out.println("</form>");
                         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_jump?index=" + index + "&course=" + course + "&jump=" + jump + "\">");
                     }
                 } else if (caller.equals("lesson")) {
                     if (!group.equals("")) {                        
                         ...
                         out.println("</form>");
                         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_lesson?proid=" +proid+ "&calDate=" +calDate+ "&jump=" +jump+ "\">");
                     } else {
                         out.println("<form action=\"/" +rev+ "/servlet/Proshop_jump\" method=\"post\" target=\"_top\">");
                         out.println("<input type=\"hidden\" name=\"lesson\" value=\"yes\">");
                         out.println("<input type=\"hidden\" name=\"proid\" value=\"" + proid + "\">");
                         ...
                         out.println("<input type=\"submit\" value=\"Return\" style=\"background:#8B8970\">");
                         out.println("</form>");
                         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_jump?lesson=yes&proid=" +proid+ "&calDate=" +calDate+ "&jump=" +jump+ "\">");
                     }
                 }
                 ...
                 if (caller.equals("email")) {
                     ...
                     out.println("<br><button align=\"center\" type=\"button\" style=\"width:80px\" onclick=\"location.href='/" + rev + "/servlet/Member_announce'\">Return</button><br>");
                     out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" + rev + "/servlet/Member_announce\">"); // auto-refresh
                 } else if (caller.equals("teetime")) {
                     if (!sub.equals("")) {
                         ...
                         out.println("<br><input type=\"submit\" value=\"Return\">");
                         out.println("</form>");
                         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Member_jump?index=" + index + "&course=" + course + "&jump=" + jump + "\">");
                     }
                 } else if (caller.equals("lesson")) {
                     if (!group.equals("")) {
                         if (!proid.equals("")) {
                             ...
                             out.println("<input type=\"hidden\" name=\"group\" value=\"yes\">");
                             out.println("</form>");
                             out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Member_lesson?proid=" + proid + "&group=yes\">");
                         } else {
                             out.println("<form name=\"memLessonForm\" action=\"/" +rev+ "/servlet/Member_teelist\" method=\"get\">");
                             out.println("</form>");
                             out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Member_teelist\">");
                         }
                     } else {
                         out.println("<form action=\"/" +rev+ "/servlet/Member_jump\" method=\"post\" target=\"_top\">");
                         out.println("<input type=\"hidden\" name=\"lesson\" value=\"yes\">");
                         ...
                         out.println("<input type=\"submit\" value=\"Return\" style=\"background:#8B8970\">");
                         out.println("</form>");
                         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Member_jump?lesson=yes&proid=" + proid + "&index=" + index + "\">");
                     }
                 }
             }
             out.println("</center>");
