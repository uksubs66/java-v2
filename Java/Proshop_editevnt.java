...
*/
              out.println("<br>");
                out.println("How many hours in advance of cut-off date/time should we remove X's?: &nbsp;&nbsp;");
                  out.println("<input type=\"text\" name=\"xhrs\" value=\"" + xhrs + "\" size=\"2\" maxlength=\"2\">&nbsp;&nbsp;(0 - 48)");
...
if (season == 0) {
   ...
   if (sheet.equals( "yes" )) {
      out.println("<form action=\"/" +rev+ "/servlet/Proshop_editevnt\" method=\"post\">");
   } else {
      out.println("<form action=\"/" +rev+ "/servlet/Proshop_editevnt\" method=\"post\" target=\"bot\">");
   }
...
*/
   ...
   //
   oldDate = oldDate / 10000;      // isolate the old year value
   ...
   try {
      ...
      if (signUp == 0) {     // only change the required parms in case they changed signup and want to come back later!!
         ...
         pstmt = con.prepareStatement (
           ...
           "gender = ?, export_type = ?, season = ?, email1 = ?, email2 = ?, activity_id = ?, locations = ? " +
           "WHERE name = ?");
...
*/
   ...
   try {
      ...
      //
      //   If the year has changed, then delete all the old entries in the Event Sign Up table
      //
 ...
 private void addEvent(HttpServletRequest req, PrintWriter out, HttpSession sess) {
   ...
   if (con == null) {
      ...
      out.println("<BR><BR>If problem persists, contact customer support.");
      out.println("<BR><BR>");
      out.println("<a href=\"/" +rev+ "/servlet/Proshop_mainleft\">Return</a>");
      out.println("</CENTER></BODY></HTML>");
      return;
   }
...
/*
   ...
   try {
      ...
      out.println("<BR>Please try again later.");
      out.println("<BR><BR>If problem persists, contact customer support.");
      out.println("<BR><BR><a href=\"/" +rev+ "/servlet/Proshop_mainleft\">Return</a>");
      out.println("</CENTER></BODY></HTML>");
      return;
   }
