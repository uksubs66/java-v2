 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("remove") != null) {         // user wants to delete the request 
      ...
      if (index.equals( "888" )) {       // if originated from Proshop_searchmem
         ...
         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_searchmem\">");
         out.println("</HEAD>");
         out.println("<BODY><CENTER><img src=\"/" +rev+ "/images/foretees.gif\"><BR>");
         out.println("<hr width=\"40%\">");
         ...
         out.println("<font size=\"2\">");
         out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Proshop_searchmem\">");
         out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
         out.println("</form></font>");
         ...
         if (index.equals( "777" )) {       // if originated from Proshop_mlottery
            ...
            out.println("<HEAD><link rel=\"stylesheet\" href=\"/" +rev+ "/web utilities/foretees2.css\" type=\"text/css\"></link>");
            out.println("<Title>Proshop Lottery Request Page</Title>");
            out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_jump?course=" + course + "&index2=" + index2 + "\">");
            out.println("</HEAD>");
            out.println("<BODY><CENTER><img src=\"/" +rev+ "/images/foretees.gif\"><BR>");
            out.println("<hr width=\"40%\">");
            out.println("<BR><BR><H3>Cancel Requested</H3>");
            ...
            out.println("<font size=\"2\">");
            out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_jump\">");
   ...
   //
   //  filter the lottery name
   //
//   lottName = SystemUtils.filter(lottName);
   ...
   if (((req.getParameter("letter") != null) || (req.getParameter("mins_before") != null) ||
      ...
      out.println("<br><table border=\"1\" cols=\"1\" bgcolor=\"#F5F5DC\" cellpadding=\"3\">");
         ...
         out.println("<table border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"5\">"); // table to contain 2 tables below
          ...
          out.println("<tr>");
          out.println("<form action=\"/" +rev+ "/servlet/Proshop_lott\" method=\"post\" name=\"reqForm\">");
               out.println("<input type=\"hidden\" name=\"sdate\" value=\"" + sdate + "\"></input>");
               out.println("<input type=\"hidden\" name=\"day\" value=\"" + day_name + "\"></input>");
               out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\"></input>");
               out.println("<input type=\"hidden\" name=\"index2\" value=\"" + index2 + "\"></input>");
            ...
            out.println("<tr><td align=\"left\">");
               ...
               if (!club.equals( "cherryhills" ) && !club.equals( "ranchobernardo" ) && !club.equals( "lakewood" )) {   // if NOT Cherry Hills & Rancho Bernardo
                     ...
                     if (club.equals( "northridge" ) || club.equals( "missionviejo" ) || club.equals( "sugarmill" )) {
                        ...
                        if (club.equals( "westchester" )) {
                           ...
                           if (club.equals( "mirasolcc" )) {
                              mins_before = 180;                // 3 hrs (changed from 6 hrs)
                           } else {
                              if (club.equals( "pecanplantation" )) {
                                 mins_before = 420;                // 7 hrs
                              } else {
                  ...
                  if (mins_after == 999) {   // if new request (default to 120)
                     ...
                     if (club.equals( "mirasolcc" )) {
                        mins_after = 180;                // 3 hrs (changed from 6 hrs)
                     }
                     if (club.equals( "pecanplantation" )) {
                        mins_after = 420;                //  7 hrs
                     }
                  }
               ...
               out.println("&nbsp;&nbsp;<b>Note:</b> Tee times to be awarded within the boundaries established for this lottery.<br>");
            out.println("</font></td></tr>");
         ...
         if (lottid > 0) {
            ...
            out.println("<form action=\"/" +rev+ "/servlet/Proshop_lott\" method=\"post\" name=\"can\">");
            out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
            out.println("<input type=\"hidden\" name=\"index2\" value=\"" + index2 + "\">");
            out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
            out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + returnCourse + "\">");
     ...
     if (!memNotice.equals( "" )) {      // if message to display
        ...
        out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
           ...
           out.println("<table border=\"1\" cols=\"1\" bgcolor=\"#f5f5dc\" cellpadding=\"3\">");
              ...
              out.println("<td align=\"center\">");
              out.println("<font size=\"2\">");
                 out.println("<form action=\"/" +rev+ "/servlet/Proshop_lott\" method=\"post\">");
                 out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
                 out.println("<input type=\"hidden\" name=\"lname\" value=\"" + lottName + "\">");
                 out.println("<input type=\"hidden\" name=\"lstate\" value=\"" + lstate + "\">");
                 out.println("<input type=\"hidden\" name=\"lottid\" value=\"" + lottid + "\">");
...
/*
      ...
      //**********************************************
      //
      if (showMemberNotices) {
          String memNotice = verifySlot.checkMemNotice(date, time, fb, course, day_name, "teetime", con);
          ...
          out.println("<!-- NOT SHOWING MEMBER NOTICES! -->");
          out.println("<!-- date=" + date + " -->");
          out.println("<!-- time=" + time + " -->");
          out.println("<!-- fb=" + fb + " -->");
          out.println("<!-- course=" + course + " -->");
          out.println("<!-- day_name=" + day_name + " -->");
      }// end is showMemberNotices
      */
      //
...
*/
  ...
  if (players > 20) {
   ...
   out.println("<tr><td align=\"center\">");
      ...
      out.println("<table border=\"0\" align=\"center\" valign=\"top\" cellpadding=\"5\" cellspacing=\"5\">"); // table to contain 4 tables below
         ...
         out.println("<td align=\"center\" valign=\"top\">");         // col for Instructions
          ...
          out.println("<form action=\"/" +rev+ "/servlet/Proshop_lott\" method=\"post\" name=\"playerform\">");
          out.println("<td align=\"center\" valign=\"top\">");
            ...
            out.println("<tr><td align=\"center\">");
              ...
              if (players > 20) {
               ...
               out.println("<input type=\"hidden\" name=\"stime\" value=\"" + stime + "\"></input>");
               ...
               out.println("<input type=submit value=\"Submit Request\" name=\"submitForm\"></input>");
               out.println("</font></td></tr>");
               out.println("</table>");
         out.println("</td>");
   ...
   //
   alphaTable.guestList(club, course, day_name, time, parm, true, false, 0, enableAdvAssist, out, con);
   ...
   if (lottid != 0) {
      ...
      try {
         ...
         if (skiplott == false) {
            ...
            if (ptime < 0) {          // if negative, then roll back one day
