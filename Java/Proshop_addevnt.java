        ...
        if (sess_activity_id == 0) {
         ...
         if (sess_activity_id != 0) {
            ...
            try {
               ...
               while ( rs.next() ) {
                   ...
                   out.println("<br>&nbsp;&nbsp;&nbsp; <input type=checkbox name=actChkBox_" + i + " value=" + rs.getInt("activity_id") + ">&nbsp; " + rs.getString("activity_name"));
                   i++;
               }
               
            } catch (Exception exc) {
                
                Utilities.logError("Error in Proshop_addevnt loading activities: " + exc.toString());
                ...
                out.println("<input type=hidden name=location_count value='" + (i - 1) + "'>");
         ...
         out.println("<div id=\"extra_info\" style=\"height: auto; width: auto\">");
           ...
           out.println("<table>");
            ...
            out.println("<tr><td>&nbsp;</td><td><input type=checkbox name=ask_otherQ1 value=1 onchange=\"updateCheckbox(this.name, 'req_otherQ1')\"></td><td><input type=checkbox name=req_otherQ1 value=1></td><td><font size=2>Include Custom Question #1?&nbsp; &nbsp;<input type=text name=otherQ1 size=26 maxlength=" + ((ext_Q) ? "64" : "32") + "></td></tr>");
            out.println("<tr><td>&nbsp;</td><td><input type=checkbox name=ask_otherQ2 value=1 onchange=\"updateCheckbox(this.name, 'req_otherQ2')\"></td><td><input type=checkbox name=req_otherQ2 value=1></td><td><font size=2>Include Custom Question #2?&nbsp; &nbsp;<input type=text name=otherQ2 size=26 maxlength=" + ((ext_Q) ? "64" : "32") + "></td></tr>");
            out.println("<tr><td>&nbsp;</td><td><input type=checkbox name=ask_otherQ3 value=1 onchange=\"updateCheckbox(this.name, 'req_otherQ3')\"></td><td><input type=checkbox name=req_otherQ3 value=1></td><td><font size=2>Include Custom Question #3?&nbsp; &nbsp;<input type=text name=otherQ3 size=26 maxlength=" + ((ext_Q) ? "64" : "32") + "></td></tr>");
           out.println("</table>");
