 ...
 *   Last Updated:  
 *
 *        4/27/10   Added guest tracking processing
    ...
    if (req.getParameter("return") != null) {     // if this is a return from verify - time = hhmm
        ...
        //if (signup_id != 0) {
            ...
            if (!allow) {
                ...
                out.println("<form action=\"/" +rev+ "/servlet/Proshop_waitlist_slot\" method=\"post\" name=\"can\">");
   ...
   out.println("<tr><td align=\"center\"><br>");
      ...
      out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" align=\"center\">"); // table to contain 4 tables below
         ...
         out.println("<td align=\"center\" valign=\"top\">");         // col for Instructions and Go Back button
            ...
            out.println("<br><br>");
            if (signup_id == 0) {
                out.println("<form action=\"/" +rev+ "/servlet/Proshop_jump\" method=\"post\" name=\"can\">");
         ...
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_waitlist_slot\" method=\"post\" name=\"playerform\" id=\"playerform\">");
...
//               }
   ...
   if (index.equals( "888" )) {         // if came from proshop_searchmain
      ...
      out.println("<title>Proshop Wait List Entry</title>");
      if (newEntry) {
          out.println("<meta http-equiv=\"Refresh\" content=\"2; url=/" +rev+ "/servlet/Proshop_jump?index=" + index + "&course=" + ((!returnCourse.equals( "" )) ? returnCourse : slotParms.course) + "&jump=" + slotParms.jump + "\">");
      } else {
          out.println("<meta http-equiv=\"Refresh\" content=\"2; url=/" +rev+ "/servlet/Proshop_dsheet?mode=WAITLIST&name=" + parmWL.name + "&index=" + index + "&course=" + slotParms.course + "&returnCourse=" + returnCourse + "&hide=1\">");
      }
      out.println("</HEAD>");
      out.println("<BODY bgcolor=\"#FFFFFF\" text=\"#000000\">");
      out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
 ...
 private void cancel(HttpServletRequest req, PrintWriter out, String club, Connection con) {
    ...
    if (index.equals( "888" )) {       // if originated from Proshop_main
      ...
      out.println("</form></font>");
        ...
        out.println("<link rel=\"stylesheet\" href=\"/" +rev+ "/web utilities/foretees2.css\" type=\"text/css\"></link>");
        out.println("<title>Proshop Tee Slot Page</title>");
        out.println("<meta http-equiv=\"refresh\" content=\"1; url=/" +rev+ "/servlet/Proshop_dsheet?mode=WAITLIST&index=" + index + "&course=" + course + "&returnCourse=" + returnCourse + "&name=" + list_name + "\">");
        out.println("</HEAD>");
        out.println("<BODY><CENTER><img src=\"/" +rev+ "/images/foretees.gif\"><BR>");
        out.println("<hr width=\"40%\">");
        out.println("<BR><BR><H3>Return/Cancel Requested</H3>");
