...
public class Support_cleanup extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      if (rs.next()) {
        ...
        // Parms do not exist yet
         ...
         if (user.startsWith( "sales" )) {
            ...
            out.println("<BR><BR><a href=\"/" +rev+ "/support_main.htm\">Home</a>");
         }
         out.println("</CENTER></BODY></HTML>");
         return;
      }
      ...
      out.println("<form action=\"/" +rev+ "/servlet/Support_cleanup\" method=\"post\" name=\"frmLoadDay\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      out.println("</tr>");
      out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Support_cleanup\">");
      ...
      out.println("<table border=\"0\" align=\"center\">");
         ...
         out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>");
         out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Support_cleanup\">");
         out.println("</td><td>");
         out.println("<font size=\"2\">");
      ...
      out.println("<br><br><a href=\"/" +rev+ "/servlet/Support_cleanup\">Return</a>");
      out.println("</CENTER></BODY></HTML>");
