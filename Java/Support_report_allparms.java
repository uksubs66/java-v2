...
public class Support_report_allparms extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<form action=\"/" +rev+ "/servlet/Support_report_allparms\" method=\"post\" target=\"_blank\">");
  ...
  // out.println("<input type=\"hidden\" name=\"mship\" value=\"mship\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("course") != null) {              // report for Club Parms              
   ...
   if (repType.equals( "Club" )) {                  // if Club Parms Report
   ...
   if (repType.equals( "Membership" )) {                  // if Membership (Dys in Adv) Parms Report
      ...
      if (singleClub == 0) {              // if request for all clubs         
         ...
         while (rs.next()) {
            ...
            if (skip == false) {
               ...
               if (repType.equals( "Club" )) {                  // if Course Parms Report

                  doClubReport(club, out, con);      
               }

               if (repType.equals( "Membership" )) {           // if Mship Parms Report
