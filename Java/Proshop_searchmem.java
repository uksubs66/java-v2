...
public class Proshop_searchmem extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<form action=\"/" +rev+ "/servlet/Proshop_searchmem\" method=\"post\" target=\"bot\" name=\"f\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
            ...
            if (!rs.next()) {              // any tee times?
               ...
               while (rs.next()) {
                  ...
                  if (!notes.equals("")) {
                     ...
                     out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_searchmem\" target=\"_blank\">");
   ...
   */
               ...
               stmt = con.prepareStatement (
                   ...
                   "WHERE " + 
                       ...
                       "np.player_name = ? AND " + 
                       "DATE_FORMAT(n.req_datetime, '%Y%m%d') >= now() " +
               ...
               while (rs.next()) {
                   ...
                   //
                   out.println("<tr>");
                   out.println("<form action=\"/" +rev+ "/servlet/ProshopTLT_slot\" method=\"get\" target=\"_top\">");
   ...
   */
            ...
            if (user.equals("")) {
               ...
               out.println("</font>");
                ...
                while (rs.next()) {
                   ...
                   out.print("<a href=\"javascript:void(0)\" onclick=\"top.location.href='/" + rev + "/servlet/Proshop_activity_slot?slot_id=" + rs.getInt("sheet_id") + "&date=" + rs.getInt("dateymd") + "&index=998'\"><font size=2 color=darkGreen>" + rs.getString("pretty_date") + " at " + rs.getString("pretty_time") + "</font></a><br>");
         ...
         out.println("<BR><BR>If problem persists, contact customer support.");
         out.println("<br><br><a href=\"/" +rev+ "/servlet/Proshop_searchmem\">Return</a>");  // return to searchmain.htm
         out.println("</CENTER></BODY></HTML>");
