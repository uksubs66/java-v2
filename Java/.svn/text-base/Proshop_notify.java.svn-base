...
public class Proshop_notify extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   // String [] course = new String [cMax];
    ...
    out.println("<form method=post action=/" + rev + "/servlet/ProshopTLT_slot name=frmNotifyTime id=frmNotifyTime target=\"_top\">");
    ...
    out.println("<tr><td align=center colspan=2><br>" +
            ...
            "</form>" +
            "<form method=get action=\"/"+rev+"/servlet/Proshop_dsheet\" target=\"_top\">" + 
    ...
    //out.println(" f.submit();");
    //out.println(" document.location.href=\"/"+rev+"/servlet/Proshop_dsheet?index=0&course=" + defaultCourse + "\";");
    //out.println("}");
