...
public class Common_mobile_help extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<img src=\"/" +rev+ "/images/foretees_nav.jpg\" border=0>");
   out.println("<font size=\"2\" face=\"Arial, Times New Roman, Helvetica\">");
   out.println("<BR><BR><H2>How to Access ForeTees From a Mobile Device</H2>");
   ...
   if (allow_mobile == 0 && !user.startsWith("proshop")) {     // if member and not allowed
      ...
      if (user.startsWith("proshop")) {     // if proshop user
         ...
         out.println("<BR><H3>FOR MEMBERS ONLY</H3>");
         ...
         out.println("<p align=center>The Mobile Interface is available for <b>members only</b> at this time, <b>not proshop users</b>.<BR><BR>" +
                     ...
                     "You may use the interface by adding a member account for yourself (use Admin).</p>");     
         ...
         if (allow_mobile == 0) {     // if not allowed
            ...
            out.println("<br><br><a href=\"/" +rev+ "/servlet/Common_mobile_help?enable=yes\">Click Here To ENABLE The Mobile Interface</a><BR><BR>");
            ...
            out.println("<br><br><a href=\"/" +rev+ "/servlet/Common_mobile_help?enable=no\">Click Here To DISABLE The Mobile Interface</a><BR><BR>");
         }        
         out.println("</font></td></tr></table>");

         out.println("<H3>Mobile Directions For Member Access</H3>");
      }
      
      out.println("<table border=0 width=600><tr>");
      out.println("<td align=left><font size=\"2\">");

      out.println("ForeTees is proud to introduce a site designed exclusively for smart phones.&nbsp;&nbsp;This site will allow you to easily view your club's tee sheets, make new tee time requests, and manage your existing tee times.");
      out.println("<BR><BR>This site currently supports the ForeTees Tee Time System only, not the FlxRez System (Tennis, etc).&nbsp;&nbsp;" +
                  "Since this is a mobile-enabled site, and NOT an 'App', there is no additional charge from ForeTees.&nbsp;&nbsp;" +
                  "However, you may incur data charges from your cellular service provider, as with any site visited from your mobile device.");
      out.println("<BR><BR><b>Phones Supported:</b>&nbsp;&nbsp;Due to the high number of phone manufacturers and models available, it is nearly impossible for us to test all phones.&nbsp;&nbsp;" +
                   "We have verified several of the current makes & models (i.e. iPhone, Blackberry, Droid, etc) and found they work very well.&nbsp;&nbsp;If you have a smart phone that is capable of browsing websites, " +
                   "then we suggest that you try our mobile site.");

         out.println("<BR><BR><H3>PLEASE READ THE FOLLOWING INSTRUCTIONS (see Print button below)</H3>");
   
      out.println("Here is what you will need to do (while logged in on your PC):");
      ...
      out.println("<BR><p align=center><b>http://m.foretees.com/" +club+ "</b></p>");
 ...
 private void switchMobile(String enable, PrintWriter out, Connection con) {
   ...
   out.println("<BR><BR>Thank you!");
   out.println("<BR><BR><a href=\"/" +rev+ "/servlet/Common_mobile_help\">Return</a><BR>");
