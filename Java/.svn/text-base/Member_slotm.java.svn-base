...
public class Member_slotm extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   //
   int ind = getDaysBetween(date);            // get # of days in between today and the date of the tee time
   ...
   if ((req.getParameter("letter") != null) || (req.getParameter("buddy") != null) || (req.getParameter("return") != null) ||
      ...
      if (parm.max_originations > 0) error2 = verifySlot.checkMaxOrigBy(user, date, parm.max_originations - (slots - 1), con);
      ...
      if (date == 0 || time == 0 || course == null || user.equals( "" ) || user == null) {
         ...
         if (club.equals("eaglecreek")) {    
            ...
            acError = checkECearly(user, ind, slots);   // check days in adv, time and slots requested
      ...
      if (!memNotice.equals( "" )) {      // if message to display
         ...
         out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
            ...
            out.println("<table border=\"1\" cols=\"1\" bgcolor=\"#f5f5dc\" cellpadding=\"3\">");
               ...
               out.println("<font size=\"2\">");
               out.println("<form action=\"/" +rev+ "/servlet/Member_slotm\" method=\"post\" name=\"can\">");
               out.println("<input type=\"hidden\" name=\"index\" value=" + index + ">");
               out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
               out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + returnCourse + "\">");
               out.println("<input type=\"hidden\" name=\"date\" value=" + date + ">");
               ...
               out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
                  out.println("<form action=\"/" +rev+ "/servlet/Member_slotm\" method=\"post\">");
                  out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
                  out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
                  out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
                  out.println("<input type=\"hidden\" name=\"returnCourse\" value=\"" + returnCourse + "\">");
...
//   }
   ...
   if (club.equals( "pinery" ) || club.equals( "trophyclubcc" ) || club.equals( "pmarshgc" )) {
   ...
   } else if (club.equals( "admiralscove" ) || club.equals( "championhills" )) {
   ...
   } else if (club.equals( "jonathanslanding" ) || club.equals("gulfharbourgcc") || club.equals("sawgrass") || club.equals("woodlandscountryclub") ||
              club.equals("turnerhill")) {
     ...
     if (!course.equals( "" )) {
      ...
      out.println("<table border=\"0\" align=\"center\" valign=\"top\" cellpadding=\"5\" cellspacing=\"5\">"); // table to contain 4 tables below
         ...
         out.println("<td align=\"center\" valign=\"top\">");         // col for Instructions
          ...
          out.println("<form action=\"/" +rev+ "/servlet/Member_slotm\" method=\"post\" name=\"playerform\" id=\"playerform\">");
          out.println("<td align=\"center\" valign=\"top\">");
            ...
            out.println("<tr><td align=\"center\">");
               ...
               out.println("1: &nbsp;&nbsp;<input type=\"text\" name=\"player1\" value=\"" + player1 + "\" size=\"20\" maxlength=\"43\">");
               ...
               out.println("2: &nbsp;&nbsp;<input type=\"text\" name=\"player2\" value=\"" + player2 + "\" size=\"20\" maxlength=\"43\">");
               ...
               out.println("3: &nbsp;&nbsp;<input type=\"text\" name=\"player3\" value=\"" + player3 + "\" size=\"20\" maxlength=\"43\">");
               ...
               out.println("4: &nbsp;&nbsp;<input type=\"text\" name=\"player4\" value=\"" + player4 + "\" size=\"20\" maxlength=\"43\">");
              ...
              if (players > 5) {
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player6', 'p6cw')\" style=\"cursor:hand\">");
                 out.println("6: &nbsp;&nbsp;<input type=\"text\" name=\"player6\" value=\"" + player6 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p6cw\">");
               
                 out.println("<option selected value=" + p6cw + ">" + p6cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p6cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player7', 'p7cw')\" style=\"cursor:hand\">");
                 out.println("7: &nbsp;&nbsp;<input type=\"text\" name=\"player7\" value=\"" + player7 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p7cw\">");
               
                 out.println("<option selected value=" + p7cw + ">" + p7cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p7cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player8', 'p8cw')\" style=\"cursor:hand\">");
                 out.println("8: &nbsp;&nbsp;<input type=\"text\" name=\"player8\" value=\"" + player8 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p8cw\">");
               
                 out.println("<option selected value=" + p8cw + ">" + p8cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p8cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 8) {
                ...
                if (p5.equals( "No" )) {   // if 4-somes only
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player9', 'p9cw')\" style=\"cursor:hand\">");
                 out.println("9: &nbsp;&nbsp;<input type=\"text\" name=\"player9\" value=\"" + player9 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p9cw\">");
               
                 out.println("<option selected value=" + p9cw + ">" + p9cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p9cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player10', 'p10cw')\" style=\"cursor:hand\">");
                 out.println("10:&nbsp;&nbsp;<input type=\"text\" id=\"player10\" name=\"player10\" value=\"" + player10 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p10cw\" id=\"p10cw\">");
               
                 out.println("<option selected value=" + p10cw + ">" + p10cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p10cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 10) {
                ...
                if (p5.equals( "Yes" )) {   // if 5-somes
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player11', 'p11cw')\" style=\"cursor:hand\">");
                 out.println("11:&nbsp;&nbsp;<input type=\"text\" name=\"player11\" value=\"" + player11 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p11cw\">");
               
                 out.println("<option selected value=" + p11cw + ">" + p11cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p11cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player12', 'p12cw')\" style=\"cursor:hand\">");
                 out.println("12:&nbsp;&nbsp;<input type=\"text\" name=\"player12\" value=\"" + player12 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p12cw\">");
              
                 out.println("<option selected value=" + p12cw + ">" + p12cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p12cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 12) {
                ...
                if (p5.equals( "No" )) {   // if 4-somes only
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player13', 'p13cw')\" style=\"cursor:hand\">");
                 out.println("13:&nbsp;&nbsp;<input type=\"text\" name=\"player13\" value=\"" + player13 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p13cw\">");
              
                 out.println("<option selected value=" + p13cw + ">" + p13cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p13cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player14', 'p14cw')\" style=\"cursor:hand\">");
                 out.println("14:&nbsp;&nbsp;<input type=\"text\" name=\"player14\" value=\"" + player14 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p14cw\">");
               
                 out.println("<option selected value=" + p14cw + ">" + p14cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p14cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
               ...
               out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player15', 'p15cw')\" style=\"cursor:hand\">");
               out.println("15:&nbsp;&nbsp;<input type=\"text\" id=\"player15\" name=\"player15\" value=\"" + player15 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p15cw\" id=\"p15cw\">");
                 
                 out.println("<option selected value=" + p15cw + ">" + p15cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p15cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 15) {
                ...
                if (p5.equals( "Yes" )) {   // if 5-somes
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player16', 'p16cw')\" style=\"cursor:hand\">");
                 out.println("16:&nbsp;&nbsp;<input type=\"text\" name=\"player16\" value=\"" + player16 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p16cw\">");
                
                 out.println("<option selected value=" + p16cw + ">" + p16cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p16cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 16) {
                ...
                if (p5.equals( "No" )) {   // if 4-somes only
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player17', 'p17cw')\" style=\"cursor:hand\">");
                 out.println("17:&nbsp;&nbsp;<input type=\"text\" name=\"player17\" value=\"" + player17 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p17cw\">");
               
                 out.println("<option selected value=" + p17cw + ">" + p17cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p17cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player18', 'p18cw')\" style=\"cursor:hand\">");
                 out.println("18:&nbsp;&nbsp;<input type=\"text\" name=\"player18\" value=\"" + player18 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p18cw\">");
               
                 out.println("<option selected value=" + p18cw + ">" + p18cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p18cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player19', 'p19cw')\" style=\"cursor:hand\">");
                 out.println("19:&nbsp;&nbsp;<input type=\"text\" name=\"player19\" value=\"" + player19 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p19cw\">");
               
                 out.println("<option selected value=" + p19cw + ">" + p19cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p19cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player20', 'p20cw')\" style=\"cursor:hand\">");
                 out.println("20:&nbsp;&nbsp;<input type=\"text\" id=\"player20\" name=\"player20\" value=\"" + player20 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p20cw\" id=\"p20cw\">");
           
                 out.println("<option selected value=" + p20cw + ">" + p20cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p20cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
              ...
              if (players > 20) {
                 ...
                 out.println("<img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player21', 'p21cw')\" style=\"cursor:hand\">");
                 out.println("21:&nbsp;&nbsp;<input type=\"text\" name=\"player21\" value=\"" + player21 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p21cw\">");
             
                 out.println("<option selected value=" + p21cw + ">" + p21cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p21cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player22', 'p22cw')\" style=\"cursor:hand\">");
                 out.println("22:&nbsp;&nbsp;<input type=\"text\" name=\"player22\" value=\"" + player22 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p22cw\">");
             
                 out.println("<option selected value=" + p22cw + ">" + p22cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p22cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player23', 'p23cw')\" style=\"cursor:hand\">");
                 out.println("23:&nbsp;&nbsp;<input type=\"text\" name=\"player23\" value=\"" + player23 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p23cw\">");
             
                 out.println("<option selected value=" + p23cw + ">" + p23cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p23cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
                 ...
                 out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player24', 'p24cw')\" style=\"cursor:hand\">");
                 out.println("24:&nbsp;&nbsp;<input type=\"text\" name=\"player24\" value=\"" + player24 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p24cw\">");
             
                 out.println("<option selected value=" + p24cw + ">" + p24cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p24cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
               ...
               out.println("<br><img src=\"/" +rev+ "/images/erase.gif\" onClick=\"erasename('player25', 'p25cw')\" style=\"cursor:hand\">");
               out.println("25:&nbsp;&nbsp;<input type=\"text\" id=\"player25\" name=\"player25\" value=\"" + player25 + "\" size=\"20\" maxlength=\"43\">");
                 out.println("&nbsp;&nbsp;&nbsp;<select size=\"1\" name=\"p25cw\" id=\"p25cw\">");
           
                 out.println("<option selected value=" + p25cw + ">" + p25cw + "</option>");
                 for (i=0; i<16; i++) {

                    if (!parmc.tmodea[i].equals( "" ) && !parmc.tmodea[i].equals( p25cw ) && parmc.tOpt[i] == 0) {
                       out.println("<option value=\"" +parmc.tmodea[i]+ "\">" +parmc.tmodea[i]+ "</option>");
                    }
                 }
                 out.println("</select>");
...
*/
   ...
   //
   //  Custom for Pelican Marsh.  Set custom_disp values so we know who added which members to the tee time.  They'd like for
   ...
   if (club.equals("pmarshgc")) {
       ...
       if (parm.player1.equals("")) {
           ...
           parm.custom_disp1 = user;
       }
       if (parm.player2.equals("")) {
           parm.custom_disp2 = "";
       } else {
           parm.custom_disp2 = user;
       }
       if (parm.player3.equals("")) {
           parm.custom_disp3 = "";
       } else {
           parm.custom_disp3 = user;
       }
       if (parm.player4.equals("")) {
           parm.custom_disp4 = "";
       } else {
           parm.custom_disp4 = user;
       }
       if (parm.player5.equals("")) {
           parm.custom_disp5 = "";
       } else {
           parm.custom_disp5 = user;
       }
       if (parm.player6.equals("")) {
           parm.custom_disp6 = "";
       } else {
           parm.custom_disp6 = user;
       }
       if (parm.player7.equals("")) {
           parm.custom_disp7 = "";
       } else {
           parm.custom_disp7 = user;
       }
       if (parm.player8.equals("")) {
           parm.custom_disp8 = "";
       } else {
           parm.custom_disp8 = user;
       }
       if (parm.player9.equals("")) {
           parm.custom_disp9 = "";
       } else {
           parm.custom_disp9 = user;
       }
       if (parm.player10.equals("")) {
           parm.custom_disp10 = "";
       } else {
           parm.custom_disp10 = user;
       }
       if (parm.player11.equals("")) {
           parm.custom_disp11 = "";
       } else {
           parm.custom_disp11 = user;
       }
       if (parm.player12.equals("")) {
           parm.custom_disp12 = "";
       } else {
           parm.custom_disp12 = user;
       }
       if (parm.player13.equals("")) {
           parm.custom_disp13 = "";
       } else {
           parm.custom_disp13 = user;
       }
       if (parm.player14.equals("")) {
           parm.custom_disp14 = "";
       } else {
           parm.custom_disp14 = user;
       }
       if (parm.player15.equals("")) {
           parm.custom_disp15 = "";
       } else {
           parm.custom_disp15 = user;
       }
       if (parm.player16.equals("")) {
           parm.custom_disp16 = "";
       } else {
           parm.custom_disp16 = user;
       }
       if (parm.player17.equals("")) {
           parm.custom_disp17 = "";
       } else {
           parm.custom_disp17 = user;
       }
       if (parm.player18.equals("")) {
           parm.custom_disp18 = "";
       } else {
           parm.custom_disp18 = user;
       }
       if (parm.player19.equals("")) {
           parm.custom_disp19 = "";
       } else {
           parm.custom_disp19 = user;
       }
       if (parm.player20.equals("")) {
           parm.custom_disp20 = "";
       } else {
           parm.custom_disp20 = user;
       }
       if (parm.player21.equals("")) {
           parm.custom_disp21 = "";
       } else {
           parm.custom_disp21 = user;
       }
       if (parm.player22.equals("")) {
           parm.custom_disp22 = "";
       } else {
           parm.custom_disp22 = user;
       }
       if (parm.player23.equals("")) {
           parm.custom_disp23 = "";
       } else {
           parm.custom_disp23 = user;
       }
       if (parm.player24.equals("")) {
           parm.custom_disp24 = "";
       } else {
           parm.custom_disp24 = user;
       }
       if (parm.player25.equals("")) {
           parm.custom_disp25 = "";
       }
 ...
 private boolean parseNames(PrintWriter out, parmSlotm parm, parmClub parm2, Connection con) {
   ...
   try {
      ...
      if (error == false) {
         ...
         //
         if (parm.members == 0 && parm2.unacompGuest == 0) {
            ...
            out.println("<center>");
            out.println("<BR><BR><H3>Data Entry Error</H3>");
            out.println("<BR><BR>Member name not found. You must specify at least one member in the request.");
            out.println("<BR>Member names must be specified exactly as they exist in the system.");
            out.println("<BR><BR>Please correct this and try again.");
            out.println("<BR><BR>");
 ...
 **/
 ...
 private void goReturn(PrintWriter out, parmSlotm parm) {
      ...
      out.println("<font size=\"2\">");
      out.println("<form action=\"/" +rev+ "/servlet/Member_slotm\" method=\"post\" target=\"_top\">");
 ...
 private void logoffAC(PrintWriter out, HttpSession session, Connection con) {
   ...
   out.println("<BR>forth by Admirals Cove. As a result you will be logged off and have to log on again.");
