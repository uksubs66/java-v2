  ...
  //     "'', 0, 0, 0, 0, 0, '', 0, ?, ?, ?, ?, ?, 0, " +
     ...
     */
     ...
     // pstmt.setInt(3, id);
      ...
      SystemUtils.logError("Error in Proshop_evntSignUp.getNewId. Exception = " + e1.getMessage());       // log it and continue
...
*/
 ...
 private static void extraInfoForm(
    ...
    out.println("</form></td>");
    out.println("</tr><tr>");
    out.println("<form action=\"/" +rev+ "/servlet/Proshop_evntSignUp\" method=\"post\" name=\"can\"><td align=center><br>");
    out.println("<input type=\"hidden\" name=\"id\" value=" + signup_id + ">");
    out.println("<input type=\"hidden\" name=\"name\" value=\"" + name + "\">");
    out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
    //out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
