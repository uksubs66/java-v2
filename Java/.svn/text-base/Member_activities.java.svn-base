...
public class Member_activities extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<p align=center><b><font size=3 color=#000000>Select your desired activity from the list below.<br>NOTE: You can set your default activity under <a href=\"/"+rev+"/servlet/Member_services\" class=actLink>Settings</a>.</font></b></p>");
    ...
    try {
        ...
        if (foretees_mode != 0) {
            ...
            out.println("<tr><td align=center><b><a href=\"/"+rev+"/servlet/Member_jump?switch&activity_id=0\" class=linkA style=\"color:#336633\" target=_top>Golf</a></b></td></tr>"); // ForeTees
        ...
        while (rs.next()) {
            ...
            out.println("<tr><td align=center><b><a href=\"/"+rev+"/servlet/Member_jump?switch&activity_id=" + rs.getInt("activity_id") + "\" class=linkA style=\"color:#336633\" target=_top>" + rs.getString("activity_name") + "</a></b></td></tr>");
...
/*
    ...
    out.println(" top.bot.location.href='/v5/servlet/Member_gensheets?id=' + id;");
    out.println("}");
    ...
    out.println("<p><a href=\"/v5/servlet/Member_genrez\">Reset</a></p>");
