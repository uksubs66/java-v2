 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (req.getParameter("switch") != null) {               // if call is from Member_activity_slot
        ...
        //if (activity_id == 0) {
            ...
            out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Member_announce\" marginheight=\"1\">");
...
*/
    ...
    if (index.equals("999")) {
        out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Member_teelist\" marginheight=\"1\">");
    } else if (index.equals("998")) {
       out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Member_teelist_list\" marginheight=\"1\">");
    } else if (index.equals("888")) {
       out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Member_searchmem\" marginheight=\"1\">");
    } else {
        out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Member_gensheets?date=" + date + "&layout_mode=" + layout + "&activity_id=" + activity_id + "&last_tab=" + last_tab + "\" marginheight=\"1\">"); // &parent_id=" + parent_id + "&sheet_id=" + sheet_id + "
    }
    out.println("</frameset>");
