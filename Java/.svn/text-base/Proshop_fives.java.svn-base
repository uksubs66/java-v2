/***************************************************************************************     
 *   Proshop_fives:  This servlet will process the '5-some Restrictions' request from
 *                    the Proshop's Config page.
 *
 *
 *   called by:  proshop menu (to doGet) and Proshop_fives (to doPost from HTML built here)
 *
 ...
 *        9/23/08   Remove check for 5-somes supported so clubs that are changing to/from 5-somes can access the restrictions.
...
public class Proshop_fives extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   //
   //  First, see if 5-somes are supported on any courses for this club
   //
   try {
   ...
   //
   out.println(SystemUtils.HeadTitle("Proshop 5-some Restrictions Page"));
   ...
   out.println("<tr><td align=\"center\">");
      ...
      out.println("<p align=\"center\"><b>Active 5-Some Restrictions</b></p>");
   ...
   try {
      ...
      rs = stmt.executeQuery("SELECT * FROM fives2 ORDER BY name");
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_fives\" target=\"bot\">");
         out.println("<td align=\"center\">");
      ...
      if (!b) {
         ...
         out.println("</font><font size=\"2\"><p>No 5-Some Restrictions Currently Exist</p>");
      }
   }
   catch (Exception exc) {
   ...
   //  End of HTML page
   //
   out.println("</table></font>");                   // end of fives table
 ...
 //
 //****************************************************************
 // Process the form request from Proshop_fives page displayed above.
 //
   ...
   if (req.getParameter("copy") != null) {
       try {
           PreparedStatement pstmt = con.prepareStatement(
                   "SELECT courseName FROM fives2 WHERE name = ?");
...
//   name = SystemUtils.filter(name);
   ...
   try {
      ...
      PreparedStatement pstmt = con.prepareStatement (
               "SELECT * FROM fives2 WHERE name = ? AND courseName = ?");
   ...
   out.println("<tr><td>");
      ...
      out.println("<tr><td align=\"center\">");
      out.println("<font color=\"#FFFFFF\" size=\"2\">");
      out.println("<b>Edit 5-Some Restriction</b><br>");
      ...
      if (req.getParameter("copy") != null) {
          out.println("<form action=\"/" +rev+ "/servlet/Proshop_addfives\" method=\"post\" target=\"bot\">");
          out.println("<input type=\"hidden\" name=\"copy\" value=\"yes\">");
      } else {
          out.println("<form action=\"/" +rev+ "/servlet/Proshop_editfives\" method=\"post\" target=\"bot\">");
      }
            ...
            if (multi != 0) {
              ...
              out.println("</select><br><br>");
               ...
               out.println("&nbsp;&nbsp;End Time:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; hr &nbsp;&nbsp;");
                ...
                out.println("<br>&nbsp;&nbsp;Color to make the Player 5 slot on the tee sheet:&nbsp;&nbsp;");
               ...
               if (req.getParameter("copy") == null) {
                   ...
                   out.println("<input type=\"submit\" name=\"Delete\" value=\"Delete\" onclick=\"return confirm('Are you sure you want to delete this 5-some restriction?')\">");
               } else {
   ...
   out.println("<font size=\"2\">");
   out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Proshop_fives\">");
 ...
 private void doCopy(HttpServletRequest req, PrintWriter out, Connection con, int lottery) {
   ...
   out.println("<tr><td align=\"center\">");
   out.println("<font color=\"#FFFFFF\" size=\"3\">");
   out.println("<b>Copy a 5-Some Restriction</b><br>");
   out.println("</font>");
   out.println("<font color=\"#FFFFFF\" size=\"2\">");
   ...
   try {
      ...
      rs = stmt.executeQuery("SELECT name FROM fives2");
      ...
      if (b == true) {
         ...
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_fives\" method=\"post\" target=\"bot\">");
         out.println("<input type=\"hidden\" name=\"copy\" value=\"yes\">");     // tell addfives its a copy
         ...
         rs = stmt.executeQuery("SELECT name FROM fives2 ORDER BY name");
         ...
         out.println("<p><font size=\"2\">No 5-Some Restrictions Currently Exist</p>");
      }
   }
   catch (Exception exc) {
