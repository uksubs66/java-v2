...
public class Proshop_memberdata extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println("<a href=\"/" + rev + "/servlet/Proshop_memberdata?todo=ratings&solo\">Adjust Individual Member Ratings</a>");
    // link for adjusting bulk member ratings
    out.println("<a href=\"/" + rev + "/servlet/Proshop_memberdata?todo=ratings&bulk\">Adjust Bulk Member Ratings</a>");
    out.println("</center>");
 ...
 private void getRatingData(HttpServletRequest req, HttpSession session, int sess_activity_id, String club, String todo, PrintWriter out, Connection con) {
    ...
    out.println("<form action=\"/" +rev+ "/servlet/Proshop_memberdata\" method=\"get\" name=\"playerform\" id=\"playerform\">");
    ...
    alphaTable.nameList(club, letter, mshipOpt, mtypeOpt, true, null, enableAdvAssist, out, con);
