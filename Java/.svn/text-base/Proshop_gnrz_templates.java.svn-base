...
//        } // end while loop for date
 ...
 private void customizeSheet(String name, String msg, boolean insert, Connection con, PrintWriter out, HttpServletRequest req) {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            out.print("<td>&nbsp;");
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_customsheets?insert&tid=" +tid+ "&name=" + name + "&hr=" + hr + "&jump=jump" + count + "\" title=\"Insert tee time\" alt=\"Insert tee time\">");
            ...
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_customsheets?delete&tid=" +tid+ "&name=" + name + "&jump=jump" + count + "\" title=\"Delete tee time\" alt=\"Delete tee time\">");
            ...
            //out.print("<a href=\"/" +rev+ "/servlet/Proshop_customsheets?fb&tid=" +tid+ "&name=" + name + "\">" + sfb + "</a>");
            ...
            out.println("<tr>");
            out.print("<td>&nbsp;");
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_customsheets?customize&comtomize2&tid=" +tid+ "&insert=yes\" title=\"Insert tee time\" alt=\"Insert tee time\">");
            out.print("<img src=/" +rev+ "/images/dts_insert.gif width=13 height=13 border=0></a>");
            out.print("<img src=/" +rev+ "/images/shim.gif width=5 height=1 border=0>");
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_customsheets?customize&comtomize2&tid=" +tid+ "&delete=yes\" title=\"Delete tee time\" alt=\"Delete tee time\" onclick=\"return confirm('Are you sure you want to permanently delete this tee time?');\">");
            out.print("<img src=/" +rev+ "/images/dts_trash.gif width=13 height=13 border=0></a>");
            out.println("&nbsp;</td>");
 ...
 public void selectActivity(String todo, HttpServletRequest req, HttpServletResponse resp)
    ...
    out.println(" location.href='/v5/servlet/Proshop_gnrz_templates?" + todo + "&activity_id=' + id;");
    out.println("}");
    ...
    out.println("<p><a href=\"/v5/servlet/Proshop_gnrz_templates?" + todo + "\">Reset</a></p>");
 ...
 private void templateForm(int template_id, String msg, boolean insert, Connection con, PrintWriter out, HttpServletRequest req) {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            out.println("<tr><a name=\"jump"+count+"\" id=\"jump" + count + "\"></a>");
            out.print("<td>&nbsp;");
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_gnrz_templates?insert&tid=" +tid+ "&template_id=" + template_id + "&hr=" + hr + "&jump=jump" + count + "\" title=\"Insert tee time\" alt=\"Insert tee time\">");
            out.print("<img src=/" +rev+ "/images/dts_insert.gif width=13 height=13 border=0></a>");
            out.print("<img src=/" +rev+ "/images/shim.gif width=5 height=1 border=0>");
            out.print("<a href=\"/" +rev+ "/servlet/Proshop_gnrz_templates?delete&tid=" +tid+ "&template_id=" + template_id + "&jump=jump" + count + "\" title=\"Delete tee time\" alt=\"Delete tee time\">");
            out.print("<img src=/" +rev+ "/images/dts_trash.gif width=13 height=13 border=0></a>");
            out.println("&nbsp;</td>");
