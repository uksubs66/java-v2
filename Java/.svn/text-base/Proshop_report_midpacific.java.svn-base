...
public class Proshop_report_midpacific extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        out.println(" f = document.forms['mainForm'];");
        ...
        out.println("<form action=\"/" +rev+ "/servlet/Proshop_report_midpacific\" method=\"post\" name=\"mainForm\">");
        ...
        out.println("<input type=\"text\" name=\"name\" size=\"20\" maxlength=\"40\" onchange=\"document.forms['mainForm'].name.value=this.value\" " +
    ...
    private static void viewRounds(HttpServletRequest req, Connection con, PrintWriter out) {
        ...
        if (errMsg.equals("")) {
            ...
            out.println("<td align=\"left\"><button onClick=\"location.href='/" + rev + "/servlet/Proshop_report_midpacific'\">Search Again</button></td>");
