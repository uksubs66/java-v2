...
public class Member_buddy extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Member_partner\">");
   return;
   ...
   //      out.println("alert(x);");
      ...
      out.println("<font face=\"Arial, Helvetica, Sans-serif\"><center>");
         ...
         out.println("<table border=\"0\" align=\"center\" valign=\"top\" cellspacing=\"8\">");  // table to contain 3 tables below
            ...
            out.println("<tr>");
            out.println("<form action=\"/" +rev+ "/servlet/Member_buddy\" name=\"buddyform\" id=\"buddyform\" method=\"post\" target=\"bot\">");
      ...
      out.println("</form><br><form method=\"get\" action=\"/" +rev+ "/servlet/Member_announce\">");
      ...
      out.println("<BR><BR>");
      out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Member_buddy\">");
