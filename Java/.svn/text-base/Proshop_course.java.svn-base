...
public class Proshop_course extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (multi == 0) {
      ...
      out.println("<meta http-equiv=\"Refresh\" content=\"0; url=/" +rev+ "/servlet/Proshop_parms?course=" + course + "\">");
      ...
      try {
         ...
         if (!rs.next()) {     // if there are none yet - go to setup parms for 1st course
            ...
            out.println("<HEAD><link rel=\"stylesheet\" href=\"/" +rev+ "/web utilities/foretees2.css\" type=\"text/css\"></link>");
            out.println("<Title>Proshop Course Page</Title>");
            out.println("<meta http-equiv=\"Refresh\" content=\"0; url=/" +rev+ "/servlet/Proshop_parms?course=''\">");
            out.println("</HEAD>");
            out.println("<BODY bgcolor=\"#FFFFFF\" text=\"#000000\">");
            SystemUtils.getProshopSubMenu(req, out, lottery);        // required to allow submenus on this page
            out.println("<font size=\"2\" face=\"Arial, Helvetica, Sans-serif\">");
         ...
         out.println("<font size=\"2\" face=\"Arial, Helvetica, Sans-serif\">");
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_parms\" method=\"get\" target=\"bot\">");
