 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Proshop_dbltee\" target=\"bot\">");
         out.println("<td align=\"center\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<tr><td>");
      ...
      out.println("<table border=\"1\" bgcolor=\"#F5F5DC\">");
         if (copy == true) {
            out.println("<form action=\"/" +rev+ "/servlet/Proshop_adddbltee\" method=\"post\" target=\"bot\">");
            ...
            out.println("<tr><td>");
               ...
               out.println("<input type=\"hidden\" maxlength=\"30\" name=\"dbl_name\" value=\"" + name + "\"></input>");
 ...
 private void doCopy(int lottery, HttpServletRequest req, PrintWriter out, Connection con) {
   ...
   try {
      ...
      if (b == true) {
         ...
         out.println("<form action=\"/" +rev+ "/servlet/Proshop_dbltee\" method=\"post\" target=\"bot\">");
