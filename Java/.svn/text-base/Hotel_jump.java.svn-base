...
public class Hotel_jump extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Hotel_maintop\" marginwidth=\"3\" marginheight=\"0\" scrolling=\"no\">");
   out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Hotel_sheet?" + index + "=a&course=" + course + "&jump=" + jumps + "\" marginwidth=\"3\" marginheight=\"5\">");
