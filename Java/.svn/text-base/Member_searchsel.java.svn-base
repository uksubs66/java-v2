...
public class Member_searchsel extends HttpServlet {
  ...
  **/
    ...
    throws IOException
  {
    ...
    if (nameRow == null)
    {
      try
      {
        ...
        String removeUrl = "javascript:removeNameFromList('" + versionId + "servlet/Member_searchsel', '" + ActionHelper.REMOVE_FROM_LIST + "', '" + name_to_add + "')";
    ...
    throws IOException
  {
    ...
    {
      //select_stmt = select_stmt + " AND email NOT LIKE '' ORDER BY name_last, name_first, name_mi";
      select_stmt += " AND email <> '' AND inact = 0 ORDER BY name_last, name_first, name_mi";
    }
    ...
    throws IOException
  {
    ...
    if (user.startsWith( "proshop" )) {
       ...
       try
       {
         ...
         String searchMemShipTypesUrl = "javascript:execute('" + versionId + "servlet/Member_searchsel" + "', '" + ActionHelper.ADD_TO_LIST + "', '" + ActionHelper.SEARCH_BY_MEMTYPE_MEMSHIP_TYPE + "')";
    ...
    String searchUrl = versionId + "servlet/Member_searchsel";
