...
public class MemberHelper {
  ...
  public static final int NUM_MEMBER_SUB_TYPES = 11;        // for Hazeltine Natl & Interlachen & others - Custom
  public static final int NUM_LIMITED_ACCESS_TYPES = 39;    // used for limited access proshop users
...
*/
  ...
  public static void addLimitedAccessTypesToForm(FormModel form, ResultSet rs, PrintWriter out, boolean newUser) {
      ...
      try {
          ...
          */
          ...
          cb37.setId("WAITLIST_UPDATE");
          if (!newUser) { isSelected = rs.getBoolean("WAITLIST_UPDATE"); }
          Checkbox WAITLIST_UPDATE = new Checkbox("ltd37", "Wait List - Add/Change Wait List Signups", "WAITLIST_UPDATE", isSelected, isProshop);
          cb37.add(WAITLIST_UPDATE, "frm");
          form.addRow(cb37);

          RowModel cb38 = new RowModel();
          cb38.setId("WAITLIST_MANAGE");
          if (!newUser) { isSelected = rs.getBoolean("WAITLIST_MANAGE"); }
          Checkbox WAITLIST_MANAGE = new Checkbox("ltd38", "Wait List - Manage Wait List Signups", "WAITLIST_MANAGE", isSelected, isProshop);
          cb38.add(WAITLIST_MANAGE, "frm");
          form.addRow(cb38);

          RowModel cb39 = new RowModel();
          cb39.setId("WAITLIST_VIEW");
          if (!newUser) { isSelected = rs.getBoolean("WAITLIST_VIEW"); }
          Checkbox WAITLIST_VIEW = new Checkbox("ltd39", "Wait List - View Wait List Signups", "WAITLIST_VIEW", isSelected, isProshop);
          cb39.add(WAITLIST_VIEW, "frm");
          form.addRow(cb39);
  ...
  **/
  ...
  public static void addActivitySelectorToForm(FormModel form, String user, int activity_id, PrintWriter out, Connection con, boolean newUser, boolean newActivity) {
      ...
      String onChangeAction = "onChange=\"javascript:viewProshopUser('/" + rev + "/servlet/Admin_editproshopuser', '" + user + "', this.options[this.selectedIndex].value)\"";
  ...
  **/
  ...
  public static SelectionList queryMembersWithEmailAddresses(Connection con, String club, String theLetter, PrintWriter out, boolean isPro) throws SQLException
  {
