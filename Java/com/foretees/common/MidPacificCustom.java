...
public class MidPacificCustom {
    ...
    public static int wkendRest1_etime = 800;         // End time for first weekend restriction (all mships except class A, Sat/Sun only)
    public static int wkendRest2_norm_stime = 1030;    // Start time for second weekend restriction (mships without Family Time access, Sat/Sun only)
    public static int wkendRest2_norm_etime = 1230;    // End time for second weekend restriction (mships without Family Time access, Sat/Sun only)
    public static int wkendRest2_fam_stime = 1222;     // Start time for second weekend restriction (mships with Family Time access, Sat/Sun only)
    public static int wkendRest2_fam_etime = 1445;     // End time for second weekend restriction (mships with Family Time access, Sat/Sun only)
    ...
    public static int restricted_month_classJ = 1;          // # of allowed rounds per month during restricted times for class J
    public static int unrestricted_year_classH1 = 12;       // # of allowed 18 hole rounds per year during unrestricted times for class H1
    ...
    public static int unrestrictedTot_month_classJ = 6;     // # of allowed rounds per month during unrestricted times for class J (18-hole rounds count as 2, 9-hole rounds count as 1)
             ...
             if (!error) {
                 ...
                 if (memberClass.equalsIgnoreCase("B")) {
                     ...
                     if (checkMidPacificClassB(midPacParms[i], con, pastOnly)) {
                         ...
                         restricted = checkMidPacificTimes("B", slotParms.day, slotParms.time);
                     ...
                     if (checkMidPacificClassC(midPacParms[i], con, pastOnly)) {
                         ...
                         // Check if this tee time is during restricted or unrestricted times
                         restricted = checkMidPacificTimes("C", slotParms.day, slotParms.time);
                     ...
                     if ((slotParms.day.equals("Saturday") || slotParms.day.equals("Sunday")) && slotParms.time <= wkendGuestTime_classD && gcount > 0) {
                         error = true;
                         midPacParms[i].errorMsg = "<br><br><h3>Unauthorized Guests Found</h3><br>" +
                                 midPacParms[i].player + " is only allowed to bring guests after 2:45pm on weekends." +
                                 "<br><br>Please remove any guests associated with this member or return to the tee sheet.";
                     }
                     ...
                     if (checkMidPacificClassH1(midPacParms[i], con, pastOnly)) {
                         ...
                         // Check if this tee time is during restricted or unrestricted times
                         restricted = checkMidPacificTimes("H1", slotParms.day, slotParms.time);
                         ...
                         if (!error) {
                             ...
                             if ((midPacParms[i].non_year + gcount + 1) > unrestricted_year_classH1) {

                                 // Member has gone over their round quota for this year
                                 error = true;
                                 midPacParms[i].errorMsg = "<br><br><h3>Round Limit Exceeded</h3><br>" +
                                         midPacParms[i].player + " is only allowed to play " + unrestricted_year_classH1 + " 18-hole round(s) per year.  This tee time would exceed that limit, and they must contact the golf shop to purchase additional rounds." +
                                         "<br><br>Please remove this player or return to the tee sheet.";
                             }
                         }
                     }
                     ...
                     if (checkMidPacificClassH2(midPacParms[i], con, pastOnly)) {
                         ...
                         // Check if this tee time is during restricted or unrestricted times
                         restricted = checkMidPacificTimes("H2", slotParms.day, slotParms.time);
                     ...
                     if (checkMidPacificClassH3(midPacParms[i], con, includeTotalRounds, pastOnly)) {
                         ...
                         // Check if this tee time is during restricted or unrestricted times
                         restricted = checkMidPacificTimes("H3", slotParms.day, slotParms.time);
                     ...
                     if (checkMidPacificClassJ(midPacParms[i], con, pastOnly)) {
                         ...
                         // Check if this tee time is during restricted or unrestricted times
                         restricted = checkMidPacificTimes("J", slotParms.day, slotParms.time);
                         ...
                         if (!error) {
                             ...
                             if (!restricted) {
                                 ...
                                 // If restricted and member has already used their restricted tee time, see if they're set up to play as Prop. guest in the current round
                                 if (restricted && midPacParms[i].res_month >= restricted_month_classJ) {
                                 ...
                                 } else if (!isPropGuest && restricted && midPacParms[i].res_month < restricted_month_classJ) {
 ...
 public static String checkMidPacificMemberClass(String user, String mship_in, Connection con) {
     ...
     if (mship.equalsIgnoreCase("Proprietary") || mship.equalsIgnoreCase("Proprietary-Certificate") || mship.equalsIgnoreCase("Proprietary Life") ||
         ...
         memberClass = "H3";
     } else if (mship.equalsIgnoreCase("Social Golf")) {
         memberClass = "J";
     }
 ...
 */
public static boolean checkMidPacificTimes(String memberClass, String day_name, int tee_time) {

    boolean restricted = false;

    if (memberClass.equalsIgnoreCase("B") || memberClass.equalsIgnoreCase("C") || memberClass.equalsIgnoreCase("H1") ||
        memberClass.equalsIgnoreCase("H2") || memberClass.equalsIgnoreCase("H3") || memberClass.equalsIgnoreCase("J")) {
         ...
         if (((day_name.equalsIgnoreCase("Wednesday") || day_name.equalsIgnoreCase("Thursday") || day_name.equalsIgnoreCase("Friday")) &&
                 ...
                 ((day_name.equalsIgnoreCase("Saturday") || day_name.equalsIgnoreCase("Sunday")) &&
 ...
 public static int checkMidPacificRounds(String user, String mship, int teecurr_id, int time_mode, boolean p9, boolean restricted, boolean checkPropGuests, boolean countGuests, boolean pastOnly, String memberClass, Connection con) {
     ...
     } else {       // If member class H2 or J, may need to search for ONLY 18 hole rounds, for others, not important

         if (p9 || (memberClass.equals("H2") || memberClass.equals("J"))) {
             if (p9) {
                 p9Check = 1;
             } else {
                 p9Check = 0;
     ...
     //   -If time_mode is 0, search current year
     ...
     if (time_mode == 0) {
         ...
         // Populate timeframe check for use in query later
         timeframeCheck = "AND mm = ? AND yy = '" + year + "' ";
     ...
     if (!skip) {
         try {
             ...
             if (!pastOnly) {
                 ...
                 pstmt.setInt(6, timeframe);

                 if (!memberClass.equals("A")) {

                     pstmt.setInt(7, wkdayRest_stime);
                     pstmt.setInt(8, wkdayRest_etime);
                     pstmt.setInt(9, wkendRest1_stime);
                     pstmt.setInt(10, wkendRest1_etime);

                     // Use family time restriction values for class D only
                     if (memberClass.equals("D")) {
                         pstmt.setInt(11, wkendRest2_fam_stime);
                         pstmt.setInt(12, wkendRest2_fam_etime);
                     } else {
                         pstmt.setInt(11, wkendRest2_norm_stime);
                         pstmt.setInt(12, wkendRest2_norm_etime);
                     }
                 }
                 ...
                 if (teecurr_id >= 0) {
                     ...
                     if (memberClass.equals("A")) {
                         pstmt.setInt(7, teecurr_id);
                     } else {
                         pstmt.setInt(13, teecurr_id);
                     }
                 }
             ...
             skip = true;
             count = -1;
             Utilities.logError("Error Mid Pacific teecurr: " + exc.getMessage() + " - teecurr_id: " + teecurr_id);  /// ****** TEMP!!!!
         }
         ...
         try {
             ...
             pstmt.setInt(11, timeframe);

             if (!memberClass.equals("A")) {

                 pstmt.setInt(12, wkdayRest_stime);
                 pstmt.setInt(13, wkdayRest_etime);
                 pstmt.setInt(14, wkendRest1_stime);
                 pstmt.setInt(15, wkendRest1_etime);

                 // Use family time restriction values for class D only
                 if (memberClass.equals("D")) {
                     pstmt.setInt(16, wkendRest2_fam_stime);
                     pstmt.setInt(17, wkendRest2_fam_etime);
                 } else {
                     pstmt.setInt(16, wkendRest2_norm_stime);
                     pstmt.setInt(17, wkendRest2_norm_etime);
                 }
             }
             ...
             skip = true;
             count = -1;
             Utilities.logError("Error Mid Pacific teepast: " + exc.getMessage());    /// ****** TEMP!!!!
         }
     }
  ...
  * -Twelve (12) 18-hole rounds per year during unrestricted times
  * -May only have guests during unrestricted times (up to 3)
  ...
  *
  * @return - error - True if member is restricted from booking this tee time, False if no problems are found.
  *         - non_year - # of unrestricted rounds (player + guest) this year
  */
 public static boolean checkMidPacificClassH1(parmMidPacific midPacParms, Connection con, boolean pastOnly) {
     ...
     if (count >= 0) {
         midPacParms.non_year = count;
     } else {
         error = true;
         midPacParms.non_year = -1;
     }
