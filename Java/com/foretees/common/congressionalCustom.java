...
public class congressionalCustom {
 ...
 public static boolean check2Somes(long date, int time) {
   ...
   //
   //   2-some ONLY times from 8:00 AM to 10:48 AM on Tuesdays on the Club Course
   //                                                                          
   // if (shortDate != 918 && shortDate != 925) {            
   if (date != 20100622 && date != 20100727 && date != 20101012) {   // exceptions for 2010 (case 1060)
     
      if (time > 759 && time < 1049) {         // if tee time is between 8:00 and 10:48 AM
