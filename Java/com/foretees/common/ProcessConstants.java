...
public class ProcessConstants {
  ...
  //
  //  Holiday Dates to be changed annually
  //
  public static long memDay = 20100531;         // Memorial Day   ********** Change these each Year *************
    
  public static long gFriDay = 20100402;         // Good Friday
    
  public static long july4 = 20100705;          // 4th of July - Monday or Friday (only when 7/04 is on or near Monday or Friday)
  public static long july4b = 20100704;         // 4th of July - Actual

  public static long laborDay = 20100906;       // Labor Day

  public static long colDay = 20101012;         // Columbus Day (always 10/12)
  public static long colDayObsrvd = 20101011;   // Columbus Day Observed

  public static long tgDay = 20101125;          // Thanksgiving Day

  //
  //  Hazeltine dates
  //
  public static long Hdate4 = 20101001;   // October 1st
  public static long Hdate5 = 20100610;   // Junior Fridays Start (start on Thurs.)
  public static long Hdate6 = 20101002;   // Junior Fridays End  (end on Sat.)
  ...
  //  codebase
  //
  public static String CODEBASE = "/v5/";   // NOTE:  see also SystemUtils & com/foretees/event/add_event.jsp
  public static String REV = "v5";
  ...
  public static String HOST = "10.0.0.25";                          // smtp server
  ...
  public static String EFROM = "auto-send@foretees.com";              // fake return address for notification emails
  public static String EFROMPROA = "YourClub@foretees.com";           // fake return address for emails from pro
  public static String EFROMPRO = "YourGolfShop@foretees.com";        // fake return address for emails from pro
  public static String EFROMMEM = "aMemberOfYourClub@foretees.com";   // fake return address for emails from members
  public static String EFROMFB = "YourFoodAndBevDept@foretees.com";   // fake return address for emails from food & bev proshop user (proshopfb only)
  ...
  public static String TRAILERAOL = "\n\n\n****************************************************************************************" +
  ...
  public static String TRAILERAOL2 = "\n\n****************************************************************************************" +
                   "\nNOTICE AOL USERS: Please DO NOT report this email as SPAM.  If you do not wish to receive " +
  ...
  public static String TRAILERMEM = "\n\n\n****************************************************************************************" +
  ...
  public static String TRAILERFB = "\n\n\n****************************************************************************************" +
