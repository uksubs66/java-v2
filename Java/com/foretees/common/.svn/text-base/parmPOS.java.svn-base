...
public class parmPOS {
   ...
   // these two object contain the charge codes and the qty of each for Club Prophet Systems POS
   public ArrayOfString codeA = new ArrayOfString();
   public ArrayOfInt qtyA = new ArrayOfInt();
