 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (req.getParameter("switch") != null) {           // if call is from Proshop_activity_slot
        ...
        //if (activity_id == 0) {
            ...
            out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_announce\" marginheight=\"1\">");
    ...
    if (!jumps.equalsIgnoreCase( "select" )) {
        ...
        out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
        out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
        // out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_sheet?index=" + num + "&course=" + course + "&jump=" + jumps + "&showlott=" + showlott + "\" marginheight=\"1\">");
        out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_sheet?index=" + num + "&course=" + course + "&showlott=" + showlott + "#jump" + jump + "\" marginheight=\"1\">");
        out.println("</frameset>");
...
*/
        ...
        out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
        out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
        // out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_sheet?index=" + ind + "&course=" + course + "&jump=" + jumps + "&showlott=" + showlott + "\" marginheight=\"1\">");
        out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_sheet?index=" + ind + "&course=" + course + "&showlott=" + showlott + "\" marginheight=\"1\">");
        out.println("</frameset>");
 ...
 private void oldsheets(HttpServletRequest req, PrintWriter out) {
    ...
    out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
    out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
    out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_oldsheets" + tmp + "\"\" marginheight=\"1\">");
    out.println("</frameset>");
 ...
 private void lesson(HttpServletRequest req, PrintWriter out) {
   ...
   out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
   out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
   out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_lesson?proid=" +proid+ "&calDate=" +calDate+ "&jump=" +jump+ "\" marginheight=\"1\">");
   out.println("</frameset>");
 ...
 private void lottery(HttpServletRequest req, PrintWriter out) {
   ...
   out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
   out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
   out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_mlottery?jump=yes&course=" + course + "&" + index2 + "=" + index2 + "\" marginheight=\"1\">");
   out.println("</frameset>");
 ...
 private void event(HttpServletRequest req, PrintWriter out) {
   ...
   out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
   out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
   out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_events2?name=" + name + "&course=" + course + "\" marginheight=\"1\">");
   out.println("</frameset>");
 ...
 private void searchmem(HttpServletRequest req, PrintWriter out) {
   ...
   out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
   out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
   out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_searchmem\" marginheight=\"1\">");
   out.println("</frameset>");
 ...
 private void newNotify(HttpServletRequest req, PrintWriter out) {
    ...
    out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
    out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
    out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_notify?course=" + course + "&mm=" + mm + ((!dd.equals("")) ? "&dd=" + dd : "") + "&yy=" + yy + "\" marginheight=\"1\">");
    out.println("</frameset>");
 ...
 private void waitList(HttpServletRequest req, PrintWriter out) {
    ...
    out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
    out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
    out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_waitlist?waitListId=" + waitListId + "&date=" + date + "&day=" + day + "&index=" + index + "&returnCourse=" + returnCourse + "\" marginheight=\"1\">");
    out.println("</frameset>");
...
*/
    ...
    out.println("<frameset rows=\"82,*\" frameborder=\"7\" framespacing=\"0\" border=\"0\">");
    out.println("<frame name=\"top\" src=\"/" +rev+ "/servlet/Proshop_maintop\" marginheight=\"1\" scrolling=\"no\">");
    out.println("<frame name=\"bot\" src=\"/" +rev+ "/servlet/Proshop_gensheets?date=" + date + "&layout_mode=" + layout + "&sheet_id=" + sheet_id + "&activity_id=" + activity_id + "&last_tab=" + last_tab + "\" marginheight=\"1\">"); // &group_id=" + group_id + "
    out.println("</frameset>");
