...
public class Hotel_slot extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
      ...
      if (!memNotice.equals( "" )) {      // if message to display
         ...
         out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
            ...
            out.println("<table border=\"1\" cols=\"1\" bgcolor=\"#f5f5dc\" cellpadding=\"3\">");
               ...
               out.println("<font size=\"2\">");
               out.println("<form action=\"/" +rev+ "/servlet/Hotel_slot\" method=\"post\" name=\"can\">");
               ...
               out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
                  out.println("<form action=\"/" +rev+ "/servlet/Hotel_slot\" method=\"post\">");
                  out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
                  out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
                  out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
   ...
   out.println("var player1 = document.playerform.player1.value;");  // get values after erase
   out.println("var player2 = document.playerform.player2.value;");  //   and shift them all up
   out.println("var player3 = document.playerform.player3.value;");
   out.println("var player4 = document.playerform.player4.value;");
   out.println("var cw1 = document.playerform.p1cw.value;");
   out.println("var cw2 = document.playerform.p2cw.value;");
   out.println("var cw3 = document.playerform.p3cw.value;");
   out.println("var cw4 = document.playerform.p4cw.value;");
   if (p5.equals( "Yes" )) {
      out.println("var player5 = document.playerform.player5.value;");
      out.println("var cw5 = document.playerform.p5cw.value;");
   }

   out.println("if (player1 == '') {");                    // if player1 is empty
      out.println("if (player2 != '') {");                    // if player2 is not empty
         out.println("document.playerform.player1.value = player2;");
         out.println("document.playerform.p1cw.value = cw2;");
         out.println("document.playerform.player2.value = '';");
      out.println("} else {");

      out.println("if (player3 != '') {");                    // else if player3 is not empty
         out.println("document.playerform.player1.value = player3;");
         out.println("document.playerform.p1cw.value = cw3;");
         out.println("document.playerform.player3.value = '';");
      out.println("} else {");

      out.println("if (player4 != '') {");                    // else if player4 is not empty
         out.println("document.playerform.player1.value = player4;");
         out.println("document.playerform.p1cw.value = cw4;");
         out.println("document.playerform.player4.value = '';");

   if (p5.equals( "Yes" )) {
      out.println("} else {");
      out.println("if (player5 != '') {");                    // else if player5 is not empty
         out.println("document.playerform.player1.value = player5;");
         out.println("document.playerform.p1cw.value = cw5;");
         out.println("document.playerform.player5.value = '';");
      out.println("}");
   }
      out.println("}");
      out.println("}");
   ...
   out.println("player2 = document.playerform.player2.value;");    // get the new values
   out.println("player3 = document.playerform.player3.value;");
   out.println("player4 = document.playerform.player4.value;");
   out.println("cw2 = document.playerform.p2cw.value;");
   out.println("cw3 = document.playerform.p3cw.value;");
   out.println("cw4 = document.playerform.p4cw.value;");
   if (p5.equals( "Yes" )) {
      out.println("player5 = document.playerform.player5.value;");
      out.println("cw5 = document.playerform.p5cw.value;");
   }

   out.println("if (player2 == '') {");                    // if player2 is empty
      out.println("if (player3 != '') {");                    // if player3 is not empty
         out.println("document.playerform.player2.value = player3;");
         out.println("document.playerform.p2cw.value = cw3;");
         out.println("document.playerform.player3.value = '';");
      out.println("} else {");

      out.println("if (player4 != '') {");                    // else if player4 is not empty
         out.println("document.playerform.player2.value = player4;");
         out.println("document.playerform.p2cw.value = cw4;");
         out.println("document.playerform.player4.value = '';");

   if (p5.equals( "Yes" )) {
      out.println("} else {");
      out.println("if (player5 != '') {");                    // else if player5 is not empty
         out.println("document.playerform.player2.value = player5;");
         out.println("document.playerform.p2cw.value = cw5;");
         out.println("document.playerform.player5.value = '';");
      out.println("}");
   }
      out.println("}");
   ...
   out.println("player3 = document.playerform.player3.value;");    // get the new values
   out.println("player4 = document.playerform.player4.value;");
   out.println("cw3 = document.playerform.p3cw.value;");
   out.println("cw4 = document.playerform.p4cw.value;");
   if (p5.equals( "Yes" )) {
   ...
   out.println("if (player3 == '') {");                    // if player3 is empty
      out.println("if (player4 != '') {");                    // if player4 is not empty
         out.println("document.playerform.player3.value = player4;");
         out.println("document.playerform.p3cw.value = cw4;");
         out.println("document.playerform.player4.value = '';");
   ...
   if (p5.equals( "Yes" )) {
      ...
      out.println("if (player4 == '') {");                    // if player4 is empty
         out.println("if (player5 != '') {");                    // if player5 is not empty
            out.println("document.playerform.player4.value = player5;");
            out.println("document.playerform.p4cw.value = cw5;");
            out.println("document.playerform.player5.value = '';");
         out.println("}");
      out.println("}");
   }
   ...
   out.println("<tr><td align=\"center\"><br>");
      ...
      out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" align=\"center\">"); // table to contain 2 tables below
         ...
         out.println("<form action=\"/" +rev+ "/servlet/Hotel_slot\" method=\"post\" name=\"playerform\" id=\"playerform\">");
                     ...
                     if ((rcourse.equals( "-ALL-" )) || (rcourse.equals( course ))) {
                        ...
                        if ((grest_recurr.equalsIgnoreCase( "every " + day_name )) ||
                           ...
                           if ((rest_fb.equals( "Both" )) || (rest_fb.equals( sfb ))) {
                              ...
                              if (!verifySlot.checkRestSuspend(-99, rs2.getInt("id"), (int)date, time, day_name, course, con)) {        // check if this guest restriction is suspended for this time)
                     ...
                     if (xCount != 0) {
                        ...
                        for (i = 0; i < hguest.size(); i++) {
                           ...
                           if (!hguest.get(i).equals( "" )) {
                              ...
                              out.println("<option value=\"" + hguest.get(i) + "\">" + hguest.get(i) + "</option>");
                           }
                        }
                     }
                     out.println("</select>");
   ...
   try {
      ...
      PreparedStatement pstmt = con.prepareStatement (
         "SELECT " +
            ...
            "show1, show2, show3, show4, player5, username5, p5cw, show5, hotelNew, hotelMod, orig_by, notes, teecurr_id " +
         "FROM teecurr2 " +
               ...
               if ((rcourse.equals( "-ALL-" )) || (rcourse.equals( course ))) {
                  ...
                  if ((grest_recurr.equalsIgnoreCase( "every " + day )) ||
                     ...
                     if ((rest_fb.equals( "Both" )) || (rest_fb.equals( sfb ))) {
                        ...
                        if (!verifySlot.checkRestSuspend(-99, rs2.getInt("id"), (int)date, time, day, course, con)) {        // check if this guest restriction is suspended for this time)
...
*/
   ...
   try {
      ...
      pstmt6.setLong(42, date);
      pstmt6.setInt(43, time);
      pstmt6.setInt(44, fb);
      pstmt6.setString(45, course);
   ...
   if (req.getParameter("remove") != null) {
      ...
      out.println("<font size=\"2\">");
      out.println("<form method=\"post\" action=\"/" +rev+ "/servlet/Hotel_slot\">");
      out.println("<input type=\"hidden\" name=\"sdate\" value=\"" + date + "\">");
      out.println("<input type=\"hidden\" name=\"stime\" value=\"" + time + "\">");
      out.println("<input type=\"hidden\" name=\"day\" value=\"" + day + "\">");
      out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
   ...
   if (index.equals( "888" )) {         // if came from Hotel_search (doPost)
      ...
      if (index.equals( "999" )) {         // if came from Hotel_search (doGet)
         ...
         out.println("<font size=\"2\">");
         out.println("<form action=\"/" +rev+ "/servlet/Hotel_jump\" method=\"post\" target=\"_top\">");
         out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; \">");
         out.println("<input type=\"hidden\" name=\"index\" value=" + index + ">");
         out.println("<input type=\"hidden\" name=\"course\" value=\"" + course + "\">");
         out.println("<input type=\"hidden\" name=\"jump\" value=\"" + jump + "\">");
 ...
 private void cancel(HttpServletRequest req, PrintWriter out, Connection con) {
   ...
   if (index.equals( "999" )) {       // if from Hotel_search (doGet)
      ...
      if (index.equals( "888" )) {       // if from Hotel_search (doPost)
         ...
         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=/" +rev+ "/servlet/Hotel_jump?index=" + index + "&course=" + course + "\">");
         out.println("</HEAD>");
         out.println("<BODY bgcolor=\"#ccccaa\"><CENTER><img src=\"/" +rev+ "/images/foretees.gif\"><BR>");
         out.println("<hr width=\"40%\">");
         out.println("<BR><BR><H3>Return/Cancel Requested</H3>");
