...
public class Proshop_addmNumrest extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<table border=\"1\" cols=\"1\" bgcolor=\"#F5F5DC\">");
      out.println("<form action=\"/" +rev+ "/servlet/Proshop_addmNumrest\" method=\"post\" target=\"bot\" name=\"f\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<BR><BR>");
   out.println("<font size=\"2\">");
   out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Proshop_addmNumrest\">");
   out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
   out.println("</input></form></font>");
   out.println("</CENTER></BODY></HTML>");
