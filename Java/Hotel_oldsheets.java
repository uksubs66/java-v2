...
public class Hotel_oldsheets extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      out.println("<BR><BR>If problem persists, contact customer support.");
      out.println("<BR><BR><a href=\"/" +rev+ "/servlet/Hotel_select\">Return</a>");
      out.println("</CENTER></BODY></HTML>");
      return;
   ...
   out.println("</font></td></tr></table><br>");
      ...
      out.println("<form action=\"/" +rev+ "/servlet/Hotel_oldsheets\" target=\"bot\" method=\"post\" name=\"frmLoadDay\">");
         ...
         out.println("<font size=\"2\">");
         out.println("<p align=\"center\">");
         out.println("<form method=\"get\" action=\"/" +rev+ "/servlet/Hotel_select\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      out.println("<td align=\"center\">");
      out.println("<form action=\"/" +rev+ "/servlet/Hotel_oldsheets\" method=\"get\" target=\"bot\">");
