      ...
      while (rs.next()) {
         ...
         if (!player1.equals("")) {
            ...
            pstmt2 = con.prepareStatement (
               ...
               "p91 = ?, p92 = ?, p93 = ?, p94 = ?, p95 = ? " +
               "WHERE date > 20090525 AND date < 20090916 AND date != 20090606 AND date != 20090620 AND date != 20090725 AND " +
               "date != 20090829 AND day = 'Saturday' AND time = ? AND fb = ? AND courseName = ?");
            ...
            pstmt2.setInt(32, time);
            pstmt2.setInt(33, fb);
            pstmt2.setString(34, course);
      ...
      while (rs.next()) {
         ...
         if (!player1.equals("")) {
            ...
            pstmt2 = con.prepareStatement (
               ...
               "userg1 = ?, userg2 = ?, userg3 = ?, userg4 = ?, userg5 = ?, orig_by = ?, " +
               "p91 = ?, p92 = ?, p93 = ?, p94 = ?, p95 = ? " +
               "WHERE date > 20090526 AND date < 20090916 AND date != 20090607 AND date != 20090726 AND " +  
               "date != 20090830 AND day = 'Sunday' AND time = ? AND fb = ? AND courseName = ?");
