...
*/
        ...
        if (req.getParameter("viewRoster") != null) {
            ...
            String redirectURL = jonasAPI.getRequestURL(club, tmpUser, "http://spurwing.clubhouseonline-e3.com/passthrough.aspx", "/Roster.aspx");
        ...
        if (club.equals("democonnect") || club.equals("spurwingcc")) {  
            ...
            out.println("<a href=\"Member_directory?viewRoster\" target=\"jonasPopup\" class=\"standard_button\">View Member Directory</a>");

            out.println("<p><br></p>");

            out.println("<a href=\"Member_directory?viewStaff\" class=\"standard_button\">View Staff Directory</a>");

            if (req.getParameter("viewStaff") != null) {

                out.println("Staff List...");

            }
          
        } else {

            out.println("<div class=\"main_instructions\" style=\"text-align:center\"><p>Staff Directory - Coming Soon!</p></div>");
...
/*        
        if (dirType.equalsIgnoreCase("member")) {     // if Member Dir requested
            ...
            } else if (club.equals("spurwingcc")) {
                
                out.println("<div class=\"main_instructions\" style=\"text-align:center\"><p>Member Directory - Coming Soon!</p></div>");
            }
