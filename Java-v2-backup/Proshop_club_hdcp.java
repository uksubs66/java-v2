  ...
  //out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1252\">");
    ...
    if (count == 0) {
        ...
        try {
            ...
            while (rs.next()) {
                String temp123 = rs.getString("tee_name");
                if (!temp123.equalsIgnoreCase("Blue-Men")) {        
                out.println("<option value=" + rs.getInt("tee_id") + (tee_id == rs.getInt("tee_id") ? " selected" : "") + ">" + temp123 + "</option>"); // + " (" + rs.getString("assoc_name") 
                }
            }
