            ...
            out.println("<tr><td align=\"left\">");
               ...
               if (courseCount > 0 && courseL.equals( "-ALL-" )) {     // if multiple courses supported for this club and lottery
                  ...
                  for (i=0; i < courseA.size(); i++) {
                     ...
                     if (club.equals("rioverdecc") && courseName.equals("Road Runner Executive")) {
                         continue;
                     }
   ...
   out.println("<tr><td align=\"center\">");
      ...
      out.println("<table border=\"0\" align=\"center\" valign=\"top\" cellpadding=\"5\" cellspacing=\"5\">"); // table to contain 4 tables below
         ...
         if (hybrid_slot) {
             ...
             out.print("<td valign=\"top\"><div class=\"hybridSlotMemberSelect slotMemberSelect\"></div><div class=\"hybridSlotMemberOther\">");
             ...
             //
             alphaTable.guestList(club, course, day_name, time, parm, (allowx > 0), false, 0, enableAdvAssist, out, con);
             out.print("</div></td>");
     ...
     if (club.equals("trooncc")) {
         ...
         if (shortDate >= 1101 || shortDate <= 430) {
             ...
             if (verifyCustom.checkMshipRoundsByMnum(slotParms, mship_list, null, "month", 0, 0, round_limit, false, true, true, con)) {
                 ...
                 out.println("<BODY><CENTER><img src=\"/" + rev + "/images/foretees.gif\"><BR>");
                 out.println("<hr width=\"40%\">");
                 out.println("<BR><BR><H3>Quota Exceeded for Membership</H3><BR>");
                 out.println("<BR>Sorry, but <span style=\"font-weight:bold;\">" + slotParms.player + "</span>, or another member with the same member number, has already scheduled or played " + round_limit + " rounds this month. "
