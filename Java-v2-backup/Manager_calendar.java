/******************************************************************************************
 *   Manager_calendar:  This servlet will display club calendar for the manager portal
 * 
 *
 *
 *
...
public class Manager_calendar extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Common_skin.outputBreadCrumb(ua.club, activity_id, out, "Club Calendar", req);
        ...
        dashboard_select.append("<div class=\"mp_dashboard_selection mp_select_by_month fta_has_date_arrows rwdCourseDate\">");
        ...
        dashboard.append(Common_skin.getElementContainer("ftd_largeCal ftd_report"));
