 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (!new_skin) {
        ...
        */
        ...
        if (todo.equals("view")) getViewScores(user, club, new_skin, req, con, out);
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (!new_skin) {
        ...
        if (todo.equals("peer")) {
            ...
            String breadcrumb_title = "Handicaps Peer Review";
            
            if (club.equals("governorsclub")) {
                breadcrumb_title = "Rounds Played vs. Scores Posted";
            }
            
            Common_skin.outputBreadCrumb(club, sess_activity_id, out, breadcrumb_title, req);
        }
        else {
            Common_skin.outputBreadCrumb(club, sess_activity_id, out, "Handicaps", req);
        }
...
*/
 ...
 private void getScoreToPost(HttpServletRequest req, String club, boolean new_skin, int sess_activity_id, Connection con, PrintWriter out) {
    ...
    if (!new_skin) {
        ...
        out.println("      <td><label><input type=text class=\"ft_date_picker"+(rwd?"_field":"")+"\" data-ftstartdate=\""+start_date+"\" data-ftenddate=\""+end_date+"\" value=\"\" name=\"date_select\" size=10 /></label></td>"); 
        out.println("    </tr>");
 ...
 private void getViewScores(String user, String club, boolean new_skin, HttpServletRequest req, Connection con, PrintWriter out) {
...
*/
    ...
    out.println("  <p class=\"handicaps_ctr\"><b>Get Your Current Handicap Data:</b></p>");
    ...
    if(rwd){
        out.println("      <label class=\"standard_label\"><input type=checkbox name=inc20 id=inc20 value=\"yes\" /><span>Include last 20 postings</span></label>");
    }else{
        out.println("      <input type=checkbox name=inc20 id=inc20 value=\"yes\" /><label for=inc20> Include last 20 postings</label>");
        out.println("  <br /><br />");
    }
    out.println("      <input class=\"standard_button\" type=submit value=\" Retrieve \" onclick=\"submitForm(1)\" name=btnSubmit />");
    out.println("    </form></p>");
    ...
    if (hdcp_memview == 1 || Common_Server.SERVER_ID == 4) {
        ...
        out.println("  <p class=\"handicaps_ctr\"><hr class=\"handicaps2\" /></p>");
        if(!rwd){
            out.println("  <br />");
        }
        out.println("  <p class=\"handicaps_ctr\"><b>Get Current Handicap Data For Other Members:</b></p>");

        out.println("  <p class=\"handicaps_ctr\">");
        if(rwd){
            out.println("      <label class=\"standard_label\"><input type=checkbox name=inc20 id=inc20 value=\"yes\" /><span>Include last 20 postings</span></label>");
            out.println("      <a href=\"#\" class=\"ftFindMemberHdcp standard_button\" data-fthdcpdata=\"view\">Select Member</a>");
        } else {
   ...
   if(!rwd){
    ...
    out.println("  <hr class=\"handicaps2\" />");
    ...
    if (peer_review == 1 || Common_Server.SERVER_ID == 4) {
        ...
        String button_text = "Peer Review Reports";
        
        if (club.equals("governorsclub")) {
            button_text = "Rounds Played vs. Scores Posted Reports";
        }
        
        if(!rwd){
            out.println("  <br />");
        }
        out.println("  <p class=\"handicaps_ctr\"><b>View 'Rounds Played vs Scores Posted' Report<br />For You or Other Members:</b></p>");

        out.println("  <p class=\"handicaps_ctr\">");
        if(rwd){
            out.println("      <a href=\"#\" class=\"ftFindMemberHdcp standard_button\" data-fthdcpdata=\"peer\">Peer Review Reports</a>");
        } else {
            ...
            out.println("      <input type=hidden name=letter value=\"A\" />");         // default member list to display.
            out.println("      <input class=\"standard_button\" type=submit value=\"" + button_text + "\" name=btnSubmit />");
            out.println("    </form>");
        }
        out.println("  </p>");
        ...
        out.println("  <p class=\"handicaps_ctr\"><b>View Your 'Rounds Played vs Scores Posted' Report</b></p>");
    ...
    */
            ...
            while (rs.next()) {
                ...
                if (!new_skin) {
                  ...
                  if (first) {
                      ...
                      if(rwd){
                          out.println("    <"+tags.caption+" class=\"rwdCaption\"><h2>Course Handicaps</h2></"+tags.caption+">");
                      ...
                      if (!course.equals("")) {
                          out.println("      <"+tags.th+" class=\"rwdTh hcaps_scores\">Course</"+tags.th+">");
                      }
                      out.println("      <"+tags.th+" class=\"rwdTh hcaps_scores\">Tees</"+tags.th+"><"+tags.th+" class=\"rwdTh hcaps_scores\">Handicap</"+tags.th+"></"+tags.tr+">");
                      out.println("    </"+tags.thead+"><"+tags.tbody+" class=\"rwdTbody\">");
                      first = false;
                  }

                  out.println("      <"+tags.tr+" class=\"rwdTr\">");
                  if (!course.equals("")) out.println("        <"+tags.td+" class=\"rwdTd hcaps_scores\">" + ((!lastCourse.equals(course)) ? course : "") + "</"+tags.td+">");
                  out.println("        <"+tags.td+" class=\"rwdTd hcaps_scores\">" + teeName + "</"+tags.td+">");
                  out.print("        <"+tags.td+" class=\"rwdTd hcaps_scores\">");
                  if (c_hdcp > 0) {
                      // positive value - scratch golfer! show plus sign
                      out.print("+" + (int)c_hdcp);
                  } else {
    ...
    if (inc20.equals("yes")) {
        ...
        if (!new_skin) {
            ...
            if(rwd){
                out.println("    <hr>");
                out.println("<h2>Recent Score Postings</h2>");
                ...
                out.println("    <thead>");
                out.println("<tr><th class=\"hcaps_scores\" colspan=3>Recent Score Postings</th></tr>");
            }
            
            out.print("<"+tags.tr+" class=\"rwdTr\"><"+tags.th+" class=\"rwdTh hcaps_scores\">Date</"+tags.th+"><"+tags.th+" class=\"rwdTh hcaps_scores\">Score</"+tags.th+"><"+tags.th+" class=\"rwdTh hcaps_scores\">Type</"+tags.th+">");
            out.print("</"+tags.tr+">");
            out.println("    </"+tags.thead+"><"+tags.tbody+" class=\"rwdTbody\">");
          ...
          if (results[i] != null) {
              ...
              if (!new_skin) {
                  ...
                  if (parts[2].indexOf("T") > 0) {
                      ...
                      out.print("<"+tags.td+" class=\"rwdTd hcaps_scores\">" + date_part[0] + "</"+tags.td+">");
                  } else {
                      out.print("<"+tags.td+" class=\"rwdTd hcaps_scores\">" + parts[2] + "</"+tags.td+">");
                  }
                  out.print("<"+tags.td+" class=\"rwdTd hcaps_scores\">" + ( (s == 0) ? parts[0] : s ) + "</"+tags.td+">");
                  out.println("<"+tags.td+" class=\"rwdTd hcaps_scores\">" + parts[1] + "</"+tags.td+"></"+tags.tr+">");
    ...
    if (!new_skin) {
       ...
       out.println("<p class=\"handicaps_ctr\"><center>");
       out.println("<form action=\"Member_handicaps\">");
       out.println("<input type=\"hidden\" name=\"todo\" value=\"view\" />");
       out.println("<input class=\"standard_button\" type=\"submit\" value=\"Go Back\" /></form>");
   ...
   if (req.getParameter("letter") != null) {     // if user clicked on a name letter
      ...
      if (!new_skin) {
         ...
         out.println("</td>");   // end of name list column
          ...
          out.println(" ");
          nameLists.displayNameList(letter, user, club, sess_activity_id, 3, con, out, false);
          out.println("      </div>");
   ...
   if (req.getParameter("letter") != null) {     // if user clicked on a name letter
      ...
      if (!new_skin) {
         ...
         out.println("<td align=\"center\">");
          ...
          out.println("      <div class=\"name_list\" id=\"name_list_content\">");
          out.println(" ");
          nameLists.displayNameList(letter, user, club, sess_activity_id, 0, con, out, false);
          out.println("      </div>");
          out.println("    </div>    <!-- res_mid -->"); 
 ...
 private void viewSavedScores2(HttpServletRequest req, String club, String user, boolean new_skin, Connection con, PrintWriter out) {
    ...
    out.println("  <h3 class=\"handicaps_ctr\"><i>For " + fullName + " (" + formatHdcpNum(hdcp_num, club.equals("mpccpb") ? 2 : 1) + ")</i></h3>");
    if(!rwd){
        out.println("  <br />");
    }
    out.println("  <div class=\"handicaps_peer_review\">");
    // Note -- since we're using colspans, and this is not a rw collapsible table,
    // We'll keep standard table tags, but use rwdTable css as well
    ...
    out.println("      <tr class=\"rwdTr\"><th class=\"rwdTh hcaps_peer\">Date</th>" +
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (!found) { // && i != 0) {
                ...
                if (!new_skin) {
                    ...
                    out.println("        <td class=\"rwdTd hcaps_peer hcaps_empty\" colspan=4>&nbsp;</td></tr>");
        ...
        for (i = 0; i < posting_dates.size(); i++) {
            ...
            if (post_date >= last_date && used == 0) {
                ...
                if (!didHeader) {
                    ...
                    if (!new_skin) {
                      ...
                      out.println("      <tr class=\"rwdTr hcaps_peer_hdr\">" +
                                  "<td class=\"rwdTd hcaps_peer_hdr_data\" colspan=\"" + ((multi == 0) ? "6" : "7") + "\">Unmatched Score Postings</td></tr>");
                ...
                if (!new_skin) {
                  ...
                  out.println("      <tr class=\"rwdTr\"><td class=\"rwdTd hcaps_peer hcaps_unmatch\" colspan=\"" + ((multi == 0) ? "2" : "3") + "\">&nbsp;</td>" +
                          "<td class=\"rwdTd hcaps_peer hcaps_unmatch\">" + post_sdate + "</td>");
                  out.println("        <td class=\"rwdTd hcaps_peer hcaps_unmatch\">" + score + "</td><td class=\"rwdTd hcaps_peer hcaps_unmatch\">" +
                          type + "</td><td class=\"rwdTd hcaps_peer hcaps_unmatch\">" + tees + "</td></tr>");
        ...
        if (!new_skin) {
            ...
            out.println("      <tr class=\"rwdTr\">" +
                    "<td class=\"rwdTd hcaps_peer hcaps_counts\" colspan=\"3\">9 hole: <b>" + rounds[0] + "</b> &nbsp; &nbsp; 18 hole: <b>" + rounds[1] + "</b></td>");
            out.println("        <td class=\"rwdTd hcaps_peer hcaps_counts\" colspan=\"" + ((multi == 0) ? "3" : "4") + "\">Posted: <b>" + rounds[2] + "</b></td>");
            out.println("      </tr>");
...
//     String index = req.getParameter("index");               // get return indicator
 ...
 private void outReturnBtn (PrintWriter out, String page) {
    ...
    out.println("<input class=\"standard_button\" type=submit value=\"Go Back\" /></form></center>");
    out.println("</p>");
