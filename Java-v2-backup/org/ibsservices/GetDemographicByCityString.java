 ...
 *         &lt;element name="a_sCity" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "GetDemographicByCityString")
public class GetDemographicByCityString {
    ...
    @XmlElement(name = "a_sCity")
    protected String asCity;
    ...
    /**
     * Gets the value of the asCity property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the asCity property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setASCity(String value) {
        this.asCity = value;
    }
