 ...
 *         &lt;element name="a_sInvMenuID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "GetInvItemsForInvMenuString")
public class GetInvItemsForInvMenuString {

    @XmlElement(name = "a_sUserID")
    protected String asUserID;
    @XmlElement(name = "a_sUserPass")
    protected String asUserPass;
    @XmlElement(name = "a_sInvMenuID")
    protected String asInvMenuID;
    ...
    /**
     * Gets the value of the asInvMenuID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getASInvMenuID() {
        return asInvMenuID;
    }

    /**
     * Sets the value of the asInvMenuID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setASInvMenuID(String value) {
        this.asInvMenuID = value;
    }
