 ...
 *         &lt;element name="a_ePlayerType" type="{http://ibsservices.org/}CodeDescriptionPair" minOccurs="0"/>
...
@XmlRootElement(name = "GetMemberByPlayerTypeString")
public class GetMemberByPlayerTypeString {
    ...
    @XmlElement(name = "a_ePlayerType")
    protected CodeDescriptionPair aePlayerType;
    ...
    /**
     * Gets the value of the aePlayerType property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CodeDescriptionPair getAEPlayerType() {
        return aePlayerType;
    }

    /**
     * Sets the value of the aePlayerType property.
     * 
     * @param value
     *     allowed object is
     *     {@link CodeDescriptionPair }
     *     
     */
    public void setAEPlayerType(CodeDescriptionPair value) {
        this.aePlayerType = value;
    }
