<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = '/usr/local/tomcat/webapps'; // absolute or relative from this script path, try to leave blank system figures it out.
	...
	// Upload options
	$mcImageManagerConfig['upload.maxsize'] = "512KB";
