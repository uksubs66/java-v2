<?php
	...
	$mcImageManagerConfig['general.plugins'] = "History,Favorites"; // comma seperated ForeTeesAuthenticator
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = "/mnt"; // /srv/webapps  ../../../../../../  // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/v5/"; // domain name
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../AEimages'; // default was 'files'; // absolute or relative from this script path, required.
	...
	// Upload options
	$mcImageManagerConfig['upload.maxsize'] = "1024KB";
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "ExternalAuthenticator"; // default was "SessionAuthenticator";
	...
	//$mcImageManagerConfig['ExternalAuthenticator.external_auth_url'] = "foretees_auth.jsp";
        $mcImageManagerConfig['ExternalAuthenticator.external_auth_url'] = "/v5/assets/jquery/tiny_mce/plugins/imagemanager/plugins/ExternalAuthenticator/foretees_auth.jsp";
	$mcImageManagerConfig['ExternalAuthenticator.secret_key'] = "f0reteesXViii";
