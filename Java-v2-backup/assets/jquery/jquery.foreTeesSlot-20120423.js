...
(function($){
    ...
    var methods = {
        ...
        initRecepientList: function(){
            ...
            parms.recipients = {};
            parms.addRecipientsObj = $('<div><ul><li><a href="#">'+options.addRecipients+'</a>'
                +'<ul>'
            ...
            obj.find("select.partner_list").each(function(){
                ...
                for(var key in slotParms.partner_list){ // Build the list
                    ...
                    if(!skip_name){
                        ...
                        var option = $('<option value="'+slotParms.partner_list[key]["display"]+'">'+name+'</option>');
