...
public class Support_problems extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<tr><td>");
      ...
      out.println("<table border=\"1\" bgcolor=\"#F5F5DC\">");
         ...
         out.println("<form action=\"Support_problems\" method=\"post\">");
         out.println("<tr><td>");
         out.println("<font size=\"2\">");
 ...
 public void listReports(String user, HttpServletRequest req, PrintWriter out, Connection con) {
   ...
   try {
      ...
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=id" + ((sort_type.startsWith("id")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Record Id</a></b></p></font></td>");
      if (list_type.equals( "myopen" ) || list_type.equals( "allopen" )) {
         out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=opendate" + ((sort_type.startsWith("opendate")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Date Opened</a></b></p></font></td>");
      } else {
         out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=closedate" + ((sort_type.startsWith("closedate")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Date Closed</a></b></p></font></td>");
      }
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=orig" + ((sort_type.startsWith("orig")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Opened By</a></b></p></font></td>");
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=assign" + ((sort_type.startsWith("assign")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Assigned To</a></b></p></font></td>");
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=club" + ((sort_type.startsWith("club")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Club</a></b></p></font></td>");
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=status" + ((sort_type.startsWith("status")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Status</a></b></p></font></td>");
      out.println("<td><font color=\"#FFFFFF\" size=\"3\"><p><b><a href=\"Support_problems?list=" + list_type + "&sort=pri" + ((sort_type.startsWith("pri")) ? sort_type_next : "") + "\" style=\"text-decoration: none; color: white\">Priority</a></b></p></font></td>");
      out.println("</td></tr>");
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"get\" action=\"Support_problems\">");
