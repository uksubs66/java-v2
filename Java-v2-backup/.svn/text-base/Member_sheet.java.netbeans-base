...
public class Member_sheet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
       ...
       // if (req.getParameter("event") != null) {
        ...
        String user_mNum = Utilities.getmNum(user, con);     // Member number of the current user
...
//        String[] eventA = new String[count_event];      // Event info
        ...
        int[] estimeA = new int[count_event];
        int[] eetimeA = new int[count_event];   
        boolean[] eskipA = new boolean[count_event]; 
        ...
        if (club.equals("sevillegcc") || club.equals("morganrun") || club.equals("cordillera") || club.equals("dovecanyonclub") || club_group_name.equalsIgnoreCase("AGC") || club.equals("tetonpines")) {   // add other clubs here!!
        ...
        */
        ...
        if (club.equals("merion")) {
            courseName1 = "East";    // Members can't changes courses, so make sure it's set to East
        }
   ...
   /*
        ...
        try {
            ...
            */
            ...
            if (club.equalsIgnoreCase("oakhillcc") && index >30) {
                parm.constimesm = 1;                //no consecutive tee times for advanced tee times
            }
      ...
      /*
            ...
            // Case #: 00001038
            //
            if (club.equals("longcove") && date >= 20150413 && date <= 20150419) {  // week of the Heritage Classic
...
//            }
            ...
            try {
                ...
                while (rs.next() && i < count_rest) {
                    ...
                    if (verifyCustom.checkRestLift((int)date, day_name, rest, club, 0, con) 
                        ...
                        if (!club.equals("interlachen") && !club.equals("spokane")) {
                            showRest = false;
                        }
                        
                        if (club.equals("spokane") && (parmr.mtype.equals("Adult Female") || parmr.mtype.equals("Male Spouse"))) {
                            showRest = false;
                        }
                    }
            ...
            try {
                ...
                pstmt2 = con.prepareStatement(
                        "SELECT name, color, stime, etime, act_hr, act_min, courseName, memedit, event_id, signup_on_teesheet, max, size, su_date, su_time, c_date, c_time "
                        + "FROM events2b "
                ...
                while (rs.next() && i < count_event) {
                    ...
                    estimeA[i] = rs.getInt("stime");
                    eetimeA[i] = rs.getInt("etime");
                    ...
                    eskipA[i] = false;    // Default to false, and override to true below, if applicable
                    
                    if (etsSignupA[i] == 0 && (club.equals("pattersonclub") || club.equals("demobrad"))) {
                        
                        PreparedStatement pstmt3 = null;
                        ResultSet rs3 = null;
                        
                        String courseCheck2 = " AND courseName = ?";
                        
                        if (ecourseA[i].equals("-ALL-")) {
                            courseCheck2 = "";
                        }
                        
                        try {
                            
                            pstmt3 = con.prepareStatement("SELECT count(*) AS round_count FROM teecurr2 WHERE date = ? AND time >= ? AND time <= ? "
                                    + "AND (player1 <> '' OR player2 <> '' OR player3 <> '' OR player4 <> '' OR player5 <> '')"
                                    + courseCheck2);
                            
                            pstmt3.clearParameters();
                            pstmt3.setLong(1, date);
                            pstmt3.setInt(2, estimeA[i]);
                            pstmt3.setInt(3, eetimeA[i]);
                            
                            if (!ecourseA[i].equals("-ALL-")) {
                                pstmt3.setString(4, ecourseA[i]);
                            }
                            
                            rs3 = pstmt3.executeQuery();
                            
                            if (rs3.next()) {
                                if (rs3.getInt("round_count") == 0) {
                                    eskipA[i] = true;
                                }
                            }
                            
                        } catch (Exception e) {
                            Utilities.logError("Member_sheet.doPost - " + club + " - Failed to determine event skip status - Error = " + e.toString());
                        } finally {
            ...
            StatCounters.sheetCountsMem[calCount.get(Calendar.HOUR_OF_DAY)]++;
          ...
          /*
            ...
            if (club.equals("sciotocc") && mtype.startsWith("Spouse")) {
            ...
            } else if (club.equals("overlakegcc")) {
                ...
                parm.advdays5 = 21;
                max = 21;
            } else if (club.equals("llnhga") && msubtype.equals("BCM")) {   //all BCM subtypes to book times 8 days out at 8am
                ...
                if (dateShort >= 501 && dateShort <1001) {   //May 1st to Sept 31st --7 days in advance beginning at 7:00am 
                    for (int k = 0; k<7; k++) {
                       advtimes[k] = 700; 
                    }
                
                } else {
                    for (int k = 0; k<7; k++) {   //Oct. 1st to April 30th --7 days in advance beginning at 9:00am
                       advtimes[k] = 900; 
                    }                    
                }
...
//                            if (thisDate <= 20150620 && (mtype.endsWith("Male") || mtype.equalsIgnoreCase("Cert Dependent over 16") || mtype.endsWith("Dependent"))) {    // Brooklawn Custom for 6/14/14 (case 1985)
//
//                                if ((thisDate > 20150521 || (thisDate == 20150521 && cal_time >= 900)) && i > 0) {
//
//                                    //  Allow member access to 6/20/15 on 5/21/15 for a tee time event
//                                    if (date == 20150620) {         // if day of event
//
//                                        daysArray.days[i] = 1;        // set ok in array
//
//                                        if (max < index) {
...
//                            }
                            ...
                            if (thisDate <= 20150624) {    // Brooklawn Custom for 6/24/15 (case 2151)

                                if (thisDate > 20150520 || (thisDate == 20150520 && cal_time >= 900) && i > 0) {

                                    if (date == 20150624) {         // if day of event
                            ...
                            if (thisDate <= 20150711) {    // Brooklawn Custom for 7/11/15 (case 2265)

                                if (thisDate > 20150601 || (thisDate == 20150601 && cal_time >= 900) && i > 0) {

                                    //  Allow member access to 7/12/14 on 5/25/14 for a tee time event
                                    if (date == 20150711) {         // if day of event
            ...
            *    // This seems to be allowing members to book times further in advance than they are configured (normally 7 days)
            */
            
            //
            //  If Tues and membertype Primary Female or Secondary Female set days in advance to 3 days
            //
            if (club.equalsIgnoreCase("woodranch") && (mtype.equals("Primary Female") || mtype.equals("Secondary Female"))) {
                if (day_num == 3) {
                    days = 2;    // set 3 days in advance for Tuesdays
                }    
            }
            ...
            if (club.equals("overlakegcc")) {
                ...
                if ((day_num == 5) && msubtype.equals("9 Holer") && (index < 7 || index == 7 && cal_time >= 600)) {
          ...
          /*
                ...
                if (restrictAll == true && !club.equals("congressional") && (!club.equals("coloradogc") || !day_name.equals("Monday"))) {
                    ...
                    if (club.equals("jonathanslanding")) {
                        ...
                        out.println("<div class=\"notice_element sub_instructions\">Please contact the Golf Shop for tee times on this day. (480) 473-4415.</div>");
                    } else {
                ...
                if (index == 0 && club.equalsIgnoreCase("meadowbrookccmi")) {                       //custom 2631- display message on day of tee sheet only
                  out.println("<div class=\"mem_notices\"><h3>*** Important Notice ***</h3>");
                  out.println("<div class=\"mem_notice\" style=\"color:red\">Please contact the 1st Tee for tee times for play today (248) 349-3681 </div>");
                  out.println("</div>");
                }
            ...
            while (rs.next()) {
                ...
                if ((club.equals("engineerscc") || club.equals("mosscreek")) && !event.equals("")) {    // if event during this time
                    ...
                    if (cat_name.equals("")) {     // cat_name will be empty if it matches
                        ...
                        //skipconstimes = true;      // do not allow consecutive times
                    }
                }                
...
//                }
                ...
                if (hideNames == 0 && make_private != 1 && !orig_by.equalsIgnoreCase(user) && !hidden_mems.isEmpty() 
                        && ((!user1.equals("") && !user1.equalsIgnoreCase(user) && hidden_mems.containsKey(user1) && (!hidden_mems.get(user1).equalsIgnoreCase(user_mNum) || user_mNum.equals(""))) 
                         || (!user2.equals("") && !user2.equalsIgnoreCase(user) && hidden_mems.containsKey(user2) && (!hidden_mems.get(user2).equalsIgnoreCase(user_mNum) || user_mNum.equals("")))
                         || (!user3.equals("") && !user3.equalsIgnoreCase(user) && hidden_mems.containsKey(user3) && (!hidden_mems.get(user3).equalsIgnoreCase(user_mNum) || user_mNum.equals("")))
                         || (!user4.equals("") && !user4.equalsIgnoreCase(user) && hidden_mems.containsKey(user4) && (!hidden_mems.get(user4).equalsIgnoreCase(user_mNum) || user_mNum.equals("")))
                         || (!user5.equals("") && !user5.equalsIgnoreCase(user) && hidden_mems.containsKey(user5) && (!hidden_mems.get(user5).equalsIgnoreCase(user_mNum) || user_mNum.equals(""))))) {
                ...
                //
                if (club.equals("mesaverdecc") || club.equals("kiawahislandclub")) {
                ...
                if (blocker.equals("")) {     // check for lottery if tee time not blocked
                    ...
                    } else if (!event.equals("") && lottery.equals("")) {          // end of IF lottery
                        
                        int e_ind = eventA.indexOf(event);
                        
                        if (!openPlayShotgun && e_ind >= 0 && eskipA[e_ind] && tee_time != estimeA[e_ind] && tee_time != eetimeA[e_ind]) {
                            continue;
                        }
                    }
                }          // end of IF blocker
...
//                    Lower Course:  8am-10am every other Wednesday April 29 - July 22.  Every Wednesday July 29th - Aug. 19.  Additional Wednesdays are Sept. 2, 30, and Oct. 14.
                    ...
                    if ((day_name.equals("Tuesday") 
                            && ((tee_time >= 730 && tee_time <= 1000 
                                && ((week_of_year % 2 == 1 && courseNameT.equals("Lower") && date >= 20150421 && date <= 20151006) 
                                 || (week_of_year % 2 == 0 && courseNameT.equals("Upper") && date >= 20150428 && date <= 20150929))) 
                            || (tee_time >= 800 && tee_time <= 900 
                                && ((week_of_year % 2 == 0 && courseNameT.equals("Lower") && date >= 20150428 && date <= 20150929) 
                                 || (week_of_year % 2 == 1 && courseNameT.equals("Upper") && date >= 20150421 && date <= 20151006)))))
                     || (day_name.equals("Thursday") && courseNameT.equals("Upper") && (date == 20150528 || date == 20151015) && tee_time >= 730 && tee_time <= 1000)) {
                    ...
                    } else if (day_name.equals("Wednesday") && tee_time >= 800 && tee_time <= 1000  
                            && ((courseNameT.equals("Upper") && ((date >= 20150422 && date <= 20150715 && week_of_year % 2 == 1) 
                              || date == 20150909 || date == 20150916 || date == 20150923 || date == 20151007)) 
                             || (courseNameT.equals("Lower") && ((date >= 20150429 && date <= 20150722 && week_of_year % 2 == 0) || (date >= 20150729 && date <= 20150819) 
...
//                        }
                    ...
                    if (club.equals("kiawahislandclub") && custom_int > 4) {
                        allow = false;
                    }
                    
                    if (club.equals("semiahmoo")) {
                        
                        if (verifyCustom.isSemiahmooPublicCourse(courseNameT, date) && (index2 > 3 || (index == 3 && cal_time < 700))) {
                            allow = false;
                        }
                    }
...
//                                }
                            ...
                            //
                            //  Custom for simple Open Play Shotgun
                            //
                            if (openPlayShotgun) {
...
//                            if ((thisDate > 20150521 || thisDate == 20150521 && cal_time >= 900) && date == 20150620 && tee_time >= 839 && tee_time <= 1400
//                                    && (mtype.endsWith("Male") || mtype.equalsIgnoreCase("Cert Dependent over 16") || mtype.endsWith("Dependent"))) {
//
//                                allow = true;
//                            }

                            if ((thisDate > 20150521 || thisDate == 20150521 && cal_time >= 900) && date == 20150624 && tee_time >= 1130 && tee_time <= 1430) {

                                allow = true;
                            }

                            if ((thisDate > 20150601 || thisDate == 20150601 && cal_time >= 900) && date == 20150711 && tee_time >= 700 && tee_time <= 1300) {
             ...
             /*
                    ...
                    if (allow == true) {     // if still ok, check more
                        ...
                        */
                        ...
                        //
                        if (club.equals("brooklawn") && dateShort >= 427 && dateShort <= 1012) {
                        ...
                        //
                        //  allow primary females and secondary females to access tuesdays from 7:00-10:09 3 days in advance
                        //
                        if (club.equalsIgnoreCase("woodranch")) {
                            if (day_name.equals("Tuesday")) {
                                if (mtype.equals("Primary Female") || mtype.equals("Secondary Female")) {
                                    if (index2 > 2 && (tee_time < 700 || tee_time > 1009)) {
                        ...
                        if (club.equalsIgnoreCase("oahucc")) {
                            if ((day_name.equals("Tuesday") || day_name.equals("Friday")) && (index2 > 4 || (index2 == 4 && cal_time < 600))) {
                        ...
                        if (club.equals("rhillscc")) {
                            ...
                            if ((day_name.equals("Tuesday") || day_name.equals("Thursday"))) {
                                ...
                                if (dateShort >= 601 && dateShort <= 831) {      // In season

                                    if (msubtype.equals("Ladies")) {

                                        //
                                        //  Process according to the day of week
                                        //    "Ladies" can book times (7:00 to 9:06) for Tues & Thurs starting 14 days in advance
                                        //
                                        if (index2 > 7 && (tee_time < 700 || tee_time > 906)) {
                                        ...
                                        if (tee_time >= 700 && tee_time <= 906) {    // if Ladies time (Women's group)

                                            allow = false;      // do not allow non Ladies (custom restriction)
                                        }
                                    }

                                } else if ((dateShort >= 501 && dateShort <= 630) || (dateShort >= 901 && dateShort <= 930)) {
                        ...
                        if (club.equals("overlakegcc")) {
                            ...
                            if (msubtype.equals("9 Holer")) {
                                ...
                                // Ladies '9 Holer' subtypes can access Thursday times 9:00-9:15AM
                                if (day_name.equals("Thursday") && (tee_time < 900 || tee_time > 915)) {
                    ...
                    if (allow == true) {         // if still ok
                        ...
                        if (club.startsWith("demo") || club.equalsIgnoreCase("ancalacc") || club.equalsIgnoreCase("engineerscc")) {
                        ...
                        if (club.equals("kiawahislandclub") && custom_int > 0) {    // Do not allow members to access advance times, even their own!
                            allow = false;
                        }
                            ...
                            if (mobile == 0 || allowMulti == true) {   // only if NOT mobile OR custom to allow it on Mobile
                                ...
                                if (parm.constimesm > 1) {           // if consecutive times allowed and ok for this tee time
                                    ...
                                    if (allow == true && player1.equals("") && player2.equals("") && player3.equals("")
                                            && player4.equals("") && player5.equals("")
                                            && (event.equals("") || openPlayShotgun == true) && (lottery.equals("") || lstate > 4) && (fb == 0 || fb == 1) && skipconstimes == false) {
...
//                    }
                    ...
                    if(maxPlayers == 5 && !rest5.isEmpty() && event.isEmpty()){
                        ...
                        if (!player5.isEmpty() && (club.equals("championhills") || club.equals("bentcreek") || club.equals("northshorecc")) && maxPlayers > 3) {
                            maxPlayers = 4;
                            showPlayer = 5;
                            restriction = true;
                    ...
                    if(rwd){ // Responsive mode
                        ...
                        for(int pl = 0; pl < (fivesALL != 0?5:4); pl++){
                            ...
                            countPlayer = true;
                            if (club.equals("southview") || club.equals("dellwood") || club.startsWith("demo") || club.equalsIgnoreCase("ancalacc") || club.equalsIgnoreCase("engineerscc")) {
                            ...
                            if(pl < showPlayer){
                                ...
                                if(!playersList.get(pl).isEmpty()){
                                    ...
                                    playerString.append(buildPlayer(hideGuestCC, disp_hndcp, hideN, gList.get(pl), hideG, hndcpList.get(pl), ghinList.get(pl), playersList.get(pl), guestLabel, memberLabel, club, club_group_name));
                                    // And player CW
                        ...
                        for(int pl = 0; pl < (fivesALL != 0?5:4); pl++){
                            ...
                            if(!playersList.get(pl).isEmpty() && pl < showPlayer) {
                                ...
                                playerHtml.append(tags.getTd(
                                        buildPlayer(hideGuestCC, disp_hndcp, hideN, gList.get(pl), hideG, hndcpList.get(pl), ghinList.get(pl), playersList.get(pl), guestLabel, memberLabel, club, club_group_name),
                                        "sP",
                                ...
                                if (club_group_name.equalsIgnoreCase("Bay Clubs") && allow && hideSubmit == 0) {
                                    playerHtml.append(tags.getTd(
                                            verifyCustom.getBayClubGreensFee(date, day_name, tee_time, club, mship),
                                            "sP",
                                            "color:steelblue; " + htmlUtil.getColorCss((pl==4&&!rest5.isEmpty()?bgcolor5:playerBgColor),true),
                                            null
                                            ));
                                } else {
                                    playerHtml.append(tags.getTd(
                        ...
                        if (!player1.equals("")) {
                            ...
                            player = buildPlayer(hideGuestCC, disp_hndcp, hideN, g1, hideG, hndcp1, ghin1, player1, guestLabel, memberLabel, club, club_group_name);
                        ...
                        if (!player2.equals("")) {
                            ...
                            player = buildPlayer(hideGuestCC, disp_hndcp, hideN, g2, hideG, hndcp2, ghin2, player2, guestLabel, memberLabel, club, club_group_name);
                        ...
                        if (club.equals("mayfieldsr") && courseNameT.equalsIgnoreCase("sand ridge") && verifyCustom.checkMayfieldSR(date, tee_time, day_name)) {
                            ...
                            if (piedmontStatus == 3) {      // if Sat or Sun special times (1st 4 tee times)
                                ...
                                if (!player3.equals("")) {
                                    ...
                                    player = buildPlayer(hideGuestCC, disp_hndcp, hideN, g3, hideG, hndcp3, ghin3, player3, guestLabel, memberLabel, club, club_group_name);
                            ...
                            if (piedmontStatus == 3) {      // if Sat or Sun special times (1st 4 tee times)
                                ...
                                if (!player4.equals("")) {
                                    ...
                                    player = buildPlayer(hideGuestCC, disp_hndcp, hideN, g4, hideG, hndcp4, ghin4, player4, guestLabel, memberLabel, club, club_group_name);
                                ...
                                if (fives != 0) {        // if 5-somes on this course
                                    ...
                                    if (!rest5.equals("") && event.equals("")) {       // if 5-somes are restricted & not an event
                                        ...
                                        if (!player5.equals("") && (club.equals("championhills") || club.equals("bentcreek"))) {
                                            player = buildPlayer(hideGuestCC, disp_hndcp, hideN, g5, hideG, hndcp5, ghin5, player5, guestLabel, memberLabel, club, club_group_name);
                                            out.print(player);
                                        } else {
                                            //out.println("&nbsp;");
                                        }
                        ...
                        if (player1.equals("") && player2.equals("") && player3.equals("") && player4.equals("") && player5.equals("")) {
                            ...
                            if (!player1.equals("")) {
                                ...
                                player = buildPlayerMobile(hideGuestCC, hideN, g1, hideG, player1, guestLabel, memberLabel, club, club_group_name);
                            ...
                            if (!player2.equals("")) {
                                ...
                                player = buildPlayerMobile(hideGuestCC, hideN, g2, hideG, player2, guestLabel, memberLabel, club, club_group_name);
                            ...
                            if (!player3.equals("")) {
                                ...
                                player = buildPlayerMobile(hideGuestCC, hideN, g3, hideG, player3, guestLabel, memberLabel, club, club_group_name);
                            ...
                            if (!player4.equals("")) {
                                ...
                                player = buildPlayerMobile(hideGuestCC, hideN, g4, hideG, player4, guestLabel, memberLabel, club, club_group_name);
                            ...
                            if (fives != 0 && rest5.equals("")) {    // if 5-somes on this course
                                ...
                                if (!player5.equals("")) {
                                    ...
                                    player = buildPlayerMobile(hideGuestCC, hideN, g5, hideG, player5, guestLabel, memberLabel, club, club_group_name);
    ...
    public String buildPlayer(boolean hideGuestCC, boolean disp_hndcp, int hideN, int g1, int hideG, float hndcp,
            String ghin, String player, String guestLabel, String memberLabel, String club, String club_group_name) {
        ...
        if (player.equalsIgnoreCase("x")) {   // if 'x'
            ...
            if (hideN == 0) {             // if ok to display names
                ...
                if (g1 != 0) {             // if guest
                    ...
                    if (hideG == 1 && (!club.equals("mesaverdecc") || !player.startsWith("No 5th Player"))) {    // if custom to hide guest names
                        ...
                        if (hideGuestCC == true) {        // if ClubCorp custom to hide guest types
                            ...
                            player = stripGuestType(player, club, club_group_name);      // remove the guest type - just show name if corp guest
                        }
                    ...
                    // Apply any custom filtering to the displayed player name
                    playerDisplay = Utilities.filterDisplayName(playerDisplay, club, club_group_name);
                }
    ...
    public String buildPlayerMobile(boolean hideGuestCC, int hideN, int g1, int hideG,
            String player, String guestLabel, String memberLabel, String club, String club_group_name) {
    ...
    // *********************************************************
    public String stripGuestType(String player, String club, String club_group_name) {
        ...
        } else if (club_group_name.equalsIgnoreCase("AGC") || club.equals("dovecanyonclub")) {     // American Golf
