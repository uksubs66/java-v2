...
public class Dining_slot_old extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
     ...
     // Jump to new Dining_slot2 if we're on a dev server or in responsive
     SystemUtils.setAppModeFromUri(req, 0); // Normally done in verifyMem, but we'll do it here for this check
     //if (/*ProcessConstants.SERVER_ID == 4 || */Utilities.getRequestBoolean(req, ProcessConstants.RQA_RWD, false)) {
     if (true){
            Dining_slot slot = new Dining_slot();
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    // Jump to new Dining_slot2 if we're rwd and a dev server (remove dev server check after development ends)
    /*
    if (rwd && ProcessConstants.SERVER_ID == 4) {
     //if (rwd) {
            Dining_slot2 rwdSlot = new Dining_slot2();
            rwdSlot.processRequest(req, resp);
            return;
    }
     * */
    ...
    if ( parmD.id != 0 && (
        ...
        for (int i = 1; i <= parmD.covers; i++) {
            ...
            if (!parmD.names[i].equals("")) {
                out.println("<!-- parmD.names[i]=" + parmD.names[i] + " -->");
                out.println("<!-- parmD.icheck_num[i]=" + parmD.check_num[i] + " -->");
...
*/
    ...
    */
        ...
        //out.println(" console.log(form_data);");
