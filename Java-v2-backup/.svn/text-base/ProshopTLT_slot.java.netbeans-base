...
*/
      ...
      try {
          ...
          if (rs.next()) {
              ...
              out.println("<BR><BR><button onclick=\"document.location.href='Proshop_jump?newnotify&yy=" + req_yy + "&mm=" + req_mm + "&dd=" + req_dd + "&course="+course+"'\">Choose Another Time</button>");
            
              out.println("<BR><BR>");
              
              out.println("<form method=post action=ProshopTLT_slot name=frmNotifyTime id=frmNotifyTime>");
 ...
 */
   ...
   out.println("<tr><td align=\"center\"><br>");
      ...
      out.println("<form action=\"ProshopTLT_slot\" method=\"get\" name=\"can\" autocomplete=\"yes\">");
      ...
      out.println("<form action=\"ProshopTLT_slot\" method=\"post\" name=\"playerform\">");
      out.println("<input type=\"hidden\" name=\"notifyId\" value=" + notify_id + ">");
   ...
   if (req.getParameter("suppressEmails") != null) {             // if email parm exists
    ...
    if (req.getParameter("remove") != null) {
        ...
        if (skip == 0) {
            ...
            //
            out.println("<font size=\"2\">");
            out.println("<form action=\"ProshopTLT_slot\" method=\"POST\" target=\"_top\">");
...
*/
   ...
   if (index.equals( "555" )) {         // if came from Proshop_notify
      ...
      if (posSent == false) {        // if pos charges not already sent
         out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_jump?newnotify=yes&course=" + nSlotParms.course + "&mm=" + mm + "&yy=" + yy + "\">");
      }
      out.println("</HEAD>");
      out.println("<BODY bgcolor=\"#FFFFFF\" text=\"#000000\">");
      out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
      ...
      out.println("<title>Proshop Tee Slot Page</title>");
      if (posSent == false) {        // if pos charges not already sent
         //out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_dsheet?course=" + nSlotParms.course + "&index=0\">");
      }
      out.println("</HEAD>");
      out.println("<BODY bgcolor=\"#FFFFFF\" text=\"#000000\">");
      out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
      ...
      if (posSent == false) {        // if pos charges not already sent
         if (!returnCourse.equals( "" )) {    // if multi course club, get course to return to (ALL?)
            //out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_jump?index=" + index + "&course=" + returnCourse + "&jump=" + nSlotParms.jump + "\">");
         } else {
            //out.println("<meta http-equiv=\"Refresh\" content=\"1; url=Proshop_jump?index=" + index + "&course=" + nSlotParms.course + "&jump=" + nSlotParms.jump + "\">");
         }
      }
      out.println("</HEAD>");
      out.println("<BODY bgcolor=\"#FFFFFF\" text=\"#000000\">");
 ...
 private void cancel(HttpServletRequest req, PrintWriter out, String club, Connection con) {
    ...
    if (index.equals( "444" ) || index.equals( "555" )) {       // if originated from Proshop_notify
        ...
        out.println("<frame name=\"bot\" src=\"Proshop_notify?course=" + course + "&mm=" + mm + "&yy=" + yy + "\" marginheight=\"1\">");
      ...
      out.println("</form></font>");
        ...
        out.println("<link rel=\"stylesheet\" href=\"/" +rev+ "/web utilities/foretees2.css\" type=\"text/css\">");
        out.println("<title>Proshop Tee Slot Page</title>");
        out.println("<meta http-equiv=\"refresh\" content=\"1; url=Proshop_dsheet?index=" + index + "&course=" + course + "\">");
        out.println("</HEAD>");
        out.println("<BODY><CENTER><img src=\"/" +rev+ "/images/foretees.gif\"><BR>");
        out.println("<hr width=\"40%\">");
        out.println("<BR><BR><H3>Return/Cancel Requested</H3>");
