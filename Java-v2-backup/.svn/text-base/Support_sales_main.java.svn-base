 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   //  Process Home page
    ...
    try {
        ...
        //
        PreparedStatement pstmt = con2.prepareStatement("SELECT clubname, fullname, id FROM clubs WHERE inactive=0 ORDER BY fullname");
        ...
        while (rs.next()) {
            ...
            id = rs.getInt("id");                            // get the club's uid

            out.println("<option " + ((clubname.equals(club)) ? "selected" : "") + " value=\"" + clubname + "\">" + fullname + " (" +clubname+ ") (id# " + id + ")</option>");    
    ...
    out.println("<tr>");
        out.println("<td>");
                out.println("<p align=\"center\">");
                out.println("<a href=\"/v5/servlet/Support_report_mobile\" target=\"_top\">Display MOBILE Login Counts For All Clubs</a>");
                out.println("</p>");
        out.println("</td>");
    out.println("</tr>");
    out.println("<tr>");
    ...
    out.println("    <td>");
    out.println("            <p align=\"center\">");
    out.println("            <a href=\"/v5/servlet/Support_emails?RWD=prompt\" target=\"_top\">Responsive Design Utilities</a>");
    out.println("            </p>");
    out.println("    </td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("    <td>");
    out.println("            <p align=\"center\">");
    out.println("            <a href=\"/v5/servlet/Support_app_utils\" target=\"_top\">ClubCentral App Utilities</a>");
    out.println("            </p>");
    out.println("    </td>");
    out.println("</tr>");
    out.println("</font>");
