 ...
 *   last updated:
 *
 *        4/27/14   Add mobile login counts.
...
public class Proshop_usereport extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   String [] month_table = { "None", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
   ...
   if ((all == 1) || (only == 1)) {                  // if doPost and long output - build separate page
      ...
      //out.println("<form action=\"Proshop_usereport\" method=\"post\">");
         ...
         out.println("<tr><td bgcolor=\"#336633\" align=\"center\" colspan=\"3\">");
            out.println("<font color=\"#FFFFFF\" size=\"3\">");
            out.println("<b>Member Access Report</b></font></td></tr>");

         out.println("<tr><td bgcolor=\"#336633\" align=\"left\">");
            out.println("<font color=\"#FFFFFF\" size=\"2\">");
            out.println("Member Name</font></td>");
            out.println("<td bgcolor=\"#336633\" align=\"center\"><font color=\"#FFFFFF\" size=\"2\">");
            out.println("Total Logins</font></td>");
            out.println("<td bgcolor=\"#336633\" align=\"center\"><font color=\"#FFFFFF\" size=\"2\">");
            out.println("Mobile Logins</font></td>");
            if (clubCentral) {
                out.println("<td bgcolor=\"#336633\" align=\"center\"><font color=\"#FFFFFF\" size=\"2\">");
                out.println("App Logins</font></td>");
            }
            out.println("</tr>");
      ...
      try {
         ...
         rs = stmt.executeQuery("SELECT name_last, name_first, name_mi, count, mobile_count, mobile_app_count " +
                                "FROM member2b " +
                                "WHERE username <> 'save4foretees' AND username <> 'jparise' " +
         ...
         while (rs.next()) {
            ...
            app_count = rs.getInt("mobile_app_count");
               

            if ((count != 0) || (mobile_count != 0) || (all == 1)) {  // skip if usage = 0 and req was 'only'

               tcount = tcount + count;                        // keep total count of usage
               tmobile_count += mobile_count;
               tapp_count += app_count;
               mem_count++;                                    // count members being totaled

               tmpOutput = NumberFormat.getIntegerInstance().format(count);           
        
               out.println("<tr><td align=\"left\">");
               out.println("<font size=\"2\">");
               out.println( lname + ", " + fname + " " + mname + "</font></td>");
               out.println("<td align=\"center\">");
               out.println("<font size=\"2\">");
               out.println( tmpOutput + "</font></td>");
               
               tmpOutput = NumberFormat.getIntegerInstance().format(mobile_count);           
               ...
               if (clubCentral) {
                   out.println("<td align=\"center\">");
                   out.println("<font size=\"2\">");
                   out.println( NumberFormat.getIntegerInstance().format(app_count) + "</font></td>");
               }
         ...
         tmpOutput = NumberFormat.getIntegerInstance().format(mem_count);           
               
         if (all == 1) {
           
            out.println("Total for all <b>" + tmpOutput + "</b> members:&nbsp;&nbsp;");
         } else {
            
            out.println("Total for <b>" + tmpOutput + "</b> members:&nbsp;&nbsp;");
         }
         out.println("</font></td><td align=\"center\">");
         out.println("<font size=\"2\">");
         
         tmpOutput = NumberFormat.getIntegerInstance().format(tcount);           
         
         out.println("<b>" + tmpOutput + "</b></font></td>");
         out.println("<td align=\"center\">");

         tmpOutput = NumberFormat.getIntegerInstance().format(tmobile_count);           
         ...
         if (clubCentral) {
             ...
             out.println( NumberFormat.getIntegerInstance().format(tapp_count) + "</b></font></td>");
         }
      ...
      out.println("&nbsp;&nbsp;Logins for individual member&nbsp;&nbsp;");
      ...
      try {
         ...
         rs = stmt.executeQuery("SELECT username, name_last, name_first, name_mi, count, mobile_count, mobile_app_count " +
                                "FROM member2b WHERE username <> 'jparise' " +
                                "ORDER BY name_last, name_first, name_mi");
         ...
         while (rs.next()) {
            ...
            if (count > 0) use_count++;               // count all members that have used system at least once
          
            if (mobile_count > 0) mobile_mems++;      // count # of members using Mobile

            if (app_count > 0) app_mems++;            // count # of members using the app
            ...
            if (ind == 1 && (user.equalsIgnoreCase( username ))) {     // if single player mode and this is that member
             
               icount = count;        // save count and name for this member
               imobile_count = mobile_count;
               iapp_count = app_count;
               i_lname = lname;
               i_fname = fname;
               i_mname = mname;
            }
      ...
      out.println("&nbsp;&nbsp;Logins for all <b>" + tmpOutput + "</b> members, itemized&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("<input type=\"submit\" name=\"all\" value=\"Go\"><br><br>");

      out.println("&nbsp;&nbsp;Logins for all members with non-zero counts&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("<input type=\"submit\" name=\"only\" value=\"Go\">");
      out.println("</font>");
      out.println("</form>");
            
      tmpOutput = NumberFormat.getIntegerInstance().format(use_count);           
         
      out.println("</td></tr>");
      out.println("<tr><td align=\"center\"><font size=\"2\"><br>");
      out.println("<b>" + tmpOutput + " members</b> have accessed this system a total of ");
      
      tmpOutput = NumberFormat.getIntegerInstance().format(tcount);           
         
      out.println("<b>" + tmpOutput + "</b> times.<br>");

      tmpOutput = NumberFormat.getIntegerInstance().format((tcount / use_count));           
      
      out.println("(an average of " + tmpOutput + " logins per member)<br>");
      
      out.println("<hr width=\"75%\"></hr>");
      
      tmpOutput = NumberFormat.getIntegerInstance().format(mobile_mems);           
      
      out.println("&nbsp;&nbsp;<b>" + tmpOutput + " members</b> have used Mobile devices a total of ");
      ...
      if (clubCentral) {
         ...
         out.println("&nbsp;&nbsp;<b>" + NumberFormat.getIntegerInstance().format(app_mems) + " members</b> have accessed ForeTees from the App a total of ");

         out.println("<b>" + NumberFormat.getIntegerInstance().format(tapp_count) + "</b> times.&nbsp;&nbsp;<br>");          
      }
      
      if (ind == 1) {            // if individual member display requested

         tmpOutput = NumberFormat.getIntegerInstance().format(icount);           
      
         out.println("</td></tr>");
         out.println("<tr><td align=\"center\"><font size=\"2\"><br>");
         out.println("<b>" + i_fname + " " + i_mname + " " + i_lname + "</b> has accessed this system <b>" + tmpOutput + "</b> times.<br>");
         
         tmpOutput = NumberFormat.getIntegerInstance().format(imobile_count);           
         
         out.println("(<b>" + tmpOutput + "</b> of those times on a Mobile device)");
      }
      out.println("</td></tr>");
      out.println("</table>");
      ...
      // **********************************************************************
      //   Display Login counts for past 12 months
      // **********************************************************************
      
       out.println("<br><br>");
       out.println("<b>Number of Logins Per Month for Past 12 Months</b><br>");
       out.println("<font size=\"2\">(NOTE: If you have deleted member records the counts will be skewed.)</font><br>");
      
       out.println("<table border=\"1\" bgcolor=\"#F5F5DC\" cellpadding=\"5\">");
       out.println("<tr>");
       out.println("<td align=\"center\" bgcolor=\"#336633\">&nbsp;</td>");
        
        
       //  Get the counts for this month (MTD)
       
       count = 0;
       mobile_count = 0;    // default in case not found
       app_count = 0;
       ...
       try {
           ...
           if (rs.next()) {
               ...
               count = rs.getInt(1);    // login count for this club
           }
           
           rs = stmt.executeQuery("SELECT SUM(mobile_count) FROM member2b WHERE mobile_count > 0");

           if (rs.next()) {

               mobile_count = rs.getInt(1);    // mobile login count for this club
           }
           
           if (clubCentral) {
               
               rs = stmt.executeQuery("SELECT SUM(mobile_app_count) FROM member2b WHERE mobile_app_count > 0 AND username <> 'jparise'");

               if (rs.next()) {
 
                   app_count = rs.getInt(1);    // mobile app login count for this club
               }
           }
        ...
        //
        //   Get the Login Counts for the past 12 months
        //
        int [] loginsA = new int [13];       // login counts for past 13 months
        int [] mloginsA = new int [13];      // mobile counts
        int [] aloginsA = new int [13];      // app counts
       
        cal = new GregorianCalendar();       // get todays date      
        cal.add(Calendar.MONTH, -13);        // go back 13 months      
        ...
        for (i=0; i<13; i++) {
            ...
            if (i > 0) {
                ...
                out.println("<font color=\"#FFFFFF\" size=\"2\">");
                out.println(month_table[month]+ "</td>");
            }
            
            //
            //  Now gather the login counts for the month
            //
            try {
                ...
                if (rs.next()) {               
                    ...
                    loginsA[i] = rs.getInt("logins_standard");    // get number of All logins for this month           
                    mloginsA[i] = rs.getInt("logins_mobile");     // get number of Mobile logins for this month   
                    aloginsA[i] = rs.getInt("logins_app");        // get number of App logins
                }
        ...
        }    // end of FOR loop - each month
        
       out.println("<td align=\"center\" bgcolor=\"#336633\">");
       out.println("<font color=\"#FFFFFF\" size=\"2\">");
       out.println("MTD</font></td>");
       
       out.println("</tr><tr>");
       out.println("<td align=\"center\" bgcolor=\"#336633\"><font color=\"#FFFFFF\" size=\"2\">All Logins</font></td>");
        
       for (i=1; i<13; i++) {

            login_count = (loginsA[i] - loginsA[i-1]);
            
            if (login_count < 0) login_count = 0;       // do not show negative counts
            
            tmpOutput = NumberFormat.getIntegerInstance().format(login_count);
           
            out.println("<td align=\"center\">");
            out.println("<font size=\"2\">" +tmpOutput+ "</font></td>");          // All Logins
       }
       
     
       tmpOutput = NumberFormat.getIntegerInstance().format((count - loginsA[12]));           
        
       out.println("<td align=\"center\">");             // MTD all logins
       out.println("<font size=\"2\">");
       out.println(tmpOutput+ "</font></td>");
            
       out.println("</tr><tr>");
       out.println("<td align=\"center\" bgcolor=\"#336633\"><font color=\"#FFFFFF\" size=\"2\">Mobile Logins</font></td>");
        
       for (i=1; i<13; i++) {
        
            mlogin_count = (mloginsA[i] - mloginsA[i-1]);   // get all login counts and mobile counts for this month
            login_count = (loginsA[i] - loginsA[i-1]);
            
            if (login_count < 0) login_count = 0;       // do not show negative counts       
            if (mlogin_count < 0) mlogin_count = 0;    
           
            tmpOutput = NumberFormat.getIntegerInstance().format(mlogin_count);           
        
            out.println("<td align=\"center\">");
            out.println("<font size=\"2\">");
            
            if (mlogin_count > 0 && login_count > 0) {
            
                out.println(tmpOutput+ " <i>(" + ((mlogin_count * 100) / login_count) + "%)</i></font></td>");    // Mobile Logins
       ...
       tmpOutput = NumberFormat.getIntegerInstance().format((mobile_count - mloginsA[12]));           
        
       out.println("<td align=\"center\">");        // MTD Mobile counts
       out.println("<font size=\"2\">");
            
            if ((mobile_count - mloginsA[12]) > 0 && (count - loginsA[12]) > 0) {
            
                out.println(tmpOutput+ " <i>(" + (((mobile_count - mloginsA[12]) * 100) / (count - loginsA[12])) + "%)</i></font></td>");
       ...
       if (clubCentral) {
            ...
            out.println("<tr>");
            out.println("<td align=\"center\" bgcolor=\"#336633\"><font color=\"#FFFFFF\" size=\"2\">App Logins</font></td>");

            for (i=1; i<13; i++) {

                    alogin_count = (aloginsA[i] - aloginsA[i-1]);   // get all login counts and app counts for this month
                    login_count = (loginsA[i] - loginsA[i-1]);

                    if (login_count < 0) login_count = 0;       // do not show negative counts       
                    if (alogin_count < 0) alogin_count = 0;    

                    tmpOutput = NumberFormat.getIntegerInstance().format(alogin_count);           

                    out.println("<td align=\"center\">");
                    out.println("<font size=\"2\">");

                    if (alogin_count > 0 && login_count > 0) {

                        out.println(tmpOutput+ " <i>(" + ((alogin_count * 100) / login_count) + "%)</i></font></td>");    // App Logins
            ...
            tmpOutput = NumberFormat.getIntegerInstance().format((app_count - aloginsA[12]));           

            out.println("<td align=\"center\">");        // MTD App counts
            out.println("<font size=\"2\">");

                    if ((app_count - aloginsA[12]) > 0 && (count - loginsA[12]) > 0) {

                        out.println(tmpOutput+ " <i>(" + (((app_count - aloginsA[12]) * 100) / (count - loginsA[12])) + "%)</i></font></td>");
       ...
       if (clubCentral) {
           ...
           out.println("<strong>Mobile Logins</strong> refer to the times when a member accesses ForeTees from their mobile device via the mobile browser (not the App).");
           out.println("<br><strong>App Logins</strong> refer to the times when a member accesses ForeTees from the ClubCentral App.</font></p>");
       }
      ...
      if (tcount > 0) {
         ...
         try {
            ...
            rs = stmt.executeQuery("SELECT count, birth FROM member2b WHERE count > 0 AND birth > 0 AND username <> 'save4foretees'");  // get # of logins
         ...
         if (grandTotal > 0 && (memCount > (use_count / 2))) {         // if something to display
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num1) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total1) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num2) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total2) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num3) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total3) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num4) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total4) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num5) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total5) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num6) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total6) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num7) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total7) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num8) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total8) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num9) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total9) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num10) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total10) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num11) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total11) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num12) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total12) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num13) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total13) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(num14) + "</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">" + NumberFormat.getIntegerInstance().format(total14) + "</font></td>");
            ...
            out.println("<td align=\"center\"><font size=\"2\"><b>" + NumberFormat.getIntegerInstance().format(memCount) + "</b></font></td>");
            out.println("<td align=\"center\"><font size=\"2\"><b>" + NumberFormat.getIntegerInstance().format(grandTotal) + "</b></font></td>");
