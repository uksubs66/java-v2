 ...
 *   History:
 *
 *                  11/18/2012   MySQL 5.5 compatability fixes (nulls w/ rollup)
 *                   2/13/2012 - Removed customs for Congressional.
 *                   1/13/2012 - Fixed issue with course detail view where if player1 didn't have a username, players 2-5 would be reported as "Removed From Member Database", 
 *                               since it was using username1 to for the member2b binding.
 *                  11/10/2011 - TPC Clubs - Set up to always run the by_gender option.  This could be made into a toggleable option later.
 *                  11/10/2011 - Updated displayGuestTypeQuery() method to have a by_gender option to break down guest types by gender, using the gender from tracked guest rounds.
 ...
 private void doTodaySummary(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
   ...
   ArrayList<String> course = new ArrayList<String>();      // unlimited courses
    ...
    if (req.getParameter("excel") == null) {     // if normal request
        ...
        out.println("<form method=\"post\" action=\"Proshop_report_course_rounds\" target=\"_blank\">");
...
*/
    ...
    for (index=0; index<count; index++) {
       ...
       if (multi != 0) {
        ...
        if (req.getParameter("excel") == null) {
            ...
            out.println("<form method=\"post\" action=\"Proshop_report_course_rounds\">");
            ...
            out.println("<form method=get action=\"Proshop_report_course_rounds\">");
 ...
 private void doTodayDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    if (req.getParameter("excel") == null) {     // if normal request
        out.println("<p><form method=\"post\" action=\"Proshop_report_course_rounds\" target=\"_blank\">");
        out.println("<input type=\"hidden\" name=\"excel\" value=\"yes\">");
        out.println("<input type=\"hidden\" name=\"today\" value=\"\">");
        out.println("<input type=\"hidden\" name=\"detail\" value=\"\">");
    ...
    for (index=0; index<count; index++) {
        ...
        displayGuestTypeQuery(club, courseName, sdate, curr_time, 11, total_course_rounds_18, total_course_rounds_9, excel, con, out);
 ...
 private void getCustomDate(HttpServletRequest req, PrintWriter out, Connection con) {
    ...
    out.println("<form action=\"Proshop_report_course_rounds\" method=\"post\">");
...
*/
 ...
 private void doCustomDateDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    // display guest type detail
    displayGuestTypeQuery(club, courseName, sdate, edate, 12, total_course_rounds_18, total_course_rounds_9, excel, con, out);
...
*/
   ...
   for (index=0; index<count; index++) {
      ...
      if (!courseName.equals( "" )) {
        ...
        if (req.getParameter("excel") == null) {
            ...
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=lm><input type=hidden name=detail><input type=hidden name=course value=\"" + courseName + "\"><input type=\"submit\" value=\"LM Detail\" style=\"text-decoration:underline; background:#8B8970; width:110px\"></form>");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=trans><input type=hidden name=detail><input type=hidden name=course value=\"" + courseName + "\"><input type=hidden name=cal_box_0 value=\"" + lm_start_date + "\"><input type=hidden name=cal_box_1 value=\"" + lm_end_date + "\"><input type=\"submit\" value=\"Trans Detail\" style=\"text-decoration:underline; background:#8B8970; width:110px\"></form>");
            out.println("</td>");

            out.println("<td align=\"center\" colspan=\"2\">");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=mtd><input type=hidden name=detail><input type=hidden name=course value=\"" + courseName + "\"><input type=\"submit\" value=\"MTD Detail\" style=\"text-decoration:underline; background:#8B8970; width:110px\"></form>");
            ...
            out.println("<td align=\"center\" colspan=\"2\">");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=ytd><input type=hidden name=detail><input type=hidden name=course value=\"" + courseName + "\"><input type=\"submit\" value=\"YTD Detail\" style=\"text-decoration:underline; background:#8B8970; width:110px\"></form>");
    ...
    if (multi != 0) {
        ...
        if (req.getParameter("excel") == null) {
            ...
            out.println("<td align=\"center\" colspan=\"2\">");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=lm><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=\"submit\" value=\" LM Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=trans><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=hidden name=cal_box_0 value=\"" + lm_start_date + "\"><input type=hidden name=cal_box_1 value=\"" + lm_end_date + "\"><input type=\"submit\" value=\" Trans Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("</td>");

            out.println("<td align=\"center\" colspan=\"2\">");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=mtd><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=\"submit\" value=\" MTD Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=trans><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=hidden name=cal_box_0 value=\"" + mtd_start_date + "\"><input type=hidden name=cal_box_1 value=\"" + mtd_end_date + "\"><input type=\"submit\" value=\" Trans Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("</td>");

            out.println("<td align=\"center\" colspan=\"2\">");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=ytd><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=\"submit\" value=\" YTD Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("<form method=get action=\"Proshop_report_course_rounds\"><input type=hidden name=trans><input type=hidden name=detail><input type=hidden name=course value=\"-ALL-\"><input type=hidden name=cal_box_0 value=\"" + ytd_start_date + "\"><input type=hidden name=cal_box_1 value=\"" + ytd_end_date + "\"><input type=\"submit\" value=\" Trans Detail \" style=\"text-decoration:underline; background:#8B8970\"></form>");
            out.println("</td>");
 ...
 private void doLastMonthDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    for (index=0; index<count; index++) {
       ...
       if (index > 0) courseName = course.get(index);  // get course name if not first time here
        ...
        // display guest type detail
        displayGuestTypeQuery(club, courseName, sdate, edate, 14, total_course_rounds_18, total_course_rounds_9, excel, con, out);
 ...
 private void doThisMonthDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    for (index=0; index<count; index++) {
        ...
        // display guest type detail
        displayGuestTypeQuery(club, courseName, sdate, edate, 15, total_course_rounds_18, total_course_rounds_9, excel, con, out);
 ...
 private void doThisYearDetail(HttpServletRequest req, PrintWriter out, Connection con, HttpSession sess) {
    ...
    for (index=0; index<count; index++) {
       ...
       if (index > 0) courseName = course.get(index);  // get next course name if not first time here
        ...
        // display guest type detail
        displayGuestTypeQuery(club, courseName, sdate, edate, 16, total_course_rounds_18, total_course_rounds_9, excel, con, out);
...
*/                    
    ...
    if (req.getParameter("excel") == null) {
        out.println("<center><form method=\"get\" action=\"Proshop_announce\">");
        out.println("<input type=\"button\" value=\"Back to Summary\" onclick=\"window.history.go(-1);\" style=\"text-decoration:underline; background:#8B8970\">&nbsp; &nbsp; ");
        out.println("<input type=\"submit\" value=\"Home\" style=\"text-decoration:underline; background:#8B8970\"> &nbsp; &nbsp; ");
 ...
 private void displayTransportationQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, String pExcel, Connection con, PrintWriter out) {
    ...
    if (pReportType == 1) {
        ...
        sqlQuery = "" +
             "SELECT * FROM (" +
             "SELECT tmode, cw, m_ship, m_or_g_type, SUM(p_9), SUM(p_18) FROM ( " +
             "SELECT cw, cn, IFNULL(m_ship,IF(null_user=1,'ZZZGuest','Removed')) AS m_ship, " +
             "IFNULL(m_type, IFNULL(guest_type,IF(null_user=1,'Unknown','Removed from Member Database'))) AS m_or_g_type, p_9, p_18 " +
                "FROM ( " +
        ...
        sqlQuery += ")  AS d_table ) AS g_table LEFT OUTER JOIN tmodes ON (tmodea = cw AND cn = tmodes.courseName";
        ...
        sqlQuery = "SELECT * FROM (" +
             "SELECT tmode, cw, m_ship, m_or_g_type, SUM(p_9), SUM(p_18) FROM ( " +
             "SELECT cw, cn, IF(m_ship='',IF(null_user=1,'ZZZGuest','Removed'), m_ship) AS m_ship, " +
             "IF(m_type='',IF(guest_type='',IF(null_user=1,'Unknown','Removed from Member Database'), guest_type), m_type) AS m_or_g_type, p_9, p_18 " +
                "FROM ( " +
                "SELECT courseName as cn, p1cw AS cw, " +
                    "p91 AS p_9, IF(p91=0,1,0) AS p_18, " +
...
/*
 ...
 private void displayMemberTypeQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    if (pReportType == 11) {
        ...
        "SELECT IFNULL(m_type, IF(null_user=1,'Unknown','Removed from Member Database')) AS m_type, p_9, p_18 FROM ( " +
        ...
        sqlQuery = "" + 
        "SELECT m_type, SUM(p_9), SUM(p_18) FROM ( " + 
        "SELECT IF(m_type='', IF(null_user=1,'Unknown','Removed from Member Database'), m_type) AS m_type, p_9, p_18 FROM ( " +      
 ...
 private void displayMemberShipTypeQuery(String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    if (g_debug) {
        ...
        out.println("<!-- pGrandTotal_18=" + pGrandTotal_18 + " -->");
        out.println("<!-- pGrandTotal_9=" + pGrandTotal_9 + " -->");
        out.println("<!-- pStartDate=" + pStartDate + " -->");
        out.println("<!-- pEndDate=" + pEndDate + " -->");
    ...
    if (pReportType == 11) {
        ...
        // build sql statement
        sqlQuery = "" +
        "SELECT m_ship, m_type, SUM(p_9) AS p_9, SUM(p_18) AS p_18 FROM ( " +
        "SELECT IFNULL(m_ship,IF(null_user=1,'Guest','Removed')) AS m_ship, IFNULL(m_type, IF(null_user=1,'Unknown','Removed from Member Database')) AS m_type, p_9, p_18 FROM (" +
        "SELECT p91 AS p_9, IF(p91=0,1,0) AS p_18, " +
                "m_type, m_ship, " +
                "IF(IFNULL(username1,'')='',1,0) AS null_user " +
                "FROM teecurr2 " +
        ...
        "SELECT (0) AS p_9, (0) AS p_18, " +
                ...
                "WHERE m2b.m_type IS NOT NULL " + 
                "GROUP BY m5.mship, m2b.m_type " + 
        ") AS d_table ) as g_table GROUP BY m_ship, m_type WITH ROLLUP;";
        ...
        while ( rs.next() ) {
            ...
            if (rs.getString(1) == null && rs.getString(2) == null) {
                ...
                if (rs.getString(1) != null && rs.getString(2) == null) {
                    ...
                    mem_type9.add(rs.getInt("p_9"));
                    mem_type18.add(rs.getInt("p_18"));

                    out.println("<!-- " + memship_type.size() + ", " + mem_type.size() + ", " + mem_type9.size() + ", " + mem_type18.size() + " -->");
    ...
    while ( tmp_index < memship_type.size() ) { //rs_rows1
            ...
            out.println("<!-- tmp_index1=" + tmp_index1 + " -->");
        ...
        //if ( !memship_type[tmp_index].equals(tmp_memship_type) ) {
            ...
            out.println("<!-- memship_type9.get(tmp_index1)=" + memship_type9.get(tmp_index1) + " -->");
            ...
            out.println("<!-- memship_type.get(" + tmp_index + ")=" + memship_type.get(tmp_index) + ", tmp_memship_type=" + tmp_memship_type + " -->");
        }
 ...
 private void displayGuestTypeQuery(String club, String pCourseName, long pStartDate, long pEndDate, int pReportType, int pGrandTotal_18, int pGrandTotal_9, String pExcel, Connection con, PrintWriter out) {
    ...
    //int rs_rows1 = 0;
    int tot9rounds = 0;
    int tot9malerounds = 0;
    int tot9femalerounds = 0;
    int tot18rounds = 0;
    int tot18malerounds = 0;
    int tot18femalerounds = 0;
    int totalGuestRounds = 0;
    int totalGuestMaleRounds = 0;
    int totalGuestFemaleRounds = 0;
    
    int grand_totalGuestRounds = 0;
    int grand_totalGuestMaleRounds = 0;
    int grand_totalGuestFemaleRounds = 0;
    int grand_tot9rounds = 0;
    int grand_tot9malerounds = 0;
    int grand_tot9femalerounds = 0;
    int grand_tot18rounds = 0;
    int grand_tot18malerounds = 0;
    int grand_tot18femalerounds = 0;
    int rev_totalGuestRounds = 0;
    int rev_totalGuestMaleRounds = 0;
    int rev_totalGuestFemaleRounds = 0;
    int rev_tot9rounds = 0;
    int rev_tot9malerounds = 0;
    int rev_tot9femalerounds = 0;
    int rev_tot18rounds = 0;
    int rev_tot18malerounds = 0;
    int rev_tot18femalerounds = 0;
    
    int tmp_index = 0;
    
    ArrayList<Integer> gst_type9 = new ArrayList<Integer>(24);
    ArrayList<Integer> gst_type9_male = new ArrayList<Integer>(24);
    ArrayList<Integer> gst_type9_female = new ArrayList<Integer>(24);
    ArrayList<Integer> gst_type18 = new ArrayList<Integer>(24);
    ArrayList<Integer> gst_type18_male = new ArrayList<Integer>(24);
    ArrayList<Integer> gst_type18_female = new ArrayList<Integer>(24);
    ...
    boolean by_gender = false;
    
    // Break down guest types by gender.  Do this as a custom for now, though if more clubs request it, we can make it a selectable option.
  ...
  while ( tmp_loop ) {
    ...
    if (pReportType == 11)  {
        ...
        sqlQuery = "" +
        "SELECT m_ship, m_or_g_type, SUM(p_9), SUM(p_18), revenue" + (by_gender ? ", SUM(p_9_male), SUM(p_9_female), SUM(p_18_male), SUM(p_18_female)" : "") + " FROM ( " +
        "SELECT IF(null_user=1,'Guest','Removed') AS m_ship, IFNULL(guest_type,IF(null_user=1,'Unknown','Removed from Member Database')) AS m_or_g_type, p_9, p_18, revenue" + (by_gender ? ", p_9_male, p_9_female, p_18_male, p_18_female" : "") + " FROM ( " +
        "SELECT p91 AS p_9, IF(p91=0,1,0) AS p_18, guest AS guest_type, revenue, " +
                "IF(IFNULL(username1,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gdb.gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gdb.gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gdb.gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gdb.gender, '')='F',1,0) as p_18_female " : " ") +
                "FROM teecurr2 " +
                "LEFT OUTER JOIN member2b ON username1 = username " + 
                "LEFT OUTER JOIN guest5 ON guest = LEFT(player1,LENGTH(guest)) " + ((!tmp_rev.equals("")) ? "AND " + tmp_rev : "") + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data gdb ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
        ...
        "SELECT p92 AS p_9, IF(p92=0,1,0) AS p_18, guest AS guest_type, revenue, " +
                "IF(IFNULL(username2,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gdb.gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gdb.gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gdb.gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gdb.gender, '')='F',1,0) as p_18_female " : " ") +
                "FROM teecurr2 " +
                "LEFT OUTER JOIN member2b ON username2 = username " +
        ...
        "SELECT p93 AS p_9, IF(p93=0,1,0) AS p_18, guest AS guest_type, revenue, " +
                "IF(IFNULL(username3,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gdb.gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gdb.gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gdb.gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gdb.gender, '')='F',1,0) as p_18_female " : " ") +
                "FROM teecurr2 " +
                "LEFT OUTER JOIN member2b ON username3 = username " +
        ...
        "SELECT p94 AS p_9, IF(p94=0,1,0) AS p_18, guest AS guest_type, revenue, " +
                "IF(IFNULL(username4,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gdb.gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gdb.gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gdb.gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gdb.gender, '')='F',1,0) as p_18_female " : " ") +
                "FROM teecurr2 " +
                "LEFT OUTER JOIN member2b ON username4 = username " +
        ...
        "SELECT p95 AS p_9, IF(p95=0,1,0) AS p_18, guest AS guest_type, revenue, " +
                "IF(IFNULL(username5,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gdb.gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gdb.gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gdb.gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gdb.gender, '')='F',1,0) as p_18_female " : " ") +
                "FROM teecurr2 " +
                "LEFT OUTER JOIN member2b ON username5 = username " +
        ...
        "UNION ALL " +
        "SELECT (0) AS p_9, (0) AS p_18, guest AS guest_type, revenue, (1) AS null_user" + (by_gender ? ", (0) as p_9_male, (0) as p_9_female, (0) as p_18_male, (0) as p_18_female" : "") + " FROM guest5) AS d_table ) AS g_table ";
        ...
        sqlQuery = "" +
    "SELECT m_ship, m_or_g_type, SUM(p_9), SUM(p_18), revenue" + (by_gender ? ", SUM(p_9_male), SUM(p_9_female), SUM(p_18_male), SUM(p_18_female)" : "") + " FROM ( " +
    "SELECT IF(null_user=1,'Guest','Removed') AS m_ship, IF(guest_type='',IF(null_user=1,'Unknown','Removed from Member Database'), guest_type) AS m_or_g_type, p_9, p_18, revenue" + (by_gender ? ", p_9_male, p_9_female, p_18_male, p_18_female" : "") + " FROM ( " +
    "SELECT p91 AS p_9, IF(p91=0,1,0) AS p_18, gtype1 AS guest_type, grev1 AS revenue, " +
                "IF(IFNULL(username1,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gender, '')='F',1,0) as p_18_female " : " ") +
            "FROM teepast2 " + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
        ...
        "SELECT p92 AS p_9, IF(p92=0,1,0) AS p_18, gtype2 AS guest_type, grev2 AS revenue, " +
                "IF(IFNULL(username2,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gender, '')='F',1,0) as p_18_female " : " ") +
            "FROM teepast2 " + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
        ...
        "SELECT p93 AS p_9, IF(p93=0,1,0) AS p_18, gtype3 AS guest_type, grev3 AS revenue, " +
                "IF(IFNULL(username3,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gender, '')='F',1,0) as p_18_female " : " ") +
            "FROM teepast2 " + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
        ...
        "SELECT p94 AS p_9, IF(p94=0,1,0) AS p_18, gtype4 AS guest_type, grev4 AS revenue, " +
                "IF(IFNULL(username4,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gender, '')='F',1,0) as p_18_female " : " ") +
            "FROM teepast2 " + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
        ...
        "SELECT p95 AS p_9, IF(p95=0,1,0) AS p_18, gtype5 AS guest_type, grev5 AS revenue, " +
                "IF(IFNULL(username5,'')='',1,0) AS null_user" + (by_gender ? ", IF(p95=1 AND IFNULL(gender, '')='M',1,0) as p_9_male, IF(p95=1 AND IFNULL(gender, '')='F',1,0) as p_9_female, IF(p95=0 AND IFNULL(gender, '')='M',1,0) as p_18_male, " + 
                "IF(p95=0 AND IFNULL(gender, '')='F',1,0) as p_18_female " : " ") +
            "FROM teepast2 " + 
                (by_gender ? "LEFT OUTER JOIN guestdb_data ON guest_id3 = guest_id " : "");
                sqlQuery += buildWhereClause(pReportType, pCourseName);
...
*/
        ...
        while ( rs1.next() ) {
            ...
            if (rs1.getString(1) == null && rs1.getString(2) == null) {
                ...
                if (by_gender) {
                    ...
                    tot9malerounds = rs1.getInt(6);
                    tot9femalerounds = rs1.getInt(7);
                    tot18malerounds = rs1.getInt(8);
                    tot18femalerounds = rs1.getInt(9);
                    totalGuestMaleRounds = tot9malerounds + tot18malerounds;
                    totalGuestFemaleRounds = tot9femalerounds + tot18femalerounds;
                }
                ...
                if (rs1.getString(1) != null && rs1.getString(2) == null) {
                    ...
                    if (by_gender) {
                        gst_type9_male.add(rs1.getInt(6));
                        gst_type9_female.add(rs1.getInt(7));
                        gst_type18_male.add(rs1.getInt(8));
                        gst_type18_female.add(rs1.getInt(9));
                    }
    ...
    if (by_gender) {
        ...
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">Total - Male:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(totalGuestMaleRounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">Total - Female:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(totalGuestFemaleRounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">Total - No Gender:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(totalGuestRounds - (totalGuestMaleRounds + totalGuestFemaleRounds), 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
    }
    ...
    if (by_gender) {
        ...
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">18 Hole Rounds - Male:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot18malerounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">18 Hole Rounds - Female:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot18femalerounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">18 Hole Rounds - No Gender:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot18rounds - (tot18malerounds + tot18femalerounds), 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
    }
    ...
    if (by_gender) {
        ...
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">9 Hole Rounds - Male:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot9malerounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">9 Hole Rounds - Female:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot9femalerounds, 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
        out.println("</tr><tr>");
        out.println("<td align=\"center\">");
        out.println("<font size=\"2\">9 Hole Rounds - No Gender:");
        out.println("</font></td>");
        out.println("<td align=\"center\"><font size=\"2\">");
        out.println(buildDisplayValue(tot9rounds - (tot9malerounds + tot9femalerounds), 0, totalGuestRounds, pExcel));
        out.println("</font></td>");
    }
    ...
    while ( tmp_index < gst_type.size() ) {
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type9_male.get(tmp_index) + gst_type18_male.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Total - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type9_female.get(tmp_index) + gst_type18_female.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Total - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue((gst_type9.get(tmp_index) + gst_type18.get(tmp_index)) - (gst_type9_female.get(tmp_index) + gst_type9_male.get(tmp_index) + gst_type18_female.get(tmp_index) + gst_type18_male.get(tmp_index)), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type18_male.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">18 Hole Rounds - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type18_female.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">18 Hole Rounds - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type18.get(tmp_index) - (gst_type18_male.get(tmp_index) + gst_type18_female.get(tmp_index)), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type9_male.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">9 Hole Rounds - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type9_female.get(tmp_index), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">9 Hole Rounds - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(gst_type9.get(tmp_index) - (gst_type9_male.get(tmp_index) + gst_type9_female.get(tmp_index)), 0, totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
    ...
    if (i == 0) {
        ...
        if (by_gender) {
            grand_totalGuestMaleRounds = totalGuestMaleRounds + rev_totalGuestMaleRounds;
            grand_totalGuestFemaleRounds = totalGuestFemaleRounds + rev_totalGuestFemaleRounds;
            grand_tot9malerounds = tot9malerounds + rev_tot9malerounds;
            grand_tot9femalerounds = tot9femalerounds + rev_tot9femalerounds;
            grand_tot18malerounds = tot18malerounds + rev_tot18malerounds;
            grand_tot18femalerounds = tot18femalerounds + rev_tot18femalerounds;
        }
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_totalGuestMaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 18
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Total - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_totalGuestFemaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 18
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Total - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_totalGuestRounds - (grand_totalGuestMaleRounds + grand_totalGuestFemaleRounds), 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot18malerounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 18
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">18 Hole Rounds - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot18femalerounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 18
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">18 Hole Rounds - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot18rounds - (grand_tot18malerounds + grand_tot18femalerounds), 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
        ...
        if (by_gender) {
            ...
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot9malerounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 9
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">9 Hole Rounds - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot9femalerounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // guest total 9
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">9 Hole Rounds - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_tot9rounds - (grand_tot9malerounds + grand_tot9femalerounds), 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            ...
            out.println("</tr><tr>");                           // revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Revenue - Male:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(rev_totalGuestMaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Revenue - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(rev_totalGuestFemaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Revenue - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(rev_totalGuestRounds - (rev_totalGuestMaleRounds + rev_totalGuestFemaleRounds), 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            ...
            out.println("</tr><tr>");                           // non-revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Non-Revenue - Male:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_totalGuestMaleRounds - rev_totalGuestMaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // non-revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Non-Revenue - Female:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue(grand_totalGuestFemaleRounds - rev_totalGuestFemaleRounds, 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
            out.println("</tr><tr>");                           // non-revenue total
            out.println("<td align=\"right\">");
            out.println("<font size=\"2\">Non-Revenue - No Gender:");
            out.println("</font></td>");
            out.println("<td align=\"center\"><font size=\"2\">");
            out.println(buildDisplayValue((grand_totalGuestRounds - (grand_totalGuestMaleRounds + grand_totalGuestFemaleRounds)) - (rev_totalGuestRounds - (rev_totalGuestMaleRounds + rev_totalGuestFemaleRounds)), 0, grand_totalGuestRounds, pExcel));
            out.println("</font></td>");
        }
        ...
        if (by_gender) {
            rev_totalGuestMaleRounds = totalGuestMaleRounds;
            rev_totalGuestFemaleRounds = totalGuestFemaleRounds;
            rev_tot9malerounds = tot9malerounds;
            rev_tot9femalerounds = tot9femalerounds;
            rev_tot18malerounds = tot18malerounds;
            rev_tot18femalerounds = tot18femalerounds;
        }
        ...
        if (by_gender) {
            gst_type9_male.clear();
            gst_type9_female.clear();
            gst_type18_male.clear();
            gst_type18_female.clear();
        }
 ...
 private void displayCourseSummary(String pCourseName, long pStartDate, long pEndDate, int pReportType, String pExcel, Connection con, PrintWriter out, boolean pVirtuals){
    ...
    if (pReportType == 0 || pReportType == 1) {
        ...
        ") " +
        "AS d_table ) AS g_table GROUP BY m_ship DESC;";
...
*/
 ...
 //**************************************************
 // Common Method for Building WHERE Clause for Congressional - NO LONGER USED as of 2/13/12
 //**************************************************
 //
