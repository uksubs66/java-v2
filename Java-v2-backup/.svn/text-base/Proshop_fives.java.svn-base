 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"post\" action=\"Proshop_fives\" target=\"bot\">");
         out.println("<td align=\"center\">");
...
//   name = SystemUtils.filter(name);
   ...
   out.println("<tr><td>");
      ...
      if (req.getParameter("copy") != null) {
          out.println("<form action=\"Proshop_addfives\" method=\"post\" target=\"bot\">");
 ...
 private void doCopy(HttpServletRequest req, PrintWriter out, Connection con, int lottery) {
   ...
   try {
      ...
      if (b == true) {
         ...
         out.println("<form action=\"Proshop_fives\" method=\"post\" target=\"bot\">");
