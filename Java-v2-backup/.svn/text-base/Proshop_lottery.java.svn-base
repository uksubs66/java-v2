...
public class Proshop_lottery extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      while (rs.next()) {
         ...
         out.println("<form method=\"post\" action=\"Proshop_lottery\" target=\"bot\">");
         out.println("<td align=\"center\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   int allow_x = 0;
   int x_value = 0;
   int custom_int = 0;       // extra int for use in customs
   int recurrpro = 0;
   int recurrmem = 0;
   int recur_days = 0;
   ...
   try {
      ...
      if (rs.next()) {
         ...
         allow_x = rs.getInt("allowx");           // allow members to use X's 
         x_value = rs.getInt("xvalue");           // how to process an X (weight)
         custom_int = rs.getInt("custom_int");    // for use in customs
         recurrpro = rs.getInt("recurrpro");      // recurrence options
         recurrmem = rs.getInt("recurrmem");      
         recur_days = rs.getInt("recur_days");          
   ...
   out.println("<tr><td>");
     ...
     if (sheet.equals( "yes" )) {
      ...
      out.println("<table border=\"1\" cellpadding=\"8\" cellspacing=\"8\" bgcolor=\"#F5F5DC\">");
            out.println("<tr><td width=\"600\">");    // was 580
               out.println("<font size=\"2\">");
            ...
            if (multi != 0) {
              ...
              out.println("</select><br><br>");
               ...
               out.println("&nbsp;&nbsp;End Time:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; hr &nbsp;&nbsp;");
                ...
                out.println("&nbsp;&nbsp;Color to make the lottery times on the tee sheet:&nbsp;&nbsp;");
                 ...
                 if (club.equals("desertmountain")) {
                    out.println("<option " + (sdays == 365 ? "selected " : "") + "value=\"365\">365</option>");
                 }
                  out.println("</select>");
                  out.println("<br><br>");
               out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;at:");
               ...
               if (club.equals("oaklandhills")) {   // custom parm for Oakland Hills CC (MAX # of Members allowed per request)
...
*/
             ...
             out.println("<br><br>");
               ...
               out.println("If yes, specify the max number of days that members can recur a request<BR>&nbsp;&nbsp;&nbsp; (0 = end date of this lottery, max = 365):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
                     out.println("<input type=\"text\" size=\"3\" maxlength=\"3\" value=\"" +recur_days+ "\" name=\"recur_days\">");
               out.println("<br><br>");
             ...
             out.println("<br>(Not necessary for any other types)<br><br>");
               ...
               out.println("Number of lottery points to assess for a weekday round:&nbsp;&nbsp;&nbsp;");
                 out.println("<select size=\"1\" name=\"wdpts\">");
                   if (wdpts == 0) {
                      out.println("<option selected value=\"00\">0</option>");
                   } else {
      ...
      out.println("</p></font></td></tr></table></form>");
      out.println("</td></tr></table>");                       // end of main page table
