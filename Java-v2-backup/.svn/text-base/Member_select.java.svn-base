 ...
 *   last updated:
 * 
 *        5/23/14   Philadelphia Cricket Club (philcricket) - commented out seamless link to their Recip site.
...
*/
   ...
   try {
      ...
      Utilities.logError("Member_select: Err=" + org.apache.commons.lang.exception.ExceptionUtils.getStackTrace(exc));
...
/*
  ...
  */ 
   ...
   if ((club.equals( "brooklawn" ) || club.equals( "sharonheights" ) || club.equals( "greenhills" ) || club.equals( "seacliffcc" ) ||
        club.equals( "paloaltohills" ) || club.equals( "rhillscc" ) || club.equals("indianhillscc") || club.equals("llnhga") ||
        club.equals("algonquin") || club.equals("rivieracc") || club.equalsIgnoreCase("lakesidecc")) && mtype.endsWith( "Female" )) {
      ...
      if (club.equals( "brooklawn" )) {
         ...
         if ((msubtype.equals( "18 Holer" ) || msubtype.equals( "9/18 Holer" )) && dateShort >= 427 && dateShort <= 1012) {  //between april 27th - october 12th
         ...
         if ((msubtype.equals("9 Holer") || msubtype.equals( "9/18 Holer" )) && dateShort >= 427 && dateShort <= 1012) {  //between april 27th - october 12th
         ...
         if (club.equals("seacliffcc")) {   // Seacliff
          ...
          parm.advdays3 = 14;
          parm.advdays5 = 14;
      } else if (club.equalsIgnoreCase("lakesidecc") && (mtype.equals("Dependent Female") || mtype.equals("Primary Female") || mtype.equals("Spouse Female"))) {
              
          days3 = 14;
          advtime[2] = 14;
          parm.advdays3 = 14;
          max = 14;
      } else if(club.equalsIgnoreCase("llnhga") && msubtype.equals("BCM")) {   //all BCM subtypes to book times 8 days out at 8am
   ...
   } else if (club.equalsIgnoreCase("woodranch") && (mtype.equals("Primary Female") || mtype.equals("Secondary Female"))) {
...
//             if (thisDate <= 20150620 && (mtype.endsWith( "Male" ) || mtype.equalsIgnoreCase("Cert Dependent over 16") ||
//                 mtype.endsWith("Dependent"))) {    // Brooklawn Custom for 6/20/15 (case 1985)
//
//                if ((thisDate > 20150521 || (thisDate == 20150521 && cal_time >= 900)) && index > 0) {
//
//                   //
//                   //  Allow member access on 6/20/15 for a tee time event
//                   //
...
//
//                   if (DateB == 20150620) {         // if day of event
//
//                      daysArray.days[index] = 1;        // set ok in array
//
...
//             }
             ...
             if (thisDate <= 20150624) {    // Brooklawn Custom for 6/24/15 (case 2151)
                ...
                if ((thisDate > 20150520 || (thisDate == 20150520 && cal_time >= 900)) && index > 0) {

                   //
                   //  Allow member access to 6/24/15 on 5/20/15 for a tee time event
                   //
                   Calendar calB = new GregorianCalendar();             // get current date
                   calB.add(Calendar.DATE,index);                       // get this day's date
                   int yearB = calB.get(Calendar.YEAR);
                   ...
                   if (DateB == 20150624) {         // if day of event
             ...
             if (thisDate <= 20150711) {    // Brooklawn Custom for 7/11/14 (case 2265)

                if ((thisDate > 20150601 || (thisDate == 20150601 && cal_time >= 900)) && index > 0) {

                   //
                   //  Allow member access on 7/12/14 for a tee time event
                   //
                   Calendar calB = new GregorianCalendar();             // get current date
                   calB.add(Calendar.DATE,index);                       // get this day's date
                   int yearB = calB.get(Calendar.YEAR);
                   ...
                   if (DateB == 20150711) {         // if day of event
            ...
            if (mtype.equalsIgnoreCase("Primary Female") || mtype.equalsIgnoreCase("Spouse Female")) {
               ...
               if ((index < 7 || (index == 7 && cal_time >= 700)) && (DateB == 20140812 || DateB == 20140819 )) {         // if day of event
             ...
             if ((index < 30 || (index == 30 && cal_time >= 700)) && day_num != 1 && DateB != Hdate1 && DateB != Hdate2 && DateB != (Hdate7 + 1)) {    // Only show green day on Sundays, Mem Day, Labor Day, and the day after Thanksgiving Day
              
                 daysArray.days[index] = 0;        // set not okay in array
             }
         }
      }
   }
...
//            }
         ...
         if (club.equals("boulder")) {
             ...
             if (!IS_TLT) {
                 if (club.equalsIgnoreCase("indianridgecc")) {
                     out.println("<b>Tee Time Request Format:</b><br>");
                     out.println("All Tee Time requests may be submitted nine days prior at 7:00 AM through eight days prior at 3:00 PM.");
                     out.println("Times will be assigned in the evening, eight days prior, for the requested day.");
                     out.println("All other tee times will be available 7 days in advance at 7:00 AM.");
                     
                 } else if (club.equals("bwrc") && activity_id == 0) {
                     
                     out.println("On Wednesday evenings at 8:00 pm the online system will open for the upcoming Saturday through the following Friday.");
             ...
             if (!club.equals("bwrc") || activity_id != 0) {
        ...
        out.println("<span class=\"serverTime\">Today's date is: <b>" + day_name + "&nbsp;" + month + "/" + day + "/" + year + "</b></span>");
   ...
   */
      ...
      out.println("<input type=\"hidden\" name=\"calDate\" value=\"\">");
       ...
       if (!IS_TLT) {
           ...
           if (rwd) {
               out.print("<p id=\"hide_calendar_select\">"
                       + "<label onclick=\"\" class=\"standard_button\"><input type=\"checkbox\" name=\"select_jump\" id=\"select_jump\" value=\"1\"" + (memSettings.compactTeeSheet ? " checked" : "") + "> <span>Hide calendar on tee sheet</span></label>");
               out.print(" <a class=\"helpButton\" href=\"#\" data-fthelp=\"hide_calendar\" title=\"How is this used?\"><span>How is this used?</span></a>");
               out.print("<span>(Default for this option can be set in <a href=\"Member_services#golf\">Settings</a>.)</span>"
                       + "</p>");
           } else {
               out.print("<p id=\"hide_calendar_select\">"
                       + "<input type=\"checkbox\" name=\"select_jump\" id=\"select_jump\" value=\"1\"" + (memSettings.compactTeeSheet ? " checked" : "") + ">");
       ...
       if (club.equals("wingedfoot")) {
           ...
           out.println("<input class=\"standard_button\" type=submit value=\" Guest Quota Report \">");
           out.println("</form>");
       }
