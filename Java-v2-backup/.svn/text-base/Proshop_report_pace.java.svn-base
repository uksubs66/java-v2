 ...
 *   Revisions:  
 *
 *        6/27/13   Updated verbiage to use "Tee Times" instead of "Rounds" to avoid confusion.
 *        6/27/13   Fixed issue that was causing the Usage Report All Data report to only look back to 1/1 of the current year.
 *       11/19/12   MySQL 5.5 compatability fix for the doMemberAvgReport
 *       10/22/08   Add PoP Report to Old Tee Sheets (case 1392).
...
public class Proshop_report_pace extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    // start form to post
    out.println("<form method=post action=\"Proshop_report_pace\" name=frmWhichReport id=frmWhichReport>");
    ...
    out.println(" <tr><td colspan=3 align=center><br>" +
            "<!--<input type=\"button\" value=\"Home\" onclick=\"document.location.href='Proshop_announce'\" style=\"width:100px;text-decoration:underline;background:#8B8970\">" +
            " &nbsp; &nbsp; &nbsp; -->" +
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
                ...
                if (todo.endsWith("-lm")) {
                    ...
                    if (todo.endsWith("-tm")) {
                        ...
                        if (todo.equals("today")) {
                           ...
                           // check to see if call for Old Tee Sheet report
                           if (todo.equals("oldtee")) {
                         
                              try {
                                  sdate = Integer.parseInt(start_date);   // get date of old tee sheet
                                  edate = 0;
                              } catch (Exception e) {
                              }
                           }
    ...
    if (todo.equals("today")) {
        ...
        doTodayReport(todo, req, sdate, excel, out, con);
        out.println("<p>&nbsp;</p>");
        out.println("</body>");
        out.println("</html>");
        return;
    ...
    if (todo.equals("oldtee")) {
        ...
        doPreviousDayReport(req, sdate, excel, out, con);
        out.println("<p>&nbsp;</p>");
        out.println("</body>");
        out.println("</html>");
        return;
    ...
    out.println("&nbsp;<br><p align=center><a href=\"Proshop_report_pace\" style=\"color:#336633\">Return to Pace of Play Report Menu</a></p>");
 ...
 private void doTodayReport(String todo, HttpServletRequest req, long pTodaysDate, String pExcel, PrintWriter out, Connection con) {
        ...
        pstmt = con.prepareStatement("" +
            "SELECT *, ( " + 
                ...
                "FROM ( " + 
                    ...
                    "FROM pace_entries pe, " +teetable+ " tp " + 
        ...
        while (rs.next()) {
            ...
            if (!tmp_header) {
                ...
                if (!pExcel.equals("yes")) {     // if normal request
                    ...
                    out.println("<center><form method=post action=\"Proshop_report_pace\" name=frmRequestExcel id=frmRequestExcel target=\"_blank\">");
            ...
            if (course == null && pace_status_id == 0) {
                ...
                out.println("<!--<td></td>-->" +
                            "<td width=300><b>Tee times with pace of play recorded:</b></td>" +
                ...
                if (pace_status_id != 0) {
                    out.println("<td align=right>Tee times " + pace_status_name + ":</td><td>");
 ...
 private void doPreviousDayReport(HttpServletRequest req, long pTodaysDate, String pExcel, PrintWriter out, Connection con) {
    ...
    try {
        ...
        pstmt = con.prepareStatement(
        "SELECT courseName, " + 
            "front_9_pace/front_count as front_9_pace, " + 
            "back_9_pace/back_count as back_9_pace, " + 
            "18_pace/18_count as 18_pace, " + 
            "if(min_front_9=999999,null,min_front_9) as min_front_9, " + 
            "max_front_9, " + 
            "if(min_back_9=999999,null,min_back_9) as min_back_9, " + 
            "max_back_9, " + 
            "if(min_18=999999,null,min_18) as min_18, " + 
            "max_18, " + 
            "front_count, " + 
            "back_count, " + 
            "18_count, " + 
        ...
        "FROM ( " + 
        "SELECT courseName, " + 
           "SUM(if(h_9-t_start>1,h_9-t_start,null)) AS front_9_pace, " + 
           "SUM(if(h_18-h_9>1,h_18-h_9,null)) AS back_9_pace, " + 
           "SUM(if(t_18-t_start>1,t_18-t_start,null)) AS 18_pace, " + 
           "SUM(if(h_9-t_start,1,0)) as front_count, " + 
           "SUM(if(h_18-h_9>1,1,0)) as back_count, " + 
           "SUM(if(t_18-t_start>1,1,0)) as 18_count, " + 
           "MIN(ifnull(if(h_9-t_start>1,h_9-t_start,null),999999)) AS min_front_9, " + 
           "MAX(if(h_9-t_start>1,h_9-t_start,null)) AS max_front_9, " + 
           "MIN(ifnull(if(h_18-h_9>1,h_18-h_9,null),999999)) AS min_back_9, " + 
           "MAX(if(h_18-h_9>1,h_18-h_9,null)) AS max_back_9, " + 
           "MIN(ifnull(if(t_18-t_start>1,t_18-t_start,null),999999)) AS min_18, " + 
           "MAX(if(t_18-t_start>1,t_18-t_start,null)) AS max_18, " + 
           "COUNT(*) AS sample_size " + 
        "FROM ( " + 
            "SELECT  courseName, pe.teecurr_id, " + 
               "MAX(IF(hole_number=0,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_start, " + 
               "MAX(IF(invert=9,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_9, " + 
               "MAX(IF(invert=18,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_18, " + 
               "MAX(IF(hole_number=9,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS h_9, " + 
               "MAX(IF(hole_number=18,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS h_18 " + 
           ...
           "GROUP BY pe.teecurr_id " +   
           ") AS times " + 
        "WHERE t_9 IS NOT NULL or t_18 IS NOT NULL " + 
        "GROUP BY courseName " + 
        ") AS time_totals;");
        ...
        out.print("<center><font size=+2>Pace of Play ");
        if (!courseName.equals("")) out.print("<br>for " + courseName);
        out.print("</font><br><font size=+1>on " + pretty_date + "</font></center><br>");
        
        out.println("<table bgcolor=\"#F5F5DC\" align=center border=0 cellpadding=6><tr>");
        ...
        while (rs.next()) {
            ...
            min_front = rs.getInt("min_front_9");
            max_front = rs.getInt("max_front_9");
            min_back = rs.getInt("min_back_9");
            max_back = rs.getInt("max_back_9");
            min_18 = rs.getInt("min_18");
            max_18  = rs.getInt("max_18");
            
            out.println("<td align=right>Avg pace:</td>" + tmp_td + "<td>" + ((pace18 == 0) ? "N/A" : minToTime(pace18)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Min pace:</td>" + tmp_td + "<td>" + ((min_18 == 0) ? "N/A" : minToTime(min_18)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Max pace:</td>" + tmp_td + "<td>" + ((max_18 == 0) ? "N/A" : minToTime(max_18)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Avg front 9 pace:</td>" + tmp_td + "<td>" + ((front9 == 0) ? "N/A" : minToTime(front9)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Min front 9 pace:</td>" + tmp_td + "<td>" + ((min_front == 0) ? "N/A" : minToTime(min_front)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Max front 9 pace:</td>" + tmp_td + "<td>" + ((max_front == 0) ? "N/A" : minToTime(max_front)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Avg back 9 pace:</td>" + tmp_td + "<td>" + ((back9 == 0) ? "N/A" : minToTime(back9)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Min back 9 pace:</td>" + tmp_td + "<td>" + ((min_back == 0) ? "N/A" : minToTime(min_back)) + "</td></tr><tr>");
            out.println("<tr><td align=right>Max back 9 pace:</td>" + tmp_td + "<td>" + ((max_back == 0) ? "N/A" : minToTime(max_back)) + "</td></tr><tr>");
        ...
        out.println("<br><center><button onclick=\"javascript:history.back(1)\">Return</button></center>");
 ...
 private void doUsageReport(HttpServletRequest req, long pStartDate, long pEndDate, String pExcel, PrintWriter out, Connection con) {
    ...
    try {
        ...
        boolean tmp_header = false;
        int wpace = 0;      // total tee times w/ pace
        int wopace = 0;     // total tee times w/o pace
        int rounds = 0;     // total tee times
        ...
        while (rs.next()) {
            ...
            if (!tmp_header) {
                ...
                out.println("<tr bgcolor=\"#336633\">" +
                                ...
                                "<td><font color=white><b>Tee Times</b></font></td>" +
 ...
 private void doMemberReport(HttpServletRequest req, long pStartDate, long pEndDate, String pExcel, PrintWriter out, Connection con) {
    ...
    // bail out if no tee times with pace data were found for this member
    if (!found) {

        // this member has no tee times with pace of play data collected
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (multi == 1 && !tmp_last.equals(courseName) && courseName != null) {
                ...
                tmp_last = courseName;
                out.println("<tr>");
                out.println("<td>" + nf.format(rounds) + " tee times</td>");
                ...
                if (multi == 1 && courseName == null) {
                    ...
                    out.println("<tr>");
                    out.println("<td colspan=2 align=center><b>Total Tee Times with Pace Data: " + nf.format(rounds) + "</td>");
                    out.println("</tr>");
                    ...
                    if (pace_status_id == 0) {
                        ...
                        // total for course
                        out.println("<tr>");
                        out.println("<td colspan=2 align=center><i>" + nf.format(rounds) + " tracked tee times</i></td>");
                        out.println("</tr>");
 ...
 private void doMemberAvgReport(HttpServletRequest req, long pStartDate, long pEndDate, String pExcel, PrintWriter out, Connection con) {
    ...
    if (!pExcel.equals("yes")) {
        ...
        out.println("<tr valign=top>" +
                ...
                "<td><font size=2>Pace times shown are averages during the time period selected.&nbsp; The sample<br>column contains the number of tee times their pace times are based upon.</font></td></tr>" +
                "</tr>");
        out.println("</table>");
    }
    ...
    try {
        ...
        String sql =
            "SELECT name_last, " +
               ...
               "sample_size, " +
               "teecurr_ids " +
               "FROM ( SELECT group_concat(teecurr_id SEPARATOR ',') AS teecurr_ids, name_last, name_first, username, courseName, " +
                      "SUM(h_9-t_start) AS front_9_pace, " +
                      "SUM(h_18-h_9) AS back_9_pace, " +
                      "SUM(t_18-t_start) AS 18_pace, " +
                      "SUM(if(h_9-t_start,1,0)) as front_count, " +
                      "SUM(if(h_18-h_9,1,0)) as back_count, " +
                      "SUM(if(t_18-t_start,1,0)) as 18_count, " +
                      "MIN(ifnull(h_9-t_start,999999)) AS min_front_9, " +
                      "MAX(h_9-t_start) AS max_front_9, " +
                      "MIN(ifnull(h_18-h_9,999999)) AS min_back_9, " +
                      "MAX(h_18-h_9) AS max_back_9, " +
                      "MIN(ifnull(t_18 - t_start,999999)) AS min_18, " +
                      "MAX(t_18 - t_start) AS max_18, " +
                      "COUNT(*) AS sample_size " +
                  "FROM ( " +
                      "SELECT teecurr_id, fb, name_last, name_first, username, courseName, t_start, t_9, t_18, h_9, h_18 " +
                              "FROM member2b m2b, ( " +
                                  "SELECT  tp.teecurr_id, fb, username1, username2, username3, username4, username5, courseName, " + // pe.teecurr_id, 
                                      "MAX(IF(hole_number=0,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_start, " +
                                      "MAX(IF(invert=9,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_9, " +
                                      "MAX(IF(invert=18,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS t_18, " +
                                      "MAX(IF(hole_number=9,HOUR(pe.hole_timestamp)*60+MINUTE(pe.hole_timestamp),null)) AS h_9, " +
                                  ...
                                  "WHERE pe.teecurr_id = tp.teecurr_id " +
                                      "AND (pe.hole_number = 0 OR pe.invert = 9 OR pe.invert = 18) " +
                                      ((pStartDate == 0 && pEndDate == 0) ? "" : "AND tp.date BETWEEN ? AND ? ") +
                                  "GROUP BY pe.teecurr_id " +
                                  ") AS times " +
                              "WHERE ( " +
                                     "times.username1 = m2b.username " +
                          ...
                          "ORDER BY name_last, name_first, courseName " +
            ") AS time_totals;";
        ...
        while (rs.next()) {
            ...
            out.println("<td>" + ((pace18 == 0) ? "N/A" : minToTime(pace18)) + "</td>");
            out.println("<td>" + ((front9 == 0) ? "N/A" : minToTime(front9)) + "</td>");
            out.println("<td>" + ((back9 == 0) ? "N/A" : minToTime(back9)) + "</td>");
...
/*            "SELECT *, ( " + 
        ...
        String tmp_last = "lkjfliuwenvdjadkfa";
        String course = "";
        String pace_status_name = "";
        int pace_status_id = 0;
        int overall = 0;
        ...
        while (rs.next()) {
            ...
            if (course == null && pace_status_id == 0) {
                ...
                out.println("<td width=300><b>Tee times with pace of play recorded:</b></td>" +
                            "<td colspan=2><b>" + nf.format(overall) + "</b></td>"); // total rounds with pace data
                tmp_gtotal = overall;
                ...
                // if we're switching courses OR going from the overall rollup
                if (!tmp_last.equals(course) && multi == 1) {

                    out.println("<td>&nbsp; &nbsp; &nbsp; <b><u>" + course + "</u></b></td>" +
                        "<td><b>" + (buildDisplayValue(tmp_total, tmp_gtotal, pExcel)) + "</td></tr><tr>");
                    
                    doCourseAvgReport(pStartDate, pEndDate, course, pExcel, out, con);
                    /*out.println("<td align=right>Average pace for 18 holes:</td>" +
                        ((!pExcel.equals("")) ? "<td></td>" : "") + 
                        "<td colspan=2>" + minToTime(avg) + "</td></tr><tr>");*/

                } else if (!tmp_last.equals(course)) {
        ...
        if (!tmp_header) {
            ...
            out.println("<tr><td colspan=3><p align=center>No tee times were found during the requested time frame that contain pace of play data.");
 ...
 private void doCourseAvgReport(long pStartDate, long pEndDate, String pCourseName, String pExcel, PrintWriter out, Connection con) {
    ...
    "FROM ( " + 
       ...
       "FROM ( " + 
        ...
        while (rs.next()) {
            ...
            if (pExcel.equals("yes")) tmp_td = "<td></td>";
 ...
 private void getCustomDate(HttpServletRequest req, PrintWriter out, Connection con) {
    ...
    out.println("<b>Note:</b>  Only tee times before today will be included in the counts.<br><br>");
    out.println("Click on <b>Generate Report</b> to build the report.</font></td></tr>");
    out.println("</table><br>");

    // start date submission form
    out.println("<form action=\"Proshop_report_pace\" method=\"post\">");
     out.println("<input type=hidden name=todo value=\""+ todo +"\">");
     out.println("<input type=hidden name=username value=\""+ username +"\">");
    ...
    out.println("<form method=\"get\" action=\"Proshop_report_pace\">");
