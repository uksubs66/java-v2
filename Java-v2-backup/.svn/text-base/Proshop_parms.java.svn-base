 ...
 *        3/07/12   TAI POS changes - add item fee and sales tax parms for Birmingham CC (others may follow after TAI makes the updates).
 *       12/14/11   Updated tpos text fields to have a max length of 30 instead of 20 (it looks like we updated this for one POS type earlier, but not for all of them).
 *       11/18/10   Typo fix for single course Insert statement
 *        9/24/10   Add a 'salestax' field to MOTs for CSG POS I/F.
...
public class Proshop_parms extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   try {
      ...
      if (multi == 0) {
         ...
         out.println("<form action=\"Proshop_parms\" method=\"post\" target=\"bot\">");
         out.println("<tr>");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   double [] salestaxA = new double [parm.MAX_Tmodes+1];
   ...
   if (req.getParameter("Submit") != null) {         // Process a request to add or change the parms
      ...
      for (i=1; i<parm.MAX_Tmodes+1; i++) {
         ...
         try {
            ...
            if (req.getParameter("salestax" + i) != null) salestaxA[i] = Double.parseDouble(req.getParameter("salestax" + i));

         } catch (Exception exc1) {

            error = true;           // indicate salestax error
         }
      ...
      if (posType.equals( "IBS" ) || posType.equals( "ClubSystems Group" ) || posType.equals( "Jonas Generic" ) || posType.equals( "Abacus21 Direct" ) || 
         ...
         for (i = 1; i < parm.MAX_Tmodes; i++) {                // check all tmodes
            ...
            if (tposcA[i].startsWith( "$" )) {

               tposcA[i] = tposcA[i].substring(1);      // strip it
            }
            
            if (t9poscA[i].startsWith( "$" )) {
             
               t9poscA[i] = t9poscA[i].substring(1);      // strip it
            }
         }
      }
      ...
      //
      //  Check for both POS Codes
      //
      error = false;
       
      for (i=1; i<parm.MAX_Tmodes+1; i++) {
        
         if ((!tposA[i].equals( "" ) && t9posA[i].equals( "" )) || (tposA[i].equals( "" ) && !t9posA[i].equals( "" ))) {

             error = true;      // error - warn user
             break;
         } 
      }
         ...
         if (multi == 0) {
            ...
            if (rs.next()) {
               ...
               PreparedStatement pstmt2 = con.prepareStatement (
                  ...
                  "tmode1_salestax = ?, tmode2_salestax = ?, tmode3_salestax = ?, tmode4_salestax = ?, tmode5_salestax = ?, tmode6_salestax = ?, tmode7_salestax = ?, tmode8_salestax = ?, " +
                  "tmode9_salestax = ?, tmode10_salestax = ?, tmode11_salestax = ?, tmode12_salestax = ?, tmode13_salestax = ?, tmode14_salestax = ?, tmode15_salestax = ?, tmode16_salestax = ? " +
                  "WHERE first_hr = ?");
               ...
               pstmt2.setDouble(122, salestaxA[1]);
               pstmt2.setDouble(123, salestaxA[2]);
               pstmt2.setDouble(124, salestaxA[3]);
               pstmt2.setDouble(125, salestaxA[4]);
               pstmt2.setDouble(126, salestaxA[5]);
               pstmt2.setDouble(127, salestaxA[6]);
               pstmt2.setDouble(128, salestaxA[7]);
               pstmt2.setDouble(129, salestaxA[8]);
               pstmt2.setDouble(130, salestaxA[9]);
               pstmt2.setDouble(131, salestaxA[10]);
               pstmt2.setDouble(132, salestaxA[11]);
               pstmt2.setDouble(133, salestaxA[12]);
               pstmt2.setDouble(134, salestaxA[13]);
               pstmt2.setDouble(135, salestaxA[14]);
               pstmt2.setDouble(136, salestaxA[15]);
               pstmt2.setDouble(137, salestaxA[16]);
                 
               pstmt2.setInt(138, temp);
               ...
               pstmt3.setDouble(123, salestaxA[1]);
               pstmt3.setDouble(124, salestaxA[2]);
               pstmt3.setDouble(125, salestaxA[3]);
               pstmt3.setDouble(126, salestaxA[4]);
               pstmt3.setDouble(127, salestaxA[5]);
               pstmt3.setDouble(128, salestaxA[6]);
               pstmt3.setDouble(129, salestaxA[7]);
               pstmt3.setDouble(130, salestaxA[8]);
               pstmt3.setDouble(131, salestaxA[9]);
               pstmt3.setDouble(132, salestaxA[10]);
               pstmt3.setDouble(133, salestaxA[11]);
               pstmt3.setDouble(134, salestaxA[12]);
               pstmt3.setDouble(135, salestaxA[13]);
               pstmt3.setDouble(136, salestaxA[14]);
               pstmt3.setDouble(137, salestaxA[15]);
               pstmt3.setDouble(138, salestaxA[16]);
            ...
            if (oldName.equals( "" )) {
               ...
               if (rs.next()) {
                  ...
                  pstmt4.setDouble(123, salestaxA[1]);
                  pstmt4.setDouble(124, salestaxA[2]);
                  pstmt4.setDouble(125, salestaxA[3]);
                  pstmt4.setDouble(126, salestaxA[4]);
                  pstmt4.setDouble(127, salestaxA[5]);
                  pstmt4.setDouble(128, salestaxA[6]);
                  pstmt4.setDouble(129, salestaxA[7]);
                  pstmt4.setDouble(130, salestaxA[8]);
                  pstmt4.setDouble(131, salestaxA[9]);
                  pstmt4.setDouble(132, salestaxA[10]);
                  pstmt4.setDouble(133, salestaxA[11]);
                  pstmt4.setDouble(134, salestaxA[12]);
                  pstmt4.setDouble(135, salestaxA[13]);
                  pstmt4.setDouble(136, salestaxA[14]);
                  pstmt4.setDouble(137, salestaxA[15]);
                  pstmt4.setDouble(138, salestaxA[16]);

                  pstmt4.setInt(139, temp);
                  ...
                  pstmt5.setDouble(123, salestaxA[1]);
                  pstmt5.setDouble(124, salestaxA[2]);
                  pstmt5.setDouble(125, salestaxA[3]);
                  pstmt5.setDouble(126, salestaxA[4]);
                  pstmt5.setDouble(127, salestaxA[5]);
                  pstmt5.setDouble(128, salestaxA[6]);
                  pstmt5.setDouble(129, salestaxA[7]);
                  pstmt5.setDouble(130, salestaxA[8]);
                  pstmt5.setDouble(131, salestaxA[9]);
                  pstmt5.setDouble(132, salestaxA[10]);
                  pstmt5.setDouble(133, salestaxA[11]);
                  pstmt5.setDouble(134, salestaxA[12]);
                  pstmt5.setDouble(135, salestaxA[13]);
                  pstmt5.setDouble(136, salestaxA[14]);
                  pstmt5.setDouble(137, salestaxA[15]);
                  pstmt5.setDouble(138, salestaxA[16]);
               ...
               pstmt6.setDouble(123, salestaxA[1]);
               pstmt6.setDouble(124, salestaxA[2]);
               pstmt6.setDouble(125, salestaxA[3]);
               pstmt6.setDouble(126, salestaxA[4]);
               pstmt6.setDouble(127, salestaxA[5]);
               pstmt6.setDouble(128, salestaxA[6]);
               pstmt6.setDouble(129, salestaxA[7]);
               pstmt6.setDouble(130, salestaxA[8]);
               pstmt6.setDouble(131, salestaxA[9]);
               pstmt6.setDouble(132, salestaxA[10]);
               pstmt6.setDouble(133, salestaxA[11]);
               pstmt6.setDouble(134, salestaxA[12]);
               pstmt6.setDouble(135, salestaxA[13]);
               pstmt6.setDouble(136, salestaxA[14]);
               pstmt6.setDouble(137, salestaxA[15]);
               pstmt6.setDouble(138, salestaxA[16]);
                 
               pstmt6.setString(139, oldName);
      ...
      out.println("<BR><BR>");
      out.println("<font size=\"2\">");
      out.println("<form method=\"get\" action=\"Proshop_parms\">");
      out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
      out.println("</form>");
 ...
 private void buildParms(HttpServletRequest req, HttpServletResponse resp, PrintWriter out, Connection con, 
   ...
   double [] salestax = new double [parm.MAX_Tmodes+1];
      ...
      try {
         ...
         if (rs.next()) {
            ...
            for (int j=1; j <= 16; j++) {
                ...
                salestax[j] = rs.getDouble("tmode" + String.valueOf(j) + "_salestax");
            }     
         }
         stmt.close();
   ...
   out.println("<font face=\"Arial, Helvetica, Sans-serif\">");
      ...
      out.println("<font size=\"2\" face=\"Arial, Helvetica, Sans-serif\">");
      out.println("<form action=\"Proshop_parms\" method=\"post\" target=\"bot\" name=\"f\">");
      ...
      out.println("<br><table border=\"2\" bgcolor=\"#F5F5DC\">");
         ...
         if (multi != 0 && (posType.equals( "Abacus21" ) || posType.equals( "Jonas" ))) {
         ...
         out.println("<tr>");
            ...
            out.println("<td valign=\"top\" align=\"right\">");
             ...
             //  } else if (posType.equals( "IBS" ) || posType.equals( "ClubSystems Group" ) || (posType.equals( "TAI Club Management" ) && club.equals("bhamcc"))) {
                        ...
                        out.println("<br><br>Specify the <b>Sales Tax Rate (i.e. 5.75)</b> for each &nbsp;&nbsp; " +
                                    "<br>Transportation Mode with an Item Code.&nbsp;&nbsp;");
               } else if (posType.equals( "Abacus21 Direct" )) {
                        out.println("<br><br>Specify the <b>Item Codes</b> &nbsp;&nbsp;");
                        out.println("<br>and the associated <b>Fee (i.e. 45.50)</b> &nbsp;&nbsp;");
                        out.println("<br>for the POS System for each &nbsp;&nbsp;");
                        out.println("<br>appropriate Transportation Mode.&nbsp;&nbsp;");
               } else if (posType.equals( "Jonas Generic" )) {
                        out.println("<br><br>Specify the <b>Item Group Codes</b> &nbsp;&nbsp;");
                        out.println("<br>and the associated <b>Fee (i.e. 45.50)</b> &nbsp;&nbsp;");
                        out.println("<br>for the POS System for each &nbsp;&nbsp;");
                        out.println("<br>appropriate Transportation Mode.&nbsp;&nbsp;");
                        out.println("<br><br>Specify the <b>Sales Tax Rate (i.e. 5.75)</b> for each &nbsp;&nbsp; " +
               ...
               } else if (posType.equals( "IBS" ) || posType.equals( "ClubSystems Group" ) || posType.equals( "Jonas Generic" )) {
                  out.println("</td><td width=\"560\" align=\"left\">");
               } else if (posType.equals( "Abacus21 Direct" )) {
                  out.println("</td><td width=\"520\" align=\"left\">");
               } else if (!posType.equals( "" ) && !posType.equals( "None" )) {
             ...
             //  } else if (posType.equals("IBS") || posType.equals( "ClubSystems Group" ) || (posType.equals( "TAI Club Management" ) && club.equals("bhamcc"))) {
               ...
               for (i = 1; i < parm.MAX_Tmodes + 1; i++) {              // do all tmodes
                 ...
                 //  } else if (posType.equals("IBS") || (posType.equals( "TAI Club Management" ) && club.equals("bhamcc"))) {
                       ...
                       out.println("<td><input type=\"text\" name=\"tpos" +i+ "\" value=\"" + tpos[i] + "\" size=\"5\" maxlength=\"30\"></td>");
                       out.println("<td><input type=\"text\" name=\"tposc" +i+ "\" value=\"" + tposc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9pos" +i+ "\" value=\"" + t9pos[i] + "\" size=\"5\" maxlength=\"30\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9posc" +i+ "\" value=\"" + t9posc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                       out.println("<td><input type=\"text\" name=\"salestax" +i+ "\" value=\"" + salestax[i] + "\" size=\"6\" maxlength=\"8\"></td>");
                   } else if (posType.equals("Abacus21 Direct")) {
                       out.println("<td><input type=\"text\" name=\"tpos" +i+ "\" value=\"" + tpos[i] + "\" size=\"10\" maxlength=\"30\"></td>");
                       out.println("<td><input type=\"text\" name=\"tposc" +i+ "\" value=\"" + tposc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9pos" +i+ "\" value=\"" + t9pos[i] + "\" size=\"10\" maxlength=\"30\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9posc" +i+ "\" value=\"" + t9posc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                   } else if (posType.equals( "ClubSystems Group" )) {
                       out.println("<td><input type=\"text\" name=\"tpos" +i+ "\" value=\"" + tpos[i] + "\" size=\"3\" maxlength=\"3\"></td>");
                       out.println("<td><input type=\"text\" name=\"tposc" +i+ "\" value=\"" + tposc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9pos" +i+ "\" value=\"" + t9pos[i] + "\" size=\"3\" maxlength=\"3\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9posc" +i+ "\" value=\"" + t9posc[i] + "\" size=\"6\" maxlength=\"6\"></td>");
                       out.println("<td><input type=\"text\" name=\"salestax" +i+ "\" value=\"" + salestax[i] + "\" size=\"6\" maxlength=\"8\"></td>");
                   } else if (posType.equals( "Jonas Generic" )) {
                       out.println("<td><input type=\"text\" name=\"tpos" +i+ "\" value=\"" + tpos[i] + "\" size=\"8\" maxlength=\"10\"></td>");
                       out.println("<td><input type=\"text\" name=\"tposc" +i+ "\" value=\"" + tposc[i] + "\" size=\"6\" maxlength=\"8\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9pos" +i+ "\" value=\"" + t9pos[i] + "\" size=\"8\" maxlength=\"10\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9posc" +i+ "\" value=\"" + t9posc[i] + "\" size=\"6\" maxlength=\"8\"></td>");
                       out.println("<td><input type=\"text\" name=\"salestax" +i+ "\" value=\"" + salestax[i] + "\" size=\"6\" maxlength=\"8\"></td>");
                   } else if (!posType.equals("") && !posType.equals("None")) {
                       out.println("<td><input type=\"text\" name=\"tpos" +i+ "\" value=\"" + tpos[i] + "\" size=\"5\" maxlength=\"30\"></td>");
                       out.println("<td><input type=\"text\" name=\"t9pos" +i+ "\" value=\"" + t9pos[i] + "\" size=\"5\" maxlength=\"30\"></td>");
