...
public class Proshop_frost extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   out.println("<table border=\"1\" cols=\"2\" bgcolor=\"#F5F5DC\" cellpadding=\"6\" align=\"center\">");
      out.println("<form action=\"Proshop_frost\" method=\"post\" target=\"bot\" name=\"f\">");
      ...
      out.println("<form action=\"Proshop_sheet\" method=\"post\" target=\"bot\">");
      out.println("<input type=\"hidden\" name=\"course\" value=\"" +course+ "\">");
      out.println("<input type=\"hidden\" name=\"index\" value=\"" + index + "\">");
         out.println("<p align=\"center\">");
...
*/
   ...
   if (emailOpt.equalsIgnoreCase( "yes" )) {
      ...
      sendEmails(date, course, club, con);
   }
 ...
 private void sendEmails(long date, String course, String club, Connection con) {
...
*/
   ...
   try {
      ...
      pstmt1 = con.prepareStatement (
         "SELECT " +
             "mm, dd, yy, day, hr, min, time, player1, player2, player3, player4, " +
 ...
 private void dbError(PrintWriter out, Exception e1, int index, String course, String eMsg) {
      ...
      out.println("<BR><BR>");
      out.println("<font size=\"2\">");
      out.println("<a href=\"Proshop_sheet?index=" +index+ "&course=" +course+ "\">");
