...
public class ForeTeesSetting {
    ...
    public ForeTeesSetting(){}; // Empty parm
    
    public ForeTeesSetting(ResultSet rs){
        loadFromResultSet(rs);
    }
    
    public ForeTeesSetting(long id, Connection con_ft){
        loadById(id, con_ft);
    }
    
    public ForeTeesSetting(long id){
        Connection con_ft = ApiCommon.getConnection();
        loadById(id, con_ft);
        Connect.close(con_ft);
    }
    
    public ForeTeesSetting(String name, Connection con_ft){
        loadByName(name, con_ft);
    }
    
    public ForeTeesSetting(String name){
        Connection con_ft = ApiCommon.getConnection();
        loadByName(name, con_ft);
        Connect.close(con_ft);
    }
    ...
    public static String getTextValue(String name, String default_value, boolean log_default, Connection con_ft) {
        String result;
        ForeTeesSetting setting = new ForeTeesSetting(name, con_ft);
    ...
    public static List<ForeTeesSetting> getList(){
        return getList(null);
    }
    
    public static List<ForeTeesSetting> getList(Long id){
        
        List<ForeTeesSetting> result = new ArrayList<ForeTeesSetting>();
        ...
        ForeTeesSetting r = new ForeTeesSetting();
