 ...
 * 
 *
 *      05/28/13 - Updated IP/PORT for our outgoing smtp server - smtp auth now off by default
...
public class parmSMTP {
   ...
   public String SMTP_ADDR = "10.0.0.26";  // 216.243.184.67 216.243.184.88
   public String SMTP_PORT = "25";   // 20025
   ...
   public boolean SMTP_AUTH = false;
