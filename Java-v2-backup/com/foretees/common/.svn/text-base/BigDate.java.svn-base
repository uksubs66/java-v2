...
/**
  ...
  *
  * @author  copyright (c) 1997-2004 Roedy Green, Canadian Mind Products
  * Shareware that may be copied and used freely for any purpose but military.
  *
  * See also com.mindprod.holidays.Holiday to compute various holidays
  * and com.mindprod.holidays.IsHoliday to tell if a given day is a holiday.
  */
public class BigDate implements Cloneable, java.io.Serializable, Comparable
   {
   ...
   /* version history
        ...
        *                   IllegalArgumentException in some JVMs.
        *                   Place warnings about Sunday base incompatibilities.
        * 3.6 1999 November 24
        *                   add getCalendarDayOfWeek and calendarDayOfWeek
        * 3.7 2001 January 26
        *                   properly implement Comparable with Object instead of BigDate
        * 3.8 2001 March 17
        *                   add code to TestDate to calculate how many sleeps until Christmas.
        * 3.9 2002 March 16 make toString non-final so you can override it.
        * 4.0 2002 April 10 addDays convenience method
        *                   toString now displays ISO format yyyy-mm-dd
        *                   TestDate examples changed to use addDays.
        * 4.3 2003 May 18   Default is now British rather than Pope Gregory's rules for
        *                   when the missing days were dealt with.
        * 4.4 2003 Aug 5    getDowMMDDYY -- alternative to toString, mainly to show how to roll
        *                   your own methods.
        * 4.5 2003 Sep 12   Added constructor that takes a Date and TimeZone.
        *                   added setDateAtTime.
        */
    ...
    * For Britain, the USA and Canada it should be true.
    *
    */
   ...
   /**
     ...
     * @see #NORMALISE
     */
   public static final int NORMALIZE = NORMALISE;
   ...
   "BigDate 4.5 shareware copyright (c) 1997-2004 Roedy Green, Canadian Mind Products, roedyg@mindprod.com";
   ...
   /**
     * Constant: month  of the last date
     * of the old Julian Calendar
     * Pope Gregory: 1582 Oct 4, British: 1752 Sep 2
     */
   private static final int OJC_lastMM = isBritish ? 9 : 10;

   /**
     * Constant: day of the last day of the month  of the old Julian
     * calendar.  Pope Gregory: 1582 Oct 4, British: 1752 Sep 2
     */
   ...
   /**
     ...
     * daysp.  Different parts of the world made the transition
     * at different times. Pope Gregory: 1582 Oct 4, British: 1752 Sep 2

     */
   private static final int GC_firstYYYY = isBritish ? 1752 : 1582;

   /**
     * Constant: month of the first date  of the Gregorian Calendar.
     * Pope Gregory: 1582 Oct 15, British: 1752 Sep 14
     */
   private static final int GC_firstMM = isBritish ? 9 : 10;

   /**
     * Constant: day of the first day of the month of the Gregorian Calendar
     * Pope Gregory: 1582 Oct 15, British: 1752 Sep 14
     */
    ...
    *
    * @param prolepticJulianDay days since 4713 BC Jan 1 noon.
    ...
    * e.g. 2000-3-20 noon is 2,451,624 in proleptic day numbers.
   ...
   public BigDate (double prolepticJulianDay)
      {
      setOrdinal((int)((long)(prolepticJulianDay
    ...
    *
    * @param timeZone Which timeZone do you want to know the date for that UTC time.
    *                 e.g. TimeZone.getDefault(), new TimeZone("GMT")
    */
   ...
   /**
     ...
     * You can find out how many ISO weeks there are per year with
   ...
   */
   ...
   /**
    * Sets the date that corresponding to a given utc timestamp
    * at a given TimeZone.
    *
    * @param utcTimestamp
    *                 milliseconds since 1970 in UTC time. E.g. Date.getTime
    *
    * @param timeZone Timezone you want to know the date in at that time.
    *                 TimeZone.getDefault() TimeZone.getU
    */
   public void setDateAtTime ( long utcTimestamp, TimeZone timeZone )
       ...
       * :return the offset in millis to add *to* GMT to get local time.
       */
      int offsetInMillis = timeZone.getOffset(getOrdinal() >= Jan_01_0001 ? 1:0,
                                              getYYYY(),
                                              getMM()-1,
                                              getDD(),
                                              getCalendarDayOfWeek(),
