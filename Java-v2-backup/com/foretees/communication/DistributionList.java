 ...
 *       6/28/11  Burlington CC (burlington) - Added custom message for add distribution list page.
...
public class DistributionList {
  ...
  public static final int LIST_NAME_MAX_LENGTH_PRO = 60;        // max length of name field in pro dist list
  public static final int MAX_NUM_LISTS = 25;
  public static final int MAX_LIST_SIZE = 30;
  public static final int MAX_LIST_SIZE_PROSHOP = 99999;          // was 100, use this number in case it is still accessed somewhere
  public static final String TABLE_NAME = "dist4";
 // public static final String TABLE_NAME_PROSHOP = "dist4p";
  public static final String TABLE_NAME_PROSHOP = "distribution_lists";   // new - allows unlimited number of entries
  ...
  public static final String NOTE_MEMBER_BURLINGTON = "<b>Note: </b>The maximum number of members per distribution list is 10.  If you attempt to add more than 10 you will recieve an error message and the \"Select Members...\" link will be disabled.  Also note that only members that have an email address registered with the system will be allowed to be added to a distribution list.";
 // public static final String NOTE_PROSHOP = "<b>Note: </b>The maximum number of members per distribution list is " + MAX_LIST_SIZE_PROSHOP + ".  If you attempt to add more than " + MAX_LIST_SIZE_PROSHOP + " you will recieve an error message and the \"Select Members...\" link will be disabled.  Also note that only members that have an email address registered with the system will be allowed to be added to a distribution list.";
  public static final String NOTE_PROSHOP = "<b>Note: </b>There is no limit to the number of members per distribution list.  Please note that only members that have an email address registered with the system will be allowed to be added to a distribution list.";
  ...
  **/
  ...
  public FeedBack isListNameValid(String theParamName, HttpServletRequest theRequest)
  {
    ...
    if (name != null)
    {
      if (name.length() < LIST_NAME_MIN_LENGTH || name.length() > LIST_NAME_MAX_LENGTH_PRO)
      {
  ...
  **/
  ...
  public static int getMaxListSize(HttpSession session)
  {
    ...
    {
      max_list_size = DistributionList.MAX_LIST_SIZE_PROSHOP;   // now unlimited, but set to 99999 
    }
