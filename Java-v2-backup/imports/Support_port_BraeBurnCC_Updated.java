...
*/           
            ...
            if (mship.equalsIgnoreCase("A")) {
                mship = "Regular Golf";
            } else if (mship.equalsIgnoreCase("D21")) {
                mship = "Inter Golf M 21-28";
            } else if (mship.equalsIgnoreCase("D29")) {
                mship = "Inter Golf M 29-30";
            } else if (mship.equalsIgnoreCase("D31")) {
                mship = "Inter Golf M 31-32";
            } else if (mship.equalsIgnoreCase("D33")) {
                mship = "Inter Golf M 33-34";
            } else if (mship.equalsIgnoreCase("E21")) {
                mship = "Inter Golf S 21-26";
            } else if (mship.equalsIgnoreCase("E27")) {
                mship = "Inter Golf S 27-28";
            } else if (mship.equalsIgnoreCase("E29")) {
                mship = "Inter Golf S 29-30";
            } else if (mship.equalsIgnoreCase("E31")) {
                mship = "Inter Golf S 31-32";
            } else if (mship.equalsIgnoreCase("E33")) {
                mship = "Inter Golf S 33-34";
            } else if (mship.equalsIgnoreCase("J")) {
                mship = "Associate Golf";
            } else if (mship.equalsIgnoreCase("T")) {
                mship = "G Sr 75/35";
            } else if (mship.equalsIgnoreCase("VGS")) {
                mship = "G SR 80/35";
            } else if (mship.equalsIgnoreCase("VG")) {
                mship = "G Sr 90/35";
            }
