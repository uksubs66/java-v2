...
D0	Active Full & House
D1	O'Sullivan Both
D2	O'Sullivan & House
D6	O'Sullivan
D9	Leave of Absence
D00	O'Sullivan & Active Restricted
D01	Household Full
D02	Active Full
D03	Family B
D04	Active Restricted
D05	Active Restricted Both
D06	O'Sullivan & Active Retired Restricted
D07	Active Retired Full
D08	Active Retired Full & Retired Restricted
D09	Active Retired Full & Active Restricted
D10	Jr. (26-32)
D11	Jr. (16-25)
D12	Active Retired Restricted Both
D13	Active Retired Restricted
D14	Active Retired Restricted & Active Restricted
D15	Half Century
D16	Honorary
D17	Executive Family
D18	Active Full & House
D19	Active Retired Restricted & House
D20	House
D21	Former Member
D22	Past President
D23	O'Sullivan & Active Retired Restricted
D25	Executive Family
D26	Active Restricted & Hosue
D27	Active Full & Active Retired Restricted
D28	Jr. (26-32) Both
D29	House Both
D30	O'Sullivan & House
D31	Active Retired Restricted & House
D41	Corporate Primary
D42	Corporate Secondary
D43	Active Retired Full & O'Sullivan
D44	Active Restricted & House
D45	Family C
D46	Corporate House
PG	Paugusset Golf
             */
            ...
            if (!use_curr_lname) {
                ...
                if (mship.equals("D0")) {
                    mship = "Active Full & House";
                } else if (mship.equals("D1")) {
                    mship = "O'Sullivan Both";
                } else if (mship.equals("D2")) {
                    mship = "O'Sullivan & House";
                } else if (mship.equals("D6")) {
                    mship = "O'Sullivan";
                } else if (mship.equals("D9")) {
                    mship = "Leave of Absence";
                } else if (mship.equals("D00")) {
                    mship = "O'Sullivan & Active Restricted";
                } else if (mship.equals("D01")) {
                    mship = "Household Full";
                } else if (mship.equals("D02")) {
                    mship = "Active Full";
                } else if (mship.equals("D03")) {
                    mship = "Family B";
                } else if (mship.equals("D04")) {
                    mship = "Active Restricted";
                } else if (mship.equals("D05")) {
                    mship = "Active Restricted Both";
                } else if (mship.equals("D06")) {
                    mship = "O'Sullivan & Active Retired Restricted";
                } else if (mship.equals("D07")) {
                    mship = "Active Retired Full";
                } else if (mship.equals("D08")) {
                    mship = "Active Retired Full & Retired Restricted";
                } else if (mship.equals("D09")) {
                    mship = "Active Retired Full & Active Restricted";
                } else if (mship.equals("D10")) {
                    mship = "Jr. 26-32";
                } else if (mship.equals("D11")) {
                    mship = "Jr. 16-25";
                } else if (mship.equals("D12")) {
                    mship = "Active Full & House";
                } else if (mship.equals("D13")) {
                    mship = "Active Retired Restricted";
                } else if (mship.equals("D14")) {
                    mship = "Active Retired Restricted & Active Restricted";
                } else if (mship.equals("D15")) {
                    mship = "Half Century";
                } else if (mship.equals("D16")) {
                    mship = "Honorary";
                } else if (mship.equals("D17")) {
                    mship = "Executive Family";
                } else if (mship.equals("D18")) {
                    mship = "Active Full & House";
                } else if (mship.equals("D19")) {
                    mship = "Active Retired Restricted & House";
                } else if (mship.equals("D20")) {
                    mship = "House";
                } else if (mship.equals("D21")) {
                    mship = "Former Member";
                } else if (mship.equals("D22")) {
                    mship = "Past President";
                } else if (mship.equals("D23")) {
                    mship = "O'Sullivan & Active Retired Restricted";
                } else if (mship.equals("D25")) {
                    mship = "Executive Family";
                } else if (mship.equals("D26")) {
                    mship = "Active Restricted & House";
                } else if (mship.equals("D27")) {
                    mship = "Active Full & Active Retired Restricted";
                } else if (mship.equals("D28")) {
                    mship = "Jr. 26-32 Both";
                } else if (mship.equals("D29")) {
                    mship = "House Both";
                } else if (mship.equals("D30")) {
                    mship = "O'Sullivan & House";
                } else if (mship.equals("D31")) {
                    mship = "Active Retired Restricted & House";
                } else if (mship.equals("D41")) {
                    mship = "Corporate Primary";
                } else if (mship.equals("D42")) {
                    mship = "Corporate Secondary";
                } else if (mship.equals("D43")) {
                    mship = "Active Retired Full & O'Sullivan";
                } else if (mship.equals("D44")) {
                    mship = "Active Restricted & House";
                } else if (mship.equals("D45")) {
                    mship = "Family C";
                } else if (mship.equals("D46")) {
                    mship = "Corporate House";
                } else if (mship.equals("PG")) {
                    mship = "Paugusset Golf";
                }
                
                mship_curr = mship;
                
                StringTokenizer tokx = new StringTokenizer(lname, " ");

                if (lname.startsWith("Mr.")) {
                    gender = "M";
                    mtype = "Primary Male";
                    tokx.nextToken();
                } else if (lname.startsWith("Mrs.")) {
                    gender = "F";
                    mtype = "Primary Female";
                    tokx.nextToken();
                }

                if (tokx.countTokens() >= 4) {

                    fname = tokx.nextToken() + " " + tokx.nextToken();
                    lname = tokx.nextToken();

                    lname_curr = lname;

                    while (tokx.countTokens() > 0) {
                        lname += " " + tokx.nextToken();
                    }
