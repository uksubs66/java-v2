...
*/
            ...
            if (mship.equals("?")) {
                ...
                try {
                    ...
                    tstmt = con.prepareStatement("SELECT m_ship from member2b where username = ?");
                    tstmt.clearParameters();
                    tstmt.setString(1, mNum);

                    trs = tstmt.executeQuery();

                    if (trs.next()) {
                        mship = trs.getString("m_ship");
                    } else {
                        mship = "Primary User Not Found";
                    }

                } catch (Exception exc) {
                    mship = "ERROR in finding primary";
                } finally {
                    tstmt.close();
                }
