            ...
            if (mNum.startsWith("S")) {
                ...
                if (gender.equals("M")) {
                    ...
                    pstmt2 = con.prepareStatement(
                            "SELECT m_ship FROM member2b WHERE memNum = ?");
             ...
             if (dupName == false) {
                 ...
                 if (!mship.equals("DO NOT SYNC")) {
                  ...
                  //
                     ...
                     out.println("<br>Primary Not Found - Passed: lname: " + lname + ", fname: " + fname + ", mNum: " + mNum);
                 }
                 } else {
                     out.println("<br>Insert failed - missing Membership type - Passed: lname: " + lname + ", fname: " + fname + ", mNum: " + mNum + " ,Membership Type:"+mship);
                 }
             } else {
