...
*/           
            ...
            int mNumint = Integer.parseInt(mNum);

            if (mNumint < 4000) {
                mship = "Equity";
            } if (mNumint >= 4000 && mNumint < 5000) {
                mship = "Associate";
            } if (mNumint >= 5000 && mNumint < 6000) {
                mship = "Social";
            } if (mNumint >= 6000 && mNumint < 7000) {
                mship = "Summer";
            } if (mNumint >= 7000 && mNumint < 8000) {
                mship = "Corporate";
            }

            mtype = "Primary Member";
...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
               ...
               StringTokenizer stok = new StringTokenizer(fname2, " ");

               if (stok.countTokens() > 0) {
                   fname2 = stok.nextToken();
               }

               mtype2 = "Spouse Member";
