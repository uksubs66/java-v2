...
*/           
            ...
            if (mship.equalsIgnoreCase("GENERAL")) {
...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
      ...
      out.println("<BR><BR>Exception Received on Line Number " + count + ", Tok Count = " + tokcount + ", memid = " +mem_id+ ", Error = "+ e3.toString());
      out.println("<BR><BR> <A HREF=\"/" +rev+ "/support_main.htm\">Return</A>");
      out.println("</CENTER></BODY></HTML>");
      return;
   }
