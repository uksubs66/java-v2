...
*/           
            ...
            if (!pri.equalsIgnoreCase("Pri")) {
                ...
                // name is all in last name field.  parse and split it
                ...
                if (nameTok.countTokens() < 2) {
                    ...
                    String tname1 = nameTok.nextToken();
                    String tname2 = nameTok.nextToken();
                    String tname3 = nameTok.nextToken();

                    if (tname3.startsWith("Jr") || tname3.startsWith("Mr") || tname3.startsWith("Ms")) {
                    ...
                    fname = nameTok.nextToken();
                    mi = nameTok.nextToken();
                    lname = nameTok.nextToken() + " " + nameTok.nextToken();
                }

                if (pri.equalsIgnoreCase("Sp")) {
                    mtype = "Spouse Female";
                    gender = "F";
                } else {
                    mtype = "Dependent";
