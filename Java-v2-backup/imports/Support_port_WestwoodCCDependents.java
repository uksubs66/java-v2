...
*/           
            ...
            if (tempStr.length == 2) {
                ...
                if (tempStr[2].toUpperCase().startsWith("SR") || tempStr[2].toUpperCase().startsWith("JR") || tempStr[2].toUpperCase().startsWith("II") || tempStr[2].toUpperCase().startsWith("MD")) {
                    lname = tempStr[1] + " " + tempStr[2];
                } else {
                    mi = tempStr[1];
                    lname = tempStr[2];
                }
                ...
                for(int x=3; x<tempStr.length; x++) {
                    lname += " " + tempStr[x];
                }
            }
