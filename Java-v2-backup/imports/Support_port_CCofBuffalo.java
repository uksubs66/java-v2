...
*/           
            ...
            if (mship.startsWith("Full")) {
                mship = "Resident";
            } else if (mship.equalsIgnoreCase("Non Full SL")) {
                mship = "Non Resident SL";
            } else if (mship.equalsIgnoreCase("Non Full 90")) {
                mship = "Non Resident 90";
            } else if (mship.equalsIgnoreCase("Non Full 10")) {
                mship = "Non Resident 10";
            } else {
                mship = "Unknown";
            }
