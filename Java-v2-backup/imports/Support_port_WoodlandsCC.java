            ...
            if (dupName == false) {
               ...
               try {
                  ...
                  pstmt2 = con.prepareStatement (
                     ...
                     "m_ship, m_type, email, count, c_hancap, " +
                     "g_hancap, wc, message, emailOpt, memNum, " +
                     "ghin, locker, bag, birth, posid, " +
                     "msub_type, email2, phone1, phone2, name_pre, " +
                     "name_suf, webid, email_bounced, email2_bounced, gender, " +
                     "pri_indicator) " +
                     "VALUES (" +
                     "?,?,?,?,?," +
                     "?,?,?,0,?," +
                  ...
                  pstmt2.close();              // close the stmt
                     ...
                     out.println("<br>Insert failed for " + lname + ", " + fname + "   - " + ignore.getMessage());
               }
