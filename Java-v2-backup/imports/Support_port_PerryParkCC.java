...
//            birth = getBirthValue(temp, 0);
            ...
            if (mship.equalsIgnoreCase("D01")) {
                mship = "Full Golf Member";
            } else if (mship.equalsIgnoreCase("D02")) {
                mship = "Full Out of Area Member";
            } else if (mship.equalsIgnoreCase("D05")) {
                mship = "Life Member";
            } else if (mship.equalsIgnoreCase("D06")) {
                mship = "Centennial";
            } else if (mship.equalsIgnoreCase("D09")) {
                mship = "Business Account";
            } else if (mship.equalsIgnoreCase("D10")) {
                mship = "Full Non-Equity";
            } else if (mship.equalsIgnoreCase("D11")) {
                mship = "Prepaid Dues";
            } else if (mship.equalsIgnoreCase("D12")) {
                mship = "Unknown - D12";
            } else if (mship.equalsIgnoreCase("D30")) {
                mship = "Honorary";
            } else if (mship.equalsIgnoreCase("D85")) {
                mship = "Annual Pass Member";
            } else {
                mship = "Unknown - " + mship;
            }
...
*/   
            ...
            if (!fname2.equals( "" )) {
               ...
               if (tok2.countTokens() == 2) {
                   ...
                   fname2 = tok2.nextToken();
                   lname2 = tok2.nextToken();
                   
               } else if (tok2.countTokens() == 3) {
                   
                   // first-name mi last-name
                   fname2 = tok2.nextToken();
                   mi = tok2.nextToken();
                   lname2 = tok2.nextToken();
               } else if (tok2.countTokens() > 0) {
                   fname2 = tok2.nextToken();
               }
           ...
           //    gender = "F";      // default for spouse
               ...
               if (gender2.equalsIgnoreCase( "F" )) {   // if primary was Male      
