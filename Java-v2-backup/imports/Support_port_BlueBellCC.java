...
//            birth = getBirthValue(temp, 0);
    ...
    //        birth = Integer.valueOf(temp);
            ...
            if (mtok.countTokens() == 2) {
                mNum = mtok.nextToken();
                primary = Integer.parseInt(mtok.nextToken());
            }
            ...
            if (mship.equalsIgnoreCase("GLF") || mship.endsWith("A1") || mship.endsWith("G1") || mship.endsWith("G2") || mship.endsWith("G3")) {
                mship = "Golf";
            } else {
                mship = "Social";
            }
