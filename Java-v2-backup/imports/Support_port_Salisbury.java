...
//            birth = getBirthValue(temp, 0);
            ...
            StringTokenizer mtok = new StringTokenizer(mNum, "-");
            ...
            if (mship.equals("1") || mship.equals("24")) {
                mship = "A Family";
            } else if (mship.equals("2")) {
                mship = "A Single";
            } else if (mship.equals("9")) {
                mship = "A Family Senior";
            } else if (mship.equals("10")) {
                mship = "A Single Senior";
            } else if (mship.equals("15")) {
                mship = "Clergy";
            } else if (mship.equals("20")) {
                mship = "Junior/Legacy Family Under 30";
            } else if (mship.equals("21")) {
                mship = "Junior/Legacy Family Over 30";
            } else if (mship.equals("22")) {
                mship = "Junior/Legacy Single Under 30";
            } else if (mship.equals("23")) {
                mship = "Junior/Legacy Single Over 30";
            } else {
                mship = mship + " - Unknown";
            }
