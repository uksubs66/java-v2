...
*/           
            ...
            if (mNum.startsWith("448-")) {
                mNum = mNum.substring(4,mNum.length() - 1);  // remove 448- and trailing 00
            }
            mem_id = mNum;
     
            if (mship.equalsIgnoreCase("full golf")) {
                mship = "Full Golf";
            } else if (mship.equalsIgnoreCase("limited golf")) {
                mship = "Limited Golf";
            ...
            } else if (mtype.equalsIgnoreCase("secondary")) {
   ...
   //            lname2 = lname;
        ...
        */
            ...
            if (!fname3.equals( "" )) {
               ...
               fname3 = fname3.substring(0, fname3.length() - 4);
            ...
            if (!fname4.equals( "" )) {
               ...
               fname4 = fname4.substring(0, fname4.length() - 4);
            ...
            if (!fname5.equals( "" )) {
               ...
               fname5 = fname5.substring(0, fname5.length() - 4);
            ...
            if (!fname6.equals( "" )) {
               ...
               fname6 = fname6.substring(0, fname6.length() - 4);
            ...
            if (!fname7.equals( "" )) {
               ...
               fname7 = fname7.substring(0, fname7.length() - 4);
