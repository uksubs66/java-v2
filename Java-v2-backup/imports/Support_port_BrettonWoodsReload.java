...
//         mi = tok.nextToken();
         ...
         primary = Integer.parseInt(tok.nextToken());
         mship = tok.nextToken();
//         temp = tok.nextToken();
         mtype = tok.nextToken();
...
*/           
            ...
            if (fname.equalsIgnoreCase("Recip")) {
                
                String [] lname_temp = lname.split(" ");
                
                lname = lname_temp[0];
                
                for (int j = 1; j < lname_temp.length; j++) {
                    lname += "_" + lname_temp[j];
                }
            }
            
            if (mtype.equalsIgnoreCase("Active")) {
            ...
            } else if (mtype.equalsIgnoreCase("Child") || mtype.equalsIgnoreCase("Daughter") || mtype.equalsIgnoreCase("Son")) {
                mtype = "Child";
            } else if (mtype.equalsIgnoreCase("Reciprocal")) {
                mtype = "Reciprocal";
            } else if (mtype.equalsIgnoreCase("Guest")) {
                mtype = "Guest Card";
            } else if (mtype.equalsIgnoreCase("Legal Dept")) {
                mtype = "Legal Department";
            } else if (mtype.equalsIgnoreCase("NON RES IM") || mtype.equalsIgnoreCase("NONRESIDE")) {
                if (gender.equalsIgnoreCase("F")) {
                    mtype = "Active Female";
                } else {
                    mtype = "Active Male";
            ...
            if (dupName == false) {
               ...
               try {
                  ...
                  pstmt2 = con.prepareStatement (
                     ...
                     "email_bounced, email2_bounced, gender, pri_indicator, tflag) " +
                     "VALUES (?,?,?,?,?,?,?,?,0,?,?,?,'',?,?,?,'',?,?,?,'',?,?,?,'','',?,0,0,?,?,?)");
