...
//            mtype = toTitleCase( mtype );
            ...
            } else if (mNum.toUpperCase().endsWith("B") || mNum.toUpperCase().endsWith("C") || mNum.toUpperCase().endsWith("D") || mNum.toUpperCase().endsWith("E") || mNum.toUpperCase().endsWith("F") || mNum.toUpperCase().endsWith("G") || mNum.toUpperCase().endsWith("H") || mNum.toUpperCase().endsWith("I") || mNum.toUpperCase().endsWith("J") || mNum.toUpperCase().endsWith("K") || mNum.toUpperCase().endsWith("L") || mNum.toUpperCase().endsWith("M") || mNum.toUpperCase().endsWith("T")) {
                mNum = mNum.substring(0, mNum.length()-1);
   ...
   //            lname2 = lname;
           ...
           //    gender = "F";      // default for spouse
               ...
               try {
                    ...
                    boolean dupName2 = false;

                    pstmt2 = con.prepareStatement(
                            "SELECT inact FROM member2b WHERE name_last = ? AND name_first = ? AND name_mi = ?");

                    pstmt2.clearParameters();
                    pstmt2.setString(1, lname2);
                    pstmt2.setString(2, fname2);
                    pstmt2.setString(3, mi);
                    rs = pstmt2.executeQuery();            // execute the prepared stmt
