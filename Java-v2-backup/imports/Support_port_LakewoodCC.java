...
//            birth = getBirthValue(temp, 0);
            ...
            if (mship.equalsIgnoreCase("AJ")) {
                mship = "Associate Junior";
            } else if (mship.equalsIgnoreCase("ALM")) {
                mship = "Active-Life Member";
            } else if (mship.equalsIgnoreCase("ALS")) {
                mship = "Active-Life Spouse";
            } else if (mship.equalsIgnoreCase("AM")) {
                mship = "Associate Member";
            } else if (mship.equalsIgnoreCase("AMC")) {
                mship = "Associate Member Child";
            } else if (mship.equalsIgnoreCase("AS")) {
                mship = "Associate Spouse";
            } else if (mship.equalsIgnoreCase("ATG")) {
                mship = "Avenel Temporary Guest";
            } else if (mship.equalsIgnoreCase("EWGP")) {
                mship = "Employee With Golf Priv";
            } else if (mship.equalsIgnoreCase("GUEST")) {
                mship = "Guest of the Club";
            } else if (mship.equalsIgnoreCase("HONORARY")) {
                mship = "Honorary";
            } else if (mship.equalsIgnoreCase("JRG")) {
                mship = "Junior Regular Golfer";
            } else if (mship.equalsIgnoreCase("LIFE ACT")) {
                mship = "Life ACT";
            } else if (mship.equalsIgnoreCase("LIFE ACTW")) {
                mship = "Life ACTW";
            } else if (mship.equalsIgnoreCase("NGP")) {
                mship = "No Golf Privilege";
            } else if (mship.equalsIgnoreCase("RECIPROCAL")) {
                mship = "Reciprocal";
            } else if (mship.equalsIgnoreCase("RMCG")) {
                mship = "Regular Member-Child Golfer";
            } else if (mship.equalsIgnoreCase("RPG")) {
                mship = "Regular Preferred Golfer";
            } else if (mship.equalsIgnoreCase("SIG OTHER")) {
                mship = "Significant Other";
            } else if (mship.equalsIgnoreCase("SPOUSE")) {
                mship = "Spouse";
            } else if (mship.equalsIgnoreCase("SRG")) {
                mship = "Spouse Regular Golfer";
            } else {
                mship = "Unknown";
            }
