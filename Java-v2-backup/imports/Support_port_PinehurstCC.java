...
*/           
            ...
            if (mship.equals("0")) {
                mtype = "Primary";
            } else if (mship.equals("1")) {
                mtype = "Secondary";
            } else if (mship.equals("2") || mship.equals("3")) {
                mtype = "Qualified Junior";
            } else if (mship.equals("4")) {
                mtype = "Junior";
            }
            ...
            if (Integer.parseInt(mNum) < 9000) {
                mship = "Proprietary";
            } else if (Integer.parseInt(mNum) >= 9000 && Integer.parseInt(mNum) < 10000) {
                mship = "Associate";
            } else {
                mship = "Unknown";
            }
