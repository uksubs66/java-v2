...
//         posid = tok.nextToken();
         ...
         if (!mNum.equalsIgnoreCase(mNum_curr)) {
             mNum_curr = mNum;
             mship_curr = mship;
         }
...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
      ...
      out.println("<BR><BR>Exception Received on Line Number " + count + ", Tok Count = " + tokcount + ", memid = " +mem_id+ ",err: " + e3.toString() + ", Error = "+ e3.getMessage());
      out.println("<BR><BR> <A HREF=\"/" +rev+ "/support_main.htm\">Return</A>");
      out.println("</CENTER></BODY></HTML>");
      return;
   }
