...
//            mtype = toTitleCase( mtype );
            ...
            if (mship.equalsIgnoreCase("S/O Child") || mship.equalsIgnoreCase("Signaficant Other") || mship.equalsIgnoreCase("Child") || mship.equalsIgnoreCase("Spouse")) {
                mNum = mNum.substring(0,mNum.length()-1);
                if (mship.equalsIgnoreCase("S/O Child") || mship.equalsIgnoreCase("Child")) {
                if (gender.equalsIgnoreCase("f")) {
                    mtype = "Depenent Female";
                } else {
