...
//            mtype = toTitleCase( mtype );
            ...
            if (dupName == false) {
                ...
                try {
                    ...
                    pstmt2 = con.prepareStatement("SELECT IF(MAX(username) REGEXP '[A-Za-z]$', SUBSTR(MAX(username), LENGTH(MAX(username))), IF(MAX(username) IS NOT NULL, 'YY', 'ZZ')) AS user_suffix "
                            + "FROM member2b WHERE memNum = ? AND username REGEXP '[0-9][A-Za-z]*$'");
                    pstmt2.clearParameters();
                    ...
                    if (rsx.next()) {
                        ...
                        if (rsx.getString("user_suffix").equalsIgnoreCase("YY")) {
                            mem_id += "A";
                            mtype = "Adult Female";
                            gender = "F";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("A")) {
                            mem_id += "B";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("B")) {
                            mem_id += "C";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("C")) {
                            mem_id += "D";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("D")) {
                            mem_id += "E";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("E")) {
                            mem_id += "F";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("F")) {
                            mem_id += "G";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("G")) {
                            mem_id += "H";
                        } else if (rsx.getString("user_suffix").equalsIgnoreCase("H")) {
                            mem_id += "I";
                        } else {
                            mtype = "Adult Male";
                            gender = "M";
                     ...
                     out.println("<br>Username suffix lookup failed for " + lname + ", " + fname + " - mNum: " + mNum + " - (" + exc.getMessage() + ")");                    
                } finally {
               ...
               try {
                  ...
                  // out.println("<br><span style=\"color:green; font-weight:bold\">Successful:</span> Adding member - name: " + lname + ", " + fname + " " + mi + " - mNum: " + mNum + ", username: " + mem_id + ", mship: " + mship + ", mtype: " + mtype);
   ...
   //            lname2 = lname;
        ...
        */
         ...
         } else {   // end of IF record is ok (name exists)   
             out.println("<br>Insert failed - missing data - Passed: lname: " + lname + ", fname: " + fname + ", mNum: " + mNum);
         }
