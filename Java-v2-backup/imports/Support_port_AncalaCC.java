...
/*
         ...
         */
            ...
            if (!lname2.equals("") && tok.countTokens() > 0 ) {         // spouse
            ...
            if ( !lname3.equals("") && tok.countTokens() > 0 ) {         // Dependents
            ...
            if (!lname4.equals("") && tok.countTokens() > 0 ) {         // Dependents
            ...
            if (!lname5.equals("") && tok.countTokens() > 0 ) {         // Dependents
...
//            mtype = toTitleCase( mtype );
   ...
   //            lname2 = lname;
               ...
               if (lname2.startsWith("\"")) {
                   lname2 = lname2.substring(1);
               }
           ...
           //    gender = "F";      // default for spouse
            ...
            if (!fname3.equals( "" )) {
               ...
               if (lname3.startsWith("\"")) {
                   lname3 = lname3.substring(1);
               }
            ...
            if (!fname4.equals( "" )) {
               ...
               if (lname4.startsWith("\"")) {
                   lname4 = lname4.substring(1);
               }
            ...
            if (!fname5.equals( "" )) {
               ...
               if (lname5.startsWith("\"")) {
                   lname5 = lname5.substring(1);
               }
