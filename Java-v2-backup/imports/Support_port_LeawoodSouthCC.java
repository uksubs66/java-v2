...
//         posid = tok.nextToken();
         ...
         if (mNum.equalsIgnoreCase(mNumCurr)) {
             if (mtype.startsWith("Junior")) {
                 famCount++;
             }
         } else {
             mNumCurr = mNum;
...
*/
            ...
            if (mtype.equalsIgnoreCase("Adult Male")) {
                primary = 0;
            } else if (mtype.equalsIgnoreCase("Adult Female")) {
                primary = 1;
                mem_id += "A";
            } else {
                primary = 1+famCount;
