 ...
 *   last updated:
 *
 *        2/10/11   Block use of this feature from FlxRez activities until it has been updated to build activity time sheets as well.
...
public class Proshop_buildTees extends HttpServlet {
 ...
 public void doGet(HttpServletRequest req, HttpServletResponse resp)
   ...
   //  *****TEMP***** Block FlxRez users from using this feature until it's updated to be able to build FlxRez time sheets (currently only does golf)
   if (sess_activity_id != 0) {

       out.println(SystemUtils.HeadTitle("Contact Support"));
       out.println("<BODY><CENTER>");
       out.println("<BR><BR><H3>Contact Support</H3>");
       out.println("<BR><BR>Please contact ForeTees Proshop Support in order to build time sheets for this activity.");
   ...
   if (multi == 0) {
      ...
      out.println("<meta http-equiv=\"Refresh\" content=\"0; url=Proshop_buildTees?course=" + course + "\">");
      out.println("</HEAD>");
      ...
      try {
         ...
         out.println("<font size=\"2\" face=\"Arial, Helvetica, Sans-serif\">");
         out.println("<form action=\"Proshop_buildTees\" method=\"post\" target=\"bot\">");
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
   ...
   if (req.getParameter("conf") != null) {
      ...
      if (!course.equals( "" )) {
         ...
         out.println("<form method=\"get\" action=\"Proshop_buildTees\">");
         out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
      ...
      try {
         ...
         if (rs.next()) {
            ...
            out.println("<form action=\"Proshop_announce\" method=\"get\" target=\"bot\">");
            out.println("<input type=\"submit\" value=\"Return\" style=\"text-decoration:underline; background:#8B8970\">");
            out.println("</form>");
            out.println("</CENTER></BODY></HTML>");
            out.close();
